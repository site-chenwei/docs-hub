...
menu_path:
  ...
  - "资源与存储优化"
  - "文件上传下载优化"
captured_at: "2026-04-17T01:54:18.219Z"
---
...
**图1** 模块流程图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/XokroGxVRj-RQRsmXO_OAA/zh-cn_image_0000002229451197.png?HW-CC-KV=V1&HW-CC-Date=20260417T015420Z&HW-CC-Expire=86400&HW-CC-Sign=5F3F9AFA9C3B6A7595AF46258950F752173F6914969051D510CC6EA3DE74A50F "点击放大")
...
**图2** 上传数量和耗时对比图表  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/58/v3/5-15CJeJSS6fYyvPQ7GyYg/zh-cn_image_0000002193851324.png?HW-CC-KV=V1&HW-CC-Date=20260417T015420Z&HW-CC-Expire=86400&HW-CC-Sign=810AA890530309861B7DA8EBC5BB027942079B28B47D18BA1F1B10AF6A8B779D "点击放大")
    ...
    async zipUploadFiles(fileUris: Array<string>): Promise<void> {
      try {
        ...
        for (let i = 0; i < fileUris.length; i++) {
          ...
          let resourceFile: fileIo.File = fileIo.openSync(fileUris\[i\], fileIo.OpenMode.READ\_ONLY);
        ...
        let options: zlib.Options = {
          level: zlib.CompressLevel.COMPRESS\_LEVEL\_DEFAULT\_COMPRESSION,
          memLevel: zlib.MemLevel.MEM\_LEVEL\_DEFAULT,
          strategy: zlib.CompressStrategy.COMPRESS\_STRATEGY\_DEFAULT\_STRATEGY
        };
...
**图3** 断点续传上传流程图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/df/v3/rlkNpHtyRriydcPEA6-0xA/zh-cn_image_0000002193851312.png?HW-CC-KV=V1&HW-CC-Date=20260417T015420Z&HW-CC-Expire=86400&HW-CC-Sign=E8FF31BFFE9448949CD7E6C73DC1A612239CE2E910CCDFEB7B45B00230EDE372 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/33/v3/qNdhSDLVRlWf-jFPdF2zjg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015420Z&HW-CC-Expire=86400&HW-CC-Sign=132C394D63CE02A724A0CB27AC480D4E88FC2314FE7D294C7B7A0E671AC4E2E7)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e/v3/1_KB7mDARg-FaGSq9mXlEA/zh-cn_image_0000002229451201.png?HW-CC-KV=V1&HW-CC-Date=20260417T015420Z&HW-CC-Expire=86400&HW-CC-Sign=675FA6F273CB4D730D0ED34C5AEC6365561DEFC964A85DB2196F2326F215ECB5 "点击放大")
...
3.  创建下载任务并注册相关监听。本例中，在每个 \`FileDownloadItem\` 中使用 \`request.agent.create()\` 创建下载任务。下载任务创建成功后，注册以下回调：下载完成、下载失败、进度更新、暂停、重新启动以及响应头数据。在相应的回调中，获取当前文件的下载状态等数据。
    ...
    private completedCallback = (progress: request.agent.Progress) => {
      this.textState = $r("app.string.download\_completed");
      if (this.sFileSize === -1) {
