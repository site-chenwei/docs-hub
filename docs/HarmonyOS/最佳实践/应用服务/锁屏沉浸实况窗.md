---
title: "锁屏沉浸实况窗"
source_url: "https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-lock-screen-immersive-live-window"
menu_path:
  - "最佳实践"
  - "应用服务"
  - "锁屏沉浸实况窗"
captured_at: "2026-04-17T01:54:15.665Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/Lw_dIlPpQu6qjGbV992-vA/zh-cn_image_0000002484414413.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=929FCD301DEDC229F3375CA4D389C5EC5227E07F0CB4144E17C37B2637827504 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/53/v3/Bh6gjqkxTqeUuD0LLJ3HZw/zh-cn_image_0000002484415005.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=AEE2017C00B1FA0CD1B90BB901C68263E9D3DEE73E112651D2A34CF2EB3139A7 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4b/v3/deAEeHSCRhKcjHs10_gtJw/zh-cn_image_0000002484291273.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=5595B3AD6230712A22C96D3520A4D2A72598FC78BDDFB899B83D420756AAAC94 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/30/v3/KyGO6agfTbKTrWpEfC7uCg/zh-cn_image_0000002309310946.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=04FFDA158A49A3B16AD185B3483F859C3A5700C201A5CDBAE0641899D0F374FB "点击放大")
        ...
        let liveView: liveViewManager.LiveView = {
          ...
          liveViewData: {
            ...
            capsule: {
              ...
              status: 1,
              icon: 'turn\_right\_light\_square.png',
              backgroundColor: this.getStringSync($r('app.string.live\_view\_background').id),
              title: this.getStringSync($r('app.string.live\_view\_title').id),
            },
            // Live view card related parameters
            primary: {
              title: this.getStringSync($r('app.string.live\_view\_title').id),
              content: \[{ text: this.getStringSync($r('app.string.live\_view\_content').id) }\],
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fb/v3/DaWLEkBlS66kC0YTL8Wf9w/zh-cn_image_0000002484410785.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=096913F9FA9FA1FBBEEA8CE01C826179EAFAC88CE36CC4C8C96277100D41FD03 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4d/v3/C05yk0UwTtWJ2si07KIQYw/zh-cn_image_0000002343349997.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=616A0A48407A33DFF2901CC340086437179AEE6C102F88B2DFE34BA5D49935BE "点击放大")
...
2.  发布公共事件传递更新数据到锁屏沉浸实况窗。
    ...
    // ...
                ...
                commonEventManager.publish('live\_view\_lock\_screen', options, (error: BusinessError) => {
                  if (error) {
                    hilog.error(0x0000, TAG, '%{public}s',
...
3.  订阅公共事件更新锁屏沉浸实况窗。
    ...
    // ...
        ...
        let subscribeInfo: commonEventManager.CommonEventSubscribeInfo = {
          events: \['live\_view\_lock\_screen'\],
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/54/v3/x5Q0b5w0SyGXnV4AthE6lg/zh-cn_image_0000002451295374.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=B9F87CA6E400E73956EA55780A31635BE498BCFA9DE784DA92E5C08F96401462 "点击放大")
    ...
    // ...
      ...
      private updateBreakPoint(windowSize: window.Size): void {
        try {
          ...
          let verticalBreakpoint: string = Constants.BREAK\_POINT\_SM;
          // Vertical breakpoints are distinguished by aspect ratio.
          if (windowRatio < 0.8) {
            verticalBreakpoint = Constants.BREAK\_POINT\_SM;
          } else if (windowRatio > 1.2) {
            verticalBreakpoint = Constants.BREAK\_POINT\_LG;
          } else {
            verticalBreakpoint = Constants.BREAK\_POINT\_MD;
          }
...
3.  在 LockScreenPage中采用纵向断点监听机制，根据窗口大小动态切换布局样式。
    ...
    @StorageLink('verticalBreakpoint') verticalBreakpoint: string = Constants.BREAK\_POINT\_SM;
    @StorageProp('laneData') laneData: LaneData | undefined = undefined;
    
    build() {
      Stack({ alignContent: Alignment.Top }) {
        Image(this.verticalBreakpoint === Constants.BREAK\_POINT\_MD ? $r('app.media.ic\_lock') : $r('app.media.ic\_lock\_md'))
          .width('100%')
          .height('100%')
    
        Row() {
          Stack() {
            Image($r('app.media.ic\_light'))
              .width(this.verticalBreakpoint === Constants.BREAK\_POINT\_MD ? 73.5 : 106)
              .height(this.verticalBreakpoint === Constants.BREAK\_POINT\_MD ? 36 : 52)
            Text(JSON.stringify(this.laneData?.lightTime ?? 90))
              .fontColor($r('sys.color.white'))
              .fontSize(this.verticalBreakpoint === Constants.BREAK\_POINT\_MD ? 24 : 30)
              .margin({ right: this.verticalBreakpoint === Constants.BREAK\_POINT\_MD ? 8 : 16 })
          }
        ...
        .position({
          ...
          right: 20,
          top: this.verticalBreakpoint === Constants.BREAK\_POINT\_MD ? 32 : 25
        })
      }
      .width('100%')
      .height('100%')
...
this.updateInterval = setInterval(() => {
  ...
  appManager.getRunningProcessInformation().then((data: Array<appManager.ProcessInformation>) => {
    ...
    if (data\[0\].state === appManager.ProcessState.STATE\_BACKGROUND) {
      // ...
    }
  }).catch((error: BusinessError) => {
    hilog.error(0x0000, TAG, '%{public}s',
