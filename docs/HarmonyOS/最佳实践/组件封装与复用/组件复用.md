---
title: "组件复用"
source_url: "https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-component-reuse"
menu_path:
  - "最佳实践"
  - "组件封装与复用"
  - "组件复用"
captured_at: "2026-04-17T01:54:13.380Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/DbdZ1F-1SHK7LtExkSZlBg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=FE0BE3DA5A0ABE63F9F232FD88A5DD9575C69F1B9340B1338F0E5FCED27FE6A9)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b/v3/FLFn1bwhRA-Af7GQLDK0QQ/zh-cn_image_0000002306983630.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=5E9BD3FE3FB7979044D4318C2A315409F965AFA1AA4C049A89BFA5AC2B703DE8 "点击放大")

#### \[h2\]实现原理

ArkUI提供了[@Reusable装饰器](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-reusable)以实现自定义组件的复用，其原理如图所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a0/v3/r09KAHqzRruqUWthfEF2dg/zh-cn_image_0000002341062601.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=5E1F4D7C7427666BA9691786B499C5A38F934A5448A0682DA23FCE5ABFFC2E87 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/36/v3/KYQMNNS9Qn-4BVQChEtFdQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=63E63D68C1DE61069503B8FE478AD2EC556BA9604F7E1C73F27FB88F03EB18E8)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/90/v3/A0x8CRXXRN-Ib_YrKdMg6g/zh-cn_image_0000002321247750.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=4FBE64D9C64863547C40708CE2959397E1F828AEE34817726A4AAA61DC45504C "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ae/v3/3-1DZ6Y-TKu5POnryUmxwg/zh-cn_image_0000002355045581.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=BB90CA148AD8CFF03416C8AEEF3A4903CF69D3C3D592E9B685812546BD68A946 "点击放大")
          ...
          LazyForEach(this.dataSource, (item: ItemData) => {
            if (item.type === 0) {
              TextTypeItemView({ item: item })
                .reuseId('text\_item\_id')
            } else if (item.type === 1) {
              ImageTypeItemView({ item: item })
                .reuseId('image\_item\_id')
            } else if (item.type === 2) {
              ThreeImageTypeItemView({ item: item })
                .reuseId('three\_image\_item\_id')
            }
          }, (item: ItemData) => item.id.toString())
        }
        // ...
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9a/v3/ymFqdxQPTFG-ct1r5g8SPA/zh-cn_image_0000002306983638.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=03CD1C79A67DC823FDF3778D4E859AB6831D66558D06C1D3BA6E0F7248FB0BB8 "点击放大")

因此，可以创建五种复用子组件，通过子组件的选择组合，实现不同类型的列表项。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/_nQWsI4SRr-eiUZIMRgXmQ/zh-cn_image_0000002341062605.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=7A9C16A12C5C53926B6E6AE0BF3F7ED4BBEF783D28B3558926BA37B7ABD2770C "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/UNfRN0ajSPCdUvABJrQBxg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=21012D146FBADEBEE5239C5ABA2A31E73332EA6FE4B321985AF34945AB21BEF3)
...
export struct ComposableItemPage {
  ...
  itemBuilderSingleImage(item: ItemData) {
    TopView({ item: item }).reuseId('top\_id')
    MiddleSingleImageView({ item: item }).reuseId('middle\_image\_id')
    BottomView({ item: item }).reuseId('bottom\_id')
  }

  @Builder
  itemBuilderThreeImage(item: ItemData) {
    TopView({ item: item }).reuseId('top\_id')
    MiddleThreeImageView({ item: item }).reuseId('middle\_three\_image\_id')
    BottomView({ item: item }).reuseId('bottom\_id')
  }
  ...
  itemBuilderVideoImage(item: ItemData) {
    TopView({ item: item }).reuseId('top\_id')
    MiddleVideoView({ item: item }).reuseId('middle\_video\_id')
    BottomView({ item: item }).reuseId('bottom\_id')
  }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b5/v3/64X7k9j9Sn6toYwVWCwVcQ/zh-cn_image_0000002307143354.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=32D423423DA895E5F6407F99D31616AF88026482EA8A35943149DE8191BC6798 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2d/v3/VMggTYtwTVyRJxV7hngIKg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=EB7C833952A90DBEA3CDDDCFED5FDBF27F8E0799A3EAB12A7786381B798257E0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/26/v3/yg1_5cUTQOSJZkHFRuJb9w/zh-cn_image_0000002340902753.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=5EF3416EF6A5E86D08077A9CAB5DB75D367F5586717B5BFE0183D52FB3F8574B "点击放大")
...
2.  使用单例模式实现复用缓存池NodePool工具类，在应用内统一管理组件的复用逻辑：实现取缓存getNode()方法，根据传入的type类型，获取对应的NodeItem，如果未找到，则新创建后绑定数据；实现缓存回收recycleNode()方法，根据type类型存入相应的集合中。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4/v3/qB1GUhOuRFGgTh402AEw8w/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=7B20B180FDDE1051281FD744A5F2631AD54AF8E781D439839A8F2134089CBDC5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8b/v3/m5jipT4eRCOStqMi0JnMYA/zh-cn_image_0000002306983642.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=05CEAC3790EE448850FF1F8BD53833566C954D82F630FBB4577AE58951BC9EDB "点击放大")

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/DQ68fXd-SZmW-JI2UD5mSQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=D9E3DDF8BA75FF95145BAC3F05AB3FAB2B3AEAEF2E0F756B54FFC7AF6C80961A)
        ...
        export class IdleCallback extends FrameCallback {
          ...
          onIdle(idleTimeInNano: number): void {
            ...
            while (timeLeft >= 1000000) {
              hiTraceMeter.startTrace('onIdle\_prebuild', 1);
              // prebuild the component
              NodePool.getInstance().preBuild('reuse\_type\_', this.dataArray\[this.todoCount\], listItemWrapper, this.uiContext);
              hiTraceMeter.finishTrace('onIdle\_prebuild', 1);
...
struct WithFuncParam {
  @State sum: number = 0;
  // ...
  private readonly MOCK\_ASYNC\_DEFAULT\_NUM: number = 1000000;
  private readonly MOCK\_ASYNC\_TIME\_OUT\_NUM: number = 2000;
  ...
  async countAndReturn(): Promise<void> {
    await this.sleep();
    this.sum = this.MOCK\_ASYNC\_DEFAULT\_NUM;
  }
  ...
  sleep(): Promise<string> {
    return new Promise<string>((resolve) => {
      setTimeout(() => {
        resolve('ok');
      }, this.MOCK\_ASYNC\_TIME\_OUT\_NUM)
    });
  }
