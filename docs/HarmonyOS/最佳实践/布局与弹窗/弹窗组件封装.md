---
title: "弹窗组件封装"
source_url: "https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-dialog-encapsulation"
menu_path:
  - "最佳实践"
  - "布局与弹窗"
  - "弹窗组件封装"
captured_at: "2026-04-17T01:54:13.687Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/_PdX7Aw1RoWTeknt-OMpPQ/zh-cn_image_0000002396265913.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=7496EBF90FCF32A2E0642A6E131F98BC21F419DA04885DBC582848253728D519 "点击放大")
    ...
    export function buildText(\_obj: Object) {
      Column({ space: 16 }) {
        Text($r('app.string.tips'))
          .fontSize($r('app.float.font\_size\_l'))
        ...
        .width($r('app.float.dialog\_width'))
      }
      .width($r('app.float.dialog\_width'))
      .padding($r('app.float.padding\_l'))
      .justifyContent(FlexAlign.Center)
      .alignItems(HorizontalAlign.Center)
      .backgroundColor(Color.White)
      .borderRadius($r('app.float.border\_radius'))
    }
