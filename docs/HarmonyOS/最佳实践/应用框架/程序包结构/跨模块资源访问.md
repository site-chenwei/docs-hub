---
title: "跨模块资源访问"
source_url: "https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-cross-module-resource-access"
menu_path:
  - "最佳实践"
  - "应用框架"
  - "程序包结构"
  - "跨模块资源访问"
captured_at: "2026-04-17T01:54:14.209Z"
---
...
1.  **方法一：通过'$r'或'$rawfile'语法访问资源。**
    ...
    Text($r('app.string.string\_in\_har2'))
    Image($r('app.media.image\_in\_har2'))
...
2.  **方法二：通过resourceManager访问资源。**
    ...
    let stringInHar1 = this.context.resourceManager.getStringSync($r('app.string.access\_resource\_har1').id);
    let imgArrayInHar1 = this.context.resourceManager.getMediaContentSync($r('app.media.image\_in\_har1').id);
    

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/yusVtZYcT4GIRgm3-LVCsQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=2261C10A86A8D4CA6499B1DBC815A9028100553A942580942F75B4522E4E5708)
...
1.  **方法一：通过"$r"或"$rawfile"语法访问资源。**
    ...
    **实现方式**
    ...
    Text($r('app.string.access\_resource\_hsp1'))
    Text($r('\[hsp1\].string.string\_in\_hsp1'))
    Image($r('\[hsp1\].media.image\_in\_hsp1'))
    ...
    **实现方式**
    ...
    import { application, common } from '@kit.AbilityKit';
          application.createModuleContext(this.context, 'hsp1').then(data => {
            let stringInHsp1 = data.resourceManager.getStringByNameSync('string\_in\_hsp1');
            let imgArrayInHsp2 = data.resourceManager.getMediaByNameSync('image\_in\_hsp1');
            // ...
          })
...
1.  在HSP中对外提供的资源封装为一个资源管理类：
    ...
    export class ResManager {
      static getPic(): Resource {
        return $r('app.media.image\_in\_hsp1');
      }
    
      static getDesc(): Resource {
        return $r('app.string.string\_in\_hsp1');
      }
    }
