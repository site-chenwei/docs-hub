---
title: "应用埋点"
source_url: "https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-application-track-practice"
menu_path:
  - "最佳实践"
  - "应用框架"
  - "ArkTS语言"
  - "应用埋点"
captured_at: "2026-04-17T01:54:14.138Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f4/v3/PZ6XLdRxRcK5C2ntOJ8EoA/zh-cn_image_0000002194010920.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=78B4D36A5D5DE8D3EFB783F88F4399CC6A78D455DCAF12EFA6A22234F01AB88C "点击放大")
...
1.  首先实现一个简单页面，在组件上绑定ID和埋点数据。ID可以根据组件名-索引命名，例如代码示例中的两个组件，ID值分别为“button-1”和“button-2”。
    ...
    Row() {
      Text('Click Tracing Point - Composite Component')
        // ...
      Image($r('app.media.ic\_public\_arrow\_right'))
        // ...
    }
    // ...
    .id('button-2')
...
TrackNode({ track: new Track().id('WaterFlow-1') }) {
  WaterFlow() {
    LazyForEach(this.dataSource, (item: number, index: number) => {
      FlowItem() {
        TrackNode({ track: new Track().id(\`flowItem\_${index}\`) }) {
          WaterFlowCard({ item: item, index: index }).id(\`flowItem\_${index}\`)
        }
      }
      // ...
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/68/v3/Do8B5b0ZT3C5Uvwgil9l-Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=882FFDA5C7E90FDF8028A1AA44A1B626AA9697916FA062C0FD51704A7DFCC2F5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/73/v3/GV4vQfwzT1CpKKtX6jCxNA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=BD02D5E692CF04BBFB1A9393794204BA1007656198D80CE5F1B3250A74511F0B)
