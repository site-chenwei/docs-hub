---
title: "自定义相机预览"
source_url: "https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-custom-camera-preview"
menu_path:
  - "最佳实践"
  - "媒体"
  - "相机"
  - "自定义相机预览"
captured_at: "2026-04-17T01:54:14.820Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d8/v3/WKPS22MZSf-S2qwiUj8ZNA/zh-cn_image_0000002400337125.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=579F93715186F4355925529F794BDA86F9676BE4B0E09C2AC76BF3A3E915E26B "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5c/v3/qncoAIrhRFu1T37pQrHb5g/zh-cn_image_0000002366737342.png?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=63B259A2DB4CC3043EE5A3B2BAD3036777FD697E27CDC4303A0436FB05CC9A97 "点击放大")
    ...
    "requestPermissions": \[
      {
        ...
        "reason": "$string:permission\_CAMERA",
        "usedScene": {
          "abilities": \[
            "EntryAbility"
          \]
...
3.  创建Surface。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/19/v3/FOBzO92NScqKUC1X69yF4w/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=2FE18C388CDECD0638160F76520D5226E4D369EC43188C2DD19CACC93512465F)
...
4.  创建预览输出流。
    ...
    async createOutput(config: CreateOutputConfig): Promise<camera.PreviewOutput | undefined> {
      ...
      try {
        ...
        Logger.error(TAG\_LOG, \`createPreviewOutput failed, code is ${exception.code}, message is ${exception.message}\`);
      }
      return this.output;
    }
    
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0e/v3/ystdVuqIRa6xEvvZLl3xOQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=1FA6BEC5F8410F6A7F4B0E7A185053F56E9BC6BCB4AB5E82D88FA823113C8689)
    ...
    public getProfile: (cameraOrientation: number) => camera.Profile = cameraOrientation => {
      ...
      return {
        format: camera.CameraFormat.CAMERA\_FORMAT\_YUV\_420\_SP,
        size: {
...
5.  配置并启动相机会话。
    ...
    if (sceneMode === camera.SceneMode.NORMAL\_VIDEO && session) {
...
7.  监听预览流状态。
    ...
    addFrameStartEventListener(output: camera.PreviewOutput): void {
      output.on('frameStart', (err: BusinessError) => {
        if (err !== undefined && err.code !== 0) {
          Logger.error(TAG\_LOG, \`FrameStart callback Error, errorMessage: ${err.message}\`);
          return;
        }
        Logger.info(TAG\_LOG, 'Preview frame started');
        this.onPreviewStart();
      });
    }
    ...
    addFrameEndEventListener(output: camera.PreviewOutput): void {
      output.on('frameEnd', (err: BusinessError) => {
        if (err !== undefined && err.code !== 0) {
          Logger.error(TAG\_LOG, \`frameEnd callback Error, errorMessage: ${err.message}\`);
          return;
        }
        Logger.info(TAG\_LOG, 'Preview frame end');
      });
    }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6c/v3/uZ_q62qfStyn4FQ5_W3t8w/zh-cn_image_0000002400217229.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=B90523A2A86799301647D14749E171E9EC6B12D0A05EC893B79B21C07C51952E "点击放大")
...
getCameraPosition(): camera.CameraPosition {
  return this.isFront
    ? camera.CameraPosition.CAMERA\_POSITION\_FRONT
    : camera.CameraPosition.CAMERA\_POSITION\_BACK;
}
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/70/v3/fSwLywW-QTy0pryCvbiKqw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=A5781D0C87ED3F052B843FC81C58EE8F3E1655BD0D286290B22D8140ADA6AD4C)

在本示例中，相机和基础预览的启动流程封装在自定义的CameraManager类的start()方法中，相机资源及输入输出流的释放封装在release()方法中。

@Builder
toggleCameraPositionButton() {
  Image($r('app.media.toggle\_position'))
    .width(48)
    .height(48)
    .onClick(async () => {
      // ...
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/b6jITUbKT0iUJKVmLxWwlg/zh-cn_image_0000002366577450.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=EB40F4F77B11EE1066638C87090C761DAA9C839FF1BE5D098693907B14E1E849 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2f/v3/u9eWqxuwQxerhbwlP7w8Rw/zh-cn_image_0000002400337137.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=8BC32FF11E7980188BFDB3E1E144AD32F7262D420204CAC6A3C85F0B75CD774F "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/H9eZTRcDSCWTUIIQN9UOCg/zh-cn_image_0000002366737362.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=C352C1B21F4C7ED6950EEAC709B1B3DD31512C81DEAC4BA1FE72171C98B62D4E "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/eb/v3/w4FyuyxETGavwuPPEQ0nwQ/zh-cn_image_0000002400217253.png?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=6AD46AF37A467FBA85CACFAB808DCBF6BD4BC6A2707312A355E7F1DA5386E0AC "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b8/v3/zUBusiiqSXq1tNaWTfQr3w/zh-cn_image_0000002384579202.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=9399E02DDBB046FA7C386A0B0E9C1F6CA59B9606C1B03420FB519295A84C3B0F "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/68/v3/vLiWCC-HSpSzoethVFhFtA/zh-cn_image_0000002366577462.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=2BA862BD88D324022CB3F9A364EE84172C42A655A5BDE81D4612A8BA52ABF212 "点击放大")
...
setFrameRate(minFps: number, maxFps: number): void {
  try {
    ...
    Logger.error(TAG\_LOG, 'setFrameRate error ' + JSON.stringify(e));
  }
}
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/GIS3fsleQ-ycFGfBMDTvSg/zh-cn_image_0000002400337145.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=1C57081FB66499D6DE1172C471A7D92A015D62520AC0A65B043AA10DE623AE52 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/wUzD2xgPRI-x1HCXcADKTA/zh-cn_image_0000002366737386.png?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=38FA153BA281FB0A9F7C004A1B9F8E46F621EBAA964C5F8DB56F03CBFD2E46E7 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f6/v3/u4hOBGWATNOdBTZlayCA_w/zh-cn_image_0000002400217277.png?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=D02CBE43DCA64C0DB25F2F64ECA5DDBC0709E72553B49E3AB4F385AD42A4CE50 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8b/v3/6SG7fsjQRImJkuqJfnv-Cw/zh-cn_image_0000002366577482.png?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=129E8C8B2A63A0634F12979C664243E4237942307C44CE9C28B665D8A54E8D2C "点击放大")
...
"requestPermissions": \[
  // ...
  {
    ...
    "reason": "$string:permission\_SENSOR",
    "usedScene": {
      "abilities": \[
        "EntryAbility"
      \]
...
export struct LevelIndicator {
  ...
  isAlign(): boolean {
    return Math.abs(this.getRotate()) - 0 <= ANGLE\_DIFFERENCE ||
      Math.abs(Math.abs(this.getRotate()) - 90) <= ANGLE\_DIFFERENCE;
  }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9d/v3/QuN4AHjdR5SGnYxmaeiyZA/zh-cn_image_0000002400337165.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=DC2D04C795646BA41DFAAD7230CC269AE05A3121A80F5D78D286E46F48B40CEC "点击放大")
...
wakeupMask() {
  Column() {
    Text($r('app.string.wakeup\_text'))
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e8/v3/4UmweALkR6-FW27bBq6GbA/zh-cn_image_0000002366737398.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=E01399CABFBF0622B0083F89F6AFF94C59E89E2F534A5AA59F4C89CBDC0203BD "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b0/v3/dkfjQ1GkRDKx_eV3P5WRbA/zh-cn_image_0000002523637923.png?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=639839DD16BDAA00A267217754C93850696802906B233358C196126CC70673B6 "点击放大")
...
1.  创建相机元数据输出流。
    ...
    async createOutput(config: CreateOutputConfig): Promise<camera.CameraOutput | undefined> {
      const cameraOutputCap = config.cameraManager?.getSupportedOutputCapability(config.device, config.sceneMode);
      if (!cameraOutputCap) {
        Logger.error(TAG\_LOG, 'Failed to get supported output capability.');
        return undefined;
      }
      ...
      try {
        ...
        Logger.error(TAG\_LOG, \`Failed to createMetadataOutput, error code: ${error.code}\`);
      }
      return this.output;
    }
...
3.  注册[on('metadataObjectsAvailable')](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-camera-metadataoutput#onmetadataobjectsavailable)回调，监听元数据流中的人脸信息。
    ...
    addMetadataObjectsAvailableListener(metadataOutput: camera.MetadataOutput): void {
      metadataOutput.on('metadataObjectsAvailable',
        ...
        if (err && err.code !== 0) {
          Logger.error(TAG\_LOG, \`Metadata output on metadataObjectsAvailable error code: ${err.code}\`);
          return;
        }
...
4.  通过回调接口返回的归一化数据，计算检测框实际坐标。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/20/v3/d2yV7MUwR_2OTPy8HKl8HQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=F7397404900B2255354D648F63A181293F65A60C6C10DA9A9318E95987EF2C3A)
...
5.  计算检测框各边的起点和终点位置坐标。
    ...
    export function calFaceBoxLinePoint(faceBoxRect: camera.Rect): LinePoint\[\] {
      ...
      let lineLength: number = Math.min(faceBoxRect.width, faceBoxRect.height) \* FACE\_BOX\_LINE\_RATIO;
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/5lZSRQRUSbipdBeiUcODOg/zh-cn_image_0000002400217289.png?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=5DF4DB7469B59F01BA41B9B3961364BAB2F78FDB1C0D7FA77D28529F37C22FFE "点击放大")
...
4.  根据stride和图像宽高对Buffer数据进行裁剪。使用[image.createPixelMap()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-f#imagecreatepixelmap8)方法创建pixelMap数据。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f0/v3/h3ZC7qYzQe2qc5k7WS-OoA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=C7B6385081F19F9E296F4D6EEDC2C641EFFEB0EB4BE593B6BFB8F235F3FA8D6D)
...
5.  使用[PreviewOutput.getPreviewRotation()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-camera-previewoutput#getpreviewrotation12)获取图像旋转角度，使用[PixelMap.rotate()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap#rotate9-1)方法对图像数据进行旋转。在使用前置镜头时，存在水平镜像和垂直镜像的差异，为了统一翻转逻辑，在屏幕旋转角度为90度或270度时，需额外旋转180度将图像转正，使用[PixelMap.flip()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap#flip9-1)方法将图像数据进行水平翻转，以达到镜像效果。参考[应用自绘制预览角度处理](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/camera-rotation-term#应用自绘制预览角度处理)。
    ...
    nextImage.getComponent(image.ComponentType.JPEG, async (err: BusinessError, imgComponent: image.Component) => {
      ...
      if (imgComponent.byteBuffer) {
        ...
        try {
          displayDefault = display.getDefaultDisplaySync();
          const displayRotation = (displayDefault?.rotation ?? 0) \* camera.ImageRotation.ROTATION\_90;
