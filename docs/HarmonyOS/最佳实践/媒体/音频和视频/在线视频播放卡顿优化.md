---
title: "在线视频播放卡顿优化"
source_url: "https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-online-video-playback-lags-practice"
menu_path:
  - "最佳实践"
  - "媒体"
  - "音频和视频"
  - "在线视频播放卡顿优化"
captured_at: "2026-04-17T01:54:15.299Z"
---
...
**图1** 缓冲区原理图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/V2vc-wMoQyunfKHrmeJwZA/zh-cn_image_0000002340616897.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=8516C6BD9F2ED0F5BEA9E2DF5F202351F0C392EEAAFE7724E53C02A154FD88C9 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d4/v3/hHPoxsA9RGGqz84scXq8gQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=69A03B55D3666FFB2B3252747DE9B314774248EF13A66FB5ACD821AF8740C8A0)
...
**图2** 多码率流切换示例图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/62/v3/ggkoNDx4SUuylO669790yg/zh-cn_image_0000002306657730.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=6AE565702927A1380663F102006990EBA29B919672E577E813217CE5FD826E5C "点击放大")
...
export class CustomConfigs {
  // ...
  public static readonly PREFERRED\_BUFFER\_SIZE = 20;

  public static readonly PLAYBACK\_STRATEGY: media.PlaybackStrategy = {
    preferredWidth: 1920,
    preferredHeight: 1080,
    preferredBufferDuration: CustomConfigs.PREFERRED\_BUFFER\_SIZE
  };
  // ...
}
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/sYanv6DZRMazpzdwEqNLjw/zh-cn_image_0000002525758808.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=A5982F2849CBA0D303A943C75BCC98EB6067AFFDA6D4094D85625E20777737E8 "点击放大")

从实验数据可以看出，当媒体文件大小超过可设置的缓冲区最大值时，缓冲区越大，视频卡顿率越低，将缓冲区设置为最大值20MB，可最大程度减少视频卡顿。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9c/v3/RMY4q5gMSlyl_lnKdJ0zkA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=8E687A87069ABF9455D6DD82983E69F8F2B1878EF08F9E6198CFC8AAF84E6556)
...
**图4** 码率调整策略示例流程图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/db/v3/r4guWzfrTx2oE-gVeM6r7w/zh-cn_image_0000002306817474.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=472D0AFBDFB5C38888E083CDB38D17AB0E09D3E1E48E9BD0132B6D2EDD3D5C84 "点击放大")
    ...
    private setPlaybackInfoInterval(avPlayer: media.AVPlayer) {
      this.playbackCallbackInterval = setInterval(async () => {
        avPlayer.getPlaybackInfo().then((playbackInfo: media.PlaybackInfo) => {
          ...
          this.videoInfo.averageDownloadRate = Number(playbackInfo\[media.PlaybackInfoKey.AVG\_DOWNLOAD\_RATE\]);
          this.videoInfo.downloadRate = Number(playbackInfo\[media.PlaybackInfoKey.DOWNLOAD\_RATE\]);
      ...
      }, AVPlayerConstants.PLAYBACK\_INTERVAL\_MS);
    }
...
3.  在on('bufferingUpdate')回调内，结合缓存信息以及下载速率信息，实现码率自定义调整策略。
    ...
    private setCustomCallback(avPlayer: media.AVPlayer) {
      ...
      avPlayer.on('bufferingUpdate', (infoType: media.BufferingInfoType, value: number) => {
        ...
        if (value < CustomConfigs.CACHED\_PERCENT\_THRESHOLD \* this.maxBufferValueList\[this.currentBitrateIndex!\]) {
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1b/v3/lJKU_56NRPi8V3FwYSBfUA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=F707BD898D9D6A83CA4AC19AB67EEF9FA15737F6770EBA18A6F7A372A21ED9A6)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/92/v3/8hoAVhHASSOXGK3_3gBCzQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=60547601EC7F963763E5218ED0CB11AC67F6C09CFDF37A3FA269D3077E61ACE3)
