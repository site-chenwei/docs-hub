---
title: "管理音频输出设备开发实践"
source_url: "https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-managing-audio-output-devices"
menu_path:
  - "最佳实践"
  - "媒体"
  - "音频和视频"
  - "管理音频输出设备开发实践"
captured_at: "2026-04-17T01:54:15.495Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8f/v3/WQmYCI1TRj2bpVkdxTh62A/zh-cn_image_0000002548392057.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=E9F3B78E02AC2025158A48C28E984E3F78339331CE664271A0713CD73BA4DA12 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d9/v3/LGkZDVjiTxadrQbIndWdSA/zh-cn_image_0000002548512059.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=5B719DEB1FEBC1D5ECB03C72AE973E2174E6330EBAA9C5FC164F136B3129F612)
...
2.  使用[AudioRoutingManager.getDevices(deviceFlag: DeviceFlag)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-audioroutingmanager#getdevices9-1)获取所有已连接的输出设备。设置deviceFlag参数为[OUTPUT\_DEVICES\_FLAG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-e#deviceflag)，表示获取输出设备。
    ...
    async getDevices() {
      ...
      this.audioRoutingManager.getDevices(audio.DeviceFlag.OUTPUT\_DEVICES\_FLAG)
        .then((audioDeviceDescriptors: audio.AudioDeviceDescriptors) => {
          ...
          let deviceUsage = this.sceneType === CommonConstants.MEDIA\_EQUIPMENT ? audio.DeviceUsage.MEDIA\_OUTPUT\_DEVICES :
            audio.DeviceUsage.CALL\_OUTPUT\_DEVICES;
...
3.  使用[AudioRoutingManager.on('deviceChange')](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-audioroutingmanager#ondevicechange9)监听输出设备连接状态的变化。
    ...
    watchDeviceChange() {
      try {
        this.audioRoutingManager.on('deviceChange', audio.DeviceFlag.OUTPUT\_DEVICES\_FLAG,
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/r2JCY4JISVeSvZ-S0KDfUA/zh-cn_image_0000002516872178.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=133DD6DA50661597E705F5D74C54A7CD44B3140204F1C87068F365539CEDB884 "点击放大")
...
1.  使用[AVSession.createAVSession(context: Context, tag: string, type: AVSessionType)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-avsession-f#avsessioncreateavsession10)创建AVSession。通过[AVSessionType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-avsession-t#avsessiontype10)区分不同的使用场景，audio表示音乐播放，voice\_call表示语音通话。
    ...
    // Create AVSession.
    try {
      this.AVSession = await avSession.createAVSession(this.context, 'PLAY\_AUDIO', this.sessionType);
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f8/v3/oOl-X3FxTBeBi5Rrm9pCcw/zh-cn_image_0000002516712260.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=A44696012DEBCBD0FAC8AA67AF9F7A298AF8AD6BD7504B9D28B1D2A77521E4DB "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2a/v3/3NAF3_GYRPCjH44OHCl_Ew/zh-cn_image_0000002548392059.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=E760B9C62A7FAD13C44FD47EB25203816A0AF0CA3F0731E04000B79EAF7A84E2 "点击放大")
...
2.  当监听到AudioStreamDeviceChangeReason.REASON\_OLD\_DEVICE\_UNAVAILABLE时，如果新设备是扬声器，并且在媒体播放场景，应考虑暂停音频播放。
    ...
    switch (deviceChangeInfo.changeReason) {
      case audio.AudioStreamDeviceChangeReason.REASON\_OLD\_DEVICE\_UNAVAILABLE:
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/SctiTJKpTGGE55xQmm8WBw/zh-cn_image_0000002548512061.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=5CF393077D686D270D10267138B263FB4A3799D5686E1952298E68D76132978B "点击放大")
    ...
    async activeAudioSession() {
      ...
      if (isAudioSessionDeactivated) {
        let strategy: audio.AudioSessionStrategy = {
          concurrencyMode: audio.AudioConcurrencyMode.CONCURRENCY\_DEFAULT
        }
