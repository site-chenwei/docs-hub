---
title: "管理音频输入设备开发实践"
source_url: "https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-managing-audio-input-devices"
menu_path:
  - "最佳实践"
  - "媒体"
  - "音频和视频"
  - "管理音频输入设备开发实践"
captured_at: "2026-04-17T01:54:15.474Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f3/v3/HU0UjlmSQG6ahgOVx7mF-g/zh-cn_image_0000002513603472.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=B9E038E4F86FFD6B0B5AD9D0A6E7634751F25A08E5AD00B39CE35831536E09D4 "点击放大")
...
2.  使用[AudioRoutingManager.getDevices(deviceFlag: DeviceFlag)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-audioroutingmanager#getdevices9-1)获取所有已连接的输入设备。设置deviceFlag参数为[INPUT\_DEVICES\_FLAG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-e#deviceflag)表示获取输入设备。
    ...
    async getDevices(inputDeviceType: string) {
      ...
      this.audioRoutingManager.getDevices(audio.DeviceFlag.INPUT\_DEVICES\_FLAG)
        .then((audioDeviceDescriptors: audio.AudioDeviceDescriptors) => {
          ...
          let deviceUsage = this.deviceType === CommonConstants.MEDIA\_EQUIPMENT ? audio.DeviceUsage.MEDIA\_INPUT\_DEVICES :
            audio.DeviceUsage.CALL\_INPUT\_DEVICES;
...
3.  使用[AudioRoutingManager.on('deviceChange')](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-audioroutingmanager#ondevicechange9)监听输入设备连接状态的变化。
    ...
    watchDeviceChange() {
      try {
        this.audioRoutingManager.on('deviceChange', audio.DeviceFlag.INPUT\_DEVICES\_FLAG,
...
4.  使用[AudioRoutingManager.getAvailableDevices(deviceUsage: DeviceUsage)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-audioroutingmanager#getavailabledevices12)获取可用输入设备。通过[DeviceUsage](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-e#deviceusage12)参数区分不同的使用场景，[MEDIA\_INPUT\_DEVICES](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-e#deviceusage12)表示媒体输入设备，[CALL\_INPUT\_DEVICES](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-e#deviceusage12)表示通话输入设备。
    ...
    getAvailableDevices() {
      ...
      try {
        ...
        AppStorage.setOrCreate(CommonConstants.AVAILABLE\_DEVICES, data);
      } catch (err) {
        let error = err as BusinessError;
        ...
        (err: BusinessError, audioDeviceDescriptors: audio.AudioDeviceDescriptors) => {
          if (err) {
            ...
            if (audioDeviceDescriptors.length > 0) {
              AppStorage.setOrCreate(CommonConstants.SELECTED\_DEVICE\_ID, audioDeviceDescriptors\[0\].id);
            }
          }
        });
    }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a8/v3/lKkX1lUbSRmso4L1T8cfig/zh-cn_image_0000002545043447.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=7506BC52A6AC2C88D11E97B2139FEB4AFB0745128EAF683E92C07FC03D1530E8 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b9/v3/qmAfXF1xTwuqInARfRXJWg/zh-cn_image_0000002545123443.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=1100FA48E02B96FD38760B697E9A2FC50F6672699B5B2C8A95196536FFAD3148)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/Ql-AsVYDRB240dqjvickYw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=80B46A1467195C753F021B063029A0868D6354C9171CDC01E26199A3C1FB1541)
    ...
    async setBluetooth(category: number) {
      await this.audioSessionManager.setBluetoothAndNearlinkPreferredRecordCategory(category)
        .then(() => {
          ...
          AppStorage.setOrCreate(CommonConstants.BLUETOOTH\_AND\_NEARLINK\_PREFERRED, category);
        })
        .catch((err: BusinessError) => {
          hilog.error(DOMAIN, 'testTag', '%{public}s',
...
5.  使用[AudioSessionManager.getSelectedMediaInputDevice()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-audiosessionmanager#getselectedmediainputdevice21)获取当前设置的输入设备。
    ...
    getSelectedMediaInputDevice() {
      try {
        ...
        AppStorage.setOrCreate(CommonConstants.SELECTED\_DEVICE\_ID, device.id);
      } catch (err) {
        let error = err as BusinessError;
        hilog.error(DOMAIN, 'testTag', '%{public}s',
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4c/v3/0-ugQ78BRXWJnBGFfbm-2w/zh-cn_image_0000002513443564.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=5C4F0F7F9E7EF70188005E15B6338A15396043B8C2762656C1B827AFE3627BC3 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/77/v3/NedaJZfaS3eP7bOc02QVPw/zh-cn_image_0000002513603474.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=67C51FC50FFB3DAB2338368BA3EDAA41883B6C2E1F3EC74CC78F6C40533F236B "点击放大")
  ...
  try {
    ...
    this.audioCapturer?.on('inputDeviceChange', (deviceChangeInfo: audio.AudioDeviceDescriptors) => {
      ...
      if (deviceChangeInfo.length > 0) {
        AppStorage.setOrCreate(CommonConstants.SELECTED\_DEVICE\_ID, deviceChangeInfo\[0\].id);
      }
    });
  } catch (err) {
    // ...
