---
title: "长截图"
source_url: "https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-long-snapshot-practice"
menu_path:
  - "最佳实践"
  - "媒体"
  - "图片"
  - "长截图"
captured_at: "2026-04-17T01:54:14.830Z"
---
...
**图1** 长截图拼接原理图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/F6a1FplgTlq2XFdAX-Jutg/zh-cn_image_0000002229449985.png?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=684A91BC3E4608D29DF5A85B138C76381FFC6145F7FBFCA2C5D518C761CDA339 "点击放大")

长截图主要流程如下：

**图2** 滚动长截图流程

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ab/v3/AijPXT5yRbWzO6CuNyxatQ/zh-cn_image_0000002407557206.png?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=E643D59EE9C09460567593B9E897844030EB3CE07A419AF0C727E532B841A7B2 "点击放大")

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4a/v3/uLz4jlxITLSAeP_XE6c_bQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=792BBCEA2421D8E09DB331FDFF9E16A9C64DCF58D17BD797A6CB8DA292AFCBD5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ba/v3/bf8YXChhRTmsfw2FiBPpCg/zh-cn_image_0000002193850120.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=A242054F5E213F34782B99B4EA4D79827C194FED21956E9930F6A8FB667831BD "点击放大")
    ...
    export struct ScrollSnapshot {
      ...
      build() {
        // ...
            ...
            .bindContentCover($$this.isShowPreview, this.previewWindowComponent(),
              {
                ...
                onWillDismiss: (action: DismissContentCoverAction) => {
                  if (action.reason === DismissReason.PRESS\_BACK) {
            ...
            Row({ space: 12 }) {
              Button($r('app.string.one\_click\_snapshot'))
                .layoutWeight(1)
                .onClick(() => {
                  this.onceSnapshot();
                })
              Button($r('app.string.scroll\_snapshot'))
                .layoutWeight(1)
                .onClick(() => {
        ...
        .title($r('app.string.title\_scroll\_snapshot'))
    ...
    export struct ScrollSnapshot {
      ...
      async beforeSnapshot() {
        try {
          ...
          this.componentMaskImage = await this.getUIContext().getComponentSnapshot().get(LIST\_ID);
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f1/v3/egZs3tB8TpSua6Kniy2eqw/zh-cn_image_0000002193850136.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=1B4AF7740DD863BA5099BE10A8B230FEB5AA8DADAB3F2A793FBFC5CB6B7C8A26 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/eb/v3/h3Z7dMCPQnKa_zrGtAEp5g/zh-cn_image_0000002522310291.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=75C632A1D3A83FB02F801A492059BC7136F3AFFCDD764223FF8123DA707CD29E "点击放大")
...
async snapAndMerge() {
  try {
    this.scrollYOffsets.push(this.curYOffset);
    // Call the component screenshot interface to obtain the current screenshot
    const pixelMap = await this.getUIContext().getComponentSnapshot().get(WEB\_ID);
    let area: image.PositionArea =
...
1.  Web初始化，调用enableWholeWebPageDrawing()方法开启网页全量绘制能力。
    ...
    aboutToAppear(): void {
      try {
        ...
        webview.WebviewController.prepareForPageLoad(EXAMPLE\_URL, true, 2);
      } catch (err) {
        let error = err as BusinessError;
...
3.  调用webPageSnapshot()方法，进行网页截图。
    ...
    async webSnapshot() {
      try {
        this.webviewController.webPageSnapshot({ id: WEB\_ID, size: { width: this.h5Width, height: this.h5Height } },
          async (error, result) => {
            if (result) {
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3a/v3/NqauLksmSMaD-LpKPvFXFA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015416Z&HW-CC-Expire=86400&HW-CC-Sign=4C1847A9906FB8A3ABA3F716CDE64DC194CD4E750975E6F185D01DF05FE2A69B)
