---
title: "图像模糊动效优化"
source_url: "https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-fuzzy-scene-performance-optimization"
menu_path:
  - "最佳实践"
  - "图形"
  - "图像处理"
  - "图像模糊动效优化"
captured_at: "2026-04-17T01:54:15.570Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/44/v3/IdB7LlOXTKqKAGgM0DI0dw/zh-cn_image_0000002337772197.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=E524999045FC4041216BBAA17312C5155A1B2A85FEF61FF1B29AE199F6401328)
    ...
    window.getLastWindow(this.getUIContext().getHostContext()!, (err, windowBar) => {
      ...
      try {
        ...
        this.bottomSafeHeight =
          this.getUIContext()
            .px2vp(windowBar.getWindowAvoidArea(window.AvoidAreaType.TYPE\_NAVIGATION\_INDICATOR).bottomRect.height);
      } catch (error) {
...
**图1** 动态模糊  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8/v3/psurXvlFTu-kSD_c1xRSMA/zh-cn_image_0000002193850416.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=67361D69E3A36D0911033622F7E915881A78E97E2D40A3F1DBC60C18EF1A30E5 "点击放大")
    ...
    export struct StaticBlur {
      ...
      async staticBlur(): Promise<void> {
        ...
        let opts: image.InitializationOptions = {
          ...
          pixelFormat: 3, // pixel format. 3 represents RGBA\_8888
          size: {
            // create image size
            height: 4,
            width: 6
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/52/v3/0x26v_O2T8WW72GzocZt7Q/zh-cn_image_0000002229450281.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=3546FB43B94C07D153CE566A3650E81449080CD9790FE4A172B982067E99F99A "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/e5pqj4A0StacLsazyLfObg/zh-cn_image_0000002229450285.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=B1123FDF38F68A2D016429B4C940D9A9ABF403AE80194DA493D9818021A24488 "点击放大")

如上图所示，通过RenderFrame（执行GPU绘制）标签可以看出，动态模糊转场平均渲染耗时为6.113ms。同时从Present Fence（图形上屏信号）标签可以看出动态模糊转场平均帧率为108.0fps。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fd/v3/nU-FrpdGRTWsRBAV-IpPDA/zh-cn_image_0000002229335801.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=859C00D32C78F3D590000018823301A8654F1DBBDF4EFC3E57B4319E5AC485B5 "点击放大")
