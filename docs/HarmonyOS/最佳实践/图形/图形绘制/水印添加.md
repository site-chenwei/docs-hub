---
title: "水印添加"
source_url: "https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-add-watermark"
menu_path:
  - "最佳实践"
  - "图形"
  - "图形绘制"
  - "水印添加"
captured_at: "2026-04-17T01:54:15.546Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/22/v3/PobSZSlFQNWTslFD2eNLTQ/zh-cn_image_0000002229451785.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=9ACA69D628C3BCFA091662CF1A6AFE64B62C3E8C7EDD9D531626660B0AA31AF3 "点击放大")
...
1.  封装水印组件
    ...
    2.  实现绘制水印draw()方法。绘制的起点默认为坐标轴的原点（画布的左上角），通过坐标轴的平移及旋转，实现在画布的不同位置、不同角度绘制水印。如果水印有一定旋转角度，想保证第一个水印能完整显示，需要对绘制的起点做平移，平移距离通过旋转角度及水印宽高计算。
        ...
        -   旋转角度大于0，由下图可知，水印沿x轴方向平移距离positionX = tan(θ) \* 水印高度，即绘制起点为(positionX, 0)。
            ...
            ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a0/v3/zi36IK1xTbaeVVUsvFPo1w/zh-cn_image_0000002229337289.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=F65A5B0B239AB5620EC0BF4B0E9E7AA25F6F13DA04DA6BFC1B4FE319B4CAC7E0 "点击放大")
            
        -   旋转角度小于0，由下图可知，水印沿y轴方向平移距离positionY = tan(θ) \* 水印宽度，即绘制起点为(0, positionY)。
            
            ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f1/v3/FNAgVi-cQwW8UdU5emUrrQ/zh-cn_image_0000002229337285.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=4E517E38E97B7E17CB01F791ECC38921F319DC8C1C7F3E7103B7E4206AD9EF9B "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/49/v3/q7mEbGTASGedOiAbAdBi6w/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=1038CB03E34CBD0E444DFA4D744E3E6572ECDC7F0AAFB010BEC4A9B743DCB0F7)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/SuxDaIXrRGG3G1OgTGXaAQ/zh-cn_image_0000002229451781.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=A99C53EDFC623451ADB1CEE209AAC02F2795C42FBD7F846C355667B2547407E9 "点击放大")
...
1.  解析图片得到pixelMap数据。
    1.  使用[resourceManager.getMediaContent()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-resource-manager#getmediacontent9-1)方法获取图片内容，得到ArrayBuffer数据。使用[image.createImageSource(buf: ArrayBuffer)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-f#imagecreateimagesource9-2)方法创建图片源实例。
        ...
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/72/v3/nYFxCiU1Rc-6-OLXUVIOSw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=0D6696B2CEEFF175CEBA8EEB33070257EEFF683BDBC38DFDE4E090044D1DAB6E)
...
3.  将添加水印后得到的pixelMap数据写入文件中。
    ...
    export async function saveToFile(pixelMap: image.PixelMap, context: Context): Promise<void> {
      try {
        ...
        const mode = fileIo.OpenMode.READ\_WRITE | fileIo.OpenMode.CREATE;
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8f/v3/p-rLzXoKSYOSl6i-2n-IYg/zh-cn_image_0000002229337293.png?HW-CC-KV=V1&HW-CC-Date=20260417T015417Z&HW-CC-Expire=86400&HW-CC-Sign=9DF5F5A8BD4FD469786399578AEC784289AD9212C506F5579434D39424836DA6 "点击放大")
...
1.  使用[getRawFileContentSync()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-resource-manager#getrawfilecontentsync10)方法获取resource/rawfile目录下的PDF文件内容，使用[fs.writeSync()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#writesync10)方法写入沙箱中。
    ...
    savePdfToSandbox(): string {
      ...
      try {
        ...
        const file = fileIo.openSync(filePath, fileIo.OpenMode.WRITE\_ONLY | fileIo.OpenMode.CREATE | fileIo.OpenMode.TRUNC);
    ...
    build() {
      // ...
          PdfView({
            ...
            pageFit: pdfService.PageFit.FIT\_WIDTH
          })
            // ...
...
3.  通过文本水印类[pdfService.TextWatermarkInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#section2094113924815)创建水印对象，设置水印内容、字体、颜色、位置等相关属性；图片水印对象通过[pdfService.ImageWatermarkInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#section1122165334818)创建。
    ...
    getWatermarkInfo() {
      ...
      watermarkInfo.watermarkType = pdfService.WatermarkType.WATERMARK\_TEXT;
...
5.  将沙箱中添加水印后的文档加载到PDF预览器中。
    ...
    async showInPdfView(filePath: string) {
      ...
      this.controller.setPageFit(pdfService.PageFit.FIT\_WIDTH);
    }
