---
title: "动画使用指导"
source_url: "https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-fair-use-animation"
menu_path:
  - "最佳实践"
  - "动画与转场"
  - "动画使用指导"
captured_at: "2026-04-17T01:54:13.938Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f3/v3/JsrjW384RUelwlZDLtwsJw/zh-cn_image_0000002229451841.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=F4EF2EE4066F92A4EA97254DF887594E52C649B72C5B689A00AF11C363CFB26F "点击放大")
...
**图2** 点击特征动效示意  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cb/v3/eWob5PE9RuikL-DOncvNxQ/zh-cn_image_0000002229337393.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=5FA920E5F43AD582ECD0C1041197DD653B414BE1FB47BE8211B45FDE430A61E9 "点击放大")
...
**图3** 转场动效示意  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4d/v3/TLSuJKtmQku_TkOHfeYNfw/zh-cn_image_0000002229451885.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=F9B0CA514387155BDDB80536E2699F0A4CF2A57C9A9A134D72B9B60A785F98F5 "点击放大")
...
**图4** 手势动效示意  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7a/v3/lamQYETiSwCh2MDwC5Z1ww/zh-cn_image_0000002194011548.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=8BCFCF61CFC1AA7CB3F3E97DB41FC53A9404226510647A7CBF5BB31A23360903 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ef/v3/VXUOJ3xKShyKlocUPeroHQ/zh-cn_image_0000002193851976.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=8918500D12F33375A95524D0632AD001D1152217C95EA05420E9E71E940AAD3E "点击放大")
...
**图6** 插画动效示意  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6f/v3/QrxUNtnuSj-UoW5ih6tyaw/zh-cn_image_0000002229337377.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=A5ECCD18D96438DD8E2118FBFAD355D435DE0EDBFB951A6880C076543DA3EF52 "点击放大")
...
**图7** 使用显式动画实现水波纹动效  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fb/v3/wlEjGr12Qa-xbJT-EPT6UA/zh-cn_image_0000002229451877.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=478D695AAE14F6F8B38DC2A3992C3727118FFA52BF534CCA5DB1AF270A479ED0 "点击放大")
...
struct ButtonWithWaterRipples {
  ...
  private readonly BUTTON\_SIZE: number = 120;
  private readonly BUTTON\_CLICK\_SCALE: number = 0.8;
  private readonly ANIMATION\_DURATION: number = 1300;

  @Styles
  ripplesStyle() {
    .width(this.BUTTON\_SIZE \* this.BUTTON\_CLICK\_SCALE)
    .height(this.BUTTON\_SIZE \* this.BUTTON\_CLICK\_SCALE)
    .borderRadius(this.BUTTON\_SIZE \* this.BUTTON\_CLICK\_SCALE / 2)
  ...
  build() {
    Stack() {
      ...
      Button() {
        Image($r('app.media.ic\_public\_music\_filled'))
          .width($r('app.float.water\_ripples\_width'))
          .fillColor(Color.White)
      }
      .clickEffect({ level: ClickEffectLevel.HEAVY, scale: this.BUTTON\_CLICK\_SCALE })
      .backgroundColor($r('app.color.music\_icon'))
      .type(ButtonType.Circle)
      .width(this.BUTTON\_SIZE)
      .height(this.BUTTON\_SIZE)
      .zIndex(1)
      // ...
    }
  }
...
.onClick(() => {
  ...
  if (this.isListening) {
    this.getUIContext().animateTo({
      duration: this.ANIMATION\_DURATION,
      iterations: CommonConstants.ITERATIONS,
      curve: Curve.EaseInOut
    }, () => {
      this.immediatelyOpacity = CommonConstants.COMMON\_NUMBER\_0;
      this.immediatelyScale = {
        x: CommonConstants.COMMON\_NUMBER\_6,
        y: CommonConstants.COMMON\_NUMBER\_6
      };
    })
    this.getUIContext().animateTo({
      duration: this.ANIMATION\_DURATION,
      iterations: CommonConstants.ITERATIONS,
      curve: Curve.EaseInOut,
      delay: CommonConstants.DELAY\_200
    }, () => {
      this.delayOpacity = CommonConstants.COMMON\_NUMBER\_0;
      this.delayScale = {
        x: CommonConstants.COMMON\_NUMBER\_6,
        y: CommonConstants.COMMON\_NUMBER\_6
      };
    ...
    this.getUIContext().animateTo({ duration: CommonConstants.COMMON\_NUMBER\_0 }, () => {
      this.immediatelyOpacity = CommonConstants.COMMON\_NUMBER;
      this.delayOpacity = CommonConstants.COMMON\_NUMBER;
      this.immediatelyScale = {
        x: CommonConstants.COMMON\_NUMBER\_1,
        y: CommonConstants.COMMON\_NUMBER\_1
      };
      this.delayScale = {
        x: CommonConstants.COMMON\_NUMBER\_1,
        y: CommonConstants.COMMON\_NUMBER\_1
...
**图8** 使用关键帧动画实现左右移动提示  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6c/v3/AVKcgYKVTYS5Ue_kk0g1QA/zh-cn_image_0000002229451869.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=277995DE6B00D59305635A676B85293139A41BB949F262ADE275314B0ED6785F "点击放大")
...
startAnimation() {
  ...
  this.translateX = CONFIGURATION.POSITION\_ZERO;
  this.uiContext.keyframeAnimateTo({ iterations: CONFIGURATION.PLAYBACK\_COUNT }, \[
    {
      duration: CONFIGURATION.ANIMATION\_TIME,
      event: () => {
        this.translateX = CONFIGURATION.TRANSLATE\_OFFSET\_X;
      }
    },
    {
      duration: CONFIGURATION.ANIMATION\_TIME,
...
Button($r('app.string.login\_in'))
  .type(ButtonType.Normal)
  .borderRadius($r('app.integer.comm\_border\_radius'))
  .fontColor($r('app.color.ohos\_id\_color\_background'))
  .fontSize($r('app.integer.login\_button\_font\_size'))
  .width(Constants.LAYOUT\_MAX\_PERCENT)
  .onClick(() => {
    if (!this.confirm) {
      this.startVibrate();
      this.startAnimation();
      ...
      try {
        this.getUIContext().getPromptAction().showToast({
          message: $r('app.string.login\_text')
        });
      } catch (err) {
...
**图9** 使用属性动画实现手势动效  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/26/v3/TtqO0sidQOeeW-5c7mN1bQ/zh-cn_image_0000002229451845.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=C4E8FBF33379A16E4BD30928E06D2D4891D7CEEE38453DDDEA410E87F8F82A71 "点击放大")
...
handleTouchEvent(event: TouchEvent): void {
  switch (event.type) {
    case TouchType.Down:
      ...
      this.isMoving = true;
      this.duration = Constants.ANIMATE\_DURATION\_DRAG;
      break;
    ...
    case TouchType.Move:
      ...
      if (delta < 0) {
        this.heightValue = Constants.AREA\_HEIGHT\_BEFORE;
        this.isExpanded = false;
        this.atStart = false;
      }
      if (delta > 0 && this.atStart) {
        this.animateToThrottle(() => {
          this.heightValue = Constants.AREA\_HEIGHT\_AFTER;
    ...
    case TouchType.Cancel:
      this.isMoving = false;
      this.duration = Constants.ANIMATE\_DURATION\_BACK;
      break;
    default:
      break;
  }
...
Column() {
  List({ space: Constants.SEARCH\_MEMO\_SPACE }) {
    ListItem() {
      Search({ placeholder: $r('app.string.search\_placeholder') })
        .width(Constants.LAYOUT\_MAX\_PERCENT)
        .height(Constants.LAYOUT\_EIGHT\_PERCENT)
  ...
  .margin({ left: $r('app.float.layout\_10'), right: $r('app.float.layout\_10') })
  .width(Constants.LAYOUT\_NINETY\_PERCENT)
...
Column() {
  Row() {
    Text(!this.isExpanded ? $r('app.string.memo\_title') : '')
      .fontSize($r('app.float.init\_title\_font\_size'))
    Blank()
    // Image($r('app.media.is\_public\_add'))
    //   .width($r('app.float.menu\_pic\_layout'))
    //   .height($r('app.float.menu\_pic\_layout'))
    // Image($r('app.media.ic\_public\_more'))
    //   .width($r('app.float.menu\_pic\_layout'))
    //   .height($r('app.float.menu\_pic\_layout'))
    //   .margin({ left: $r('app.float.layout\_8') })
  }
  .width(Constants.LAYOUT\_MAX\_PERCENT)
  .padding($r('app.float.layout\_25'))
  .margin({ top: $r('app.float.layout\_10') })
  .alignItems(VerticalAlign.Center)
  .translate(this.getMenuTranslateOptions())
  .animation({ duration: this.duration, curve: Curve.FastOutLinearIn })

  Column() {
    Text($r('app.string.memo\_title'))
      .fontSize($r('app.float.expanded\_title\_font\_size'))
    Text($r('app.string.memo\_counts'))
      .fontSize($r('app.float.memo\_counts\_font\_size'))
      .fontColor(Color.Grey)
  }
  .width(Constants.LAYOUT\_MAX\_PERCENT)
  .padding({ left: $r('app.float.layout\_25') })
  .margin({ top: $r('app.float.layout\_10') })
  .alignItems(HorizontalAlign.Start)
  .translate(this.getTitleTranslateOptions())
  .scale(this.getTitleScaleOptions())
  .animation({ duration: this.duration, curve: Curve.FastOutLinearIn })
  .transition({ type: TransitionType.Insert, translate: { y: Constants.TRANSLATE\_Y } })
  .visibility(this.isExpanded ? Visibility.Visible : Visibility.Hidden)
}
.height(Constants.LAYOUT\_MAX\_PERCENT)
.width(Constants.LAYOUT\_MAX\_PERCENT)
...
**图10** 同一界面多个按钮同时缩放示意图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b3/v3/sq4YkuS-T76t4XhbjaWcmw/zh-cn_image_0000002229337385.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=7321D18F52908528D54F59BACA79D03283C723B248C8050AD41BD5A07EC719A8 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9b/v3/jmBt4wLXQduSy_pHrWK6og/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=A0F39AC88E6513090E4F7884310F165B71867B911A380C865D3CC43FE94C88FB)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1e/v3/KwFYoab3Q3O4d8VPitOwMA/zh-cn_image_0000002193852008.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=7D2552325EA9C845887D2FD61BE0D0C94DC97647C54CCC4F7F2C4CE68A686262 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f9/v3/06aza7uOS7qM7LgWLZs9pA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=B72294F8C25DCA3B185DCFCCD328D1403D8B7E865309FA650DB837E5B14A0E29)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d7/v3/fmB7iaNET6yuk0wcEjwlNQ/zh-cn_image_0000002229337397.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=1EED32A97704739E4920A8ABAE260D9D78C1E61593DE1E46A9A5EFB51BF0495D "点击放大")
...
**图13** 多个相同组件修改多个属性示意图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/67/v3/Hn7e_gogQumrC2KuNG3jVw/zh-cn_image_0000002193851988.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=F2479B2E598A2566E9F2AC7904576D08A569B09D9E185C573A44021F188550B8 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a6/v3/S7WROQY5QOS-BGk9K1cL2A/zh-cn_image_0000002229337361.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=7F287C21A282BC3D911189624A3C27CA136C68D5FD104960007200626DB56AE2 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1a/v3/SWQ2C8s3QuSgdjL_JHZvbw/zh-cn_image_0000002194011564.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=1D0D5A86F7A9766DA5C09ACEEA06C1F04C350129B53619A6505D1B1FBCAA3ABF "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ad/v3/QhldDjf8S4qBxgxVZOVxqA/zh-cn_image_0000002229337381.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=795D3F77D8BC590C70B0531074388085411795DFD12ABAA6B7139E3255E2227B "点击放大")
...
**图17** 组件渲染流程图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/49/v3/1kCfuMkXRS25kc78YBNdvA/zh-cn_image_0000002229451865.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=B359B48E4ED69944B69E916E0C066561D785FFB602C9FB3C3CD12294A69AB5E0 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6c/v3/328a2f-7TMKeWyRttxXpnA/zh-cn_image_0000002194011572.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=D0361EC735CCEC9A1EB4EFAB8D0A92B7761763FC1949259AFEE7397A01E3B401 "点击放大")

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/55/v3/5rq9ozFAR-iGsrTswBmDFw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=7EE2F43C6737BC480624A287531CAC447CE4B1FD7B8DE9A0E2A754AA4813F176)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c9/v3/dHi5rAyCTL-Po5yvopH6NA/zh-cn_image_0000002229451857.gif?HW-CC-KV=V1&HW-CC-Date=20260417T015415Z&HW-CC-Expire=86400&HW-CC-Sign=71196E65A27656F1F3A6125C0247845D04ABC5E7433835D06B8BAC2A1E0C5819 "点击放大")
  ...
  aboutToAppear() {
    for (let index = 0; index < 20; index++) {
      ...
      this.iconItemSourceList.push(
        new IconItemSource($r('app.media.app\_icon'), \`item${numStart + 1}\`),
        new IconItemSource($r('app.media.app\_icon'), \`item${numStart + 2}\`),
        new IconItemSource($r('app.media.app\_icon'), \`item${numStart + 3}\`),
      );
    }
  }
