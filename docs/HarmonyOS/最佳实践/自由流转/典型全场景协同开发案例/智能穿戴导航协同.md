---
title: "智能穿戴导航协同"
source_url: "https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-smartwatchnavigation"
menu_path:
  - "最佳实践"
  - "自由流转"
  - "典型全场景协同开发案例"
  - "智能穿戴导航协同"
captured_at: "2026-04-17T01:54:16.764Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/47/v3/hxWZz-4CSzCND1QzXVUF6Q/zh-cn_image_0000002318967316.png?HW-CC-KV=V1&HW-CC-Date=20260417T015418Z&HW-CC-Expire=86400&HW-CC-Sign=4FDB7A1A03A3345594AFAEA700BBF99418B85BC3DE5E0CC4306A1B00DCBCB5D9 "点击放大")

 | 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/47/v3/xEJDC6y0Spq-ZZQ0VNcs1g/zh-cn_image_0000002353005921.png?HW-CC-KV=V1&HW-CC-Date=20260417T015418Z&HW-CC-Expire=86400&HW-CC-Sign=6188F601DEBFD7448AAA322168D77786B92A946F4E649A4100248F1EC3EDF2D0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f0/v3/cF_J1EBMTqyotVKIDjcQeA/zh-cn_image_0000002319127156.png?HW-CC-KV=V1&HW-CC-Date=20260417T015418Z&HW-CC-Expire=86400&HW-CC-Sign=FC7A573F70F197EED4103CB6F8970A8199E03D881E3C4AC6392462C99746C70A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/86/v3/MciEBTUHQYaFzduOoLMJmQ/zh-cn_image_0000002353086117.jpg?HW-CC-KV=V1&HW-CC-Date=20260417T015418Z&HW-CC-Expire=86400&HW-CC-Sign=8806B05FC1F8F09CAC32A3B365F98AD3439708069F958350A91128A47F8F57D1 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ce/v3/OQm27TeKRoS-SWn_INBWyw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015418Z&HW-CC-Expire=86400&HW-CC-Sign=8F924DC6D56DC818778A0465438E2F6C6F0AD5FD4BD09C6B89E076DD7E7B24DF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/26/v3/_aOlBUvaROuyV_atghOXeg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015418Z&HW-CC-Expire=86400&HW-CC-Sign=AA33338BE2D3B27682273E24B22DEA51F0D9C21646F726D9E7929265A11D830D)
...
**图1** 地图点击操作时序图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/19/v3/pbsmQ_aRQzyg7tYelGB6Xw/zh-cn_image_0000002318967344.jpg?HW-CC-KV=V1&HW-CC-Date=20260417T015418Z&HW-CC-Expire=86400&HW-CC-Sign=BA935A33974C053D643BC40FFBBD35F4D2FA5A1FE1CF82AC56122585EBD4F932 "点击放大")
...
1.  注册地图点击事件监听器，在回调函数中将触点的地理坐标持久化存储至destination\_Position状态变量中。
    ...
    @StorageLink('destination\_Position') @Watch('changeDestinationPositionMark') destination\_Position: mapCommon.LatLng =
      {
        longitude: 0,
        latitude: 0
      };
        ...
        if (!err) {
          ...
          let mapOnclickCallBack = async (position: mapCommon.LatLng) => {
            if (this.isStartNavigation) {
              ...
              // Modify destination\_Position to trigger changeDestinationPositionMark
              // To refresh the destination mark on the map.
              this.destination\_Position = position;
              this.isBarShow = true;
            }
          };
...
2.  监听destination\_Position变化，调用[addMarker()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapcomponentcontroller#section0810361284)动态更新目的地地图标记。
    ...
    // ...
    /\*
     \* Triggered when destination\_Position changes.
    ...
    async changeDestinationPositionMark() {
      if (this.mapController) {
        ...
        let markerOptions: mapCommon.MarkerOptions = {
          position: this.destination\_Position,
          rotation: 0,
          visible: true,
          zIndex: 0,
          alpha: 1,
    ...
    Button($r('app.string.DrawRoute'))
      ...
      .onClick(async () => {
        let params: navi.RouteParams = {
          ...
          \],
          destination: this.destination\_Position,
          language: 'zh\_CN'
        };
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/21/v3/LQjJ2kWpQVefLO24dP5ClQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015418Z&HW-CC-Expire=86400&HW-CC-Sign=B1733DE5A03F5FEAEB538D0893DACA3F64B43DD9C44A0821FB07E90B0E18F864)
...
private onMsgCallback: Callback<wearEngine.P2pMessage> = (data: wearEngine.P2pMessage): void => {
  ...
  if (communicationInformation.tag === 0) {
    ...
    AppStorage.setOrCreate('route\_information', communicationInformation.routeInfomation);
    ...
    AppStorage.setOrCreate('destination\_Position', communicationInformation.location);
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/39/v3/ceNE1farQ_CtJRvP9ln25w/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015418Z&HW-CC-Expire=86400&HW-CC-Sign=3A2B7DCA6DE31C3CDDF571C3C7518CE8C56B392A19162281F556D0DAFEDE2707)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7d/v3/FpRC3fW9SOqsgqWCof_p0A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015418Z&HW-CC-Expire=86400&HW-CC-Sign=9E48965119A7BC35191252031C9FA5CB7F20B9A171DBDF44FA67137B1CA09025)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6a/v3/aIWHon5xQWa7n9KCZLPnaA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015418Z&HW-CC-Expire=86400&HW-CC-Sign=68D7E1A3351C609CB8A80CA669E6BBD8F6830CCC2AEE8B2EE9CAA061D8B9F278)
