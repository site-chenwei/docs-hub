---
title: "内容编辑多设备协同"
source_url: "https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-continue"
menu_path:
  - "最佳实践"
  - "自由流转"
  - "典型全场景协同开发案例"
  - "内容编辑多设备协同"
captured_at: "2026-04-17T01:54:16.811Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/rNya6jDTSoisRhTVr2SUPg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015418Z&HW-CC-Expire=86400&HW-CC-Sign=7C9F566D7A43783BB1424A7CB0BE2C7A98C08DE63447B490A7B3A0FC848DBEEB)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/IKDm136aST6HeiKqU_8qDg/zh-cn_image_0000002345774957.jpg?HW-CC-KV=V1&HW-CC-Date=20260417T015418Z&HW-CC-Expire=86400&HW-CC-Sign=2771B84D20084D84767D6A5C0C3DF8B971AF4F877932C29A23BFC44F55949C8E "点击放大")
...
-   拉取远端菜单，选择远端设备
    ...
    MyTestMenu() {
      Menu() {
        MenuItem({
          symbolStartIcon: new SymbolGlyphModifier($r('sys.symbol.picture\_2')),
          content: $r('app.string.local\_device')
        })
          .onClick(() => {
            if (this.imageUriArray.length < CommonConstants.MAX\_ADD\_PIC) {
              this.selectImage();
            } else {
              try {
                this.getUIContext().getPromptAction().showToast({ message: $r('app.string.add\_picture\_prompt') });
              } catch (err) {
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/52/v3/AQ2htVAARimqG7ZrdT3TAw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015418Z&HW-CC-Expire=86400&HW-CC-Sign=384D3CF3BDF6626E4280F908292D983BB11222AC989F7901899876A855872BB3)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ae/v3/265rxrkSQL2KPQj2jj20wg/zh-cn_image_0000002311815960.jpg?HW-CC-KV=V1&HW-CC-Date=20260417T015418Z&HW-CC-Expire=86400&HW-CC-Sign=CEB26EE1C13BF0CFBE74C98C4033F482CF341037B2C2B9B6B57406D2E6FA21DC "点击放大")
...
-   定义[拖拽事件](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop)
    ...
    build() {
      ...
      .allowDrop(\[uniformTypeDescriptor.UniformDataType.IMAGE,
        uniformTypeDescriptor.UniformDataType.OPENHARMONY\_PIXEL\_MAP\])
    ...
    addPic() {
      Row() {
        List({ space: CommonConstants.LIST\_COMM\_SPACE }) {
    ...
    build() {
      Flex({ direction: FlexDirection.Column }) {
        TextInput({ text: this.mainTitle, placeholder: $r('app.string.text\_input\_placeholder') })// ...
          .draggable(true)
        ...
        TextArea({ text: this.textContent, placeholder: $r('app.string.richEditor\_placeholder') })// ...
          .draggable(true)
          .allowDrop(\[uniformTypeDescriptor.UniformDataType.PLAIN\_TEXT\])
          .onDrop((dragEvent?: DragEvent) => {
            // The logic after the text falls in, realizing the writing of text.
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9f/v3/RCOUB1c1SZeATfB0OapalQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015418Z&HW-CC-Expire=86400&HW-CC-Sign=EAA2151691E8151749681F81CF7A58CFE59CC63DC25D061B7FEEF0BBEFBCFE29)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/24/v3/t9X9ior0RUmHO-SLQwPQcA/zh-cn_image_0000002345774965.jpg?HW-CC-KV=V1&HW-CC-Date=20260417T015418Z&HW-CC-Expire=86400&HW-CC-Sign=829CC3A48705806293A32DC683F6810D000239E4641D6EE174983FA5C843C3AC "点击放大")
...
-   本端复制数据，写入到剪贴板服务
    ...
    async setPasteDataTest(pixelMap: image.PixelMap): Promise<void> {
      let pasteData: pasteboard.PasteData = pasteboard.createData(pasteboard.MIMETYPE\_PIXELMAP, pixelMap);
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8d/v3/rZFdhEc4RXeuElx2yANcbg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T015418Z&HW-CC-Expire=86400&HW-CC-Sign=CC9AA45E4B3440BF6751E49C34843678D6D8B09025ECAD1476E27DDC4E485A81)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f6/v3/z4VZL0bXT5-ACjxRjUlIww/zh-cn_image_0000002311815980.png?HW-CC-KV=V1&HW-CC-Date=20260417T015418Z&HW-CC-Expire=86400&HW-CC-Sign=F55D380351F1DFF16360CB6AF70F91F90BC42CFFD0742F1F186AF607C40BFD18 "点击放大")
      ...
      if (canIUse('SystemCapability.DistributedDataManager.CommonType')) {
        ...
        try {
          if (fs.accessSync(filePath)) {
            let saveFile = fs.openSync(savePath, fs.OpenMode.READ\_WRITE | fs.OpenMode.CREATE);
            let file = fs.openSync(filePath, fs.OpenMode.READ\_WRITE);
