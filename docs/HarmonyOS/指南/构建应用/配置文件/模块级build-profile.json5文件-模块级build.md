---
title: "模块级build"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-hvigor-build-profile"
menu_path:
  - "指南"
  - "构建应用"
  - "配置文件"
  - "模块级build-profile.json5文件"
captured_at: "2026-04-17T01:36:50.800Z"
---
...
指定ability图标文件的索引，格式为"$media:ability\_icon"。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/d1EMod5gTH2M1ByZT8Nubg/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013651Z&HW-CC-Expire=86400&HW-CC-Sign=B6A063F728CC45C12DDCFDDACC90FB70D02CDC5813E2D194FD251194AB568473)
...
配置语言、文字、国家或地区限定词目录，匹配到的目录会被打包到产物中，如\['zh\_CN'\]表示过滤其他语言，打包包含zh\_CN的目录。
...
-   以下目录配置后不生效，即不会被打包到产物中：node\_modules、oh\_modules、.preview、build、.cxx、.test。
