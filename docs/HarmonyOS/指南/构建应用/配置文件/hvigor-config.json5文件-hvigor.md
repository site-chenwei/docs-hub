---
title: "hvigor"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-hvigor-set-options"
menu_path:
  - "指南"
  - "构建应用"
  - "配置文件"
  - "hvigor-config.json5文件"
captured_at: "2026-04-17T01:36:50.717Z"
---
...
-   模块级build-profile.json5文件中也可以通过[arguments字段](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-exception-stack-parsing-principle#section147714466283)指定cmake构建类型，例如"arguments": "-DCMAKE\_BUILD\_TYPE=RelWithDebInfo"。arguments字段的优先级比ohos.defaults.release.cmakebuildtype更高。
