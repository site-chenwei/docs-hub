---
title: "混淆加固"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-build-obfuscation"
menu_path:
  - "指南"
  - "构建应用"
  - "混淆加固"
captured_at: "2026-04-17T01:36:51.298Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/50/v3/Qz6qG_5ZT3ywwk1-hVeMkw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=23B8FAC242D511F4908A75AB3F57ABD205DA20511A34A66BED4CA525E566732D)
...
2.  打开模块目录内的obfuscation-rules.txt文件配置混淆规则，具体的配置规则请参见[配置混淆规则](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/source-obfuscation)，对于不需要混淆的内容，请配置[保留选项](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/source-obfuscation#保留选项)。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fe/v3/nGtO9OlzQWa7Oo5-kJhkwg/zh-cn_image_0000002530913828.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=57637248BD59D22BF1B8B9656840468B52C231D97D8D8A494B6140D6105D0FAF)
...
2.  打开模块目录内的consumer-rules.txt文件配置[保留选项](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/source-obfuscation#保留选项)。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4c/v3/bv0ck98BQCKUw5SRyE0Y8w/zh-cn_image_0000002561833723.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=1498B5F0490FB39893DC3D7E40F647270EC2BF290CE1001770AB561217FCA9E5)
...
1.  通过以下任意一种方式打开ObfuscationHelper：
    ...
    -   在模块目录上点击鼠标右键，在弹出的菜单中选择**ObfuscationHelper**。
        ...
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fb/v3/gtUXDmPDTom4jD41kI2DRw/zh-cn_image_0000002530913810.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=827ACB756E312F1A1FF3F622F10897602EB006E530B98384E3B207FF515A0183)
...
3.  如果模块之前被扫描过，并且生成了排查白名单，则会生成相应的历史记录。选择对应的历史记录，在本次扫描完成后，会自动关联历史的排查记录，历史已经排查过的白名单字段无需再重复排查。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/Yyl1wx8tRPWqbYTNHgTlYA/zh-cn_image_0000002530913790.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=4BE5D2FC1C68FD82B53429D961742DDAE628529181CDB65B6F378F7E5775B016)
    
4.  根据涉及的混淆场景，选择一个或多个扫描任务，点击**开始扫描**。关于扫描任务的介绍请参考[扫描任务](#section18125192133818)。
    
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a6/v3/s-YUG8fTRJqtjnOt0tyHWQ/zh-cn_image_0000002530913836.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=6FC9DAC9CDE00CA5705845E87F4226A4896D0ACF729E2948F2FBD5F15E2E3827)
    
5.  等待扫描成功后，进入[推荐白名单](#section3989185975217)和[待排查白名单](#section42331014105310)配置页面。在扫描的过程中，也可以点击**停止扫描**按钮，结束扫描。
    
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b8/v3/9EhHLstPTxypV8XmXPv4fg/zh-cn_image_0000002530913824.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=7B0E2DCE07A2DB7B3ED38E6CDAC738FB7B9D3D30D9D420B8BC4F3AC0ACF6DBED)
...
-   **使用DevEco Studio 6.0.0 Beta1及以上版本，按以下步骤操作：**
    1.  在页面上方，按照以下的树状结构呈现扫描结果。
        ...
        -   **关键代码**：点击关键代码，可以跳转到代码所在的文件和代码行。
            ...
            ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/_V6DhDYnTmCTBWDQeisLSw/zh-cn_image_0000002561833717.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=2687849689F41863417CE17E6AE1F8D22381AEABA633D0756D79D7124DAF01D7)
            
        -   **白名单字段**：点击白名单字段，可以跳转到字段所在的文件和代码行。
            
            ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fd/v3/He3ODj_LTT2920pJVOPmKg/zh-cn_image_0000002561833741.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=50AD9E4148549841CB42AAE0DFE876B4CC04D4230675623F654BF76C627F1786)
    ...
    2.  如果需要将白名单文件生成到工程中，可以点击**生成推荐白名单**按钮，ObfuscationHelper会在对应模块下生成推荐白名单文件Hm-recommend-keep-list.txt/Hm-recommend-consumer-keep-list.txt，并提示对应的文件路径。同时在工程根目录下生成对应的白名单Excel表格obfuscation-helper-xxx.xlsx。
        ...
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/23/v3/588ffqO1QOSFgcDIX_k-Mw/zh-cn_image_0000002561753757.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=D9470E7E3DAF90193E0EDB043C96CA4A341482A1E06B9B737D6FA6CF961BCFC7)
        ...
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/39/v3/CQWCJCq_QvCxstpIf7Yrmg/zh-cn_image_0000002561833713.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=59B29787F153AA913AAE0E0DA9087AF0E4B092658AA32BE2637638ED5031C569)
    ...
    3.  在混淆配置中添加白名单文件，有两种方式。
        ...
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/89/v3/erdRXjRxRVuX9NqBg_Po_Q/zh-cn_image_0000002530913816.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=0D4BE56903388201D6D40DF5C54FEB0A3F5608CE98BBDCCD14570B388EDE0F02)
...
-   **使用DevEco Studio 6.0.0 Beta1以下版本，按以下步骤操作：**
    1.  在页面上方，按照以下的树状结构呈现扫描结果。
        ...
        -   **关键代码**：点击关键代码，可以跳转到代码所在的文件和代码行。
            ...
            ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bf/v3/y3fVwMJ0Rci_BAKpha_k8A/zh-cn_image_0000002561833729.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=06D1F5FDD2BF6AD96CF4C6037D9D7E14A030EC7923F1F8E7B414938F4F763D95)
            
        -   **白名单字段**：点击白名单字段，可以跳转到字段所在的文件和代码行。
            
            ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ac/v3/yR05CtG7T_yoFh3xRh_DgQ/zh-cn_image_0000002530753812.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=3E7D6CB1B25A8FE47BBCC4962586575F4248D0F342FDB693EBAB4D35992F0E81)
    ...
    2.  如果需要将白名单文件生成到工程中，可以点击**生成推荐白名单**按钮，ObfuscationHelper会在对应模块下生成Hm-recommend-keep-list.txt文件，并提示对应的文件路径。同时在工程根目录下生成对应的白名单Excel表格obfuscation-helper-xxx.xlsx。
        ...
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c1/v3/pzACD1qeSGW0LR-zgvaGXw/zh-cn_image_0000002530753838.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=6B6579DD08774D7AF2AAA991406671139925877B7A18EFEF2C9CFF8048FB4032)
        ...
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/99/v3/KWyrSnZwSY6i-wWOWZxfQA/zh-cn_image_0000002530753828.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=512337EB81FAB8AC796AA505CF0314431ACF871438B5CF9D48A2086A4F428488)
    ...
    3.  在模块下的build-profile.json5中，将模块下生成的推荐白名单文件Hm-recommend-keep-list.txt加入到混淆配置files或consumerFiles字段下。关于字段的介绍请参考[字段说明](#section88021016154414)。
        ...
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fd/v3/MrtkSVplTD-ozgH3UDCh3w/zh-cn_image_0000002530913796.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=C01440F7494F203BE6C0A05FB9078E2B3BA568EF244CA99E79F5840E4DF73E60)
...
-   **使用DevEco Studio 6.0.0 Beta1及以上版本，按以下步骤操作：**
    1.  在页面上方，按照以下的树状结构呈现扫描结果。
        ...
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e4/v3/z-Yl0NPERs-sDAb9d5scxg/zh-cn_image_0000002561833733.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=0C536AADDC5F2C51EE7615CCCE73725FA484A1AACC81B92F4A5FDBA4E8DF09D3)
    ...
    2.  跳转到关键代码后，根据具体场景识别是否需要配置白名单字段，排查方式请参考[扫描任务](#section18125192133818)。
        ...
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/68/v3/Iv4qqCoWSvSA6Kvs-XnroA/zh-cn_image_0000002561753765.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=6CB6EB3097A7870CB1D1A58B2F445557F5F6E418C64EF18A083942F8B287FB98)
    ...
    3.  排查完成后，点击**生成排查白名单**按钮，ObfuscationHelper会在对应模块下生成排查白名单文件Hm-manual-keep-list.txt/Hm-manual-consumer-keep-list.txt，并提示对应的文件路径。同时在工程根目录下生成对应的白名单Excel表格obfuscation-helper-xxx.xlsx。
        ...
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/20/v3/8EZgFMvWT5WunyN_K2UGgQ/zh-cn_image_0000002561753775.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=04FC0A5C07B679CAF0F590871E6329EEECB0C731822D0C8731A21B512B5E7AA5)
        ...
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f8/v3/cl5H4o7wSDCGTddR-csGCg/zh-cn_image_0000002530913800.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=B46130E84282358C3A3656A1173D30DB8122649B82D31A87C2167CCA8013F0E1)
    ...
    4.  在混淆配置中添加白名单文件，有两种方式。
        ...
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/57_4auk8TYWwEJf_5SSMOQ/zh-cn_image_0000002561753771.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=A891373CEFC0B1282423F6986FA936411CDDF01E3C43D46135C4310CAE8DB993)
...
-   **使用DevEco Studio 6.0.0 Beta1以下版本，按以下步骤操作：**
    1.  在页面上方，按照以下的树状结构呈现扫描结果。
        ...
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f8/v3/aGagVxk_TF2KvDAzUEBjuA/zh-cn_image_0000002561833759.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=C870477EC7FAD17B14CF7A3265E888A016ECBD908F655F3D6125E81944E5796B)
        
    2.  跳转到关键代码后，根据具体场景识别是否需要配置白名单字段，排查方式请参考[扫描任务](#section18125192133818)。如果存在需要配置的字段，在上方的输入框中，输入保留选项和对应的白名单字段。
        
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/15/v3/fnMl_j8HSt2bUbxhHkALJA/zh-cn_image_0000002530753820.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=1082CE573B9052B6DDF122D56C0BEECD9D7190181AAF2B67B38D9A330AA86F22)
    ...
    3.  排查完成后，点击**生成排查白名单**按钮，ObfuscationHelper会在对应模块下生成Hm-manual-keep-list.txt文件，并提示对应的文件路径。同时在工程根目录下生成对应的白名单Excel表格obfuscation-helper-xxx.xlsx。
        ...
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/57/v3/bdavsz8ZRSWxMOmElss-GA/zh-cn_image_0000002530913832.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=0814E76D7755BBEECB2E3A340D0B111CF7FCBA0C03524B4FB684E18EFC7BFC41)
        
        如以下模块下生成排查白名单文件：
        
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fd/v3/g-eCg7QeTCGwwTHYsrI4Yw/zh-cn_image_0000002561753779.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=C049D8C4F29C1482FC2383ECBDF67C49A4266C74EE64BA76C3AB60331905B5B1)
    ...
    4.  在模块下的build-profile.json5中，将模块下生成的排查白名单文件Hm-manual-keep-list.txt加入到混淆配置files或consumerFiles字段下。关于字段的介绍请参考[字段说明](#section88021016154414)。
        ...
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/24/v3/kU2m7oNDQhixImyWCwJM5g/zh-cn_image_0000002530913806.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=A230E70327766AEAE7C8FAF9F7AD925EF69CDA6C8EA4AE48A5CA9E1566FC7A04)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f6/v3/TrfiQKDRRFeEVwYqi5U2JA/zh-cn_image_0000002530753816.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=B4FCA092D2B6AE64F14EBD2FF9DC48C8786CBC74598C82FD2B70601F57B5CEB5)

-   保存路径是历史记录的缓存文件，鼠标悬停在保存路径上，可以查看白名单文件和Excel表格保存的路径。
-   点击查看详情图标![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/34/v3/fjc2jOEcQpuAhqEePCCElA/zh-cn_image_0000002530913818.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=910002F7FD913648DFA6E2EBBE9733457B7E4A36897BE90AB8F6F9768EA11154)，可以跳转到对应的白名单场景配置页面。
...
-   **C++侧访问/操作ArkTS对象属性**
    ...
    func() {
      ...
      let result: ESObject = testNapi.setProperty(obj, "napiTestClassObjMessage", "100");    // 根据napi\_set\_property接口排查到ArkTS中的属性napiTestClassObjMessage被修改，需要将napiTestClassObjMessage加入-keep-property-name白名单
    ...
    //napi\_init.cpp
    static napi\_value SetProperty(napi\_env env, napi\_callback\_info info) {
        size\_t argc = 3;
        napi\_value args\[3\];
        napi\_status status = napi\_get\_cb\_info(env, info, &argc, args, nullptr, nullptr);
        if (status != napi\_ok) {
            napi\_throw\_error(env, nullptr, "Node-API napi\_get\_cb\_info fail");
        }
        status = napi\_set\_property(env, args\[0\], args\[1\], args\[2\]);    // 扫描napi\_set\_property关键API
        if (status != napi\_ok) {
            napi\_throw\_error(env, nullptr, "Node-API napi\_set\_property fail");
            return nullptr;
        }
        return args\[0\];
    }
...
-   **namespace中导出的名称**
    ...
    export namespace namespace1 {
      ...
      export namespace namespace1\_1 {      // namespace1\_1加入推荐白名单-keep-global-name
        export let namespace1Property1\_1: string = '111';      // namespace1Property1\_1加入推荐白名单-keep-global-name
        export function namespace1Func1\_1() {      // namespace1Func1\_1加入推荐白名单-keep-global-name
          console.log('namespace1Func1\_1 execute success');
        }
        export class namespaceClass1\_1{      // namespaceClass1\_1加入推荐白名单-keep-global-name
          func(){
            console.log(""namespaceClass1\_1 success"")
          }
        }
      }
    }
...
-   **传递给动态路由的路径名**
    ...
    // 模块下resources/base/profile/route\_map.json文件
    {
      "routerMap": \[
        {
          "name": "PageOne",
...
-   **hsp对外暴露的接口**
    ...
    // 导出的常量
    export const LOCAL\_NUM = 100  // LOCAL\_NUM加入keep-global-name
    // 导出的方法
    ...
    export namespace NmSpace {
      export const NUM\_NAME\_SPACE = 100   // 常量NUM\_NAME\_SPACE加入-keep-global-name
...
-   **har对外暴露的接口**
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dd/v3/J7E584F2SKqkGdTtzLuGRw/zh-cn_image_0000002561833755.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=E29351D19D33794BA3707044B7C7D16ADCC1B11201D5790F7F22A36DE65F5D85)
