---
title: "基础构建能力"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-hvigor-api"
menu_path:
  - "指南"
  - "构建应用"
  - "扩展构建能力"
  - "扩展构建API"
  - "基础构建能力"
captured_at: "2026-04-17T01:36:51.429Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5a/v3/qW_jT_P2ShCU9x3uMMdd-A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=AC2DB68CBFEEA4979F620E339D29D06510835F152BBEB9D194A503BA3AE683D5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0c/v3/dgl3RNawSyKPH6ZBQlmUUA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=F3506892D88E837FB824A2218E9719A21BCFA4B6BBBE5C5E113301948C84FD4E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d0/v3/7Znsx6DASeSAvhHG3PModA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=796660B23369E0B42CF37F6752521066F2EDE17108414D8E43077043581FA2B6)
...
hvigor.nodesEvaluated(() => {
  ...
  hvigor.getRootNode().subNodes(subNode => {
    const hapContext = subNode.getContext(OhosPluginId.OHOS\_HAP\_PLUGIN) as OhosHapContext;
  });
});
...
const node = getNode(\_\_filename);
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/62/v3/0elbGYR9QGKATe4Y2BPjug/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=7648243209900855D460D101932FF69A928997564003032438E9E60D16250EF5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/MxnYnCb8RPeU2CEQquaaTw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=486FAD393C5B7956E61F50956AE13649A8B4A591D05E4CEFB347EE5E7FC1C15B)
    ...
    return {
        ...
        async apply(currentNode: HvigorNode): Promise<void\> {
            hvigor.nodesEvaluated(async () \=\> {
                const context: OhosAppContext \= currentNode.getContext(OhosPluginId.OHOS\_APP\_PLUGIN) as OhosAppContext;
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e2/v3/TnEbzsIXQG22M6RFTP79oA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=89FF5A019F01BB2B3D88A9AE77EC59F99978A927B1977DD90CDB10B0E67A5E77)
...
hvigor.nodesEvaluated(() \=\> {
    ...
    const appContext \= node.getContext(OhosPluginId.OHOS\_APP\_PLUGIN) as OhosAppContext;
...
export function customPlugin(): HvigorPlugin {
    return {
        pluginId: 'customPlugin',
        async apply(currentNode: HvigorNode): Promise<void\> {
            const appContext \= currentNode.getContext(OhosPluginId.OHOS\_APP\_PLUGIN) as OhosAppContext;
            console.log('projectName:', appContext.getProjectName());
        }
    };
}
...
const currentNode \= getNode(\_\_filename);

hvigor.nodesEvaluated(() \=\> {
    const context \= currentNode.getContext(OhosPluginId.OHOS\_APP\_PLUGIN) as OhosAppContext;
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c0/v3/OgslZQWzQAaqWAwYFDG_NA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=F42A3551D0508F67730AD0009646807C2EB01FD5C136E78850CCDCF488DE0FD1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/lQyGDQs-T3Sv0C7xDYOODw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013652Z&HW-CC-Expire=86400&HW-CC-Sign=C9B53EA379F36B7C8B21F2EA07845D351877F6A2E0565221E89D526A087CC340)
...
hvigor.nodesEvaluated(() \=\> {
    ...
    FileUtil.ensureFileSync(json5FilePath);
    FileUtil.writeFileSync(json5FilePath, JSON.stringify(context.getAppJsonOpt()));
    const copyFilePath \= FileUtil.pathResolve(context.getProjectPath(), 'testJson\_copy.json5');
  ...
  return {
    ...
    apply(node: HvigorNode) {
      ...
      node.registerTask({
        name: 'customTask',
        run() {
          submitWorker(node, this.name, path.join(\_\_dirname, 'wait-job.js', 'wait'), {callback: () => {
