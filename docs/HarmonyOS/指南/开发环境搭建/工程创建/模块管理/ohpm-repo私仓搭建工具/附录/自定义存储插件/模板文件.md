---
title: "模板文件"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-ohpm-repo-template-file"
menu_path:
  - "指南"
  - "开发环境搭建"
  - "工程创建"
  ...
  - "自定义存储插件"
  - "模板文件"
captured_at: "2026-04-17T01:36:42.972Z"
---
...
export class CustomStorage implements StoragePlugin {
  async init(): Promise<void>{
    ...
    //   config:         // 配置信息：export\_name和plugin\_path 是必选配置项
    //     export\_name: ExampleDemo          // 插件类的名字：例如 ExampleDemo
    //     plugin\_path: ../plugins/storage/customStorage/ExampleDemo.js    // 插件文件的存放位置
