...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/canvas-get-result-draw-arkts"
menu_path:
  - "指南"
  - "图形"
  ...
  - "画布的获取与绘制结果的显示"
  - "画布的获取与绘制结果的显示（ArkTS）"
captured_at: "2026-04-17T01:36:08.500Z"
---
...
5.  将自定义NodeController进行显示。
    ...
    struct RenderTest {
      ...
      myNodeController\_1 = new MyNodeControllerDirectDisplay();
      myNodeController\_2 = new MyNodeControllerIndirectDisplay();
        ...
        Row() {
          Column() {
            Column(){
              ...
              // 直接上屏显示画布
              NodeContainer(this.myNodeController\_1)
                .width('100%')
                .height('40%')
            }
            Column(){
              ...
              // 离屏画布
              NodeContainer(this.myNodeController\_2)
                .width('100%')
                .height('40%')
                .margin({ top: 20 })
            }
    ...
    export class MyRenderNodeIndirectDisplay extends RenderNode {
      ...
      async draw(context: DrawContext) {
        ...
        if (this.pixelMap != null) {
          ...
          const canvas\_ = new drawing.Canvas(this.pixelMap);
    
          // 5.2 离屏绘制
          const brush = new drawing.Brush();
          brush.setColor({ alpha: 255, red: 0, green: 0, blue: 255 });
          canvas\_.attachBrush(brush);
          canvas\_.drawRect({ left: 150, right: 575, top: 0, bottom: 600 });
