---
title: "创建并使用图片资源"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkgraphics3d-resource-image"
menu_path:
  - "指南"
  - "图形"
  ...
  - "创建并使用图片资源"
captured_at: "2026-04-17T01:36:09.208Z"
---
      ...
      return new Promise((resolve, reject) => {
        ...
        if (globalScene) {
          ...
          let sceneImageParameter: SceneResourceParameters = {
            name: 'image',
            uri: $rawfile('image/Cube\_BaseColor.png')
          };
...
6.  应用图片材质到模型节点。
    ...
    Button('Replace with a Image material')
      ...
      .onClick(async (): Promise<void> => {
        ...
        if (createdImage) {
          this.imageMat.colorShader.inputs\['BASE\_COLOR\_Image'\] = createdImage;
        }
