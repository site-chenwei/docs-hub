---
title: "创建并使用材质资源"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkgraphics3d-resource-material"
menu_path:
  - "指南"
  - "图形"
  ...
  - "创建并使用材质资源"
captured_at: "2026-04-17T01:36:09.199Z"
---
...
4.  获取几何体节点。
    ...
    this.geom = this.scene.getNodeByPath('rootNode\_/Unnamed Node 1/AnimatedCube') as Geometry;
      ...
      return new Promise((resolve, reject) => {
        ...
        if (globalScene) {
          ...
          let sceneResourceParameter: SceneResourceParameters = {
            name: 'shaderResource',
            uri: $rawfile('shaders/custom\_shader/custom\_material\_sample.shader')
          };
...
3.  获取几何体节点并预加载纹理。
    ...
    if (pbrNode) {
      ...
      const helmAlbedo: Resource = $rawfile('image/round\_pattern.png');
      const irregularUri: Resource = $rawfile('image/irregular\_pattern.png');
...
4.  配置环境光照。
    ...
    scene.environment.backgroundType = EnvironmentBackgroundType.BACKGROUND\_CUBEMAP;
    scene.environment.environmentImage = await rf.createImage({ name: 'cube', uri: $rawfile('Environment/quarry\_02\_2k\_skybox.ktx') });
    scene.environment.radianceImage = await rf.createImage({ name: 'rad', uri: $rawfile('Environment/quarry\_02\_2k\_radiance.ktx') });
