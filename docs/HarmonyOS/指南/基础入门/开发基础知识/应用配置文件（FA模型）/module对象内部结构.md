---
title: "module对象内部结构"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/module-structure"
menu_path:
  - "指南"
  - "基础入门"
  - "开发基础知识"
  - "应用配置文件（FA模型）"
  - "module对象内部结构"
captured_at: "2026-04-17T01:35:30.944Z"
---
...
标识Ability图标资源文件的索引。取值示例：$media:ability\_icon。如果在该Ability的skills属性中，actions的取值包含 "action.system.home"，entities取值中包含"entity.system.home"，则该Ability的icon将同时作为应用的icon。如果存在多个符合条件的Ability，则取位置靠前的Ability的icon作为应用的icon。
...
标识Ability对用户显示的名称。取值是对该名称的资源索引，支持多语言，例：$string:ability\_label。如果在该Ability的skills属性中，actions的取值包含 "action.system.home"，entities取值中包含"entity.system.home"，则该Ability的label将同时作为应用的label。如果存在多个符合条件的Ability，则取位置靠前的Ability的label作为应用的label。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d9/v3/mEAQiVVVRlW8Z1eMiCtHUQ/zh-cn_image_0000002538178320.jpg?HW-CC-KV=V1&HW-CC-Date=20260417T013531Z&HW-CC-Expire=86400&HW-CC-Sign=083FE61CB3D1D1781BE010C3DFFE23532E9377C1633C9A90BB57026D79BB6421)
