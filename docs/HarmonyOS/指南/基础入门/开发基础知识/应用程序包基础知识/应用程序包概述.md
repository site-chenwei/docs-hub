---
title: "应用程序包概述"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/application-package-overview"
menu_path:
  - "指南"
  - "基础入门"
  - "开发基础知识"
  - "应用程序包基础知识"
  - "应用程序包概述"
captured_at: "2026-04-17T01:35:30.549Z"
---
...
-   **Library类型的Module：** 用于实现代码和资源的共享。同一个Library类型的Module可以被其他的Module多次引用，合理地使用该类型的Module，能够降低开发和维护成本。Library类型的Module分为Static和Shared两种类型，编译后生成共享包。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f9/v3/xORfuXTAQnSmo9wWmOy1Dg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013530Z&HW-CC-Expire=86400&HW-CC-Sign=7C58F66CB521A10AE865CCEC323B36B963082332A78695F263FD482D311E7782)
    ...
    HSP一般随应用进行打包，当前支持应用内和[集成态HSP](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/integrated-hsp)。应用内HSP只支持应用内引用，集成态HSP支持发布到OHPM私仓和跨应用引用。
    ...
    **图1** HAR和HSP在APP包中的形态示意图
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/58/v3/Nji5K21aRoCJyQd7pu6YEg/zh-cn_image_0000002569018103.png?HW-CC-KV=V1&HW-CC-Date=20260417T013530Z&HW-CC-Expire=86400&HW-CC-Sign=F43DB12835867C4DD26C7A73799F6AA99C06CD9A9123F3D71903477576162899)
...
| Static Library | [HAR](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/har-package) | 
静态共享包，编译态复用。
...
\- 注意：[构建HAR](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/har-package#构建)时，建议开启混淆能力，保护代码资产。
 ...
 |
| Shared Library | [HSP](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/in-app-hsp) | 
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e8/v3/g0cea8DnTcG9Yq_vEytAlw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013530Z&HW-CC-Expire=86400&HW-CC-Sign=9F7D8C8ED7011F77689587A135594BB72A67E99EDD3F028A0AA191C82817FB25)
