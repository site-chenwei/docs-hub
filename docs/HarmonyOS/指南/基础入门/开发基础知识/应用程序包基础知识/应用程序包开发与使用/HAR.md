---
title: "HAR"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/har-package"
menu_path:
  - "指南"
  - "基础入门"
  - "开发基础知识"
  ...
  - "应用程序包开发与使用"
  - "HAR"
captured_at: "2026-04-17T01:35:30.719Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/80/v3/AcPbuwV2RmGjDFI43xj-fA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013531Z&HW-CC-Expire=86400&HW-CC-Sign=016CCB7ED9BFCFDD1552F6965812A7E29FAE75F09F6145CA8D2781C139963D26)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/mv6BmXlHQ7a92g1l1qfV7g/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013531Z&HW-CC-Expire=86400&HW-CC-Sign=F08B5DE24DADEAF10CFA53F9D688D9E40853BA2FE8CCA20918034DD78B733F1A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/69/v3/6Qwa0zjxQtCLsLJed4e4TA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013531Z&HW-CC-Expire=86400&HW-CC-Sign=66060EDB8399805F862DA25373127D9991D5ED94B37F2316E08B646E56A27475)
  ...
  build() {
    Column() {
      ...
      Flex({ justifyContent: FlexAlign.Center, alignItems: ItemAlign.Center, alignContent: FlexAlign.Center }) {
        Column() {
          Image($r('app.media.pic\_empty')).width('33%')
    ...
    .width('100%')
    .height('100%')
    .backgroundColor($r('app.color.page\_background'))
  }
}
...
-   依赖的HAR模块，如果依赖的多个HAR之间有资源冲突，会按照工程oh-package.json5中dependencies下的依赖顺序进行覆盖，依赖顺序在前的优先级较高。例如下方示例中dayjs和lottie中包含同名文件时，会优先使用dayjs中的资源。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/78/v3/oqqqe2QdRHigJd0dU9MYmQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013531Z&HW-CC-Expire=86400&HW-CC-Sign=87F66FDCB716E7AF4FB0AD25848D3D89658C813C1FD2C734E0A1C10166AE8A88)
...
struct Index {
  ...
  build() {
    Column() {
      ...
      // ...
      // 引用HAR的native方法
      Button($r('app.string.native\_add'))
        .id('nativeAdd')
        .height(48)
        .width('624px')
