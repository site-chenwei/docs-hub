---
title: "HSP"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/in-app-hsp"
menu_path:
  - "指南"
  - "基础入门"
  - "开发基础知识"
  ...
  - "应用程序包开发与使用"
  - "HSP"
captured_at: "2026-04-17T01:35:30.708Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/58/v3/blHT25j3Q3mGrKtqjLXk8g/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013531Z&HW-CC-Expire=86400&HW-CC-Sign=88D3D0467BF373DB0E07918DCFE3124FE9CD44CDF1855314FFE1C9CEBEB41F62)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8f/v3/7Q43LqYWQsmQAPW9ryIybg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013531Z&HW-CC-Expire=86400&HW-CC-Sign=1BF7184D0438CA067C3DF33EA48F5614F67FE26EB265F1A99E0EA896BF917A75)
...
export struct MyTitleBar {
  build() {
    Row() {
      Text($r('app.string.library\_title'))
        .id('library')
  ...
  build() {
    Column() {
      List() {
        ...
        .width('685px')
        .height('84px')
        .backgroundColor($r('sys.color.ohos\_id\_color\_foreground\_contrary'))
        .margin({ top: 10, bottom: 10 })
        .padding({ left: 12, right: 12, top: 4, bottom: 4 })
        .onClick(() => {
        ...
        ListItem() {
          Text($r('app.string.native\_multi'))
            .fontSize(18)
            .textAlign(TextAlign.Start)
            .width('100%')
            .fontWeight(500)
  ...
  build() {
    Navigation(this.pathStack) {
      Column() {
        List() {
          ListItem() {
            Text($r('app.string.click\_to\_menu'))
              .fontSize(18)
              .textAlign(TextAlign.Start)
              .width('100%')
              .fontWeight(500)
          ...
          .onClick(() => {
            this.pathStack.pushPathByName('library\_menu', null)
          })
        }
        .alignListItem(ListItemAlign.Center)
      }
    ...
    NavDestination() {
      Row() {
        Column() {
          ...
          Button('back\_to\_index').fontSize(50).onClick(() => {
            this.pathStack.pop();
          })
        }
        .width('100%')
...

{
  "module": {
    "name": "library",
    "type": "shared",
    "description": "$string:shared\_desc",
    "deviceTypes": \[
      "tablet",
      "2in1"
    \],
    ...
    "routerMap": "$profile:route\_map" // 新增配置，指向route\_map.json文件
  }
}
