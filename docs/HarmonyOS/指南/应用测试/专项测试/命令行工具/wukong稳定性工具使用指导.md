...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/wukong-guidelines"
menu_path:
  - "指南"
  - "应用测试"
  - "专项测试"
  - "命令行工具"
  - "wukong稳定性工具使用指导"
captured_at: "2026-04-17T01:36:44.060Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/40/v3/LsXAk4D4TeWoapE9KSLiQw/zh-cn_image_0000002529581642.png?HW-CC-KV=V1&HW-CC-Date=20260417T013644Z&HW-CC-Expire=86400&HW-CC-Sign=B3B1CAD979F7DE28EDF6F65495811C9C37B64448E5059319F4EA061BA0F60047)
...
-   执行查看帮助命令
    ...
    These are wukong special arguments list:
      ...
      -k, --spec\_insomnia        power on/off event
...
-   设置允许测试和禁止测试的ability
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e1/v3/DlgnXrSTTNqRXSUbwSl3PA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013644Z&HW-CC-Expire=86400&HW-CC-Sign=AA10F3B9528F3A658B3D136D931A3A2E00EE30439391A24CE35DD857F250C6A0)
...
\# wukong.log文件对应路径如下
/data/local/tmp/wukong/report/xxxxxxxx\_xxxxxx/wukong.log

# 查看wukong测试报告文件目录操作如下
$ cd /data/local/tmp/wukong/report/20170805\_170053
$ ls
data.js  exception  wukong.log  wukong\_report.csv

# 开启shell窗口，用hdc file recv获取wukong日志
C:\\Users\\xxx>hdc file recv /data/local/tmp/wukong/report/20170805\_170053/wukong.log C:\\Users\\xxx\\Desktop\\log
