...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/smartperf-guidelines"
menu_path:
  - "指南"
  - "应用测试"
  - "专项测试"
...
captured_at: "2026-04-17T01:36:44.042Z"
---
...
![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260126143804.17525464194895450448511407749172:50001231000000:2800:24BA15C3EB653FA40DD40D8B576291797F3A53EDABD0A4B00AD5104EC1579018.png)
...
$ SP\_daemon 
// 查看daemon进程是否存在
$ ps -ef | grep SP\_daemon
shell          1584     1 0 21:50:05 ?     00:00:00 SP\_daemon
shell          1595  1574 3 21:51:02 pts/0 00:00:00 grep SP\_daemon
$
...
//查看daemon进程是否存在
$ ps -ef | grep SP\_daemon
testserver   40960     1 4 15:38:48 ?     00:00:00 SP\_daemon -deviceServer:69df7e4df0edf70cbe204549028d7171
shell        41109 41033 67 15:38:59 ?    00:00:00 grep SP\_daemon
$
...
Usage: SP\_daemon \[options\] \[arguments\]
...
example1:
SP\_daemon -N 20 -c -g -t -p -r -net -snapshot -d
SP\_daemon -N 20 -PKG ohos.samples.ecg -c -g -t -p -f -r -net -snapshot -d -nav -gc
SP\_daemon -start -c
SP\_daemon -stop
example2: These parameters need to be used separately
SP\_daemon -screen
SP\_daemon -deviceinfo
SP\_daemon -server
SP\_daemon -clear
SP\_daemon -ohtestfps 10
SP\_daemon -recordcapacity
example3: These parameters need to be used separately
SP\_daemon -editor responseTime ohos.samples.ecg app name
SP\_daemon -editor completeTime ohos.samples.ecg app name
SP\_daemon -editor fpsohtest
...
采集指定应用的fps以及屏幕刷新率，必须设置应用包名，采集游戏时会自动抓取游戏图层。
...
$ SP\_daemon -N 1 -PKG ohos.samples.ecg -threads
...
$ SP\_daemon -N 2 -PKG ohos.samples.ecg -c
...
![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260126143804.17457683519579276282760878516067:50001231000000:2800:A6866574D218214685CA3328199D33EE267EADEDAD9DC8AB0B0177F6AF10D5DB.png)
...
order:3 npu\_thermal=35.000000
order:4 shell\_back=32.445000
order:5 shell\_frame=31.445000
order:6 shell\_front=31.438000
order:7 soc\_thermal=41.933000
order:8 system\_h=32.250000
...
order:5 shell\_frame=31.445000
order:6 shell\_front=31.438000
order:7 soc\_thermal=41.742000
order:8 system\_h=32.200000
...
$ SP\_daemon -N 1 -PKG ohos.samples.ecg -ci
...
![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260126143804.92627846199650121836457752269895:50001231000000:2800:0EE69F3D0FD2A0F084BB7FB5ACC7016800B77B3A2563726CD816D7BCD9FDC237.png)
...
$ SP\_daemon -N 1 -PKG ohos.samples.ecg -r
...
![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260126143804.33705514653533827269251418178187:50001231000000:2800:799B94C99A2B999CB3728595C89FFC7F8F7B86E2847FC2ABC833C1684F6E9DA2.png)

-   使用该命令采集时需进入被测应用内。

-   采集2次截图

$ SP\_daemon -N 2 -snapshot

order:0 timestamp=1739349178766
order:1 capture=data/local/tmp/capture/screenCap\_1739349178766.png
...
![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260126143805.74565438005907699672783864293163:50001231000000:2800:A7C1BD2A58540332FA11E735B69845A76DCD0F1A258063A5F3343DBDEACDDF0F.png)
...
$ SP\_daemon -N 5 -PKG ohos.samples.ecg -f
...
![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260126143805.61691930894742895071893280207493:50001231000000:2800:2653CD053CCFB79C4C193246351C2CAFDC2C02B513329834BE9DAB0A5EF70125.png)
...
$ SP\_daemon -N 10 -VIEW DisplayNode -f
...
![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260126143805.82862205525747589234936077723318:50001231000000:2800:5C4F4257B7794B6F8DCC940A91B0336C0DB0248594924CB8B3A599392B271EE2.png)
...
$ SP\_daemon -N 10 -c -g -t -p -r -d -net -snapshot
...
order:122 npu\_thermal=35.000000
order:123 shell\_back=35.870000
order:124 shell\_frame=34.870000
order:125 shell\_front=34.524000
order:126 soc\_thermal=59.114000
order:127 system\_h=36.777000
...
order:134 capture=data/local/tmp/capture/screenCap\_1739349730947.png
...
...
$ SP\_daemon -N 10 -PKG ohos.samples.ecg -c -g -t -p -f -r -d -net -snapshot -threads
...
order:21 capture=data/local/tmp/capture/screenCap\_1755656583554.png
...
...
order:167 npu\_thermal=52.000000
...
order:174 shell\_back=41.871000
order:175 shell\_frame=40.871000
order:176 shell\_front=40.549000
order:177 soc\_thermal=63.358000
order:178 stackPss=536
order:179 swap=16144
order:180 swapPss=16144
order:181 system\_h=42.764000
...
$ SP\_daemon -N 10 -PID 18847 -c -g -t -p -f -r -d -net -snapshot -threads
...
order:21 capture=data/local/tmp/capture/screenCap\_1768031295544.png
...
...
order:165 networkDown=0
order:166 networkUp=0
order:167 npu\_thermal=38.000000
...
order:174 shell\_back=34.667000
order:175 shell\_frame=33.667000
order:176 shell\_front=33.167000
order:177 soc\_thermal=39.971000
order:178 stackPss=2620
order:179 swap=200684
order:180 swapPss=200617
order:181 system\_h=34.900000
...
![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260126143805.63043995237776578902165187942534:50001231000000:2800:2325191C6411FD7808F8CAF092595CFE1FCE5ABA3F3B5C5DB1647C3C7228F824.png)
...
结束采集
$ SP\_daemon -stop
SP\_daemon Collection ended
Output Path: data/local/tmp/smartperf/1/t\_index\_info.csv
...
![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260126143805.10879664477892234749885123419509:50001231000000:2800:7969D68E228DD0DC934734FA6F4E07738050B69B4708240026CB31A2A0996157.png)
...
MAX\_RENDER\_SEQ\_MISSED\_FRAMES
...
$ SP\_daemon -editor timeDelay
ResponseTime:41ms
CompleteTime:593ms
HitchTimeRate:68.65ms/s
MAX\_RENDER\_SEQ\_MISSED\_FRAMES:3
$

![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260126143805.89665638687315056159524642846449:50001231000000:2800:883AA81C9FDE578FF835EC8BDFE81E021D77283AFF7E1703F456F7A37C6A282A.png)
...
$ SP\_daemon -editor slideList
FPS:107.181fps
ResponseTime:20ms
HitchTimeRate:1.49ms/s
MAX\_RENDER\_SEQ\_MISSED\_FRAMES:0
$

![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260126143805.36655894118925936508619288285966:50001231000000:2800:077A82458515561C886A6413A4F2754B5CB6A1190FC017F3978EAF0CFF79EEA7.png)
...
![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260126143805.40661402577167563153793982267471:50001231000000:2800:13943D1A43AEACE7C337F901322CE823B020799053C377FA62C996943C30D4F2.png)
...
board: default
brand: default
cpu\_c1\_cluster: 0 1 2 3
cpu\_c1\_max: 1530000
cpu\_c1\_min: 418000
cpu\_c2\_cluster: 4 5 6 7 8 9
cpu\_c2\_max: 2150000
cpu\_c2\_min: 418000
cpu\_c3\_cluster: 10 11
cpu\_c3\_max: 2620000
cpu\_c3\_min: 1239000
cpu\_cluster\_name: policy0 policy1 policy2
daemonPerfVersion: 1.0.5
deviceTypeName: default
fullname: OpenHarmony-5.1.0.50
gpu\_max\_freq: 750000000
gpu\_min\_freq: 279000000
model: ohos
name: default
sn: default
version: default
...
![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260126143805.12063000467366205586789981817120:50001231000000:2800:56B425E2384088CF1E4776C220D72C39DC71987ADBE88CFF5C6E066A5CC9160D.png)
...
![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260126143805.76813450679616290198260292213829:50001231000000:2800:F94E616715642F12BF184587443EBF103333EFE9E6D3C27DE2167DA873F31EFE.png)

-   可执行pidof SP\_daemon查看进程id。

-   采集当前界面fps

$ SP\_daemon -profilerfps 10
set num:10 success
...
SP\_daemon exec finished!
$

![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260126143805.96072756676255037649653120084077:50001231000000:2800:F746E364CF7F3B78AC2767A37428ADD6EB8F79CECA73DD13363C0D5BDC229784.png)

-   该条命令里的10表示采集的次数（一秒采集一次），可以设置为其他正整数。

-   采集当前界面fps（分段采集）

$ SP\_daemon -profilerfps 100 -sections 10
set num:100 success
...
![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260126143805.41181224008506012790208334649739:50001231000000:2800:8BE77B8E531E21057DB4ED666C1A72B648648E6B45999235C4944686D459AAB9.png)
...
![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260126143805.32251177078102994547211246210933:50001231000000:2800:F6C001D54B2A9469D3DDF84B52BD3D0C8DC1FC16BA03C6ACAE2B02122A862EF3.png)
