---
title: "日历账户管理"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/calendarmanager-calendar-developer"
menu_path:
  - "指南"
  - "应用服务"
  - "Calendar Kit（日历服务）"
  - "日历账户管理"
captured_at: "2026-04-17T01:36:12.788Z"
---
...
3.  根据上下文获取日程管理器对象calendarMgr，用于对日历账户进行相关管理操作。推荐在EntryAbility.ets文件中进行操作。
    ...
    export default class EntryAbility extends UIAbility {
      ...
      onWindowStageCreate(windowStage: window.WindowStage): void {
        ...
        const permissions: Permissions\[\] = \['ohos.permission.READ\_CALENDAR', 'ohos.permission.WRITE\_CALENDAR'\];
