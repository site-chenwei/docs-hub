...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/share-access-one-step"
menu_path:
  - "指南"
  - "应用服务"
  - "Share Kit（分享服务）"
  - "Share Kit体验规范"
  - "目标设备接收分享数据一步直达体验"
captured_at: "2026-04-17T01:36:22.637Z"
---
...
| 接收能力 | 数据类型 | 存储位置 | 预览方式 |
| :-- | :-- | :-- | :-- |
| 一步直达 | 媒体类型（仅包含图片和视频文件） | 
PC/2in1设备：文件管理“华为分享”目录。

其他设备：图库“华为分享”相册。

 | 

PC/2in1设备：文件管理文件高亮显示。
...
| 一步直达 | 文件类型 | 文件管理“华为分享”目录。 | 单文件使用文件预览，多文件高亮显示。 |
