---
title: "管理通知角标"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/notification-badge"
menu_path:
  - "指南"
  - "应用服务"
  - "Notification Kit（用户通知服务）"
  - "管理通知角标"
captured_at: "2026-04-17T01:36:19.136Z"
---
...
2.  增加角标个数。
    ...
    notificationManager.setBadgeNumber(badgeNumber).then(() => {
      hilog.info(DOMAIN\_NUMBER, TAG, \`Succeeded in setting badge number.\`);
...
-   反例
    ...
    notificationManager.setBadgeNumber(badgeNumber).then(() => {
      hilog.info(DOMAIN\_NUMBER, TAG, \`setBadgeNumber 10 success.\`);
    }).catch((err: BusinessError) => {
      hilog.error(DOMAIN\_NUMBER, TAG,
        \`Failed to set badge number. Code is ${err.code}, message is ${err.message}\`);
    });
    badgeNumber = 11;
    notificationManager.setBadgeNumber(badgeNumber).then(() => {
      hilog.info(DOMAIN\_NUMBER, TAG, \`setBadgeNumber 11 success.\`);
    }).catch((err: BusinessError) => {
      hilog.error(DOMAIN\_NUMBER, TAG,
        \`Failed to set badge number. Code is ${err.code}, message is ${err.message}\`);
    });
