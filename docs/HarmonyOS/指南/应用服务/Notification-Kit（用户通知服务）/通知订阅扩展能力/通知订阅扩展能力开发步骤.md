---
title: "通知订阅扩展能力开发步骤"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ion-subscriber-extension-ability-development-steps"
menu_path:
  - "指南"
  - "应用服务"
  ...
  - "通知订阅扩展能力"
  - "通知订阅扩展能力开发步骤"
captured_at: "2026-04-17T01:36:19.324Z"
---
...
5.  需要申请权限ohos.permission.ACCESS\_BLUETOOTH。如何配置和申请权限，具体操作请参考[声明权限](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/declare-permissions)和[向用户申请授权](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/request-user-authorization)。
