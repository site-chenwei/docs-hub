---
title: "@security/specified"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-specified-interface-call-chain-check"
menu_path:
  - "指南"
  - "编写与调试应用"
  - "代码编辑"
...
captured_at: "2026-04-17T01:36:46.552Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f3/v3/hssIJpNMTfya-dgOU_MjJw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013647Z&HW-CC-Expire=86400&HW-CC-Sign=8B6789DAF4A5D04ED1FD1BBA58F6D672A8CF27D55BDDE3A3AE91425E9A247D80)
...
// code-linter.json5
{
  "rules": {
    "@security/specified-interface-call-chain-check": \[
      "suggestion",
      {
        "outputDirPath": "", // 配置输出结果的文件目录，填写文件夹绝对路径，目录不存在则新建，输出文件名为specified-interface-call-chain-check\_result.txt。
