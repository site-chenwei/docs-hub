---
title: "@correctness/avsession"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-avsession-metadata-check"
menu_path:
  - "指南"
  - "编写与调试应用"
  - "代码编辑"
...
captured_at: "2026-04-17T01:36:48.312Z"
---
...
let playbackState: avSession.AVPlaybackState = {
  // Playing state.
  state:avSession.PlaybackState.PLAYBACK\_STATE\_PLAY,
  speed: 1.0,
  // Playback position.
  position:{elapsedTime:10, updateTime:(new Date()).getTime()},
  bufferedTime:1000,
  loopMode:avSession.LoopMode.LOOP\_MODE\_SINGLE,
  isFavorite:true
};
