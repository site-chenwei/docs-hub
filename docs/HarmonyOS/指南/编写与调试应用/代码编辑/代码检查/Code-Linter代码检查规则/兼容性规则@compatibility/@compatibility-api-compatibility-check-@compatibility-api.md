...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-api-compatibility-check"
menu_path:
  - "指南"
  - "编写与调试应用"
  - "代码编辑"
...
captured_at: "2026-04-17T01:36:48.440Z"
---
...
struct Test {
  build() {
    Text('hello').onClick(() => {
      // ScrollEffectType.COMMON\_BLUR从5.1.0(18)开始支持，不可直接调用
      const value = ScrollEffectType.COMMON\_BLUR
