---
title: "@performance/lottie"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-lottie-animation-destroy-check"
menu_path:
  - "指南"
  - "编写与调试应用"
  - "代码编辑"
...
captured_at: "2026-04-17T01:36:47.359Z"
---
...
const FRAME\_START: number = 60;
const FRAME\_END: number = 120;
    ...
    Canvas(this.politeChickyController)
      ...
      .onReady(() => {
        this.animateItem = lottie.loadAnimation({
          ...
          initialSegment: \[FRAME\_START, FRAME\_END\]
        })
      })
      .onDisAppear(() => {
