---
title: "使用Node"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/use-napi-life-cycle"
menu_path:
  - "指南"
  - "NDK开发"
  - "代码开发"
...
captured_at: "2026-04-17T01:36:40.626Z"
---
...
#### \[h2\]napi\_open\_handle\_scope、napi\_close\_handle\_scope
...
#### \[h2\]napi\_open\_escapable\_handle\_scope、napi\_close\_escapable\_handle\_scope、napi\_escape\_handle
...
#### \[h2\]napi\_create\_reference、napi\_delete\_reference

为Object创建一个reference，以延长其生命周期。调用者需要自己管理reference生命周期。可以调用napi\_delete\_reference删除传入的reference。

#### \[h2\]napi\_reference\_ref、napi\_reference\_unref

增加/减少传入的reference的引用计数，并获取新的计数。

#### \[h2\]napi\_get\_reference\_value

获取与reference相关联的ArkTS Object。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1e/v3/2WLaIQXzQ3GWIOvYXlJV8w/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013640Z&HW-CC-Expire=86400&HW-CC-Sign=5C8AC0B0F87493AE526F1D36C1EBA71378ED42A8D9407080E2CF717ECE90BAD3)
