---
title: "媒体资源变更通知相关指导"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/photoaccesshelper-notify-guidelines"
menu_path:
  - "指南"
  - "媒体"
  ...
  - "受限开放能力"
  - "媒体资源变更通知相关指导"
captured_at: "2026-04-17T01:36:07.255Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c2/v3/V7zWEeZuTZKm-DBZjPVnsg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013607Z&HW-CC-Expire=86400&HW-CC-Sign=683DA814C04CC87CFD82D7A81C5E11937AC04A69CFB6CB3865CD3CF1EE599471)
...
async function example(phAccessHelper: photoAccessHelper.PhotoAccessHelper) {
  let predicates: dataSharePredicates.DataSharePredicates = new dataSharePredicates.DataSharePredicates();
  let albumName: photoAccessHelper.AlbumKeys = photoAccessHelper.AlbumKeys.ALBUM\_NAME;
  ...
  try {
    let fetchResult: photoAccessHelper.FetchResult<photoAccessHelper.Album> =
      await phAccessHelper.getAlbums(
        ...
        photoAccessHelper.AlbumSubtype.USER\_GENERIC,
        fetchOptions);
...
async function example(phAccessHelper: photoAccessHelper.PhotoAccessHelper, context: Context) {
  ...
  phAccessHelper.registerChange(photoAccessHelper.DefaultChangeUri.DEFAULT\_PHOTO\_URI, true, onCallback);
  let predicates: dataSharePredicates.DataSharePredicates = new dataSharePredicates.DataSharePredicates();
  let fetchOptions: photoAccessHelper.FetchOptions = {
    fetchColumns: \[\],
    predicates: predicates
