---
title: "用户相册资源使用指导"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/photoaccesshelper-useralbum-guidelines"
menu_path:
  - "指南"
  - "媒体"
  ...
  - "受限开放能力"
  - "用户相册资源使用指导"
captured_at: "2026-04-17T01:36:07.248Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/58/v3/5wxPxnzOS2eMZ3wQefKC1Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013607Z&HW-CC-Expire=86400&HW-CC-Sign=2E2CA385F910FD9AD00F0FBCCE477D8C3B1BAC06E8E9ABC9B4CF8AD29A3C0FE6)
  ...
  try {
    let fetchResult: photoAccessHelper.FetchResult<photoAccessHelper.Album> =
      await phAccessHelper.getAlbums(photoAccessHelper.AlbumType.USER,
        photoAccessHelper.AlbumSubtype.USER\_GENERIC, fetchOptions);
...
async function example(phAccessHelper: photoAccessHelper.PhotoAccessHelper) {
  ...
  try {
    let albumFetchResult: photoAccessHelper.FetchResult<photoAccessHelper.Album> =
      await phAccessHelper.getAlbums(photoAccessHelper.AlbumType.USER,
        photoAccessHelper.AlbumSubtype.USER\_GENERIC, albumFetchOptions);
