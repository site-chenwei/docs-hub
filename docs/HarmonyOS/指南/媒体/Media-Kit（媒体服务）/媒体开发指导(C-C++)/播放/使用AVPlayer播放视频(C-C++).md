...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/using-ndk-avplayer-for-video-playback"
menu_path:
  - "指南"
  - "媒体"
  - "Media Kit（媒体服务）"
  ...
  - "播放"
  - "使用AVPlayer播放视频(C/C++)"
captured_at: "2026-04-17T01:36:06.740Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/Qzf5wQpLT5K2LpEj1cyyEw/zh-cn_image_0000002538179474.png?HW-CC-KV=V1&HW-CC-Date=20260417T013607Z&HW-CC-Expire=86400&HW-CC-Sign=2EB8F6C82583A56E4BC8CE4847DA0BABA0938BC95EF4B4D2227DFB6B7501C9A4)
...
2.  设置回调监听函数：使用[OH\_AVPlayer\_SetOnInfoCallback()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-avplayer-h#oh_avplayer_setoninfocallback)、[OH\_AVPlayer\_SetOnErrorCallback()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-avplayer-h#oh_avplayer_setonerrorcallback)接口设置信息监听回调函数和错误监听回调函数，搭配全流程场景使用。支持的监听事件包括：
    ...
    需要播放器在AV\_IDLE状态下、未调用设置资源接口前完成设置监听，若在调用设置资源接口后再设置监听，可能导致无法收到资源设置过程中上报的OH\_AVPlayerOnInfoCallback事件。
    ...
    需要播放器在AV\_IDLE状态下、未调用设置资源接口前完成设置监听，若在调用设置资源接口后再设置监听，可能导致无法收到资源设置过程中上报的OH\_AVPlayerOnErrorCallback事件。
