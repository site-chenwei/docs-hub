...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/using-opensl-es-for-recording"
menu_path:
  - "指南"
  - "媒体"
  - "Audio Kit（音频服务）"
...
captured_at: "2026-04-17T01:36:03.995Z"
---
...
-   **HarmonyOS上支持的BufferQueue接口：**
    ...
    如果是播放操作，则将带有音频数据的buffer插入到filledBufferQ\_队列中；如果是录音操作，则将录音使用后的空闲buffer插入到freeBufferQ\_队列中。
    ...
    如果是播放操作，则从freeBufferQ\_队列中获取空闲buffer；如果是录音操作，则从filledBufferQ\_队列中获取携带录音数据的buffer。
