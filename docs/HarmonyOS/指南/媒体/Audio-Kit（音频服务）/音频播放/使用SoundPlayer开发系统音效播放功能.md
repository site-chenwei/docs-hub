...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/using-soundplayer-for-playback"
menu_path:
  - "指南"
  - "媒体"
  - "Audio Kit（音频服务）"
...
captured_at: "2026-04-17T01:36:03.495Z"
---
...
2.  调用[load](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-multimedia-systemsoundplayer#load)接口，加载指定类型音效资源。
    ...
    // 音效类型。
    let systemSoundType: systemSoundManager.SystemSoundType = systemSoundManager.SystemSoundType.PHOTO\_SHUTTER;
