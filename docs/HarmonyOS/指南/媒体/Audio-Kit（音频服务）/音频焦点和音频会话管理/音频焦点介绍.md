---
title: "音频焦点介绍"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/audio-playback-concurrency"
menu_path:
  - "指南"
  - "媒体"
  - "Audio Kit（音频服务）"
  - "音频焦点和音频会话管理"
  - "音频焦点介绍"
captured_at: "2026-04-17T01:36:03.352Z"
---
...
-   打断类型（[InterruptForceType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-e#interruptforcetype9)）：
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7/v3/wpCQdy9oR3-zo55x2Zy0RQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013603Z&HW-CC-Expire=86400&HW-CC-Sign=B8C91517130AA23457645BFFE8499FC95AC15D829A467000CD9772B0642875D6)
...
| 音乐 | STREAM\_USAGE\_MUSIC | 导航 | STREAM\_USAGE\_NAVIGATION | 
导航正常播放，音乐降低音量播放。

导航结束后，音乐恢复正常音量。

 | 音乐应用注册焦点事件监听，接收到INTERRUPT\_HINT\_DUCK和INTERRUPT\_HINT\_UNDUCK事件时，可以选择更新UI界面。 |
| 视频 | STREAM\_USAGE\_MOVIE | 闹铃 | STREAM\_USAGE\_ALARM | 
...
视频应用注册焦点事件监听。接收到INTERRUPT\_HINT\_PAUSE事件时，直接暂停视频播放，并更新UI界面。

当闹铃结束后，视频应用接收到INTERRUPT\_HINT\_RESUME事件，重新启动播放。

 |
| 音乐 | STREAM\_USAGE\_MUSIC | 来电铃声 | STREAM\_USAGE\_RINGTONE | 
...
音乐应用注册焦点事件监听。接收到INTERRUPT\_HINT\_PAUSE事件时，直接暂停音乐播放，并更新UI界面。

当电话结束后，音频应用接收到INTERRUPT\_HINT\_RESUME事件，重新启动播放。

 |
| 音乐 | STREAM\_USAGE\_MUSIC | VoIP通话 | STREAM\_USAGE\_VOICE\_COMMUNICATION | 
...
接收到INTERRUPT\_HINT\_PAUSE事件时，直接暂停音乐播放，并更新UI界面。

当通话结束后，音乐应用接收到INTERRUPT\_HINT\_RESUME事件，重新启动播放。
