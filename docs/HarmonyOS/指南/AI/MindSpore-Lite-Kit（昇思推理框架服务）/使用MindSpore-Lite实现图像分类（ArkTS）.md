...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/mindspore-guidelines-based-js"
menu_path:
  - "指南"
  - "AI"
  - "MindSpore Lite Kit（昇思推理框架服务）"
  - "使用MindSpore Lite实现图像分类（ArkTS）"
captured_at: "2026-04-17T01:36:39.785Z"
---
...
2.  调用[@ohos.ai.mindSporeLite](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-mindsporelite)实现端侧推理。具体开发过程及细节如下：
    ...
    export default async function modelPredict(
      ...
      context.cpu.precisionMode = 'enforce\_fp32';
      ...
      // 4.执行推理。
      hilog.info(0xFF00, 'MindSporeLiteArkTSDemo', '%{public}s', \`=========MS\_LITE\_LOG: MS\_LITE predict start=====\`);
          ...
          Column() {
            ...
            .onClick(() => {
              ...
              if (resMgr === null || resMgr === undefined){
                hilog.error(0xFF00, 'MindSporeLiteArkTSDemo', '%{public}s', \`MS\_LITE\_ERR: get resMgr failed.\`);
                return
              }
              resMgr?.getRawFileContent(this.modelName).then(modelBuffer => {
                ...
                photoSelectOptions.MIMEType = photoAccessHelper.PhotoViewMIMETypes.IMAGE\_TYPE; // 过滤选择媒体文件类型为IMAGE
                ...
                photoPicker.select(photoSelectOptions, async (
                  ...
                  hilog.info(0xFF00, 'MindSporeLiteArkTSDemo', '%{public}s', \`MS\_LITE\_LOG: uri: ${this.uris}\`);
    
                  // 预处理图片数据
                  try {
                    // 1.使用fileIo.openSync接口，通过uri打开这个文件得到fd
                    let file = fileIo.openSync(this.uris\[0\], fileIo.OpenMode.READ\_ONLY);
                    hilog.info(0xFF00, 'MindSporeLiteArkTSDemo', '%{public}s', \`MS\_LITE\_LOG: file fd: ${file.fd}\`);
                    ...
                    if (imageSource === undefined) {
                      hilog.error(0xFF00, 'MindSporeLiteArkTSDemo', '%{public}s', \`MS\_LITE\_ERR: createImageSource failed.\`);
                      return
                    }
                        ...
                        pixelMap.scale(256.0 / info.size.width, 256.0 / info.size.height).then(() => {
                          pixelMap.crop(
                            ...
                            modelPredict(modelBuffer.buffer.slice(0), inputs).then(outputs => {
                              hilog.info(0xFF00, 'MindSporeLiteArkTSDemo', '%{public}s',
                                \`=========MS\_LITE\_LOG: MS\_LITE predict success=====\`);
                              ...
                              for (let i = 0; i < outputs.length; i++) {
                                ...
                                hilog.info(0xFF00, 'MindSporeLiteArkTSDemo', '%{public}s', \`MS\_LITE\_LOG: ${printStr}\`);
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bf/v3/neJbftxfTOOoAsq3JGsYEg/zh-cn_image_0000002569020005.png?HW-CC-KV=V1&HW-CC-Date=20260417T013639Z&HW-CC-Expire=86400&HW-CC-Sign=EF01456E691DA1757A173A326EA3E240F6E5BF42158018D2BB7BE99D97BBCBD1) ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5c/v3/9RW-RzZjSGqFjGgcO8Xshw/zh-cn_image_0000002568899997.png?HW-CC-KV=V1&HW-CC-Date=20260417T013639Z&HW-CC-Expire=86400&HW-CC-Sign=F17F96AD3F15C67BF0C691CAFB0D31594E91872BDC102C37BF117C51F7E69242)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d2/v3/DjXv7sdcRZe3QYPrGJrmRg/zh-cn_image_0000002538020292.png?HW-CC-KV=V1&HW-CC-Date=20260417T013639Z&HW-CC-Expire=86400&HW-CC-Sign=E4CFE5F146A10B41364763F2C7211CFE3396BE2329CDBF6FC167D0402A5B8CF9) ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a/v3/nQDslIQHQqivXkWURIUWjw/zh-cn_image_0000002538180218.png?HW-CC-KV=V1&HW-CC-Date=20260417T013639Z&HW-CC-Expire=86400&HW-CC-Sign=84A65A9D134B2CAD27A7232E075F4502FBF6F9944B9281AA9BE0030544D0F532)
