---
title: "普通数据搬运"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-common-data-movement"
menu_path:
  - "指南"
  - "AI"
  - "CANN Kit（CANN 服务）"
  ...
  - "DataCopy"
  - "普通数据搬运"
captured_at: "2026-04-17T01:36:26.130Z"
---
...
目的操作数，相邻连续数据块间的间隔（前面一个数据块的尾与后面数据块的头的间隔），单位为datablock(32Bytes)。数据类型为uint16\_t，dstStride不要超出该数据类型的取值范围。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/36/v3/XNzr5kkfT3KV3I2mtSTJpw/zh-cn_image_0000002538180148.png?HW-CC-KV=V1&HW-CC-Date=20260417T013628Z&HW-CC-Expire=86400&HW-CC-Sign=F123DAC90B0A20CFF778085FBFE30178A4B91B2CDD76EEC1A72E461E9257C464)
