---
title: "GlobalTensor"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-globaltensor"
menu_path:
  - "指南"
  - "AI"
  - "CANN Kit（CANN 服务）"
  ...
  - "数据类型定义"
  - "GlobalTensor"
captured_at: "2026-04-17T01:36:25.409Z"
---
...
bufferSize：所包含的类型为T的数据个数，单位为element，需自行保证不会超出实际数据的长度
 ...
 | 设置GlobalTensor的存储位置：buffer指向外部存储的起始地址，bufferSize为Tensor所占外部存储的大小，如指向的外部存储有连续256个int32\_t，则其bufferSize为256。 |
