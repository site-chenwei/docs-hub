---
title: "ShiftRight"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-scalar-binocular-shiftright"
menu_path:
  - "指南"
  - "AI"
  - "CANN Kit（CANN 服务）"
  ...
  - "标量双目指令"
  - "ShiftRight"
captured_at: "2026-04-17T01:36:25.898Z"
---
...
前n个tensor：uint16\_t、int16\_t、uint32\_t、int32\_t

不支持浮点类型（half、float32\_t）

KirinX90系列处理器，支持的数据类型为：

前n个tensor、mask连续模式支持：uint16\_t、int16\_t、uint32\_t、int32\_t
...
当src为uint16\_t/int16\_t类型时，scalar取值范围：\[0, 16\]。

当src为uint32\_t/int32\_t类型时，scalar取值范围：\[0, 32\]。
