...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-json-configuration"
menu_path:
  - "指南"
  - "AI"
  - "CANN Kit（CANN 服务）"
  ...
  - "数据准备和配置说明"
  - "固定输入/输出顺序的算子json配置"
captured_at: "2026-04-17T01:36:24.797Z"
---
...
| data\_script | N/A | string | 数据生成脚本（python），用于生成输入和标杆数据。 | 
根据实际情况设置，如"/home/flash\_attention\_golden.py"。

**说明：** 若无数据生成脚本，填写空字符或null。

 | 否 |
| gen\_data | N/A | bool | 是否根据data\_script生成输入和标杆数据。 | 
...
outputs
 ...
 | param\_type | string | 是否必选该输入/输出。 | 

\- required：必选。

\- optional：可选。

**说明：** 当param\_type为optional时
...
outputs
 ...
 | data\_value | 由dtype确定 | 输入的Scalar值。 | 
...
outputs
 ...
 | value\_depend | string | 输入是否为Const类型 | 
...
-   **场景3：支持原地算子格式的输入。**
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/de/v3/6MxynLOISvqP8sztkTbovw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013626Z&HW-CC-Expire=86400&HW-CC-Sign=4A125B5B77438BF39B25FD26A7144581528051BE605384B7CD5A63CD7BE9F413)
