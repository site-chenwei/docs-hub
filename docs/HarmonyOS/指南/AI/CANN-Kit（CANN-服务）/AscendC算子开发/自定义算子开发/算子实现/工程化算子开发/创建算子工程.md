---
title: "创建算子工程"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-creating-an-operator-project"
menu_path:
  - "指南"
  - "AI"
  - "CANN Kit（CANN 服务）"
  ...
  - "工程化算子开发"
  - "创建算子工程"
captured_at: "2026-04-17T01:36:24.636Z"
---
...
2.  使用msOpGen工具生成算子的开发工程。以生成AddCustom的算子工程为例，下文仅针对关键参数进行解释，详细参数说明请参见[算子工程创建工具参数说明](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-creating-operator-project-msopgen)。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/73/v3/f9I6O8oqSh-uZzxzTHdYaA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013626Z&HW-CC-Expire=86400&HW-CC-Sign=FE2C41EA3ECE9AB05091B281A0C75A29622CD8A39A52AEEDA73543F4198B0D37)
...
3.  命令执行完后，会在-out指定目录或者默认路径下生成算子工程目录，工程中包含算子实现的模板文件，编译脚本等，以AddCustom算子为例，目录结构如下所示：
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1e/v3/Ry9S133ETKS6kDwusyseQQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013626Z&HW-CC-Expire=86400&HW-CC-Sign=480E0C450A349F75A520898344EDD59B4A8255B2268E3316A0688EC50ADE670B)
