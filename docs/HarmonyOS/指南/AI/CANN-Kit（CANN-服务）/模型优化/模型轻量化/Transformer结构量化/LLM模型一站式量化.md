---
title: "LLM模型一站式量化"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-large-language-one-stop"
menu_path:
  - "指南"
  - "AI"
  - "CANN Kit（CANN 服务）"
  ...
  - "Transformer结构量化"
  - "LLM模型一站式量化"
captured_at: "2026-04-17T01:36:23.773Z"
---
...
\- dopt\_config.json：开发者需完成该文件的量化策略配置后，重新执行此阶段

\- trained\_quant\_weight.pth：权重量化参数

**说明：** 开发者需根据阶段一生成的dopt\_config.json文件手动进行量化策略配置后，再次执行该阶段。
...
\- fake\_quant\_weight.pth：用于ONNX模型导出

\- quant\_params\_file：权重及激活量化参数
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bc/v3/alfNfia7Tnm_dW_TnnB6YA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013625Z&HW-CC-Expire=86400&HW-CC-Sign=E1756AA55ADA7F999A1D27CDF3E1435BB85C9E732AF20F7F901A52DF93E9CF52)
...
| kd：量化蒸馏相关 | trainable\_keys | \- | 

配置可训练参数。

\- quant\_alpha：量化层的可训练参数

\- norm：layer\_norm层的可训练参数

 |
| kd：量化蒸馏相关 | no\_split\_module\_classes | \- | 
...
\- False：KirinX90
 ...
 |
| dataset | embedding\_separate | True | 
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e9/v3/kWP3kFyQQ1ih7X0la5crYA/zh-cn_image_0000002538020152.jpg?HW-CC-KV=V1&HW-CC-Date=20260417T013625Z&HW-CC-Expire=86400&HW-CC-Sign=C9A6B7E4438364EB999ED668C7C35F1542AD78A07A59FAD2B14A610F7AF8FB92)
