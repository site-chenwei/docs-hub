---
title: "通用文字识别"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/core-vision-text-recognition"
menu_path:
  - "指南"
  - "AI"
  - "Core Vision Kit（基础视觉服务）"
  - "通用文字识别"
captured_at: "2026-04-17T01:36:38.909Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/56/v3/VA-yndo7Q1WXD-cxns1wpg/zh-cn_image_0000002538180176.png?HW-CC-KV=V1&HW-CC-Date=20260417T013638Z&HW-CC-Expire=86400&HW-CC-Sign=5F4B3D67E0BBAE022B78ED87805ED11AF2B78C9803FB057A8C3F2051E8A3F336)
...
4.  实例化[VisionInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/core-vision-text-recognition-api#visioninfo)对象，并传入待检测图片的[PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap)。
...
5.  配置通用文本识别的配置项[TextRecognitionConfiguration](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/core-vision-text-recognition-api#textrecognitionconfiguration)，用于配置是否支持朝向检测。
...
6.  调用textRecognition的[recognizeText](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/core-vision-text-recognition-api#textrecognitionrecognizetext-1)接口，对识别到的结果进行处理。
