---
title: "方舟字节码基本原理"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-bytecode-fundamentals"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkTS（方舟编程语言）"
  ...
  - "方舟字节码"
  - "方舟字节码基本原理"
captured_at: "2026-04-17T01:35:35.383Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/82/v3/zrSmJmsPRIyh-4cJ0INz0g/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013536Z&HW-CC-Expire=86400&HW-CC-Sign=6230E24F4301767668BCD334585A6929FE8226CB98D059036EBEC7A83E1F5B1B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/TDRbGkN5TUCORB5zj2a2qA/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013536Z&HW-CC-Expire=86400&HW-CC-Sign=E90980F7DC90E28818A2F5A92298C923C82EFD6B24CB4ACAA7DD322B3A665CA8)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f4/v3/K_uepG02S-OaGMlQROE2Aw/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013536Z&HW-CC-Expire=86400&HW-CC-Sign=CC4B11CF5D4D0C97249DC66C9DEF92D823EB5070B114BBD941E5858F69E13624)
...
| 0x06 | IMM8\_ID16 | createarraywithbuffer RR, @AAAA | 
R：方舟运行时内部使用的8位保留数字

A：16位的literal id

 | 使用索引A对应的字面量数组，创建一个数组对象，并将其存放到acc中。 |
| 0x07 | IMM8\_ID16 | createobjectwithbuffer RR, @AAAA | 
...
| 0x08 | IMM8\_IMM8\_V8 | newobjrange RR, +AA, vBB | 
...
A：操作数
 ...
 | 计算A > acc，并将计算结果存放到acc中。 |
| 0x14 | IMM8\_V8 | greatereq RR, vAA | 
...
| 0x26 | IMM8\_V8 | instanceof RR, vAA | 
...
| 0x27 | IMM8\_V8 | strictnoteq RR, vAA | 
...
| 0x2b | IMM8\_V8\_V8 | callargs2 RR, vAA, vBB | 
...
| 0x2c | IMM8\_V8\_V8\_V8 | callargs3 RR, vAA, vBB, vCC | 
...
| 0x2d | IMM8\_V8 | callthis0 RR, vAA | 
...
| 0x2e | IMM8\_V8\_V8 | callthis1 RR, vAA, vBB | 
...
| 0x2f | IMM8\_V8\_V8\_V8 | callthis2 RR, vAA, vBB, vCC | 
...
| 0x30 | IMM8\_V8\_V8\_V8\_V8 | callthis3 RR, vAA, vBB, vCC, vDD | 
...
| 0x31 | IMM8\_IMM8\_V8 | callthisrange RR, +AA, vBB | 
...
| 0x32 | IMM8\_IMM8\_V8 | supercallthisrange RR, +AA, vBB | 
...
此指令仅出现在非箭头函数中。
 ...
 |
| 0x33 | IMM8\_ID16\_IMM8 | definefunc RR, @AAAA, +BB | 
...
| 0x34 | IMM8\_ID16\_IMM8 | definemethod RR, @AAAA, +BB | 
...
| 0x35 | IMM8\_ID16\_ID16\_IMM16\_V8 | defineclasswithbuffer RR, @AAAA, @BBBB, +CCCC, vDD | 
...
| 0x37 | IMM8\_V8 | ldobjbyvalue RR, vAA | 
...
| 0x38 | IMM8\_V8\_V8 | stobjbyvalue RR, vAA, vBB | 
...
| 0x39 | IMM8\_V8 | ldsuperbyvalue RR, vAA | 
...
| 0x3a | IMM8\_IMM16 | ldobjbyindex RR, +AAAA | 
...
| 0x3b | IMM8\_V8\_IMM16 | stobjbyindex RR, vAA, +BBBB | 
...
| 0x3f | IMM8\_ID16 | tryldglobalbyname RR, @AAAA | 
...
| 0x40 | IMM8\_ID16 | trystglobalbyname RR, @AAAA | 
...
| 0x41 | IMM16\_ID16 | ldglobalvar RRRR, @AAAA | 
...
| 0x42 | IMM8\_ID16 | ldobjbyname RR, @AAAA | 
...
| 0x43 | IMM8\_ID16\_V8 | stobjbyname RR, @AAAA, vBB | 
...
| 0x46 | IMM8\_ID16 | ldsuperbyname RR, @AAAA | 
...
| 0x47 | IMM16\_ID16 | stconsttoglobalrecord RRRR, @AAAA | 
...
| 0x48 | IMM16\_ID16 | sttoglobalrecord RRRR, @AAAA | 
...
| 0x49 | IMM8\_ID16 | ldthisbyname RR, @AAAA | 
...
| 0x4a | IMM8\_ID16 | stthisbyname RR, @AAAA | 
...
| 0x4c | IMM8\_V8 | stthisbyvalue RR, vAA | 
...
指令功能未使能，暂不可用。
 ...
 |
| 0x5e | V8\_IMM8 | jstricteq vAA, +BB | 
...
指令功能未使能，暂不可用。
 ...
 |
| 0x5f | V8\_IMM8 | jnstricteq vAA, +BB | 
...
| 0x68 | IMM8\_V8 | closeiterator RR, vAA | 
...
| 0x71 | IMM8\_ID16\_IMM8 | createregexpwithliteral RR, @AAAA, +BB | 
...
B和所指代的修饰符的对应关系为：0（默认值，无修饰符），1（g），2（i），4（m），8（s），16（u），32（y）；B也可以指代符合语法规范的修饰符的组合，例如3，指代的修饰符是gi。
 ...
 |
| 0x72 | IMM16\_ID16\_IMM8 | createregexpwithliteral RRRR, @AAAA, +BB | 
...
B和所指代的修饰符的对应关系为：0（默认值，无修饰符），1（g），2（i），4（m），8（s），16（u），32（y）；B也可以指代符合语法规范的修饰符的组合，例如3，指代的修饰符是gi。
 ...
 |
| 0x73 | IMM8\_IMM8\_V8 | callrange RR, +AA, vBB | 
...
| 0x74 | IMM16\_ID16\_IMM8 | definefunc RRRR, @AAAA, +BB | 
...
B：方法A的形参数量
 ...
 | 创建方法A的函数对象，并将其存放到acc中。 |
| 0x75 | IMM16\_ID16\_ID16\_IMM16\_V8 | defineclasswithbuffer RRRR, @AAAA, @BBBB, +CCCC, vDD | 
...
| 0x77 | IMM8\_V8 | setobjectwithproto RR, vAA | 
...
A：值
 ...
 | 将acc中存放对象的 **\_\_proto\_\_** 属性设置为A。 |
| 0x78 | IMM8\_V8\_V8 | stownbyvalue RR, vAA, vBB | 
...
B：属性键值
 ...
 | 将acc中的值存放到对象A的键值为B的属性上。 |
| 0x79 | IMM8\_V8\_IMM16 | stownbyindex RR, vAA, +BBBB | 
...
B：属性键值
 ...
 | 将acc中的值存放到对象A的键值为B的属性上。 |
| 0x7a | IMM8\_ID16\_V8 | stownbyname RR, @AAAA, vBB | 
...
| 0x7f | IMM16\_ID16 | stglobalvar RRRR, @AAAA | 
...
| 0x81 | IMM16\_ID16 | createarraywithbuffer RRRR, @AAAA | 
...
A：literal id
 ...
 | 使用索引A对应的字面量数组，创建一个数组对象, 并将其存放到acc中。 |
| 0x82 | IMM16\_ID16 | createobjectwithbuffer RRRR, @AAAA | 
...
A：literal id
 ...
 | 使用索引A对应的字面量数组，创建一个对象, 并将其存放到acc中。 |
| 0x83 | IMM16\_IMM8\_V8 | newobjrange RRRR, +AA, vBB | 
...
R：方舟运行时内部使用的16位保留数字
 ...
 | 计算typeof acc，并将计算结果存放到acc中。 |
| 0x85 | IMM16\_V8 | ldobjbyvalue RRRR, vAA | 
...
A：对象
 ...
 | 加载A对象的键值为acc的属性，并将结果存放到acc中。 |
| 0x86 | IMM16\_V8\_V8 | stobjbyvalue RRRR, vAA, vBB | 
...
B：属性键值
 ...
 | 将acc中的值存放到对象A的键值为B的属性上。 |
| 0x87 | IMM16\_V8 | ldsuperbyvalue RRRR, vAA | 
...
A：对象
 ...
 | 在当前函数中，获取super的键值为acc的属性，并将其存放到acc中。若该属性为访问器属性，则将A中的对象作为调用该属性getter函数时的this参数。 |
| 0x88 | IMM16\_IMM16 | ldobjbyindex RRRR, +AAAA | 
...
A：属性键值
 ...
 | 加载acc中所存对象的键值为A的属性，并将其存放到acc中。 |
| 0x89 | IMM16\_V8\_IMM16 | stobjbyindex RRRR, vAA, +BBBB | 
...
B：属性键值
 ...
 | 将acc中的值存放到对象A的键值为B的属性上。 |
| 0x8a | IMM8\_IMM8 | ldlexvar +AA, +BB | 
...
B：槽位号
 ...
 | 将A个层次外的词法环境的B号槽位上的值存放到acc中。 |
| 0x8b | IMM8\_IMM8 | stlexvar +AA, +BB | 
...
B：槽位号
 ...
 | 将acc中的值存放到A个层次外的词法环境的B号槽位上。 |
| 0x8c | IMM16\_ID16 | tryldglobalbyname RRRR, @AAAA | 
...
A：string id
 ...
 | 将名称为索引A对应的字符串的全局变量存放进acc中，不存在名称为A的全局变量时，抛出异常。 |
| 0x8d | IMM16\_ID16 | trystglobalbyname RRRR, @AAAA | 
...
A：string id
 ...
 | 将acc中的值存放到名称为索引A对应的字符串的全局变量上，不存在名称为A的全局变量时，抛出异常。 |
| 0x8e | IMM8\_ID16\_V8 | stownbynamewithnameset RR, @AAAA, vBB | 
...
| 0x90 | IMM16\_ID16 | ldobjbyname RRRR, @AAAA | 
...
A：string id
 ...
 | 加载acc中所存对象的键值为索引A对应的字符串的属性，并将其存放到acc中。 |
| 0x91 | IMM16\_ID16\_V8 | stobjbyname RRRR, @AAAA, vBB | 
...
B：对象
 ...
 | 将acc中的值存放到对象B的键值为索引A对应的字符串的属性上。 |
| 0x92 | IMM16\_ID16 | ldsuperbyname RRRR, @AAAA | 
...
A：string id
 ...
 | 在当前函数中，获取super的键值为索引A对应的字符串的属性，并将其存放到acc中。若该属性为访问器属性，则将acc中的对象作为调用该属性getter函数时的this参数。 |
| 0x93 | IMM16\_ID16 | ldthisbyname RRRR, @AAAA | 
...
A：string id
 ...
 | 加载this的键值为索引A对应的字符串的属性，并把结果存放到acc中。 |
| 0x94 | IMM16\_ID16 | stthisbyname RRRR, @AAAA | 
...
R：方舟运行时内部使用的16位保留数字
 ...
 | 加载this的键值为acc的属性，并将结果存放到acc中。 |
| 0x96 | IMM16\_V8 | stthisbyvalue RRRR, vAA | 
...
| 0x99 | IMM8\_V8\_V8 | stownbyvaluewithnameset RR, vAA, vBB | 
...
指令功能未使能，暂不可用。
 ...
 |
| 0xa9 | V8\_IMM16 | jstricteq vAA, +BBBB | 
...
指令功能未使能，暂不可用。
 ...
 |
| 0xaa | V8\_IMM16 | jnstricteq vAA, +BBBB | 
...
R：方舟运行时内部使用的16位保留数字
 ...
 | 执行[GetIterator](https://262.ecma-international.org/12.0/#sec-getiterator)(acc, sync)方法，并将结果存放到acc中。 |
| 0xac | IMM16\_V8 | closeiterator RRRR, vAA | 
...
| 0xb2 | V8\_V8 | createiterresultobj vAA, vBB | 
...
| 0xb3 | IMM8\_V8\_V8 | createobjectwithexcludedkeys +AA, vBB, vCC | 
...
这个指令用于支持使用析构和扩展语法创建对象。
 ...
 |
| 0xb4 | IMM8\_V8 | newobjapply RR, vAA | 
...
| 0xb5 | IMM16\_V8 | newobjapply RRRR, vAA | 
...
A：类对象
 ...
 | 使用acc中存放的参数列表，创建一个A类的实例，并将其存放到acc中。 |
| 0xb6 | IMM8\_ID16 | newlexenvwithname +AA, @BBBB | 
...
| 0xb8 | V8\_V8\_V8 | asyncgeneratorresolve vAA, vBB, vCC | 
...
| 0xb9 | IMM8\_V8 | supercallspread RR, vAA | 
...
| 0xba | IMM8\_V8\_V8 | apply RR, vAA, vBB | 
...
| 0xbb | IMM8\_IMM8\_V8 | supercallarrowrange RR, +AA, vBB | 
...
此指令仅出现在箭头函数中。
 ...
 |
| 0xbc | V8\_V8\_V8\_V8 | definegettersetterbyvalue vAA, vBB, vCC, vDD | 
...
| 0xbe | IMM16\_ID16\_IMM8 | definemethod RRRR, @AAAA, +BB | 
...
| 0xc6 | V8\_V8 | starrayspread vAA, vBB | 
...
| 0xc7 | IMM16\_V8 | setobjectwithproto RRRR, vAA | 
...
A：值
 ...
 | 将acc中存放对象的 **\_\_proto\_\_** 属性设置为A。 |
| 0xc8 | IMM16\_V8\_V8 | stownbyvalue RRRR, vAA, vBB | 
...
B：属性键值
 ...
 | 将acc中的值存放到对象A的键值为B的属性上。 |
| 0xc9 | IMM8\_V8\_V8 | stsuperbyvalue RR, vAA, vBB | 
...
| 0xca | IMM16\_V8\_V8 | stsuperbyvalue RRRR, vAA, vBB | 
...
B：属性键值
 ...
 | 在当前函数中，将acc中的值存放到super的键值为B的属性上。若该属性为访问器属性，则将A中的对象作为调用该属性setter函数时的this参数。 |
| 0xcb | IMM16\_V8\_IMM16 | stownbyindex RRRR, vAA, +BBBB | 
...
B：属性键值
 ...
 | 将acc中的值存放到对象A的键值为B的属性上。 |
| 0xcc | IMM16\_ID16\_V8 | stownbyname RRRR, @AAAA, vBB | 
...
| 0xd0 | IMM8\_ID16\_V8 | stsuperbyname RR, @AAAA, vBB | 
...
若该属性为访问器属性，则将B中的对象作为调用该属性setter函数时的this参数。
 ...
 |
| 0xd1 | IMM16\_ID16\_V8 | stsuperbyname RRRR, @AAAA, vBB | 
...
若该属性为访问器属性，则将B中的对象作为调用该属性setter函数时的this参数。
 ...
 |
| 0xd2 | IMM16\_V8\_V8 | stownbyvaluewithnameset RRRR, vAA, vBB | 
...
| 0xd4 | IMM16\_ID16\_V8 | stownbynamewithnameset RRRR, @AAAA, vBB | 
...
| 0xd8 | IMM8\_IMM16\_IMM16 | ldprivateproperty RR, +AAAA, +BBBB | 
...
| 0xd9 | IMM8\_IMM16\_IMM16\_V8 | stprivateproperty RR, +AAAA, +BBBB, vCC | 
...
| 0xda | IMM8\_IMM16\_IMM16 | testin RR, +AAAA, +BBBB | 
...
| 0xdb | IMM8\_ID16\_V8 | definefieldbyname RR, @AAAA, vBB | 
...
| 0xdc | IMM8\_ID16\_V8 | definepropertybyname RR, @AAAA, vBB | 
...
B：对象
 ...
 | 为对象B定义一个键值为A的属性，并将acc中的值存放到其中。 |
| 0xfb | PREF\_NONE | callruntime.notifyconcurrentresult | 默认入参：acc：并发函数的返回值 | 
...
| 0xfd | PREF\_IMM16\_V8\_V8 | wide.createobjectwithexcludedkeys +AAAA, vBB, vCC | 
...
| 0x01fb | PREF\_IMM8\_V8\_V8 | callruntime.definefieldbyvalue RR, vAA, vBB | 
...
| 0x01fd | PREF\_IMM16\_V8 | wide.newobjrange +AAAA, vBB | 
...
| 0x02fb | PREF\_IMM8\_IMM32\_V8 | callruntime.definefieldbyindex RR, +AAAAAAAA, vBB | 
...
| 0x03fd | PREF\_IMM16\_ID16 | wide.newlexenvwithname +AAAA, @BBBB | 
...
| 0x04fb | PREF\_IMM\_16\_ID16 | callruntime.createprivateproperty +AAAA, @BBBB | 
...
| 0x04fd | PREF\_IMM16\_V8 | wide.callrange +AAAA, vBB | 
...
| 0x05fb | PREF\_IMM8\_IMM\_16\_IMM\_16\_V8 | callruntime.defineprivateproperty RR, +AAAA, +BBBB, vCC | 
...
| 0x05fd | PREF\_IMM16\_V8 | wide.callthisrange +AAAA, vBB | 
...
| 0x06fb | PREF\_IMM8\_V8 | callruntime.callinit +RR, vAA | 
...
| 0x06fd | PREF\_IMM16\_V8 | wide.supercallthisrange +AAAA, vBB | 
...
此指令仅出现在非箭头函数中。
 ...
 |
| 0x06fe | PREF\_V8\_V8 | throw.undefinedifhole vAA, vBB | 
...
| 0x07fb | PREF\_IMM16\_ID16\_ID16\_IMM16\_V8 | callruntime.definesendableclass RRRR, @AAAA, @BBBB, +CCCC, vDD | 
...
| 0x07fd | PREF\_IMM16\_V8 | wide.supercallarrowrange +AAAA, vBB | 
...
此指令仅出现在箭头函数中。
 ...
 |
| 0x07fe | PREF\_IMM8 | throw.ifsupernotcorrectcall +AA | 
...
| 0x08fd | PREF\_IMM32 | wide.ldobjbyindex +AAAAAAAA | 
...
A：属性键值
 ...
 | 加载acc中所存对象的键值为A的属性，并将其存放到acc中。 |
| 0x08fe | PREF\_IMM16 | throw.ifsupernotcorrectcall +AAAA | 
...
| 0x09fd | PREF\_V8\_IMM32 | wide.stobjbyindex vAA, +BBBBBBBB | 
...
B：属性键值
 ...
 | 将acc中的值存放到对象A的键值为B的属性上。 |
| 0x09fe | PREF\_ID16 | throw.undefinedifholewithname @AAAA | 
...
| 0x0afd | PREF\_V8\_IMM32 | wide.stownbyindex vAA, +BBBBBBBB | 
...
| 0x0cfd | PREF\_IMM16\_IMM16 | wide.ldlexvar +AAAA, +BBBB | 
...
B：槽位号
 ...
 | 将A个层次外的词法环境的B号槽位上的值存放到acc中。 |
| 0x0dfb | PREF\_IMM4\_IMM4 | callruntime.stsendablevar +A +B | 
...
| 0x0dfd | PREF\_IMM16\_IMM16 | wide.stlexvar +AAAA, +BBBB | 
...
B：槽位号
 ...
 | 将acc中的值存放到A个层次外的词法环境的B号槽位上。 |
| 0x0efb | PREF\_IMM8\_IMM8 | callruntime.stsendablevar +AA +BB | 
...
| 0x0ffb | PREF\_IMM16\_IMM16 | callruntime.widestsendablevar +AAAA +BBBB | 
...
| 0x0ffd | PREF\_IMM16 | wide.stmodulevar +AAAA | 
...
A：槽位号
 ...
 | 将acc中的值存放到槽位号为A的模块变量中。 |
| 0x10fb | PREF\_IMM4\_IMM4 | callruntime.ldsendablevar +A +B | 
...
| 0x11fb | PREF\_IMM8\_IMM8 | callruntime.ldsendablevar +AA + BB | 
...
| 0x12fb | PREF\_IMM16\_IMM16 | callruntime.wideldsendablevar +AAAA +BBBB | 
...
| 0x12fd | PREF\_IMM16 | wide.ldpatchvar +AAAA | A：补丁变量槽位号 | 
...
此指令仅出现在补丁模式编译场景下。
 ...
 |
| 0x13fb | PREF\_IMM8 | callruntime.istrue +RR | 
...
| 0x13fd | PREF\_IMM16 | wide.stpatchvar +AAAA | 
...
此指令仅出现在补丁模式编译场景下。
 ...
 |
| 0x14fb | PREF\_IMM8 | callruntime.isfalse +RR | 
