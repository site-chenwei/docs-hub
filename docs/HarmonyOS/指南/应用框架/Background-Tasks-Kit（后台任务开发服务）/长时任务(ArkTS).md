---
title: "长时任务(ArkTS)"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/continuous-task"
menu_path:
  - "指南"
  - "应用框架"
  - "Background Tasks Kit（后台任务开发服务）"
  - "长时任务(ArkTS)"
captured_at: "2026-04-17T01:35:42.936Z"
---
...
| AUDIO\_PLAYBACK | 音视频播放。 | audioPlayback | 
音频、视频在后台播放，音视频投播。
...
| MULTI\_DEVICE\_CONNECTION | 多设备互联。 | multiDeviceConnection | 
...
**说明：** 从API version 21开始，对PC/2in1设备、非PC/2in1设备但申请了ACL权限为[ohos.permission.KEEP\_BACKGROUND\_RUNNING\_SYSTEM](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/restricted-permissions#ohospermissionkeep_background_running_system)的应用开放。 API version 20及之前版本，仅对PC/2in1设备开放。
 ...
 | taskKeeping | 如杀毒软件。 |
| MODE\_AV\_PLAYBACK\_AND\_RECORD | 

多媒体相关业务。

**说明：** 从API version 22开始支持。

 | avPlaybackAndRecord | 音视频播放，录制，音视频通话时退后台。在上述三种场景下，选择本类型或对应类型的长时任务均可。例如：音视频播放场景下，选择AUDIO\_PLAYBACK或者MODE\_AV\_PLAYBACK\_AND\_RECORD任意一个即可。 |
| MODE\_SPECIAL\_SCENARIO\_PROCESSING | 
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/02/v3/uqI3M8w8S7-482Pt9LsV6g/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013544Z&HW-CC-Expire=86400&HW-CC-Sign=1EABFA092FBABC7C80DCCA8F9D2B0089E5F44B2D70CDB1C137C5F18FC75D2560)
    ...
    struct Index {
      ...
      startContinuousTask() {
        let wantAgentInfo: wantAgent.WantAgentInfo = {
          ...
          // extraInfo: {
            // \[backgroundTaskManager.BackgroundModeType.SUB\_MODE\] :backgroundTaskManager.BackgroundSubMode.CAR\_KEY
          // }
        };
        ...
        try {
          ...
          wantAgent.getWantAgent(wantAgentInfo).then((wantAgentObj: WantAgent) => {
            try {
              ...
              // let list: string\[\] = \['bluetoothInteraction'\]; 长时任务类型包含bluetoothInteraction，CAR\_KEY子类型合法
