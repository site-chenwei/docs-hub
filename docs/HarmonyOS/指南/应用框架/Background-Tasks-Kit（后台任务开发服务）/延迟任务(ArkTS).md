---
title: "延迟任务(ArkTS)"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/work-scheduler"
menu_path:
  - "指南"
  - "应用框架"
  - "Background Tasks Kit（后台任务开发服务）"
  - "延迟任务(ArkTS)"
captured_at: "2026-04-17T01:35:42.963Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2d/v3/4pRMibjIQbunZJ1xQ46RsQ/zh-cn_image_0000002538019180.png?HW-CC-KV=V1&HW-CC-Date=20260417T013544Z&HW-CC-Expire=86400&HW-CC-Sign=566167E83B184DCB86C2E96E1BEBC48D03EAD07EAC611B572D6378FFE8818634)
...
2.  申请延迟任务。
    ...
    let workInfo: workScheduler.WorkInfo = {
      workId: 1,
      networkType: workScheduler.NetworkType.NETWORK\_TYPE\_ANY,
...
3.  取消延迟任务。
    ...
    let workInfo: workScheduler.WorkInfo = {
      workId: 1,
      networkType: workScheduler.NetworkType.NETWORK\_TYPE\_WIFI,
      bundleName: 'ohos.samples.workschedulerextensionability',
      abilityName: 'WorkSchedulerAbility',
    }
