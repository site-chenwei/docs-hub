---
title: "拉起指定类型的应用概述"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/start-intent-panel"
menu_path:
  - "指南"
  - "应用框架"
  - "Ability Kit（程序框架服务）"
  ...
  - "拉起指定类型的应用"
  - "拉起指定类型的应用概述"
captured_at: "2026-04-17T01:35:31.968Z"
---
...
-   如果当前设备已安装应用中存在匹配的应用，选择框中将展示已接入的垂类应用，由用户选择打开指定应用以实现相应的意图。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/LziKGE6lTXSFvSqxFTl7qw/zh-cn_image_0000002568898127.png?HW-CC-KV=V1&HW-CC-Date=20260417T013532Z&HW-CC-Expire=86400&HW-CC-Sign=5CBC7E90C79CBB04383E703BEFA7315E4F2B990ABF2D8DBEB51C36053EA74CFE)
    
-   如果当前设备已安装应用中没有匹配的应用，系统将自动弹窗提示用户没有相关应用（下图以导航类应用匹配失败为例）。无需开发者适配。
    
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ce/v3/KvVnPkwLQ2u2-vDxtUSrGg/zh-cn_image_0000002538018420.png?HW-CC-KV=V1&HW-CC-Date=20260417T013532Z&HW-CC-Expire=86400&HW-CC-Sign=9157C22881B31742C77A3513FE2C92588A7867431E8582B9A2B31CD5FFAC1FAF)
