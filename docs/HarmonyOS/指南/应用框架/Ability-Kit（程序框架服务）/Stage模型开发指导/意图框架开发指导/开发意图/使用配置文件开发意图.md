---
title: "使用配置文件开发意图"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/insight-intent-config-development"
menu_path:
  - "指南"
  - "应用框架"
  - "Ability Kit（程序框架服务）"
  ...
  - "开发意图"
  - "使用配置文件开发意图"
captured_at: "2026-04-17T01:35:32.305Z"
---
...
| 组件类型 | 意图配置 | 意图执行器 |
| :-- | :-- | :-- |
| UIAbility | 需要在insight\_intent.json文件中配置"uiAbility"字段。 | 
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/08/v3/0NlaKxM_Rv2A2PVXW38DLg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013532Z&HW-CC-Expire=86400&HW-CC-Sign=0A5B52B25DB29A5FEFD1B0C92C23E5B4CFC6C49B428215ECA82C7C6D3F268E47)
