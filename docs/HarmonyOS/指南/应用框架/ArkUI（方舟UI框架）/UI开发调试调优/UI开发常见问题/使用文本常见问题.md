---
title: "使用文本常见问题"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-text-faq"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "UI开发常见问题"
  - "使用文本常见问题"
captured_at: "2026-04-17T01:35:41.373Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f/v3/zzoR598TQFOSLpmQqukChw/zh-cn_image_0000002538019090.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013542Z&HW-CC-Expire=86400&HW-CC-Sign=D7271FD1A0703A325A404162CE79DAB27D438CF4005CCD81E4BAAC309D73294A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/51/v3/pyPYtr6lTNSinvc0v1uL-A/zh-cn_image_0000002538179018.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013542Z&HW-CC-Expire=86400&HW-CC-Sign=24BDF6A949713CC4CC89A5F78D04ACEB5B089C08E7F8547D7E5FD0945F06C965)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/61/v3/r1OuanMITp6rCGYznNUY_Q/zh-cn_image_0000002569018807.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013542Z&HW-CC-Expire=86400&HW-CC-Sign=A2A285EF0CBE3CC989C25F552FA5C47D9801D99D914BCDBD41870648D02EE2A1)
...
export struct LengthMetric {
  ...
  // 'Text\_Add\_Tags\_Front\_and\_Post'资源文件中的value值为'这是一段长文本，超长部分折行，前后添加标签'
  @State message: string = this.manager.getStringByNameSync('Text\_Add\_Tags\_Front\_and\_Post');
  // 'Text\_Add\_Tags\_Front'前标签'
  @State frontTag: string = this.manager.getStringByNameSync('Text\_Add\_Tags\_Front');
  // 'Text\_Add\_Tags\_Post'资源文件中的value值为'后标签'
  @State backTag: string = this.manager.getStringByNameSync('Text\_Add\_Tags\_Post');
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/36/v3/z0gnl6hQSRm34Z954K7FhA/zh-cn_image_0000002568898797.png?HW-CC-KV=V1&HW-CC-Date=20260417T013542Z&HW-CC-Expire=86400&HW-CC-Sign=30507F0420AF33AEEE5D7CB6E28D63E07D99902F273A5F92BEDA32784FBEBE3B)
...
export struct DisplayedTogether {
  ...
  // 'Text\_Full\_Text'资源文件中的value值为
  // '你好我是Text\[grin\]，你好我\[rolling\_on\_the\_floor\_laughing\]是Text，\[slightly\_smiling\_face\]你好我是Text\[grin\]'
  @State fulltext: string = this.manager.getStringByNameSync('Text\_Full\_Text');

  static classifyTextAndEmojis(input: string): Map<string, string\[\]> {
    const emojiRegex = /\\\[(\[a-zA-Z\_\]+)\\\]/g; // 根据实际情况编写正则表达式
  ...
  static getEmojiImg(emojis: string\[\]): Resource\[\] { // 根据正则匹配结果返回自定义表情资源
    ...
    for (let i = 0; i < emojis.length; i++) {
      switch (emojis\[i\]) {
        case 'rolling\_on\_the\_floor\_laughing':
          emojisImg.push($r('app.media.rolling\_on\_the\_floor\_laughing'))
          break;
        case 'slightly\_smiling\_face':
          emojisImg.push($r('app.media.slightly\_smiling\_face'))
          break;
        case 'grin':
  ...
  build() {
    NavDestination() {
      Column() {
        TextInput({
          // 请将$r('app.string.Text\_emoji')替换为实际资源文件，在本示例中该资源文件的value值为"用户输入带表情的文本，例如：你好\[grin\]"
          placeholder: $r('app.string.Text\_emoji')
        })
          .width('80%')
          .padding(10)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/47/v3/729u31sqTvCJKAtyclsVmQ/zh-cn_image_0000002538019092.png?HW-CC-KV=V1&HW-CC-Date=20260417T013542Z&HW-CC-Expire=86400&HW-CC-Sign=C6415CBEBFA9343560EA26EC6A57781E7184A6E032E75A4048FE197DEC338ED5)
...
export struct TextLong {
  ...
  // 'Text\_Long\_String'资源文件中的value值为'这是一段超长文本'
  @State message: string = this.manager.getStringByNameSync('Text\_Long\_String').repeat(50);
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/62/v3/HrQbIru5S6mg42-ZEl0kmA/zh-cn_image_0000002538179020.png?HW-CC-KV=V1&HW-CC-Date=20260417T013542Z&HW-CC-Expire=86400&HW-CC-Sign=11A3293C5B354AE3704EE8F371C87EFCB643C84C75293E10F297DBDD7197A3FC)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3d/v3/3B27wXFNRVOboBKnERDryQ/zh-cn_image_0000002569018809.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013542Z&HW-CC-Expire=86400&HW-CC-Sign=18F4A506649ACE7A4D6A97B4C7AA6F08AD0964B05175DE1C37F0B7CFD861CB7D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/fnHRf1VbRrq31wK8I4tuNQ/zh-cn_image_0000002568898799.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013542Z&HW-CC-Expire=86400&HW-CC-Sign=38B71D0666CBDA434B6B32EACA3D5143415D42D5D231042ABDA9E5009C3F2BA0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f4/v3/-qQ2c4ekSlarK8zqR-cTig/zh-cn_image_0000002538019094.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013542Z&HW-CC-Expire=86400&HW-CC-Sign=6B55D7449EE940457AD37839A39EAAA8A4904B15927301F6E6B764FB0C81A80B)
