---
title: "JS语法参考"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/js-framework-syntax-js"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "语法"
  - "JS语法参考"
captured_at: "2026-04-17T01:35:40.190Z"
---
...
-   页面对象
    ...
    页面的数据模型，类型是对象或者函数，如果类型是函数，返回值必须是对象。属性名不能以$或\_开头，不要使用保留字for, if, show, tid。
...
-   公共方法
    ...
    | :-- | :-- | :-- |
    | $element | id: string | 
    获得指定id的组件对象，如果无指定id，则返回根组件对象。示例见[获取DOM元素](#获取dom元素)。
    ...
    获得指定id的子级自定义组件的ViewModel实例。[获取ViewModel](#获取viewmodel)示例。
...
-   事件方法
    ...
    观察data中的属性变化，如果属性值改变，触发绑定的事件。示例见[$watch感知数据改变](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-components-custom-props#watch感知数据改变)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5d/v3/gEnu-cWzRSO0RbV0d_eWkQ/zh-cn_image_0000002538178930.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013541Z&HW-CC-Expire=86400&HW-CC-Sign=DA554889751E62739874406F16C1739E51E87355DC1D5CA77B6C174304B309EF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/99/v3/TEsjtJiOSYqLMBq2SK-B0A/zh-cn_image_0000002569018719.png?HW-CC-KV=V1&HW-CC-Date=20260417T013541Z&HW-CC-Expire=86400&HW-CC-Sign=82195D73FE6804B36733BE5EB8C1C40ADD939B9E45461F26F1FA1679AC42AAA1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/2KwOkk9yRpy3ZYaDE4pQkg/zh-cn_image_0000002568898709.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013541Z&HW-CC-Expire=86400&HW-CC-Sign=D14FE8461216D485DB4FF982CDA1D24E82C77E6ECB912607EEFD20AF57CD8940)
