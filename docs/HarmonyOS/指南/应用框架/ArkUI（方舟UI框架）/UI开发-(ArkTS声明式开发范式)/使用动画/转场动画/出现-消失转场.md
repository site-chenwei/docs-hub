---
title: "出现/消失转场"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-enter-exit-transition"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "转场动画"
  - "出现/消失转场"
captured_at: "2026-04-17T01:35:38.836Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f3/v3/8en0ZcRzR9Ky4z0cd-pyTg/zh-cn_image_0000002538018906.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=DB65255AA861C797753212C164C513579109E075F58EC86FA30FA8CEDAEE759B)
...
const ITEM\_COUNTS = 9;
const ITEM\_COLOR = '#ED6F21';
const INTERVAL = 30;
const DURATION = 300;
...
struct Index1 {
  ...
  private dataArray: number\[\] = new Array(ITEM\_COUNTS);

  aboutToAppear(): void {
    for (let i = 0; i < ITEM\_COUNTS; i++) {
      this.dataArray\[i\] = i;
    }
  }
  ...
  build() {
    ...
    .onClick(() => {
      this.getUIContext()?.animateTo({
        duration: DURATION + INTERVAL \* (ITEM\_COUNTS - 1),
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5c/v3/C5ZKwz4_Q2q86OQ-lk-bwQ/zh-cn_image_0000002538178834.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=6B2A7DCDD3CF8996988A10383178F0DA17F661A95981CBCE093E99F0AF7EB53A)
