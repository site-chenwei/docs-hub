---
title: "组件动画"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-component-animation"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "使用动画"
  - "组件动画"
captured_at: "2026-04-17T01:35:38.940Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c8/v3/wOBlyn3JRvOLIQVOJTnzuw/zh-cn_image_0000002538178846.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=15E607193A540DE5B3F177BE68BF6BDBB6A5E9932EFE0E6414CFF71D2C103E79)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bf/v3/OyLUhKGNQHm73km2nD8gHg/zh-cn_image_0000002569018635.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=FA76BAB82C9FC78E3122C519BDC8F4534FD55EAF7655BE081C2EB7A93F1852C1)
...
class DragSortCtrl<T> {
  ...
  onMove(item: T, offset: number) {
    ...
    if (this.offsetY < -this.ITEM\_INTV / 2) { // 通过判断使指定的item逐一移动到首位
      // 使用interpolatingSpring曲线生成弹簧动画
      this.uiContext.animateTo({ curve: curves.interpolatingSpring(0, 1, 400, 38) }, () => { // 400: 弹簧刚度，38: 弹簧阻尼
        this.offsetY += this.ITEM\_INTV; // 调整偏移量实现平滑移动
        this.dragRefOffset -= this.ITEM\_INTV; // 移动的总偏移量
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f9/v3/gRGjdYkAQSK8e3RESL8Bjw/zh-cn_image_0000002568898625.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=321B41C08BF747CFF00E98212FF45C6A85481645D223B6C2E2E11C24A505A235)
