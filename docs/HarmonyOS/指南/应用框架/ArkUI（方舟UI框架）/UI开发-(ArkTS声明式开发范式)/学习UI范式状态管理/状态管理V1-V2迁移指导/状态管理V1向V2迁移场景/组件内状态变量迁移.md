---
title: "组件内状态变量迁移"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-v1-v2-migration-inner-component"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "状态管理V1向V2迁移场景"
  - "组件内状态变量迁移"
captured_at: "2026-04-17T01:35:36.860Z"
---
...
| V1装饰器名 | V2装饰器名 |
| :-- | :-- |
| [@State](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-state) | 
无外部初始化：[@Local](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-local)
...
const INITIAL\_VALUE = 10;

@Entry
@Component
struct Child {
  @State val: number = INITIAL\_VALUE;
...
@ComponentV2
struct Child {
  @Local val: number = INITIAL\_VALUE;
...
class Child {
  public value: number = INITIAL\_VALUE;
}
...
@ObservedV2
class Child {
  @Trace public value: number = INITIAL\_VALUE;
}
...
@Component
struct Parent {
  @State myVal: number = INITIAL\_MYVAL;
...
@ComponentV2
struct Parent {
  @Local myVal: number = INITIAL\_MYVAL;
...
const APPLE\_INITIAL\_COUNT = 5;
const ORANGE\_INITIAL\_COUNT = 10;

class Fruit {
  public apple: number = APPLE\_INITIAL\_COUNT;
  public orange: number = ORANGE\_INITIAL\_COUNT;
}
...
@ObservedV2
class Fruit {
  @Trace public apple: number = APPLE\_INITIAL\_COUNT;
  @Trace public orange: number = ORANGE\_INITIAL\_COUNT;
...
const PARENT\_INITIAL\_STATE\_VALUE = 10;
...
@Component
struct Parent {
  @State value: number = PARENT\_INITIAL\_STATE\_VALUE;
...
const DOMAIN = 0xFF00;
const TAG = '\[Sample\_StateMigration\_App\]';
const PARENT\_INITIAL\_LOCAL\_VALUE = 10;
...
@ComponentV2
struct Parent {
  @Local value: number = PARENT\_INITIAL\_LOCAL\_VALUE;
...
const STATE\_INITIAL\_PARENT\_VALUE = 42;

@Entry
@Component
struct Parent {
  @State parentValue: number = STATE\_INITIAL\_PARENT\_VALUE;
...
const LOCAL\_INITIAL\_PARENT\_VALUE = 42;

@Entry
@ComponentV2
struct Parent {
  @Local parentValue: number = LOCAL\_INITIAL\_PARENT\_VALUE;
...
const GRANDPARENT\_REVIEW\_VOTES\_INITIAL = 40;
const PARENT\_REVIEW\_VOTES\_INITIAL = 20;

@Entry
@Component
struct GrandParent {
  @Provide('reviewVotes') reviewVotes: number = GRANDPARENT\_REVIEW\_VOTES\_INITIAL;
...
struct Parent {
  ...
  @Provide({ allowOverride: 'reviewVotes' }) reviewVotes: number = PARENT\_REVIEW\_VOTES\_INITIAL;
...
@ComponentV2
struct GrandParent {
  @Provider('reviewVotes') reviewVotes: number = GRANDPARENT\_REVIEW\_VOTES\_INITIAL;
...
struct Parent {
  ...
  @Provider() reviewVotes: number = PARENT\_REVIEW\_VOTES\_INITIAL;
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/32/v3/zpErgmsjTG6Bw-8_JjWbfQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=5523E41E7D45734F3FA6BE379FE4BDFF72528427106C785CB1F2D0EC5C7DE13D)
