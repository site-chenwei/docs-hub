---
title: "应用内状态变量迁移"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-v1-v2-migration-application"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "状态管理V1向V2迁移场景"
  - "应用内状态变量迁移"
captured_at: "2026-04-17T01:35:36.865Z"
---
...
export class MyStorage {
  public static singleton\_: MyStorage;

  static instance() {
    if (!MyStorage.singleton\_) {
      MyStorage.singleton\_ = new MyStorage();
    }
    return MyStorage.singleton\_;
  }
