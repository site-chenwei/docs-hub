---
title: "内置对象的迁移"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-v1-v2-migration-inner-object"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "状态管理V1向V2迁移场景"
  - "内置对象的迁移"
captured_at: "2026-04-17T01:35:36.889Z"
---
...
struct MyImage1 {
  ...
  build() {
    // 此处'app.media.app\_icon'仅作示例，请开发者自行替换，否则imageSource创建失败会导致后续无法正常执行。
...
struct Index {
  ...
  build() {
    Column() {
      Button($r('app.string.EntryAbility\_label'))
        .margin(10)
        .onClick(() => {
