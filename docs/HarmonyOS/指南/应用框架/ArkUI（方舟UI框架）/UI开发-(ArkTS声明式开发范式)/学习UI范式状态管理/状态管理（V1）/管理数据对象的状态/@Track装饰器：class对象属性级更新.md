...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-track"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
...
captured_at: "2026-04-17T01:35:36.335Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5c/v3/-uGl40kvT9iYRJR2pzKxsw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=8BDD573CFE6CD18180ACD06EC4362DEB1AA526C87AFD3E67841F86082CF21ABE)
...
const TAG: string = '\[Sample\_StateTrack\]';
class Info {
...
struct Index {
  ...
  getFontSize(id: number): number {
    hilog.info(DOMAIN\_NUMBER, TAG, \`Component ${id} render\`);
    return 30;
  }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/40/v3/ptFqDrDGTxmMZ7FdS-VTHQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=97219FB0DD5D7D630140B59D4C0A45FADC95230496FEBD540F75FDD9F5984DA2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b0/v3/suVo2I-oTDqOTFLCxS6sjw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=73C645CC0F3840905CB71802370544601F8283B4601E5819E72E6A696F1FF8D0)
...
struct AddLog {
  ...
  isRender(index: number) {
    hilog.info(DOMAIN\_NUMBER, TAG, \`Text ${index} is rendered\`);
    return 50;
  }
      ...
      Column() {
        Text(this.log.logInfo)
          ...
          .onClick(() => {
            ...
            hilog.info(DOMAIN\_NUMBER, TAG, 'owner: ' + this.log.owner +
              ' id: ' + this.log.id +
              ' time: ' + this.log.time +
