---
title: "MVVM模式（V1）"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-mvvm"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "学习UI范式状态管理"
  - "MVVM模式（V1）"
captured_at: "2026-04-17T01:35:36.143Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8d/v3/UE32YCa3TvuPcM0RPOKdFg/zh-cn_image_0000002569018223.png?HW-CC-KV=V1&HW-CC-Date=20260417T013536Z&HW-CC-Expire=86400&HW-CC-Sign=4649A68D86097DB85BCF7F7A985DEFFB1FDFE560CDD216B5224D309FB6B6E264)
...
struct StateIndex {
  ...
  build() {
    Column() {
      Row() {
        // 请将$r('app.string.all\_tasks')替换为实际资源文件，在本示例中该资源文件的value值为"全部待办"
        Text($r('app.string.all\_tasks'))
          .fontSize(30)
      ...
      Row({ space: 15 }) {
        ...
        // 请将$r('app.string.all\_learn\_advanced\_math')替换为实际资源文件，在本示例中该资源文件的value值为"学习高数"
        Text($r('app.string.learn\_advanced\_math'))
          .fontSize(24)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/84/v3/nFToRNPbTCWkoOv0NjzD1Q/zh-cn_image_0000002568898219.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013536Z&HW-CC-Expire=86400&HW-CC-Sign=3E07DA9192B16463D11E8E588E815425B31928F3B9F36E782597FCE0694A642B)
...
struct PropLinkAllChooseComponent {
  ...
  build() {
    Row() {
      // 请将$r('app.string.check\_all')替换为实际资源文件，在本示例中该资源文件的value值为"全选"
      Button($r('app.string.check\_all'), { type: ButtonType.Normal })
        .onClick(() => {
          this.isFinished = !this.isFinished;
        })
        .fontSize(30)
...
struct ThingComponent1 {
  ...
  build() {
    ...
    Row({ space: 15 }) {
      ...
      // 请将$r('app.string.learn\_chinese')替换为实际资源文件，在本示例中该资源文件的value值为"学习语文"
      Text($r('app.string.learn\_chinese'))
        .fontSize(24)
        .decoration({ type: this.isFinished ? TextDecorationType.LineThrough : TextDecorationType.None })
    }
    .height('40%')
...
struct ThingComponent2 {
  ...
  build() {
    ...
    Row({ space: 15 }) {
      ...
      // 请将$r('app.string.learn\_advanced\_math')替换为实际资源文件，在本示例中该资源文件的value值为"学习高数"
      Text($r('app.string.learn\_advanced\_math'))
        .fontSize(24)
        .decoration({ type: this.isFinished ? TextDecorationType.LineThrough : TextDecorationType.None })
    }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ff/v3/A4F8r3N1TwCozKULEkf0xg/zh-cn_image_0000002538018510.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013536Z&HW-CC-Expire=86400&HW-CC-Sign=B22118B069CFF340A635C4B5625C7EFE65167F351B42A93BDD97849318F42829)
...
struct ForEachIndex {
  ...
  @State planList: ResourceStr\[\] = \[
    // 请将$r('app.string.get\_up')替换为实际资源文件，在本示例中该资源文件的value值为"7.30 起床"
    $r('app.string.get\_up'),
    ...
    $r('app.string.dinner'),
    // 请将$r('app.string.midnight\_snack')替换为实际资源文件，在本示例中该资源文件的value值为"21.30 夜宵"
    $r('app.string.midnight\_snack'),
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d0/v3/W34hExBuRfOOrXGptjWtmQ/zh-cn_image_0000002538178438.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013536Z&HW-CC-Expire=86400&HW-CC-Sign=B6EB89A395F4AB3AE6FC93F6786751E10D9B402789A393228CE7D3A63934ABEE)
...
struct BuilderAllChooseComponent {
  ...
  build() {
    Row() {
      // 请将$r('app.string.check\_all')替换为实际资源文件，在本示例中该资源文件的value值为"全选"
      Button($r('app.string.check\_all'), { type: ButtonType.Capsule })
        .onClick(() => {
          this.isFinished = !this.isFinished;
        })
        .fontSize(30)
  ...
  build() {
    ...
    Row({ space: 15 }) {
      ...
      Text(\`${this.thing}\`)
        ...
        .decoration({ type: this.isFinished ? TextDecorationType.LineThrough : TextDecorationType.None })
        .onClick(() => {
          // 请将$r('app.string.la\_la')替换为实际资源文件，在本示例中该资源文件的value值为"啦"
          this.thing += this.getUIContext().getHostContext()!.resourceManager.getStringSync($r('app.string.la\_la').id);
        })
    }
    .height('8%')
    .width('90%')
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/74/v3/TtyZ7aVwSA-bFv4rQsCdsg/zh-cn_image_0000002569018227.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013536Z&HW-CC-Expire=86400&HW-CC-Sign=FBF4FF6B4FE0560EC58EBD8F44CEA2641D717A1EB83F261D9342F20F27AD988F)
...
export default class TodoListModel {
  ...
  async loadTasks(context: common.UIAbilityContext) {
    try {
      let getJson = await context.resourceManager.getRawFileContent('default\_tasks.json');
...
export struct AllChooseComponent {
  ...
  // 请在resources\\base\\element\\string.json文件中配置name为'check\_all'，value为非空字符串的资源
  @State titleName: ResourceStr = this.context1.resourceManager.getStringSync($r('app.string.check\_all').id);
      ...
      Button(\`${this.titleName}\`, { type: ButtonType.Capsule })
        .onClick(() => {
          ...
          this.titleName = this.todoListViewModel.isChosen ?
            // 请在resources\\base\\element\\string.json文件中配置name为'check\_all'，value为非空字符串的资源
            this.context1.resourceManager.getStringSync($r('app.string.check\_all').id)
            // 请在resources\\base\\element\\string.json文件中配置name为'deselect\_all'，value为非空字符串的资源
            : this.context1.resourceManager.getStringSync($r('app.string.deselect\_all').id);
        })
        .fontSize(30)
        .fontWeight(FontWeight.Bold)
        .backgroundColor('#f7f6cc74')
...
export default class ThingViewModel {
  ...
  addSuffixes(): void {
    // 请在resources\\base\\element\\string.json文件中配置name为'la\_la'，value为非空字符串的资源
    this.thingName += this.context.resourceManager.getStringSync($r('app.string.la\_la').id);
  }
}
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/GET5cJ0LQ9m9V_R3se1V2Q/zh-cn_image_0000002568898221.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013536Z&HW-CC-Expire=86400&HW-CC-Sign=1146C2D127B1A31451599AF73213C3C3A026202FA9239AFC4A6D1F3D14D21016)
