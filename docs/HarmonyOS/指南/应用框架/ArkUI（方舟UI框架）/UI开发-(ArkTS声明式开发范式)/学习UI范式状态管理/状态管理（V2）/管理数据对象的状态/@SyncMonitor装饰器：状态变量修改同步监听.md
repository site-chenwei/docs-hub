...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-syncmonitor"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
...
captured_at: "2026-04-17T01:35:36.598Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/12/v3/Ew0oOBGaRRSpZrY1KC2Kaw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=71ECD6353B8450CAF5F72E26AEF290CEBA91A0BC94C3009F0D89A7E8D99E8BA2)
...
-   @SyncMonitor支持对数组项进行监听，包括多维数组，对象数组。@SyncMonitor可以观察由调用Array的API引起的变化，比如copyWithin, fill, sort, push。当@SyncMonitor观察整个数组时，只能检测到整个数组的值变化。可以通过监听数组的长度变化来判断数组是否有插入、删除等变化。目前，只能使用点符号 (.) 来观察嵌套属性和数组项。
