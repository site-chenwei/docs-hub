---
title: "数据对象状态管理常见问题"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-state-management-faq-inner-class"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "状态管理常见问题"
  - "数据对象状态管理常见问题"
captured_at: "2026-04-17T01:35:37.046Z"
---
...
const TAG: string = '\[Sample\_StateManagement\]';
...
struct Index {
  ...
  isRenderText(index: number): number {
    hilog.info(DOMAIN\_NUMBER, TAG, \`index ${index} is rendered\`);
    return 1;
  }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b4/v3/2xEKMom5TeuBWkz13rP9zg/zh-cn_image_0000002568898265.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=9D33FA4C7BCA3F7B659980D2962F4E0FFFA83803A41E55DBDC4056EF14C1F66F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/db/v3/MBWKm16QTUe976VUnOEtgw/zh-cn_image_0000002538018556.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=FC24C6C079A675091D2C158BE2B80FDF9A9B25F14E1B5E3048A9B107BE0873CF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/23/v3/rtyaHE8CQGCtCZDRBb6SIQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=7E6817DB18053A11B5DCE8113A2EF72665A298AAD5A7F0C7F5F7CEE9A534EBDB)
...
struct SpecialImage {
  ...
  private isRenderSpecialImage(): number { // 显示组件是否渲染的函数
    hilog.info(DOMAIN\_NUMBER, TAG, 'SpecialImage is rendered');
    return 1;
  }
...
struct PageChild {
  ...
  private isRenderColumn(): number {
    hilog.info(DOMAIN\_NUMBER, TAG, 'Column is rendered');
    return 1;
  }

  private isRenderStack(): number {
    hilog.info(DOMAIN\_NUMBER, TAG, 'Stack is rendered');
    return 1;
  }

  private isRenderImage(): number {
    hilog.info(DOMAIN\_NUMBER, TAG, 'Image is rendered');
    return 1;
  }

  private isRenderText(): number {
    hilog.info(DOMAIN\_NUMBER, TAG, 'Text is rendered');
    return 1;
  }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/K_uP2R-MQM2pRYzf_EJ3yQ/zh-cn_image_0000002538178484.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=F833A64F1C55D44FCB8F2C3B8F8985CAEDD2BFBB01469E8872EB4DFD96FF98A2)

优化前点击move按钮的脏节点更新[耗时](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ui-inspector-profiler#trace调试能力)如下图：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/34/v3/yGDovCSATHaKtghtGnfY8A/zh-cn_image_0000002569018275.png?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=7A49BD21F39EF5251A03D259FE915EBDA8E659C98295DD8CC044880C163347C4)
...
上述代码的运行效果如下。![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/qoTPgrs2QOyNmJnb_Mo8yA/zh-cn_image_0000002568898267.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=A458E64CBEEF798629725521329C6F684176730BF9AE65E667E66E139B944B28)

优化后点击move按钮的脏节点更新耗时如下图：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b/v3/w18RqLPAQNuxcMSRmXUg2w/zh-cn_image_0000002538018558.png?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=420139ED3A277E0E0CE0BC63282E17E339C30B003774D1F4FCFE20C9F97A3953)
...
struct CompList {
  ...
  changeChildList() {
    hilog.info(DOMAIN\_NUMBER, TAG, 'CompList ChildList change');
  }

  isRenderCompChild(index: number): number {
    hilog.info(DOMAIN\_NUMBER, TAG, 'Comp Child is render' + index);
    return 1;
  }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/78/v3/1EKSKM_BQOGeJxmowm1h9w/zh-cn_image_0000002538178486.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=211D06D033FA25F972CDC5BA75425D38008565ADFF48EB0CB86DBFD290BD4665)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d4/v3/ZVn3d3muQSOBssbSk4Bd6A/zh-cn_image_0000002569018277.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=AC20B9907A2864C587972D84E0D614063DB55C666340C73D7B42C7A1BBEFC5E6)
