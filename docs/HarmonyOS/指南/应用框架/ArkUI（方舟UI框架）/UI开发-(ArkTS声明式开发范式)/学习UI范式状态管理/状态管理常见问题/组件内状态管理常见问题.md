---
title: "组件内状态管理常见问题"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-state-management-faq-inner-component"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "状态管理常见问题"
  - "组件内状态管理常见问题"
captured_at: "2026-04-17T01:35:37.034Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/7_-V_oTSSKaLwhX_cqRosQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=8D7F53862F7A2BA56DF489D1E96FF52F64DABDD91CF7EFB04837521B140DB9D9)
...
struct Test {
  ...
  build() {
    Column() {
      // 请在resources\\base\\element\\string.json文件中配置name为'state\_countvalue\_text1' ，value为非空字符串的资源
      Text(this.context.resourceManager.getStringByNameSync('state\_countvalue\_text1') + \`${this.count}\`)
      Button('change')
        .onClick(() => {
          model.call();
        })
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/35/v3/4vb18YKnTTysy3mQSPxrPA/zh-cn_image_0000002538178480.png?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=1C49C9118C7C374A81C15F25567F75C64A0453AD6381A03D1B0B00B4DE77042D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/Wq5Zfm4zR0G6bWXX8Vs5BA/zh-cn_image_0000002569018271.png?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=A634F7F316DB391B91ACE8D10F14C523C192038E3E9AE1817ACC23F3FE557461)
...
class BasicDataSource implements IDataSource {
  ...
  registerDataChangeListener(listener: DataChangeListener): void {
    if (this.listeners.indexOf(listener) < 0) {
      hilog.info(DOMAIN\_NUMBER, TAG, 'add listener');
  ...
  unregisterDataChangeListener(listener: DataChangeListener): void {
    ...
    if (pos >= 0) {
      hilog.info(DOMAIN\_NUMBER, TAG, 'remove listener');
        ...
        ListItem() {
          Column() {
            Text(item.message).fontSize(20)
              .onAppear(() => {
                hilog.info(DOMAIN\_NUMBER, TAG, 'text appear:' + item.message);
              })
            Image(item.imgSrc)
              .width(100)
              .height(100)
              .onAppear(() => {
                hilog.info(DOMAIN\_NUMBER, TAG, 'image appear');
              })
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/eIFSkEIMQ-SPqGH1sDEgAQ/zh-cn_image_0000002568898263.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=39E67A20A384C45EB170ED4826DEC01D495B42DA2BB03B20899BFCA9D4B3D04A)
  ...
  build() {
    Column() {
      Text(this.data.message).fontSize(20)
        .onAppear(() => {
          hilog.info(DOMAIN\_NUMBER, TAG, 'text appear:' + this.data.message);
        })
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/qs2vq8OKRuCEv0JZUsfOLw/zh-cn_image_0000002538018554.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=B4EF160C850E80E95214C26AC4F0A9B4445BC9CEE49E733A3372F228C89B0F92)
    ...
    Column() {
      Text('Font Size List')
        ...
        .onClick(() => {
          ...
          hilog.info(DOMAIN\_NUMBER, TAG, 'change font size');
        })
      List() {
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d3/v3/Bl3ybw8uS7aPELs1bv8bfA/zh-cn_image_0000002538178482.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=8F3C5789D05612F99DAFE74801461A9DEBDD6BDDDE07FADBE6FAA84826A16D0B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/8tvYge3qTzuXvlQ0Q6AEFg/zh-cn_image_0000002569018273.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013537Z&HW-CC-Expire=86400&HW-CC-Sign=56B9409C1532759659AA4492E1B2C4B035A5459849C472EBE1AD12AF7179FC46)
