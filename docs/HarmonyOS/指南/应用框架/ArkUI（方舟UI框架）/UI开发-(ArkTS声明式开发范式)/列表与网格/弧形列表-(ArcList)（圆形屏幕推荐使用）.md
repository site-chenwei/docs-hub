...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-layout-development-create-arclist"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
...
captured_at: "2026-04-17T01:35:37.536Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1d/v3/nsfvVr6gSXqRlZQ9uT9Bpg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=6F02D9C28435371437065ED49B8E6A2AA560F8BEEB33A8A0EBC6633669DA40EC)
...
export struct ArcListShow {
  build() {
          ...
          ArcList({ initialIndex: 2 }) {
            ArcListItem() {
              Row() {
                ...
                Column() {
                  Text($r('app.string.ArcListStyles\_waln')).fontSize('38px').fontColor('#FFFFFFFF')
                  Text($r('app.string.ArcListStyles\_open')).fontSize('20px').fontColor('#FFFFFFFF')
                }.width('190px')

                Image($r('app.media.ic\_settings\_arrow')).width('92px').height('92px')
                  .borderRadius('50px')
              }
            }
            .borderRadius('65px')
            ...
            ArcListItem() {
              Row() {
                Image($r('app.media.blueTooth')).width('99px').height('99px')
                  .borderRadius('50px').margin({ left: 7 })
                Column() {
                  Text($r('app.string.ArcListStyles\_blue')).fontSize('38px').fontColor('#FFFFFFFF')
                  Text($r('app.string.ArcListStyles\_open')).fontSize('20px').fontColor('#FFFFFFFF')
                }.width('190px')
            ...
            ArcListItem() {
              Row() {
                Image($r('app.media.mobileData')).width('99px').height('99px')
                  .borderRadius('50px').margin({ left: 7 })
                Column() {
                  Text($r('app.string.ArcListStyles\_net')).fontSize('38px').fontColor('#FFFFFFFF')
                }.width('190px')
            ...
            ArcListItem() {
              Row() {
                Image($r('app.media.ic\_settings\_more\_connections')).width('99px').height('99px')
                  .borderRadius('50px').margin({ left: 7 })
                Column() {
                  Text($r('app.string.ArcListStyles\_connect')).fontSize('38px').fontColor('#FFFFFFFF')
                }.width('190px')
            ...
            ArcListItem() {
              Row() {
                Image($r('app.media.displayAndBrightness')).width('99px').height('99px')
                  .borderRadius('50px').margin({ left: 7 })
                Column() {
                  Text($r('app.string.ArcListStyles\_light')).fontSize('38px').fontColor('#FFFFFFFF')
                }.width('190px')
    ...
    // 请将$r('app.string.ArcListShow\_title')替换为实际资源文件，在本示例中该资源文件的value值为"在弧形列表中显示数据"
    .title($r('app.string.ArcListShow\_title'))
  }
}

**图1** 显示弧形列表数据

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d1/v3/eudL_aZATr-2deMd3K2m_A/zh-cn_image_0000002538018688.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=F7F04A1B9D9BD4D13F0431C4FF172D099D608E2CADC160E336E6640403B79DDF)
...
export struct ArcListContents {
  ...
  @State private contacts: Array<object> = \[
    ...
    new Contact($r('app.string.name\_xiaohong'), $r('app.media.ic\_contact')),
    new Contact($r('app.string.name\_xiaolan'), $r('app.media.ic\_contact')),
    new Contact($r('app.string.name\_xiaowang'), $r('app.media.ic\_contact')),
    new Contact($r('app.string.name\_xiaoli'), $r('app.media.ic\_contact')),
    new Contact($r('app.string.name\_xiaoming'), $r('app.media.ic\_contact'))
  \];
  ...
  build() {
    ...
    .backgroundColor('#f1f2f3')
    // 请将$r('app.string.ArcListContents\_title')替换为实际资源文件，在本示例中该资源文件的value值为"迭代弧形列表内容"
    .title($r('app.string.ArcListContents\_title'))
  }
}

**图2** 迭代弧形列表内容

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/II3B2rdNTyifSU4-wWg2Qg/zh-cn_image_0000002538178630.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=3E1EB2F0F4C9D2B45BDB08ECDC02E97F4B16C1B302E99797258BD9D34EACFC3E)
...
1.  首先，需要构造自定义标题组件customHeader。
    ...
    function customHeader() {
      Column() {
        Text($r('app.string.ArcListCrown\_set'))
          .fontColor('#FFFFFFFF')
          .fontSize('19fp')
      }
    }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/55/v3/0wXDRrTfS--zcfcyk68l0A/zh-cn_image_0000002569018419.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=9212FF5D5C13E6FF5F8E0871D9C88B20DBD36AD92E92FA5AC08EA5AD3FFD3AF5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b3/v3/p8JXfIJFSsueLgAcS6eJxA/zh-cn_image_0000002568898409.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=3A018877DA10911813E3095641EF8A7DAD21E74C5AAD7E31145F2745876397C2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/57/v3/U4thSuJ-SbK15lZC94GzUQ/zh-cn_image_0000002538018704.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=F53243A2CE8DF34A36095CB9F91A7CB8E16CF8FA4612F4835B5C676E507B5049)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dd/v3/PAeJhXU7TJmfrETQxf6iBw/zh-cn_image_0000002538178632.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=4BB265DF5A646F407C6DAF255F155C5E0310278492EB5B38353EE9FF62117D5B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/20/v3/Py01w8I8TYGvo9KFKqCkbA/zh-cn_image_0000002569018421.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=5FBC90A0852803B6EA5571208D252F3EC075BE4211C6475C7F1DF3DAB0F10321)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/tcykTXS7Rhi__QdnKmi9yg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=060F970BF4D8BDBFE54C7A0E4D8782AF99F861EE7B25A55406E7E436445B2FBE)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/1WzsrYdkSJaoZWzZ26sNgw/zh-cn_image_0000002568898411.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=4FDEB165DA78474EAB24D1831EDAD3314EE64E224045BA2D44725D23F698A221)
...
1.  首先，实现尾端滑出组件的构建。
    ...
    itemEnd(item: Contact) {
      ...
      Button({ type: ButtonType.Circle }) {
        Image($r('app.media.ic\_public\_delete\_filled'))
          .width(20)
          .height(20)
      }
      .width(20)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/59/v3/YlKeXgPyRr-HgFKW-RVHJA/zh-cn_image_0000002538018706.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=677724F6701AB51ACC4F721F248BFF11BBF387AA761288D34CD9C37C2FFF553A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a8/v3/P1QFlFcPQWmsqQQVcRhDHw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=C8632A651F5291B044715418F925B07420576504EC19B91398F9DF994961E195)
