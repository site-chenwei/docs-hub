...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-sheet-page"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "绑定模态页面"
  - "绑定半模态页面（bindSheet）"
captured_at: "2026-04-17T01:35:38.332Z"
---
...
struct SheetDemo {
  ...
  SheetBuilder() {
    Column() {
      ...
      // 请将$r('app.string.tSheetBuilder\_text1')替换为实际资源文件，在本示例中该资源文件的value值为"非滚动区域"
      Text($r('app.string.tSheetBuilder\_text1'))
        .width('100%')
    ...
    Column() {
      Button('Open Sheet').width('90%').height('80vp')
        ...
        .bindSheet($$this.isShowSheet, this.SheetBuilder(), {
          ...
          // 请将$r('app.string.tSheetBuilder\_text2')替换为实际资源文件，在本示例中该资源文件的value值为"嵌套滚动场景"
          title: { title: $r('app.string.tSheetBuilder\_text2') },
        })
    }.width('100%').height('100%')
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a4/v3/4wSZ7-8lQPevR7GJcyQ-KQ/zh-cn_image_0000002538018846.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=8812342DADA819EB02F3479C61D553418EBB4470EBEE29680A7400D9BF17C65F)

#### 二次确认能力

推荐使用onWillDismiss接口，此接口支持在回调中处理二次确认，或自定义关闭行为。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/89/v3/k_TKFEpWQyq7z86dqxrjHg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=7AE33223993BB012879929B568D7AA0C7167E61E50022482A959CC774D278763)

声明onWillDismiss接口后，半模态页面的所有关闭操作，包括侧滑、点击关闭按钮、点击蒙层和下拉关闭，都需通过调用dismiss方法来实现。若未实现此逻辑，半模态页面将无法响应上述关闭操作。

import { hilog } from '@kit.PerformanceAnalysisKit';

const TAG = '\[Sample\_SupportingAgingFriendly\]';
const DOMAIN = 0xF811;
const BUNDLE = 'SupportingAgingFriendly\_';

@Entry
@Component
struct OnWillDismiss\_Dismiss {
      ...
      .bindSheet($$this.isShow, this.myBuilder(), {
        ...
        onWillDismiss: ((dismissSheetAction: DismissSheetAction) => {
          ...
          this.getUIContext().showAlertDialog(
            {
              // 请将$r('app.string.bindContentCover\_label2')替换为实际资源文件，在本示例中该资源文件的value值为"示例2（自定义转场动画）"
              message: $r('app.string.bindContentCover\_label2'),
              autoCancel: true,
              ...
              cancel: () => {
                hilog.info(DOMAIN, TAG, BUNDLE + 'onWillDismiss\_Dismiss:' + 'AlertDialog Closed callbacks');
              }
            }
          )
        })
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/HzbwhD8XR7WaOaHqlds0Eg/zh-cn_image_0000002538178774.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=F95DD617C72372AE6C73C3B28522884BD6BAEA2DE1233BA70B0A55A63739A387)
...
struct SheetTransitionExample {
  ...
  @State hoverModeArea: HoverModeAreaType = HoverModeAreaType.TOP\_SCREEN;

  @Builder
  myBuilder() {
    Column() {
      // 请将$r('app.string.bindSheetCmd\_label10')替换为实际资源文件，在本示例中该资源文件的value值为"enableHoverMode切换"
      Button($r('app.string.bindSheetCmd\_label10'))
        .margin(10)
        .fontSize(20)
        .onClick(() => {
      ...
      // 请将$r('app.string.bindSheetCmd\_label11')替换为实际资源文件，在本示例中该资源文件的value值为"hoverModeArea切换"
      Button($r('app.string.bindSheetCmd\_label11'))
        .margin(10)
        .fontSize(20)
        .onClick(() => {
          this.hoverModeArea = this.hoverModeArea === HoverModeAreaType.TOP\_SCREEN ?
            HoverModeAreaType.BOTTOM\_SCREEN : HoverModeAreaType.TOP\_SCREEN;
        })
  ...
  build() {
    Column() {
      // 请将$r('app.string.bindSheetCmd\_label9')替换为实际资源文件，在本示例中该资源文件的value值为"拉起半模态"
      Button($r('app.string.bindSheetCmd\_label9'))
        .onClick(() => {
          this.isShow = true;
        })
        .fontSize(20)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/sNOtB6R1RouilzfJYxO7zA/zh-cn_image_0000002569018563.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=E516719C451380BF3711CEA389BE1A228A49E5E48665C7558B6A1064453D11DA)
