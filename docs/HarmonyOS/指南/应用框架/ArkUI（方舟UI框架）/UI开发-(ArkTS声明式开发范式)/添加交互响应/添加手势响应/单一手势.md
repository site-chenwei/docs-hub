---
title: "单一手势"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-gesture-events-single-gesture"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "添加手势响应"
  - "单一手势"
captured_at: "2026-04-17T01:35:38.619Z"
---
...
export struct OnClickGesture {
  ...
  build() {
    ...
    // 请将$r('app.string.singlegesture\_Index\_Click\_title')替换为实际资源文件，在本示例中该资源文件的value值为"点击事件"
    .title($r('app.string.singlegesture\_Index\_Click\_title'))
  }
}
...
export struct Tap {
  ...
  build() {
    ...
    .backgroundColor('#f1f2f3')
    // 请将$r('app.string.singlegesture\_TapGesture\_title')替换为实际资源文件，在本示例中该资源文件的value值为"点击手势"
    .title($r('app.string.singlegesture\_TapGesture\_title'))
  }
}

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/77/v3/4R2Qyi6DTBOV5GyaX3zhSw/zh-cn_image_0000002538018880.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=ABB67E7CDC7C3A1465EEFF49F678E253F33BB3EDB5B1736CAB8B8F307DCCC873)
...
export struct LongPress {
  ...
  build() {
    ...
    .backgroundColor('#f1f2f3')
    // 请将$r('app.string.singlegesture\_LongPressGesture\_title')替换为实际资源文件，在本示例中该资源文件的value值为"长按手势"
    .title($r('app.string.singlegesture\_LongPressGesture\_title'))
  }
}

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/34/v3/iGw_gbgLSMS2wEt2MjMEmA/zh-cn_image_0000002538178808.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=A2201E06604839FA014AE86460F22826305161C0C33CDDE679BCFCCAD917EC6F)
...
export struct VolumeControlDemo {
  ...
  private readonly MAX\_VOLUME: number = 100;
  private readonly MIN\_VOLUME: number = 0;
  ...
  private handleVolumeChange(delta: number) {
    this.currentVolume = Math.min(
      this.MAX\_VOLUME,
      Math.max(this.MIN\_VOLUME, this.currentVolume + delta)
    );
  }
  ...
  build() {
    ...
    .backgroundColor('#f1f2f3')
    // 请将$r('app.string.singlegesture\_Index\_Pancom\_title')替换为实际资源文件，在本示例中该资源文件的value值为"滑动手势"
    .title($r('app.string.singlegesture\_Index\_Pancom\_title'))
  }
}

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/WzuZ6YwfS9aby2WygBUXsw/zh-cn_image_0000002569018597.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=57CB9D67D8F3C65180ECAB497FB1A47654B89A2CFA6B1B68E3E4C75682BE8A36)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0c/v3/MZxWg7_QR3q55PVgFViWhw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=EF1704359B144D241349613710060BFBD81295053945C08E13760B6129A09954)
...
export struct Pinch {
  ...
  build() {
    ...
    .backgroundColor('#f1f2f3')
    // 请将$r('app.string.singlegesture\_PinchGesture\_title')替换为实际资源文件，在本示例中该资源文件的value值为"捏合手势"
    .title($r('app.string.singlegesture\_PinchGesture\_title'))
  }
}

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/33/v3/K4UtE7B_QgmBzMonDopeRQ/zh-cn_image_0000002568898587.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=96D41A1497385E9DE2396D114C356C4D8DF500512741A8990E8D7F7C09382A3B)
...
export struct Rotation {
  ...
  build() {
    ...
    .backgroundColor('#f1f2f3')
    // 请将$r('app.string.singlegesture\_RotationGesture\_title')替换为实际资源文件，在本示例中该资源文件的value值为"旋转手势"
    .title($r('app.string.singlegesture\_RotationGesture\_title'))
  }
}

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bd/v3/GRSABrS3Q2i72r3qzqbi8A/zh-cn_image_0000002538018882.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=2746F3D97AD6B9B9DAD5C2ED92BF401EB23EB33FF3F9440BD17EF0EDC3B1EC7C)
...
export struct Swipe {
  ...
  build() {
    ...
    .backgroundColor('#f1f2f3')
    // 请将$r('app.string.singlegesture\_SwipeGesture\_title')替换为实际资源文件，在本示例中该资源文件的value值为"快滑手势"
    .title($r('app.string.singlegesture\_SwipeGesture\_title'))
  }
}

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d4/v3/pl90IvgQSFW8Y87IzWVPSA/zh-cn_image_0000002538178810.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=4D20809C21AE2F5427BBADDE15FA172B70D34B0B2D001D2CE06F62C078677813)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/x2uzMWdvRz2DUZQRk26w0w/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=A84ADC9CE230282BD52A66BB63047CEDBF68C303B5B6608AF41E3CDBC9502559)
