---
title: "交互基础机制说明"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-interaction-basic-principles"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "添加交互响应"
  - "交互基础机制说明"
captured_at: "2026-04-17T01:35:38.483Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/vJPywFBCR2-KVUcrgdqL7w/zh-cn_image_0000002569018577.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=0EE02C7AC427A1652F10BC40F6AAFFE2F8F10FDF2C5D02543EEDCF737DCF85B1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d2/v3/PN9EGUxDTK-Oa7E6DwIR5g/zh-cn_image_0000002568898567.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=DCD442D70DF240BD66F6C290ACD421D7D524DCD6D24ED0095975C562236FA5C3)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/47/v3/9UHdYahES8isJSeJzhg67g/zh-cn_image_0000002538018862.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=4F4199D9E1C51B568CDC851F1DC11C0F15239EB03BD3D3E1F8BF2BA5B109EA36)
...
| 干预方式 | 功能描述 | 对应接口 | 说明 |
| :-- | :-- | :-- | :-- |
| 触摸热区设置 | 设置组件能够响应用户交互的热区范围。 | [responseRegion](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-touch-target#responseregion) | 
1.热区会被用来识别用户手指落下的位置是否在热区范围内，只有在范围内的才会被收集；

2\. 热区也会影响一些手势的判定，比如点击，只有当在热区范围抬手时才会被触发。

 |
| 触摸热区设置 | 设置组件能够响应鼠标交互的热区范围。 | [mouseResponseRegion](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-touch-target#mouseresponseregion10) | 

设置一个或多个鼠标触摸热区。功能与responseRegion类似，但仅对鼠标事件生效。

 |
| 触摸热区设置 | 设置组件的触摸热区列表。 | [responseRegionList](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-touch-target#responseregionlist22) | 
...
| 自定义事件拦截 | 干预自身及其他组件收集结果。 | [onTouchIntercept](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-on-touch-intercept#ontouchintercept) | 
...
1.  触摸热区设置
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/57/v3/IzWscUygRhSnY5h40KQIyw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=233E6F01CDF9EE381EB7668E97CD1A7E990B48E80C37F7E9411C5AF4E3F8731D)
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d/v3/uMqdYNIrTwqPKB98gQSs_A/zh-cn_image_0000002538178790.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=C9FD4F9CF50A2BC29476589F05816C378BC8C444B9A1CDE4303BEFF111440947)
...
2.  触摸测试控制
    ...
    -   HitTestMode.Default：默认不配hitTestBehavior属性，自身如果命中会阻塞兄弟组件，但是不阻塞子组件。
        ...
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c0/v3/cj74nLFlQ-eEjALAbTr_fw/zh-cn_image_0000002569018579.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=5B4B1C5A5F2FE8691E667F2D0F7BCE9070E9F68C35F759B5EEDD5D760957C540)
        
    -   HitTestMode.None：自身不接收事件，但不会阻塞兄弟组件或子组件继续做触摸测试。
        
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fd/v3/PLi-cr9ERWGJxq6oeyzHag/zh-cn_image_0000002568898569.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=E1EF73B62472A05D2AD4AA4193EFB61D03280E55A9F01BFBC7C1E09FEFE722F2)
        
    -   HitTestMode.Block：阻塞子组件的触摸测试，如果自身触摸测试命中，会阻塞兄弟组件及父组件的触摸测试。
        
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d4/v3/OR4VWGMIToSKsROuLUitJA/zh-cn_image_0000002538018864.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=532A786CFC2C1D34B56F57A235AB7A47A0137CF221CBE3A2445A081A35399275)
        
    -   HitTestMode.Transparent：自身进行触摸测试，同时不阻塞兄弟组件及父组件。
        
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/88/v3/DcV18V_wRXeeMdEfDWo6ww/zh-cn_image_0000002538178792.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=6D91FA249590A20F5A68D9A4EEC134688058499D901CDC0889585A160C4FCDF4)
        
    -   HitTestMode.BLOCK\_HIERARCHY（从API version 20开始支持）: 自身和子节点响应触摸测试，阻止所有优先级较低的兄弟节点和父节点参与触摸测试。
        
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d/v3/ydZGJe9AS0GuV6IbD7PiOQ/zh-cn_image_0000002569018581.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=497365F4ECFBEB724DE575EDAA23C2FECBBB87374DD57A23237141D4CB92EA52)
        
    -   HitTestMode.BLOCK\_DESCENDANTS（从API version 20开始支持）: 自身不响应触摸测试，并且所有的后代（孩子，孙子等）也不响应触摸测试，不会影响祖先节点的触摸测试。
        
        ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7d/v3/0M7w_4v3QYacMbHIi1oT0Q/zh-cn_image_0000002568898571.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=F9CED6D66D33CA63CFF6756C9B8A0A74DE5A1B73EB652C9897BF7EC9EE2221C7)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3d/v3/-7yuXBSSQq2y2pO9T1G9bQ/zh-cn_image_0000002538018866.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=8587CC724C719277D26BB95D4CE89D411D3FE2E6CE3D3707A69EC21B03C8E68B)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c2/v3/PxeFJMzYTO2hKL2qtCILcw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=0D2F5585F8504244C5E0E070ACDE1476965A2B112D1B2F7C5F7FCD54978D7F55)
