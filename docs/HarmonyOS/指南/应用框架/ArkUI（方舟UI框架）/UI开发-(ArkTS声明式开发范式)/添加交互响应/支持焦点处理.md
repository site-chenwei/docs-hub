---
title: "支持焦点处理"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-common-events-focus-event"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "添加交互响应"
  - "支持焦点处理"
captured_at: "2026-04-17T01:35:38.735Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/s7jCgddMSEmqGqh2gX11tg/zh-cn_image_0000002538018892.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=2C17BB871337F3202C5BA8A8E518673DC324DCE91CF64C1892AD33BC16972A86)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9b/v3/3YLmMTNpRMyAQzjbpcpSFw/zh-cn_image_0000002538178820.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=B40951FA0E5EF1CDF8ACD63799539FA514AD2F7B8773D13C2812AA7E9DAB58C8)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/be/v3/-4hwJQaITbKWUjlX0YOxkw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=F139636B12C6EA0046DEDAF62B6172D9EAE7CA5183F670E638206AA7F88F54ED)
        ...
        Row() {
          Column() {
            Button('Button 1')
              .margin(20)
              .onClick(() => {
                // 请将$r('app.string.Focus\_Event')替换为实际资源文件，在本示例中该资源文件的value值为"获焦信息"
                this.logText = this.context!.resourceManager.getStringSync($r('app.string.Focus\_Event').id) + '：\\n';
        ...
        Column() {
          Row() {
            Button('Button 2')
              .margin(20)
              .onFocus(() => {
                // 请将$r('app.string.Get\_Focus')替换为实际资源文件，在本示例中该资源文件的value值为"获得焦点"
                this.addText('Button 2' + this.context!.resourceManager.getStringSync($r('app.string.Get\_Focus').id));
              })
            Button('button 3')
              .margin(20)
              .onFocus(() => {
                // 请将$r('app.string.Get\_Focus')替换为实际资源文件，在本示例中该资源文件的value值为"获得焦点"
                this.addText('Button 3' + this.context!.resourceManager.getStringSync($r('app.string.Get\_Focus').id));
              })
          }
          .id('Row 2')
          .onFocus(() => {
            // 请将$r('app.string.Get\_Focus')替换为实际资源文件，在本示例中该资源文件的value值为"获得焦点"
            this.addText('Row 2' + this.context!.resourceManager.getStringSync($r('app.string.Get\_Focus').id));
          })
        }
        .onFocus(() => {
          // 请将$r('app.string.Get\_Focus')替换为实际资源文件，在本示例中该资源文件的value值为"获得焦点"
          this.addText('Column 2' + this.context!.resourceManager.getStringSync($r('app.string.Get\_Focus').id));
        })
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/46/v3/NlEoq2x3RMa4onoR5UD0kQ/zh-cn_image_0000002569018609.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=B05C2E5EEF4A515387A5BCA10D47C5BA692AEDBE5E39FBEEC34C17B448607A78)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d1/v3/9zLdRyXVQCe6AH03kyutHA/zh-cn_image_0000002568898599.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=239EB5F77691CB5AFFC57AB54CCF1FE2D423BFD28D729A8E59E2494A270A61D4)

方向键上下走焦：纵向的Column容器中，可以使用上下键走焦，无法使用左右键走焦。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ad/v3/rjFK9q7bSsKLqJG1dSKeWw/zh-cn_image_0000002538018894.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=7795474D8197EA2E6648B7AD7D98B0247B929EDE4A2C1DBE8A4FBE18A1FE396F)

横向的Row容器中，可以使用左右键走焦，无法使用上下键走焦。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4a/v3/tWhN2Kb3SQWeNe7Ne4OPJw/zh-cn_image_0000002538178822.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=EC1700175A05630BC3C3EF0338B2712BC5E3AE67700472FF1214B369796B783E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/XBHqWw_DTKWCmdEiTCyTIQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=3C104F51D944659E873B21F2AA7C083EF7C8732194A644A733BBE6B83810CEDF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f1/v3/qJjaYRhQQruvJuybaN5cyg/zh-cn_image_0000002569018611.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=157B12EEFE92E261386570967AC328C6646277819B7405416BD14CE24637ABB6)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/75/v3/LtwYNmiqRzm6zFkjo41C6g/zh-cn_image_0000002568898601.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=9E11A985461FA30021F81B973BCF4B231DBD8B3EF7112F1E86081810053179F0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/55/v3/2ZNov0LgTu-GgLwGbZDMag/zh-cn_image_0000002538018896.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=F21A0797A73AC77D43F69370AD3E63019A4CE202A4B1224728A69C874848A44C)
...
const TAG = '\[Sample\_FocusAndBlurExample\]';
const DOMAIN = 0xF811;
const BUNDLE = 'MyApp\_FocusAndBlurExample';
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/ViBajwS8RPSHIHTN-IIdpQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=62E8078AEE329E562B41F0364CD51E7B5B00F14062DF688CDA5C1812968AEDC0)
...
export struct FocusableExample {
  ...
  build() {
    NavDestination() {
      Column({ space: 12 }) {
        // 请将$r('app.string.Focus\_Focusable\_text')替换为实际资源文件，在本示例中该资源文件的value值为"当某组件处于获焦状态"
        Text($r('app.string.Focus\_Focusable\_text'))
          .fontSize(14)
          .fontColor('#666')
        Column({ space: 5 }) {
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/BLr6Z3o8Txuk9TZ1pmdAZQ/zh-cn_image_0000002538178824.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=9F45ED7AFEF3DE8860FBB67EA4B75088CE6637394B63ED7E15DB97BAFB8BADFF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/24/v3/lQgf16iTSP6qnTJBrhckUQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=77B01DB71E9AABC321DF9D6D2BA3D5F120CCDEA31CDD6DA37B77FA61B9034FA9)
...
export struct ScopeFocusExample {
  ...
  build() {
    NavDestination() {
      Column() {
        Column({ space: 5 }) {
          // 请将$r('app.string.Container\_Coking')替换为实际资源文件，在本示例中该资源文件的value值为"容器获焦"
          Text($r('app.string.Container\_Coking')).textAlign(TextAlign.Center)
        }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/5etj1xckRw2lRKZ_Lecnpg/zh-cn_image_0000002569018613.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=B8D500CDBAD62114C94F238E43E6E6F1693AEED503E8E04C9C5299386AC11AC3)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a9/v3/DifA6RIpS5uwH7po6gPljQ/zh-cn_image_0000002568898603.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=1C1698A40956C2F14287FDEF2F8417741EC91F22D0717DBDEC2DC04DA9C33519)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/ZCys-xSCSzenFm2I8YbFhA/zh-cn_image_0000002538018898.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=B4AE9E46668EFE75EF63D4622301EF6E448D3822CC789911C45951C04A837DAC)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/89/v3/RgM98udaRgalFf5gKHRNnQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=3FC4CC78548AF00FE825734F41F91BE239AF0DD7DADD495067FBB06B75BE1EE4)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e7/v3/toXkEDDwQaeZQUnFaQAJjw/zh-cn_image_0000002538178826.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=D7295EAE17CEA41BD438C8F8C48DD8301602920D1BC1BF597FC07D35330EF06F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/da/v3/HlBEUC--TiekJnN792HF1w/zh-cn_image_0000002569018615.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=DD63EB99BFDE62C30C6303254E3177BC5F624BE2E860E5FDFBA40665209F6ED7)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a1/v3/Bu-ing_uT_Otu7y-bETq4Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013539Z&HW-CC-Expire=86400&HW-CC-Sign=942E1B35B0B342547B395B026D50A532A98B3E4725C90CEFA380CAAB1D02F3AD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1