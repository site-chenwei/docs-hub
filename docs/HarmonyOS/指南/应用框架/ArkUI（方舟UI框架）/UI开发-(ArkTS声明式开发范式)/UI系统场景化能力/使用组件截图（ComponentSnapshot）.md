...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-uicontext-component-snapshot"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
...
captured_at: "2026-04-17T01:35:39.509Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/99/v3/6NinlGKxRfCG_LCM7uhg_g/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=69D06BDBE1AC88219E5E0921535902FDBAF01AF225BFE8CDD83F966F768E3BA9)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a7/v3/Z8G_P3bMT2m8o6x2m3-g8Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=B08279EFB5F1BA41E382359E690747829B05C6D7D4514D6CA97D419BC6C5AF9D)
...
async scrollSnapAndMerge() {
  try {
    ...
    const pixelMap = await this.getUIContext().getComponentSnapshot().get(LIST\_ID);
    // 获取位图像素字节，并保存在数组中
...
async saveSnapshot(result: SaveButtonOnClickResult): Promise<void> {
  try {
    if (result === SaveButtonOnClickResult.SUCCESS) {
      ...
      const file = await fileIo.open(uri, fileIo.OpenMode.READ\_WRITE | fileIo.OpenMode.CREATE);
      ...
      imagePackerApi.packToData(this.mergedImage, packOpts).then((data) => {
        ...
        this.getUIContext().getPromptAction().showToast({
          // 请将$r('app.string.save\_album\_success')替换为实际资源文件，在本示例中该资源文件的value值为"Saved to album"
          message: $r('app.string.save\_album\_success'),
          duration: 1800
        })
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/49/v3/nPsOc7n-TVGZ17XGuZ1P-w/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=30C1786416DB1143DF819C2ABEBD9BA4FF3BDD6BB05542BBB9426CC43CC349D9)
