...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-navigation-cross-package"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "组件导航(Navigation) (推荐)"
  - "Navigation跨包路由"
captured_at: "2026-04-17T01:35:37.297Z"
---
...
2.  添加完路由配置文件地址后，在工程resources/base/profile路径下创建router\_map.json文件。添加如下配置信息，各字段含义详见[routerMap标签](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/module-configuration-file#routermap标签)。
...
3.  编译构建。
    ...
    **图1** HSP、HAR编译产物示意图
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cc/v3/K9VkNnbSRtWIHCM7RYc4jQ/zh-cn_image_0000002569018321.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=60D4C94EBE69274F0E89E5079C8F0C995F4D446397265C0AAEEE9A294E642D24)
    ...
    **图2** Navigation跨包跳转示例
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/27/v3/aVOF7-i9QeOlV3AeQmws6A/zh-cn_image_0000002568898313.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=81F9F749648015F0E10A4CEC50F05D99878FE5BE1953559BC0CF19CDBD336A52)
