...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-routing"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
...
captured_at: "2026-04-17T01:35:37.357Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/aa/v3/eapLlKynTZa-ebNzDJULag/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=FC28FD177590B0D9C86074FC365088AD3BFC51FC5E2AB1077C27622FA5DB3CD4)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9b/v3/l3URxuj1S3W4dh7nGnXmRQ/zh-cn_image_0000002569018327.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=0EB320DFD3B2D232779D3F50C5D3320461096F7B0DDF3A7212E0B8E4BC028972)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1c/v3/HDfVC0zWS4imm8oKy0Jwaw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=75C4D5DCF1940152CD6D124A423E1F6880E839DB985DA87C3F1D4526ABDF881B)
...
-   场景一：有一个主页（Home）和一个详情页（Detail），希望从主页点击一个商品，跳转到详情页。同时，需要保留主页在页面栈中，以便返回时恢复状态。这种场景下，可以使用pushUrl方法，并且使用Standard实例模式（或者省略）。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c5/v3/hx_YKWfRS2SlL8_T4NfkLw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=1972B22E306A415490C93375B4DDF691CB20BE5D851338285DE33FCE5F3C5778)
...
-   场景二：有一个登录页（Login）和一个个人中心页（Profile），希望从登录页成功登录后，跳转到个人中心页。同时，销毁登录页，在返回时直接退出应用。这种场景下，可以使用replaceUrl方法，并且使用Standard实例模式（或者省略）。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/23/v3/pB8_WvHxRpiwFcqQSigFtQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=0ACB1EABAA3ADAAD18870453D003D304A873BE175E3040B5AFBA13688EB564A3)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/66/v3/Ee0yGjyxRR25lS0ABrRNCw/zh-cn_image_0000002568898319.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=D86DB267F28A8E49B70B6499C8C4FCC8BC534F151856A7BFCCCE4F621E92E13C)
...
-   方式三：返回到指定页面，并传递自定义参数信息。
    ...
    this.getUIContext().getRouter().back({
      url: 'pages/pageRouter/jumpPage/BackHome',
      params: {
        // 请将$r('app.string.pageRouter\_jump\_text7\_fromHome')替换为实际资源文件，在本示例中该资源文件的value值为"来自Home页"
        info: $r('app.string.pageRouter\_jump\_text7\_fromHome')
      }
    });
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/21/v3/utjO1VggTI2GmrYXTFNN9Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=7D34B24E12A99A465EC7BEE42C800F3AE88E7654F8192224AFAA30530DFE40CB)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/-9ZwbW1HTl2NGY7zjLb4tg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=B55546A840BB394AB27CE3BC04BCED3D5D8E4BC4CBE7B60A6C168DB7BF6E7CA5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/N8uLuqB1Q_SMWUNCd2Uxxw/zh-cn_image_0000002538018614.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=878744550DD5640AC9B8F4AE7B3F25B85A35B1B2C96E9143937E149BE8890C2F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/IYJPSU6YSbqRPNskdU1OIg/zh-cn_image_0000002538178540.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=22592EBE7227B00A9F0772467DB6EA41CC23CAAAB408BF97EC029700BC98EECE)
...
onBackClick(): void {
  ...
  try {
    this.getUIContext().getRouter().showAlertBeforeBackPage({
      // 请在resources\\base\\element\\string.json文件中配置name为'pageRouter\_dialog\_context'，value为非空字符串的资源
      message: this.getUIContext().getHostContext()?.resourceManager.getStringByNameSync('pageRouter\_dialog\_context') as string, // 设置询问框的内容
    });
  } catch (err) {
...
onBackClick() {
  ...
  this.getUIContext().getPromptAction().showDialog({
    // 您还没有完成支付，确定要返回吗？
    // 请将$r('app.string.pageRouter\_dialog\_context')替换为实际资源文件，在本示例中该资源文件的value值为"您还没有完成支付，确定要返回吗？"
    message: $r('app.string.pageRouter\_dialog\_context'),
    buttons: \[
      {
        // 请将$r('app.string.pageRouter\_dialog\_canceled')替换为实际资源文件，在本示例中该资源文件的value值为"取消"
        text: $r('app.string.pageRouter\_dialog\_canceled'),
        color: '#FF0000'
      },
      {
        // 请将$r('app.string.pageRouter\_dialog\_confirmed')替换为实际资源文件，在本示例中该资源文件的value值为"确认"
        text: $r('app.string.pageRouter\_dialog\_confirmed'),
        color: '#0099FF'
      }
    \]
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ff/v3/pI2OdppjQ8KDpI-3xVaKKg/zh-cn_image_0000002569018329.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=0C6675B96360F0CF51D1B596ABB2E159858B42114E7B683196D26D7DDC0A6701)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/39/v3/oGglTMUdR7CxFKa_lw7GEA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=9DE31BE0E4D732EE43BC2546E6D234A95121A11E3AA394937BD9D41936C35AE6)
