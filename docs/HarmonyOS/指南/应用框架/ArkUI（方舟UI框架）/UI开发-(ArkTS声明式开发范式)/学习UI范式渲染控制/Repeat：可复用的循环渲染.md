...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-rendering-control-repeat"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "学习UI范式渲染控制"
  - "Repeat：可复用的循环渲染"
captured_at: "2026-04-17T01:35:37.180Z"
---

# Repeat：可复用的循环渲染

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2f/v3/Rw-KNdd-QF25RT__x4HCKg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=56E09EE0D1516054ED15365A23B1938B6C9830A7B020DF209CE532D5A1D7AE16)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/55/v3/TBFOnP6LS-2-5lAgo_Ffsw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=097F95E02CA0ECC2196703AFE92A454EA588EC0FBF6827619AF0D716BE049DFA)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/47/v3/nMzRh6LiSpaVCQCADV4VTg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=92612C6FF7EE99842BCCFD72209EB8083C3A507C2E691B35849D74CA0F813B83)
...
struct RepeatExample {
  ...
  aboutToAppear(): void {
    for (let i = 0; i < 50; i++) {
      this.dataArr.push(\`data\_${i}\`); // 为数组添加一些数据
    }
  }
      ...
      List() {
        Repeat<string>(this.dataArr)
          .each((ri: RepeatItem<string>) => {
            ListItem() {
              Text('each\_' + ri.item).fontSize(30)
            }
          })
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7f/v3/1ZWL53zpSqyP8z9c2hE8NQ/zh-cn_image_0000002538178512.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=48BCD3CC5684B2C3243A1139E3B57FC043643CB19982DAAC1DF2E8630C247133)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/qj7f5lezQWCna6qdIJMoxQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=1CBB86A18CE42D4392F2549AD01A7AAA7515A08E2C640E66CF48C23269C5198C)
      ...
      List() {
        Repeat<string>(this.dataArr)
          .each((ri: RepeatItem<string>) => { // 默认渲染模板
            ListItem() {
              Text('each\_' + ri.item).fontSize(30).fontColor('rgb(161,10,33)') // 文本颜色为红色
            }
          })
          ...
          .template('A', (ri: RepeatItem<string>) => { // 'A'模板
            ListItem() {
              Text('A\_' + ri.item).fontSize(30).fontColor('rgb(23,169,141)') // 文本颜色为绿色
            }
          }, { cachedCount: 3 }) // 'A'模板的缓存列表容量为3
          .template('B', (ri: RepeatItem<string>) => { // 'B'模板
            ListItem() {
              Text('B\_' + ri.item).fontSize(30).fontColor('rgb(39,135,217)') // 文本颜色为蓝色
            }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/aPBRBqM5S7ODIlk_Jirlqg/zh-cn_image_0000002569018301.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=E8ADF9663F031533C774D4EA3FB95B3B638ACB552ECC6DB271D166B7CDF549C4)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/16/v3/34xrtYJ8Qmugc1SKQRPBfg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=851518732A51B57DCADCEFE71F873F0738232455C3E391D421472966E81330BC)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/16/v3/KXvi3x62QFyOJbZuHnZcIQ/zh-cn_image_0000002568898293.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=430914AE01CAA85745068B830F37FD01A073E1E2A7967A558C37C1BF40A703C3)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2c/v3/_2EZqiiFRuKN015u4k78Wg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=8C193314A6AF7E7143A97E224DC747EE1C5409DE538230CE66404C4AC48ED6D3)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a4/v3/Ss9mVh5NRDi8RznWdHaKRw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=F1F0F34B0BFE09A69275ACBC8A1212CABEDD26F5BCD885E4436708A73CF496AF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c0/v3/6iH8-x6URWSwQTw_Yvya-g/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=AC5A66B027C8E66E02EEAAE6D6C0C71CF7731B5D95C92EE2EF99D551BB234027)
...
1.  首次渲染。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bd/v3/elnc_cTWSv2hOoHiKaavrg/zh-cn_image_0000002538018586.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=A57A52DC5988412876A806AABF5FE0EA2D7AFD2DBF611B122D7BA580C8F726EB)
...
2.  滑动场景。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1c/v3/_HGqd9pzQZuliViclhzfvQ/zh-cn_image_0000002538178514.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=FA940FCD8C79DFB71014AAAC6E3CDFCAA15BC521B16CECD5B73E1A9491A88249)
...
3.  数据更新场景。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bc/v3/scodzvLDRpOoICS3DM_HxQ/zh-cn_image_0000002569018303.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=C0F482EF3DCD41D9C8F648734B3EDE1AD6DF855E3A5338D6A5E4C66325DC54D1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cb/v3/hnzVjPuYSu-XhALmZSeu2A/zh-cn_image_0000002568898295.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=60214FBED6AE1E1ACB0AEEF2BAE55C6FA46DBB501A7D9870E553D20F84202BFA)

以下图中的数组变化为例，图中的item\_X表示数据项的键值key。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bd/v3/6kYJZERmSBqz4TXp_4fTCA/zh-cn_image_0000002538018588.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=53CAA3EEDF2156B9A08582D2CFF1686272D3A1B7D01CDDA9516B4F61154594EB)

根据上述判断逻辑：item\_0没有变化，item\_1和item\_2只更新了索引，item\_n1和item\_n2分别由item\_4和item\_3进行节点更新获得，item\_n3为新创建的节点。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/99/v3/_Xviseu0SdyLMWt05iJlQQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=8571449F7A2DA4211F04A3242DD667155EAAAD1F79F2B1634A76886D035B8542)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d0/v3/Z3-3t4syTZWEKiPbhLyLqA/zh-cn_image_0000002569018283.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=88032D87A9D1AFDC0CEF9B80340489EBBBA913F1A8A003248846D2340399F0CD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/47/v3/hTWhKl8fR_ahDI5zp2_KXg/zh-cn_image_0000002538178516.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=12FED266C0E1F12D3B66B6DD19BD74EA9D73B4734B7A56148CAC3AF8B8D10C82)
      ...
      List({ scroller: this.scroller, space: 5, initialIndex: 100 }) {
        Repeat(this.arr)
          ...
          .each((obj: RepeatItem<string>) => {
            ListItem() {
              Row({ space: 5 }) {
                Text(\`${obj.index}: Item\_${obj.item}\`)
              }
            }
            .height(50)
          })
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/71/v3/WXkcDUbCRc-Yv4AVtzvx3A/zh-cn_image_0000002569018305.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=C237E29E7C4B9BE4A35BD8F8376F80DC973AF3D93056B0959F494A9DEE5BE8AB)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/iUrs3ns5Qo24bByyI3IK0g/zh-cn_image_0000002568898297.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=D28F4541D84466B8FD188E790EB94138F87F1616F4C2E461FEE1A6C8DE2D22BF)

**示例3**

使用数据懒加载，并配合设置onTotalCount: () => { return this.arr.length + 1; }，可实现数据无限懒加载。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/ZdbLx0DmT_qYNM9gF26SDw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=31677CA0DC4593FF1D1E4CE685C04ABEF7B1566AD08FA4A860B65677581D3942)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/wY5iiAA9QVWWo16_uRxtCw/zh-cn_image_0000002538018590.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=A9AD362EEA23B470BE9B11E262A3222620AE6EE6B74FD7A298DCEFCE95AA8732)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4c/v3/Wy_HHfqWQriBD6Owz-aDtg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=CB1D6B662C34A4B194EE3402AFA45A376A9C9072324DECA3766202D004F8C069)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/15/v3/z9j00FT9QF-SJ8tPLyxEkA/zh-cn_image_0000002538178518.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=E85FB1DAA74692034557AE771D222A6AA60EE8CCA6442450DF9DD97CBEA72E5F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/AmkpC0cyT1WIAJdxHQjeag/zh-cn_image_0000002569018307.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=AFF97B2DA008DAB36F663D40977D9A24A2589B09A10064BC0A2A90BA84715D1F)
...
struct RepeatVirtualScroll {
  ...
  aboutToAppear(): void {
    for (let i = 0; i < 100; i++) {
      this.simpleList.push(new Repeat006Clazz(\`item\_${i}\`));
    }
    ...
    Column({ space: 10 }) {
      ...
      Row({ space: 5 }) {
        Button('Add No.' + this.selectIdx)
          .onClick(() => {
            this.simpleList.splice(this.selectIdx, 0, new Repeat006Clazz(\`${this.counter++}\_add\_item\`));
            this.reloadSelectOptions();
          })
        Button('Modify No.' + this.selectIdx)
          .onClick(() => {
            this.simpleList.splice(this.selectIdx, 1, new Repeat006Clazz(\`${this.counter++}\_modify\_item\`));
          })
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/db/v3/5SjlJrRDTZusILTrwwqYSg/zh-cn_image_0000002568898299.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=29A00992202490C94EB7FBF11C07B6AACD714548C14B8A5B66254D6872AF7A9C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/aa/v3/UfJ3IM_EQB6YBAwLDoywBw/zh-cn_image_0000002538018592.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=0DD6E0F8EE8E4FC56CAD486D88B2E11E67FC019A9F74C0C224A56F564FB68784)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b5/v3/sjU3CwfcT6ip2l1yBEMJmQ/zh-cn_image_0000002538178520.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=154E98E0BAF88E44E12AD59C12FDC3179057D9C32AC1A1A8B8FDF9A2FE7E0A7E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/28/v3/il5uctEqQfqjZXnVs60o_Q/zh-cn_image_0000002569018309.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=99DCF938863CE672B817A8F1A035B6238EC9498C4B16AB47F10870F09EEE619B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/84/v3/eArj6eHITpmNMrQRtn_afg/zh-cn_image_0000002568898301.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=8806572D41475689F3CBC12A404A14D00ACDAAD481A15633605A148D63614FEF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0f/v3/AQp5yy8WTy--OPYBvxLQlQ/zh-cn_image_0000002538018594.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=01A606A815CB5A566D4A3CA6950E3F4CDDACFF8AFDEBBF4817B93244722F0068)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/52/v3/QRqGsY4ES6Wa7eSSKflelA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=8CA4238705409255BC3681DBE2269D70DBE0F61C9D7E7555774F9CC2D483D699)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2a/v3/Rz3sjDBVRcy_vNBdsvyjbQ/zh-cn_image_0000002538178522.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=F21125A7CA834ED9B55F3833DD65F4BBC679380779D969044C16507B22BB848F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f9/v3/I2uJo0ycT_aLzfp1LzVvxw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=ACEC67FFB4B462C551B3898A07C681235B53A08BEA2E650BFAE84599E6D46458)
    ...
    Column({ space: 3 }) {
      ...
      .onScrollIndex((start, end) => {
        ...
        if (this.vehicleItems.length < 50) {
          for (let i = 0; i < 10; i++) {
            if (this.vehicleItems.length < 50) {
              this.vehicleItems.push(new VehicleData('Vehicle\_loaded', i));
            }
          }
        }
      })
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4e/v3/D4gyewfQQnOBFvcQ6Q22qw/zh-cn_image_0000002569018311.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=6B82439F78F193FCF4B52560175454B48081185BCA06555186B8F8B4168767F6)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4c/v3/CnGJOd-WRIqIC6EFNZ0yPw/zh-cn_image_0000002568898303.png?HW-CC-KV=V1&HW-CC-Date=20260417T013538Z&HW-CC-Expire=86400&HW-CC-Sign=46734136EC3A46842C0B4F3BEBC9825209AB6F8ACCB69315A54C8FFE06AD379C)
