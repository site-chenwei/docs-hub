...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-user-defined-arktsnode-buildernode"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
...
captured_at: "2026-04-17T01:35:39.233Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/hALcHp9dQO21HBHIYEPOGw/zh-cn_image_0000002569018649.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=A09ACF927EE7BAD3C516E9816CAD232C815A7652FE96ED5976ADABFABCF0E464)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/95/v3/VeAWst39Rrm6By1AWzb9RQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=52781B9D7543EFAC7CEEC21C555E99E47FEA19008777051BDC52F28C3D86BA91)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d7/v3/emPwRyZXSf2HUDb74usQpg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=EFF8861E2893735E58A6B77BF10F25BF2CE70577E2C9B517DF2607630C58C91D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/N4bTKYBvT9mi4iU_ecPldA/zh-cn_image_0000002568898639.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=DA5E4BE15B60CEB036556D8FF141BE12E6DD1EA6ECDB1C43CCD8EAC9BD4C2347)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/60/v3/JLFe7ZnYRxOnsVRC8BAv8Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=2A97C4DDBC23161935BA3C42FF59C22FC335D6B3053C55944E05145FE5349E72)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b7/v3/y0NT2H9cTDGUFIYgiWz8rQ/zh-cn_image_0000002538018934.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=1E17BEB75319F00C622EB18D090C132D9EE13F2F7633BE152F0C1D04969C59AA)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/8a4K8cpqSoumpNxdlwemVw/zh-cn_image_0000002538178862.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=5AB5D2AF74EACC6D8A2F919DBDA882809A606B5DB703188358B581E180036F94)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/28/v3/dhmusyTbSyW0xhNggmKhtQ/zh-cn_image_0000002569018651.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=65247A0C37662ECDCB8DC9A1A3F229FA85A26D7CDC99AA41472CDFAB79F1BAA0)
...
@Builder
function buildGreenColumn() {
  // 给自定义组件设置属性生成\_\_Common\_\_节点，Builder根节点为\_\_Common\_\_节点，不会生成BuilderProxyNode。
  GreenColumnComponent()
    .hitTestBehavior(HitTestMode.Transparent)
}
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/70/v3/8XjIOaVtTbSjjY1HrMejQg/zh-cn_image_0000002568898641.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=12D7FB1883C21AB10576F3E93C0EE8B4055DAC2C730AE49D202B1E310233F7C8)

import { FrameNode, NodeController, BuilderNode, UIContext } from '@kit.ArkUI';
import { hilog } from '@kit.PerformanceAnalysisKit';

const TEST\_TAG: string = 'Reuse+Recycle';
...
struct ReusableChildComponent {
  ...
  aboutToRecycle(): void {
    hilog.info(0xF811,'testTag','%{public}s',\`${TEST\_TAG} ReusableChildComponent aboutToRecycle ${this.item}\`);
  ...
  aboutToReuse(params: object): void {
    hilog.info(0xF811,'testTag','%{public}s',\`${TEST\_TAG} ReusableChildComponent aboutToReuse ${JSON.stringify(params)}\`);
...
struct ChildComponent2 {
  ...
  aboutToReuse(params: Record<string, object>) {
    hilog.info(0xF811,'testTag','%{public}s',\`${TEST\_TAG} ChildComponent2 aboutToReuse ${JSON.stringify(params)}\`);
  }

  aboutToRecycle(): void {
    hilog.info(0xF811,'testTag','%{public}s',\`${TEST\_TAG} ChildComponent2 aboutToRecycle ${this.item}\`);
  }
...
struct ChildComponent3 {
  ...
  aboutToReuse(params: Record<string, object>) {
    hilog.info(0xF811,'testTag','%{public}s',\`${TEST\_TAG} ChildComponent3 aboutToReuse ${JSON.stringify(params)}\`);
  }

  aboutToRecycle(): void {
    hilog.info(0xF811,'testTag','%{public}s',\`${TEST\_TAG} ChildComponent3 aboutToRecycle ${this.item}\`);
  }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1b/v3/EM4iSiP4RRCrmkqJK-9uAA/zh-cn_image_0000002538018936.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=0D0841C9A51B0DB58E365C942FD0EC3979B731DD65B4D3F5F1553C85CF8F126F)

import { FrameNode, NodeController, BuilderNode, UIContext } from '@kit.ArkUI';
import { hilog } from '@kit.PerformanceAnalysisKit';

const TEST\_TAG: string = 'Reusable';
...
struct ReusableChildComponent {
  ...
  aboutToReuse(params: object): void {
    hilog.info(0xF811, 'testTag', '%{public}s',
      \`${TEST\_TAG} ReusableChildComponent aboutToReuse ${JSON.stringify(params)}\`);
  }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c9/v3/mxwTviJgQyyxiOKKn2tLow/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=7C139DEEF35A40D9058D802D647C7BE325181E1A2B16E62E63A89413AAC4BF46)
    ...
    Row() {
      Column() {
        Text(this.message)
          ...
          .fontWeight(FontWeight.Bold)
          .margin({ bottom: 36 })
          .fontColor($r(\`app.color.text\_color\`)) // 开发者可在资源目录下的color.json文件中自定义颜色
          .backgroundColor($r(\`app.color.start\_window\_background\`))
      }
    }
  }
}
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ec/v3/dPw07gziRJqvgbQ-U3xl_A/zh-cn_image_0000002538178864.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=3D8DE93C6236AE7C9CCA0C7A24112C5743F8FA1C23A75658CFD1D9346D5C0264)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/sjATqLjYTEeg47LqZ-cI8A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=55F0B1A38BE993245CB91EFB5868E175B65DFC6625636BF8850053EB55668370)
...
const PAGE\_ONE\_INDEX = 1;
const PAGE\_TWO\_INDEX = 2;
...
struct pageOneStack {
  ...
  @State index: number = PAGE\_ONE\_INDEX;
  @Link message: number;
...
struct pageTwoStack {
  @Consume('pageInfo') pageInfo: NavPathStack;
  @State index: number = PAGE\_TWO\_INDEX;
  @Link message: number;
  @Link logNumber: number;
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/67/v3/B8pQsYvNQ6KRE337qhf75A/zh-cn_image_0000002569018653.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=F461B957D29D1F952EE3DC0B3CAB67C01C13C68971604779939746DC715BC0EC)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c8/v3/keZ2cXhQT9SsWbiuLVdyTQ/zh-cn_image_0000002568898183.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=1D79A4E0833C200171AFAF142DDB5F177A0454538B88B21C1D6FF8C6FE78F40B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e7/v3/yipAJSjjRMizD_ujpkm2PQ/zh-cn_image_0000002568898643.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=F3A39A0D2692A103EFB8747683D5DCD2B7624E27C890AEE22C526C7955C5BF17)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/21/v3/MemH7vMpRpyNdRftMTfupw/zh-cn_image_0000002538018476.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=A79680AFCF181F3C42402169EE439A318A8FFC49FBFCC1B16C18FFFC6A5BD032)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/glW8nD2oRcCHtskWw8mk_w/zh-cn_image_0000002538018938.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=2F2E588EB14D267A7284DF30213081D6950C2E71189D9F1673E27B5B949E04B2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/ZMxH63SRTQmlvyCSSlo_Pw/zh-cn_image_0000002538178866.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=70EDFB09AA3E40D63A77FD0617BA9576DD048459D2AFDFBADD02F41EEDBBA544)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/49/v3/FBC0w4xRT0aAEY4v8RwyVQ/zh-cn_image_0000002569018655.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=BA067502BDAF11337D486F2EB3475B4C3E1E87A284607CF2A0D2E9B2A7D1CB88)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6f/v3/KErfLKBQRYOf97oq1rs1Aw/zh-cn_image_0000002568898645.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=46C3744138042455FC3C89E31045BE6E4969B50909BC86A150743380D42E883D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3c/v3/_UCYsQykSlKrcce9MW5x8w/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=3F7DF2FDAC232F2249BBAADBDC3C4632351BBD76EAC84F220DCD5940E6149578)
