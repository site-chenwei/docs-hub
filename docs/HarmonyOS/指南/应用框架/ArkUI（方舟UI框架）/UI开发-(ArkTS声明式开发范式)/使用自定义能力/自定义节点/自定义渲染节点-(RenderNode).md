...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-user-defined-arktsnode-rendernode"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "自定义节点"
  - "自定义渲染节点 (RenderNode)"
captured_at: "2026-04-17T01:35:39.214Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/14/v3/7wY9XerCQIqx0L2N7A3UDw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=A6BE12C2FE79AA6D9ACB18D0FD639681883E3B7E83A8119B304959D560C609F7)
...
const TEST\_TAG: string = 'RenderNode';
        ...
        Button('getNextSibling')
          .onClick(() => {
            ...
            if (child === null || nextSibling === null) {
              hilog.info(DOMAIN, TEST\_TAG, ' the child or nextChild is null');
              this.myLog = 'the child or nextChild is null';
            } else {
              // 获取子节点的位置信息
              hilog.info(DOMAIN, TEST\_TAG, \`the position of child is x: ${child.position.x}, y: ${child.position.y}, \` +
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dd/v3/TZbjlX_YRsGzH0VI9--XLg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=F1AAC83DF5DC7244407A2E2E4A49C5F5E685FD5BBD2B3B37EA476C698AAB2266)
      ...
      Flex() {
        ...
        Button('position')
          ...
          .onClick(() => {
            ...
            hilog.info(DOMAIN, TEST\_TAG, ' position:' + JSON.stringify(renderNode.position));
          });
        Column().width(20);
        // 设置RenderNode的轴心
        Button('pivot')
          ...
          .onClick(() => {
            ...
            hilog.info(DOMAIN, TEST\_TAG, ' pivot:' + JSON.stringify(renderNode.pivot));
          });
      }
      ...
      Flex() {
        ...
        Button('scale')
          ...
          .onClick(() => {
            ...
            hilog.info(DOMAIN, TEST\_TAG, ' scale:' + JSON.stringify(renderNode.scale));
          });
        Column().width(20);
        // 设置RenderNode的平移量
        Button('translation')
          ...
          .onClick(() => {
            ...
            hilog.info(DOMAIN, TEST\_TAG, ' translation:' + JSON.stringify(renderNode.translation));
          });
      }
      ...
      Flex() {
        ...
        Button('rotation')
          ...
          .onClick(() => {
            ...
            hilog.info(DOMAIN, TEST\_TAG, ' rotation:' + JSON.stringify(renderNode.rotation));
          });
        Column().width(20);
        // 设置RenderNode的变换矩阵
        Button('transform')
          ...
          .onClick(() => {
            renderNode.transform = \[
              ...
              0, 0, 0, 1
            \];
            hilog.info(DOMAIN, TEST\_TAG, ' transform:' + JSON.stringify(renderNode.transform));
          });
      }
      ...
      Flex() {
        ...
        Button('shadow')
          ...
          .onClick(() => {
            ...
            hilog.info(DOMAIN, TEST\_TAG, ' shadowElevation:' + JSON.stringify(renderNode.shadowElevation));
            hilog.info(DOMAIN, TEST\_TAG, ' shadowColor:' + JSON.stringify(renderNode.shadowColor));
            hilog.info(DOMAIN, TEST\_TAG, ' shadowOffset:' + JSON.stringify(renderNode.shadowOffset));
            hilog.info(DOMAIN, TEST\_TAG, ' shadowAlpha:' + JSON.stringify(renderNode.shadowAlpha));
          });
        Column().width(20);
        // 设置RenderNode的阴影模糊半径
        Button('shadowRadius')
          ...
          .onClick(() => {
            ...
            hilog.info(DOMAIN, TEST\_TAG, ' shadowOffset:' + JSON.stringify(renderNode.shadowOffset));
            hilog.info(DOMAIN, TEST\_TAG, ' shadowAlpha:' + JSON.stringify(renderNode.shadowAlpha));
            hilog.info(DOMAIN, TEST\_TAG, ' shadowRadius:' + JSON.stringify(renderNode.shadowRadius));
          });
      }
      ...
      Flex() {
        ...
        Button('border')
          ...
          .onClick(() => {
            ...
            hilog.info(DOMAIN, TEST\_TAG, ' borderWidth:' + JSON.stringify(renderNode.borderWidth));
            hilog.info(DOMAIN, TEST\_TAG, ' borderStyle:' + JSON.stringify(renderNode.borderStyle));
            hilog.info(DOMAIN, TEST\_TAG, ' borderColor:' + JSON.stringify(renderNode.borderColor));
            hilog.info(DOMAIN, TEST\_TAG, ' borderRadius:' + JSON.stringify(renderNode.borderRadius));
          })
        Column().width(20);
        // 设置RenderNode的遮罩
        Button('shapeMask')
          ...
          .onClick(() => {
            ...
            hilog.info(DOMAIN, TEST\_TAG, ' shapeMask:' + JSON.stringify(renderNode.shapeMask));
          });
      }
        ...
        Button('shapeClip')
          ...
          .onClick(() => {
            ...
            hilog.info(DOMAIN, TEST\_TAG, ' shapeClip:' + JSON.stringify(renderNode.shapeClip));
          });
      }
      .padding({
        left: 35,
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/68/v3/314eeVvgSLKuvwaeeUPlDg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=1F9F9E5BB7D2CFD4C200B9D51C9F7CD26AA742D3D5CB05AE53E4A17B0D5053B0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dc/v3/1CzfphVQT3aT55qcIRbMnA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=13B1B81C3034B89005B86601FA5CE97850A051243ED969FF2B69139401930729)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f6/v3/_t4fzejuRc6zvRMaGFA8Yw/zh-cn_image_0000002538178860.png?HW-CC-KV=V1&HW-CC-Date=20260417T013540Z&HW-CC-Expire=86400&HW-CC-Sign=1BECE683D4B3CB06B58E3BCC8F000AD72052EE29EC794B11D2FC0AA1B5D32456)
...
namespace {
    const int32\_t ARG\_NUM0 = 0;
    const int32\_t ARG\_NUM1 = 1;
    const int32\_t ARG\_NUM2 = 2;
    const int32\_t ARG\_NUM3 = 3;
    const int32\_t ARG\_NUM4 = 4;
}

static napi\_value OnDraw(napi\_env env, napi\_callback\_info info)
{
    size\_t argc = ARG\_NUM4;
    napi\_value args\[ARG\_NUM4\] = {nullptr};
    napi\_get\_cb\_info(env, info, &argc, args, nullptr, nullptr);

    int32\_t id;
    napi\_get\_value\_int32(env, args\[ARG\_NUM0\], &id);

    // 获取 Canvas 指针
    void \*temp = nullptr;
    napi\_unwrap(env, args\[ARG\_NUM1\], &temp);
    OH\_Drawing\_Canvas \*canvas = reinterpret\_cast<OH\_Drawing\_Canvas \*>(temp);

    // 获取 Canvas 宽度
    int32\_t width;
    napi\_get\_value\_int32(env, args\[ARG\_NUM2\], &width);

    // 获取 Canvas 高度
    int32\_t height;
    napi\_get\_value\_int32(env, args\[ARG\_NUM3\], &height);
    ...
    OH\_Drawing\_PathMoveTo(path, width \* kQuarter, height \* kQuarter);
    OH\_Drawing\_PathLineTo(path, width \* kThreeQuarters, height \* kQuarter);
    OH\_Drawing\_PathLineTo(path, width \* kThreeQuarters, height \* kThreeQuarters);
    OH\_Drawing\_PathLineTo(path, width \* kQuarter, height \* kThreeQuarters);
    OH\_Drawing\_PathLineTo(path, width \* kQuarter, height \* kQuarter);
    OH\_Drawing\_PathClose(path);

    auto pen = OH\_Drawing\_PenCreate();
    const int lineWidth = 10;
    OH\_Drawing\_PenSetWidth(pen, lineWidth);
