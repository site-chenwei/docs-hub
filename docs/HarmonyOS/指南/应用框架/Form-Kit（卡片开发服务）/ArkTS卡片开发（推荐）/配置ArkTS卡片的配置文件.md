...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-ui-widget-configuration"
menu_path:
  - "指南"
  - "应用框架"
  - "Form Kit（卡片开发服务）"
  - "ArkTS卡片开发（推荐）"
  - "配置ArkTS卡片的配置文件"
captured_at: "2026-04-17T01:35:44.031Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fb/v3/V86ILUiNT4CuKBDJ7A453Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013545Z&HW-CC-Expire=86400&HW-CC-Sign=EB199944EEA2DC95E7915BC5224021C53A1A72649202DCFD7193B19EC459A76A)
...
表示卡片的[定点刷新](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-ui-widget-passive-refresh#卡片定点刷新)的时刻，采用24小时制，精确到分钟，例如："10:30"。
...
表示[卡片定时刷新](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-ui-widget-passive-refresh#卡片定时刷新)的更新周期，单位为30分钟，取值为自然数。
...
从API version 20开始，支持该字段。
 ...
 | 字符串 | 可缺省，空字符串。 |
| [supportDeviceTypes](#supportdevicetypes标签) | 
...
| [supportDevicePerformanceClasses](#supportdeviceperformanceclasses标签) | 
