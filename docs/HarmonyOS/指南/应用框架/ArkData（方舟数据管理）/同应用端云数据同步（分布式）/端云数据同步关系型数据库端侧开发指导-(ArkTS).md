...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/data-cloud-sync-of-rdb-store"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkData（方舟数据管理）"
...
captured_at: "2026-04-17T01:35:33.671Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/VhEPUpDFQr6YnPQguRRvNA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013534Z&HW-CC-Expire=86400&HW-CC-Sign=B33DD2C75C72947CE7E8A0E223BC31CDBBD35C2FB3AC618FD1334F85F87817AF)

从HarmonyOS开发套件（基于API 23）配套的系统版本开始，支持使用关系型数据库实现端云数据同步。
