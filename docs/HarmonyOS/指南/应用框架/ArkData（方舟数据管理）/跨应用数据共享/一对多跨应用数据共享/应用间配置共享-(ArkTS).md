---
title: "应用间配置共享 (ArkTS)"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/share-config"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkData（方舟数据管理）"
  ...
  - "一对多跨应用数据共享"
  - "应用间配置共享 (ArkTS)"
captured_at: "2026-04-17T01:35:33.902Z"
---
    ...
    function publishSharedConfig() {
      dataShare.createDataProxyHandle().then((dataProxyHandle) => {
        ...
        const config: dataShare.DataProxyConfig = {
          type: dataShare.DataProxyType.SHARED\_CONFIG,
        };
