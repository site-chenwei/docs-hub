...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/data-sync-of-rdb-store"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkData（方舟数据管理）"
  - "同应用跨设备数据同步（分布式）"
  - "关系型数据库跨设备数据同步 (ArkTS)"
captured_at: "2026-04-17T01:35:33.651Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/p7K7q34QSLe8uwZKq77-tQ/zh-cn_image_0000002538018440.jpg?HW-CC-KV=V1&HW-CC-Date=20260417T013534Z&HW-CC-Expire=86400&HW-CC-Sign=33C1772BAFA3DB98D50CEC560C00642A724312B24363AF852A6CB39E5083FF4E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5d/v3/sJDvKofaTxWXooWhiPMfHg/zh-cn_image_0000002538178368.jpg?HW-CC-KV=V1&HW-CC-Date=20260417T013534Z&HW-CC-Expire=86400&HW-CC-Sign=CE5E5CBD2229E794527356357E823A9B0B8771917837C4AF9CC5F250111E4BEF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/43/v3/wxYhQ6ZOTlq_ak4r4NoO0A/zh-cn_image_0000002569018155.jpg?HW-CC-KV=V1&HW-CC-Date=20260417T013534Z&HW-CC-Expire=86400&HW-CC-Sign=B09D2A5E30E3CE1EFBAC9AF462E4A7C47C324CBDBF7BADCE3ED590FF1D2A3C39)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2f/v3/1MojykV9QqimHyeOCgI0HA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013534Z&HW-CC-Expire=86400&HW-CC-Sign=B03B6B95B7EEBD445F910AD9203B18D0D6A7AE2AA5E04F98B224511842DD8432)
    ...
    if (store) {
      ...
      if (syncTarget.length === 0) {
        ...
        try {
          ...
          const result = await store.sync(relationalStore.SyncMode.SYNC\_MODE\_PUSH, predicates);
    ...
    if (store) {
      ...
      if (syncTarget.length === 0) {
        ...
        try {
          ...
          const result = await store.sync(relationalStore.SyncMode.SYNC\_MODE\_PULL, predicates);
