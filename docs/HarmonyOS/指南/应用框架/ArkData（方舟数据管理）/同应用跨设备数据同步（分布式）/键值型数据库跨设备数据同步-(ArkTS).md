...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/data-sync-of-kv-store"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkData（方舟数据管理）"
  - "同应用跨设备数据同步（分布式）"
  - "键值型数据库跨设备数据同步 (ArkTS)"
captured_at: "2026-04-17T01:35:33.575Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/clCSoRawQpOV40EmiVRaxw/zh-cn_image_0000002538018438.jpg?HW-CC-KV=V1&HW-CC-Date=20260417T013534Z&HW-CC-Expire=86400&HW-CC-Sign=0336D3B763D89E2A6A21676017F0992E2F703B9E026D80A92E4FD33B64A3A1A1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/21/v3/j7fbP_tIT6Ob-GZXoHjMlw/zh-cn_image_0000002538178366.jpg?HW-CC-KV=V1&HW-CC-Date=20260417T013534Z&HW-CC-Expire=86400&HW-CC-Sign=076E8F5D8731E4E315043BAD3152C6E806E9F892A03A7DAAE8E9E9EBF8A154CA)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/14/v3/2cfpoScrS4GfS0ypQP4nXQ/zh-cn_image_0000002569018153.jpg?HW-CC-KV=V1&HW-CC-Date=20260417T013534Z&HW-CC-Expire=86400&HW-CC-Sign=80C47B94EB89F484556F436E68AA96E246CF1053D7B0A42ECAFA87E418942113)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/60/v3/KBXrPAYfRn-eybs3lrFb_Q/zh-cn_image_0000002568898147.png?HW-CC-KV=V1&HW-CC-Date=20260417T013534Z&HW-CC-Expire=86400&HW-CC-Sign=484FAB476455F8E6FB4DF5280D54F518F1BFA7847A88A75AA85E78FC321734E5)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d4/v3/1gRx8pSLSoGyidfU4AyoKw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013534Z&HW-CC-Expire=86400&HW-CC-Sign=670A945559BE630F5606E64C088D3C69E65B0AB4E72B68FB0C6C1A44351AD50B)
...
5.  调用on()方法订阅分布式数据变化，如需关闭订阅分布式数据变化，调用[off('dataChange')](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-distributedkvstore#offdatachange)关闭。
    ...
    public On = (() =>{
      ...
      try {
        kvStore.on('dataChange', distributedKVStore.SubscribeType.SUBSCRIBE\_TYPE\_ALL, (data) => {
...
7.  调用get()方法查询分布式数据库数据。
    ...
    public Get = (() => {
      ...
      const KEY\_TEST\_STRING\_ELEMENT = 'key\_test\_string';
      try {
        kvStore.get(KEY\_TEST\_STRING\_ELEMENT, (err, data) => {
          if (err != undefined) {
...
8.  调用sync()方法同步数据到其他设备。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9b/v3/zZxy_EibRoOKOKhIRbXxBw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013534Z&HW-CC-Expire=86400&HW-CC-Sign=541E4ED888B1ADEF3D045691AC0D684B4205CD572C56AF63B009540200C74163)
    ...
    public Sync = (() =>{
      ...
      try {
        ...
        try {
          // 1000表示最大延迟时间为1000ms
          kvStore.sync(deviceIds, distributedKVStore.SyncMode.PUSH\_PULL, 1000);
        } catch (e) {
          let error = e as BusinessError;
          Logger.error(\`An unexpected error occurred. Code:${error.code},message:${error.message}\`);
        }
