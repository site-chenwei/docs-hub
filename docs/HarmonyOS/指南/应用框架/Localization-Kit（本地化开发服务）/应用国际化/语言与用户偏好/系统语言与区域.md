---
title: "系统语言与区域"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-system-language-region"
menu_path:
  - "指南"
  - "应用框架"
  ...
  - "语言与用户偏好"
  - "系统语言与区域"
captured_at: "2026-04-17T01:35:45.684Z"
---
...
-   获取系统语言、系统地区、系统区域。
    ...
    // 通过监听公共事件COMMON\_EVENT\_LOCALE\_CHANGED可以感知系统语言、系统地区或系统区域变化
    let subscriber: commonEventManager.CommonEventSubscriber; // 用于保存创建成功的订阅者对象，后续使用其完成订阅及退订的动作
    let subscribeInfo: commonEventManager.CommonEventSubscribeInfo = {
      events: \[commonEventManager.Support.COMMON\_EVENT\_LOCALE\_CHANGED\]
    };
    // 创建订阅者
