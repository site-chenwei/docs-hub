---
title: "用户偏好"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-user-preferences"
menu_path:
  - "指南"
  - "应用框架"
  ...
  - "语言与用户偏好"
  - "用户偏好"
captured_at: "2026-04-17T01:35:45.682Z"
---
...
-   获取用户偏好。
    ...
    // 通过监听公共事件COMMON\_EVENT\_TIME\_CHANGED可以感知系统时制变化
    ...
    let timeSubscribeInfo: commonEventManager.CommonEventSubscribeInfo = {
      events: \[commonEventManager.Support.COMMON\_EVENT\_TIME\_CHANGED\]
    };
    // 创建订阅者
