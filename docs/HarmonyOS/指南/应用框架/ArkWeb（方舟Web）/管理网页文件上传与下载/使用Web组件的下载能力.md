---
title: "使用Web组件的下载能力"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/web-download"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkWeb（方舟Web）"
  - "管理网页文件上传与下载"
  - "使用Web组件的下载能力"
captured_at: "2026-04-17T01:35:42.575Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/80/v3/o-eyPn3GRryZ3WdnUlfXSw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013543Z&HW-CC-Expire=86400&HW-CC-Sign=1AC821B24AE351E6394599773D8D4D30426820E7A97EEC7737627BA34E59489C)
...
export namespace  DownloadUtil {
  ...
  export function writeToFileSync(dir: string, fileName: string, msg: string): void {
    let file = fileIo.openSync(dir + '/' + fileName, fileIo.OpenMode.WRITE\_ONLY | fileIo.OpenMode.CREATE);
