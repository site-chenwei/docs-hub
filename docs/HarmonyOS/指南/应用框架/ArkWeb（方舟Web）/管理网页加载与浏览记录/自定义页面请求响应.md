---
title: "自定义页面请求响应"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/web-resource-interception-request-mgmt"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkWeb（方舟Web）"
  - "管理网页加载与浏览记录"
  - "自定义页面请求响应"
captured_at: "2026-04-17T01:35:42.463Z"
---
...
-   被拦截后的页面
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a4/v3/f6Rb_jJ-TFWi94ogXalnCw/zh-cn_image_0000002569018865.png?HW-CC-KV=V1&HW-CC-Date=20260417T013543Z&HW-CC-Expire=86400&HW-CC-Sign=AC4ED255E14284EF7E675372E2C299E1A9AAE27EA2215006F1FBC4B077A9DE6A)
...
-   应用侧代码。
    ...
    struct WebComponent {
      ...
      @State jsData: string = 'let text\_msg = "the modified content:version 0000000000001";\\n' +
        ...
        'element1.innerHTML = text\_msg;\\n' +
        'element2.innerHTML = text\_msg;\\n' +
        'element3.innerHTML = text\_msg;\\n' +
        'element4.innerHTML = text\_msg;\\n' +
        'element5.innerHTML = text\_msg;\\n' +
        'element6.innerHTML = text\_msg;\\n' +
        'element7.innerHTML = text\_msg;\\n' +
        'element8.innerHTML = text\_msg;\\n' +
        'element9.innerHTML = text\_msg;\\n' +
        'element10.innerHTML = text\_msg;\\n' +
        'element11.innerHTML = text\_msg;\\n';
      build() {
        Column() {
...
-   被拦截后的页面
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/28/v3/9Xh7m3dQRtiNnm40lOvQPw/zh-cn_image_0000002568898855.png?HW-CC-KV=V1&HW-CC-Date=20260417T013543Z&HW-CC-Expire=86400&HW-CC-Sign=0CB79E91686F3CDD12D667471F7D6A68FFCA06F06A561A89FD069E590CD83DDE)
