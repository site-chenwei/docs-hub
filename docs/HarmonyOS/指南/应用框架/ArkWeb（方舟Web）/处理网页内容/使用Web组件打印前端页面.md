---
title: "使用Web组件打印前端页面"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/web-print"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkWeb（方舟Web）"
  - "处理网页内容"
  - "使用Web组件打印前端页面"
captured_at: "2026-04-17T01:35:42.663Z"
---
      ...
      Button('createWebPrintDocumentAdapter')
        .onClick(() => {
          try {
            ...
            print.print('example\_job\_id', webPrintDocadapter, null, this.getUIContext().getHostContext());
          } catch (error) {
