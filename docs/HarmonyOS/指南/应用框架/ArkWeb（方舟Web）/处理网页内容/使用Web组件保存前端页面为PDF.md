...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/web-createpdf"
menu_path:
  - "指南"
  - "应用框架"
  - "ArkWeb（方舟Web）"
  - "处理网页内容"
  - "使用Web组件保存前端页面为PDF"
captured_at: "2026-04-17T01:35:42.667Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f4/v3/TAvqOMriTcGyaTLAT50UYA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013544Z&HW-CC-Expire=86400&HW-CC-Sign=93BCA6BCED1E74805766D593A5DE1AE242E0AD762D94CE7B601682707308EDDB)
          ...
          this.controller.createPdf(
            ...
            (error, result: webview.PdfData) => {
              try {
                ...
                let file = fs.openSync(filePath, fs.OpenMode.READ\_WRITE | fs.OpenMode.CREATE);
