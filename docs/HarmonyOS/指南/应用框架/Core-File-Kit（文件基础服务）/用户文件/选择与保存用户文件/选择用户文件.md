---
title: "选择用户文件"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/select-user-file"
menu_path:
  - "指南"
  - "应用框架"
  ...
  - "选择与保存用户文件"
  - "选择用户文件"
captured_at: "2026-04-17T01:35:43.424Z"
---
...
3.  创建文件选择器[DocumentViewPicker](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-picker#documentviewpicker)实例。调用[select()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-picker#select-3)接口拉起FilePicker应用界面进行文件选择。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bd/v3/GL1NrxW8ST273jWV_K1VjQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013544Z&HW-CC-Expire=86400&HW-CC-Sign=564FD16B31524DAC607B861DDCD4401D3E6DEE8D48508140887FDEA20DA6BF12)
...
2.  创建音频类型文件选择选项实例。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/98/v3/qgeRdg7-SImYFwmIDJdDjQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013544Z&HW-CC-Expire=86400&HW-CC-Sign=9D11A328B622B93E464F9C1399626BE8E34AC831B9FCC95CB8C985D57D98B5F0)
...
3.  创建音频选择器[AudioViewPicker](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-picker#audioviewpicker)实例。调用[select()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-picker#select-5)接口拉起AudioPicker应用界面进行文件选择。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2a/v3/MzLc1JffSQe7DKdAOnW2Hg/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013544Z&HW-CC-Expire=86400&HW-CC-Sign=213EBD2A32921B2DF3A64E6A866523F017B3CD17F8C5A7A0E1E4FE0C6243A74A)
