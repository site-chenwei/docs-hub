---
title: "应用共享目录配置"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/share-app-file-configuration"
menu_path:
  - "指南"
  - "应用框架"
  ...
  - "应用文件"
  - "应用共享目录配置"
captured_at: "2026-04-17T01:35:43.101Z"
---
...
2.  在开发视图的resources/base/profile下面定义配置文件share\_files.json，以标识当前模块所有共享路径的权限信息。
    ...
    **scopes标签说明**
    ...
    | :-- | :-- | :-- | :-- |
    | path | 
    共享路径配置，当前仅支持[el2目录](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/share-app-file#应用可分享目录)，scopes中的path不可重复。支持的取值如下：
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fd/v3/YyFj6qDjT2i8KBojcMk6mQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013544Z&HW-CC-Expire=86400&HW-CC-Sign=45543AA6C79DFEADC9C47B78DF5012C3C20DC04A969ECCEBC8E83BBFF492FF48)
