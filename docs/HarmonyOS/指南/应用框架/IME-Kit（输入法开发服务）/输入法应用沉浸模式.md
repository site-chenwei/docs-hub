---
title: "输入法应用沉浸模式"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/inputmethod-immersive-mode-guide"
menu_path:
  - "指南"
  - "应用框架"
  - "IME Kit（输入法开发服务）"
  - "输入法应用沉浸模式"
captured_at: "2026-04-17T01:35:45.491Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/QJJtunrgQlGs1QXQHJzYWA/zh-cn_image_0000002568898945.png?HW-CC-KV=V1&HW-CC-Date=20260417T013547Z&HW-CC-Expire=86400&HW-CC-Sign=A9C2F75CF957882CCFDD0B0CD111D03F68885F0EF28FB93EDE9F63C27737A431)
...
1.  前台应用[设置编辑框沉浸模式](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-textarea#keyboardappearance15)。示例代码如下。
    ...
    TextArea({placeholder: '非沉浸模式'})
      .keyboardAppearance(KeyboardAppearance.NONE\_IMMERSIVE)
