---
title: "鼠标光标开发指导"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/pointerstyle-guidelines"
menu_path:
  - "指南"
  - "系统"
  - "基础功能"
  - "Input Kit（多模输入服务）"
  - "鼠标光标开发指导"
captured_at: "2026-04-17T01:35:55.739Z"
---
  ...
  .onClick(() => {
    ...
    window.getLastWindow(this.getUIContext().getHostContext(),
      (error: BusinessError, windowClass: window.Window) => {
        ...
        try {
          // 3.设置鼠标光标样式为取色器样式
          pointer.setPointerStyle(windowId, pointer.PointerStyle.COLOR\_SUCKER).then(() => {
