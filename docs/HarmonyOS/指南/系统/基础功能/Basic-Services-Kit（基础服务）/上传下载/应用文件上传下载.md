---
title: "应用文件上传下载"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/app-file-upload-download"
menu_path:
  - "指南"
  - "系统"
  - "基础功能"
  ...
  - "上传下载"
  - "应用文件上传下载"
captured_at: "2026-04-17T01:35:55.257Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c2/v3/xhVm5Mt4TTCqpe_AmiXlIw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013557Z&HW-CC-Expire=86400&HW-CC-Sign=8C167DB30C141722153262E6C366238A58EF062F8BE6671AACBCDF9BA20931DF)
...
async requestUploadFile(fileName: string, callback: (progress: number, isSuccess: boolean) => void,
  ...
  // 新建一个本地应用文件
  try {
    let file = fs.openSync(cacheDir + '/test.txt', fs.OpenMode.READ\_WRITE | fs.OpenMode.CREATE);
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/06/v3/GyqJQ0ppTGaMdYpGaNAacg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013557Z&HW-CC-Expire=86400&HW-CC-Sign=48EDC7B78571BFFF0D721B8C5B43AF1B290E69F8B81A5B03D86BCE1058F62327)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c5/v3/ECWQgYUqQF2SvuKsecmPpQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013557Z&HW-CC-Expire=86400&HW-CC-Sign=66CADFFB229789277D3743F334138B78FF5FCBEB9ED9465E7D88275B04D6B07A)
...
async mediaFileAgentTask(url: string, callback: (progress: number, isSuccess: boolean) => void,
  ...
  bundleManager.BundleFlag.GET\_BUNDLE\_INFO\_WITH\_METADATA;
  ...
  await atManager.checkAccessToken(tokenID, 'ohos.permission.WRITE\_IMAGEVIDEO')
    .then((data: abilityAccessCtrl.GrantStatus) => {
      logger.info(TAG, \`Request checkAccessToken success, data->${JSON.stringify(data)}\`);
      if (data != abilityAccessCtrl.GrantStatus.PERMISSION\_GRANTED) {
        grant = false;
      }
    })
    .catch((err: BusinessError) => {
  ...
  if (!grant) {
    ...
    await atManager.requestPermissionsFromUser(context, \['ohos.permission.WRITE\_IMAGEVIDEO'\])
...
async wantAgentDownload(url: string, fileName: string, callback: (progress: number, isSuccess: boolean) => void,
  ...
  let config: request.agent.Config = {
    ...
    gauge: true,
    notification: {
      visibility: request.agent.VISIBILITY\_COMPLETION | request.agent.VISIBILITY\_PROGRESS,
