---
title: "连接VPN"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/net-vpnextension"
menu_path:
  - "指南"
  - "系统"
  - "网络"
  ...
  - "连接网络"
  - "连接VPN"
captured_at: "2026-04-17T01:35:53.511Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/06/v3/VoAkFzukTte4uBdIJ6RfiA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013555Z&HW-CC-Expire=86400&HW-CC-Sign=F6C80EAC6E14D89097F2FE8FFB4463858958FAAA234ADC0CFD0EBEE60C89B161)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7d/v3/UkUTexgBRuiVjOixwYytNg/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013555Z&HW-CC-Expire=86400&HW-CC-Sign=5D3C1BFA9BD6999E74311BABF84840EA11D430CC2264F8A3000442BCA1412F20)
...
const TITLE\_FONT\_SIZE = 35; // 标题字体大小
const BUTTON\_FONT\_SIZE = 25; // 按钮字体大小
const BUTTON\_MARGIN = 16;

let want: Want = {
  deviceId: '',
  bundleName: 'com.samples.vpncontrol\_case',
  ...
  build() {
    Row() {
      Column() {
        ...
        // ···
        Button($r('app.string.start\_vpnExt'))
          .onClick(() => {
            // ···
          ...
          .width('70%')
        // ···
          .fontSize(BUTTON\_FONT\_SIZE)
          .margin(BUTTON\_MARGIN)
        // ···
      }.width('100%');
    }.height('100%');
  ...
  build() {
    Row() {
      Column() {
        ...
        Button($r('app.string.stop\_vpnExt'))
          .onClick(() => {
            try {
...
// ...
export class VpnTest extends VpnExtensionAbility {
  public vpnId: string = 'test\_vpn\_id';
