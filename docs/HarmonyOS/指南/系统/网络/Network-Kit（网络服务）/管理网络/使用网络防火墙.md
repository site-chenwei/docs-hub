---
title: "使用网络防火墙"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/net-netfirewall"
menu_path:
  - "指南"
  - "系统"
  - "网络"
  ...
  - "管理网络"
  - "使用网络防火墙"
captured_at: "2026-04-17T01:35:53.528Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/J2S9uCc_RG2u78Hz84YHuQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013555Z&HW-CC-Expire=86400&HW-CC-Sign=CD45F73BB37455984BBE558D333AEB531580EC8F8F4589398B9A5408834DB0C8)
...
3.  用户调用setNetFirewallPolicy方法，打开防火墙。
    ...
    // ...
        ...
        let policy: netFirewall.NetFirewallPolicy = {
          isOpen: true,
          inAction: netFirewall.FirewallRuleAction.RULE\_DENY,
          outAction: netFirewall.FirewallRuleAction.RULE\_ALLOW
        };
...
4.  用户通过addNetFirewallRule方法，添加防火墙规则。
    ...
    let ipRule: netFirewall.NetFirewallRule = {
      ...
      direction: netFirewall.NetFirewallRuleDirection.RULE\_IN,
      action: netFirewall.FirewallRuleAction.RULE\_DENY,
      type: netFirewall.NetFirewallRuleType.RULE\_IP,
      isEnabled: true,
      appUid: 20001,
      localIps: \[
        {
...
4.  通过addNetFirewallRule方法，添加防火墙规则。
    ...
    let domainRule: netFirewall.NetFirewallRule = {
      ...
      direction: netFirewall.NetFirewallRuleDirection.RULE\_IN,
      action: netFirewall.FirewallRuleAction.RULE\_DENY,
      type: netFirewall.NetFirewallRuleType.RULE\_DOMAIN,
      isEnabled: true,
      appUid: 20002,
      domains: \[
        {
