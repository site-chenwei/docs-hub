---
title: "感知和调整认证过程"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/perceive-adjust-authentication-process"
menu_path:
  - "指南"
  - "系统"
  - "安全"
  ...
  - "用户身份认证开发指导"
  - "感知和调整认证过程"
captured_at: "2026-04-17T01:35:52.517Z"
---
    ...
    try {
      ...
      userAuthInstance.on('authTip', (authTipInfo: userAuth.AuthTipInfo) => {
        try {
          ...
          this.result\[ResultIndex.PERCEIVE\_ADJUST\] = (\`${authTipInfo.tipType}\`);
          // 认证完成后取消订阅
