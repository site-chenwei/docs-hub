...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-sm4-sym-encrypt-decrypt-ecb-ndk"
menu_path:
  - "指南"
  - "系统"
  - "安全"
...
captured_at: "2026-04-17T01:35:48.257Z"
---
...
OH\_Crypto\_ErrCode doTestSm4Ecb()
{
    ...
    // 加密操作
    ret = OH\_CryptoSymCipher\_Create("SM4\_128|ECB|PKCS7", &encCtx);
    if (ret != CRYPTO\_SUCCESS) {
        goto end;
    }
    ...
    // 解密操作
    ret = OH\_CryptoSymCipher\_Create("SM4\_128|ECB|PKCS7", &decCtx);
    if (ret != CRYPTO\_SUCCESS) {
        goto end;
    }
