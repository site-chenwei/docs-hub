...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-chacha20-encrypt-decrypt-poly1305"
menu_path:
  - "指南"
  - "系统"
  - "安全"
...
captured_at: "2026-04-17T01:35:48.390Z"
---
...
4.  调用[Cipher.doFinal](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cryptoframework#dofinal-1)，获取加密后的数据。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0e/v3/FysyWe-iS9-jr663LifKLQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013550Z&HW-CC-Expire=86400&HW-CC-Sign=94868E7D3002F420636B4082C9DD39211B8BACDEE2905E5F62B62E01128C0DF8)
...
-   异步方法示例：
    ...
    async function encryptMessagePromise(symKey: cryptoFramework.SymKey, plainText: cryptoFramework.DataBlob) {
      ...
      await cipher.init(cryptoFramework.CryptoMode.ENCRYPT\_MODE, symKey, poly1305Params);
    ...
    async function decryptMessagePromise(symKey: cryptoFramework.SymKey, cipherText: cryptoFramework.DataBlob) {
      ...
      await decoder.init(cryptoFramework.CryptoMode.DECRYPT\_MODE, symKey, poly1305Params);
...
-   同步方法示例：
    ...
    function encryptMessage(symKey: cryptoFramework.SymKey, plainText: cryptoFramework.DataBlob) {
      let cipher = cryptoFramework.createCipher('ChaCha20|Poly1305');
      cipher.initSync(cryptoFramework.CryptoMode.ENCRYPT\_MODE, symKey, poly1305Params);
    ...
    function decryptMessage(symKey: cryptoFramework.SymKey, cipherText: cryptoFramework.DataBlob) {
      let decoder = cryptoFramework.createCipher('ChaCha20|Poly1305');
      decoder.initSync(cryptoFramework.CryptoMode.DECRYPT\_MODE, symKey, poly1305Params);
