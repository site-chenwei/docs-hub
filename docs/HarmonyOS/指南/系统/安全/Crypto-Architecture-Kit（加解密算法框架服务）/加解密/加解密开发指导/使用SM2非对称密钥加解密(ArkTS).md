...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-sm2-asym-encrypt-decrypt"
menu_path:
  - "指南"
  - "系统"
  - "安全"
  ...
  - "加解密开发指导"
  - "使用SM2非对称密钥加解密(ArkTS)"
captured_at: "2026-04-17T01:35:48.504Z"
---
...
-   异步方法示例：
    ...
    async function encryptMessagePromise(publicKey: cryptoFramework.PubKey, plainText: cryptoFramework.DataBlob) {
      let cipher = cryptoFramework.createCipher('SM2\_256|SM3');
      await cipher.init(cryptoFramework.CryptoMode.ENCRYPT\_MODE, publicKey, null);
    ...
    async function decryptMessagePromise(privateKey: cryptoFramework.PriKey, cipherText: cryptoFramework.DataBlob) {
      let decoder = cryptoFramework.createCipher('SM2\_256|SM3');
      await decoder.init(cryptoFramework.CryptoMode.DECRYPT\_MODE, privateKey, null);
...
-   同步方法示例：
    ...
    function encryptMessage(publicKey: cryptoFramework.PubKey, plainText: cryptoFramework.DataBlob) {
      let cipher = cryptoFramework.createCipher('SM2\_256|SM3');
      cipher.initSync(cryptoFramework.CryptoMode.ENCRYPT\_MODE, publicKey, null);
    ...
    function decryptMessage(privateKey: cryptoFramework.PriKey, cipherText: cryptoFramework.DataBlob) {
      let decoder = cryptoFramework.createCipher('SM2\_256|SM3');
      decoder.initSync(cryptoFramework.CryptoMode.DECRYPT\_MODE, privateKey, null);
