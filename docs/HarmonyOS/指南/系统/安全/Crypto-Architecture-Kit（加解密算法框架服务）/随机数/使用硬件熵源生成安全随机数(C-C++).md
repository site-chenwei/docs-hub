...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-generate-random-number-hardware-ndk"
menu_path:
  - "指南"
  - "系统"
  - "安全"
  ...
  - "随机数"
  - "使用硬件熵源生成安全随机数(C/C++)"
captured_at: "2026-04-17T01:35:49.176Z"
---
...
OH\_Crypto\_ErrCode doTestHardwareRandomNumber()
{
    // 创建随机数生成器。
    ...
    // 开启硬件熵源。
    ret = OH\_CryptoRand\_EnableHardwareEntropy(rand);
    if (ret != CRYPTO\_SUCCESS) {
