---
title: "消息摘要计算SHA3"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-generate-message-digest-sha3-ndk"
menu_path:
  - "指南"
  - "系统"
  - "安全"
  ...
  - "消息摘要计算开发指导"
  - "消息摘要计算SHA3-256(C/C++)"
captured_at: "2026-04-17T01:35:49.034Z"
---
...
OH\_Crypto\_ErrCode doTestSha3Md()
{
    ...
    int mdLen = 0;
    ret = OH\_CryptoDigest\_Create("SHA3-256", &ctx);
...
OH\_Crypto\_ErrCode doLoopSha3Md()
{
    OH\_Crypto\_ErrCode ret;
    OH\_CryptoDigest \*ctx = nullptr;
