...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-key-derivation-using-hkdf"
menu_path:
  - "指南"
  - "系统"
  - "安全"
  ...
  - "密钥派生"
  - "使用HKDF进行密钥派生(ArkTS)"
captured_at: "2026-04-17T01:35:49.303Z"
---
...
-   通过await返回结果：
    ...
    async function kdfAwait() {
      ...
      let kdf = cryptoFramework.createKdf('HKDF|SHA256|EXTRACT\_AND\_EXPAND');
