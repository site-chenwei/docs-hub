...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-convert-binary-data-to-asym-key-pair"
menu_path:
  - "指南"
  - "系统"
  - "安全"
...
captured_at: "2026-04-17T01:35:47.779Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a7/v3/d_flySB5TaScYEQYhc9T_Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013549Z&HW-CC-Expire=86400&HW-CC-Sign=B295593F13094EE01FFE2FFD6E62BA99E98B969071CE1ECAC1DE890C0BD7B2EC)
...
-   以使用callback方式生成SM2密钥对为例：
    ...
    function convertSM2AsyKey() {
      ...
      let pubKeyBlob: cryptoFramework.DataBlob = { data: pubKeyArray };
      let priKeyBlob: cryptoFramework.DataBlob = { data: priKeyArray };
      let generator = cryptoFramework.createAsyKeyGenerator('SM2\_256');
      generator.convertKey(pubKeyBlob, priKeyBlob, (error, data) => {
        if (error) {
          console.error(\`convertKey failed: errCode: ${error.code}, message: ${error.message}\`);
          return;
