...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-generate-sym-key-randomly"
menu_path:
  - "指南"
  - "系统"
  - "安全"
  ...
  - "密钥生成和转换开发指导"
  - "随机生成对称密钥(ArkTS)"
captured_at: "2026-04-17T01:35:47.654Z"
---
...
-   以使用Promise方式随机生成SM4密钥为例：
    ...
    function testGenerateSM4Key() {
      // 创建SymKeyGenerator实例
      let symKeyGenerator = cryptoFramework.createSymKeyGenerator('SM4\_128');
      // 使用密钥生成器随机生成对称密钥
      let promiseSymKey = symKeyGenerator.generateSymKey();
      promiseSymKey.then(key => {
