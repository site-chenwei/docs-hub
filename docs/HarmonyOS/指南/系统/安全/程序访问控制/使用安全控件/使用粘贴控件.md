---
title: "使用粘贴控件"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/pastebutton"
menu_path:
  - "指南"
  - "系统"
  - "安全"
  ...
  - "使用安全控件"
  - "使用粘贴控件"
captured_at: "2026-04-17T01:35:46.999Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b9/v3/N26ib6T2R5q6M-ihP6F64g/zh-cn_image_0000002538019282.gif?HW-CC-KV=V1&HW-CC-Date=20260417T013548Z&HW-CC-Expire=86400&HW-CC-Sign=2B76F3E4A35EE1A21699246C8BD31B463079BF2825898C061C41A2597E92A24D)
...
2.  添加输入框和粘贴控件。
    ...
    struct Index {
      ...
      build() {
        Row() {
          Column({ space: 10 }) {
            TextInput({ placeholder: $r('app.string.input\_verify\_code'), text: this.message })
              .onChange((val: string) => {
                this.message = val;
              })
            PasteButton()
