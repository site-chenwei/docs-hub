---
title: "使用保存控件"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/savebutton"
menu_path:
  - "指南"
  - "系统"
  - "安全"
  ...
  - "使用安全控件"
  - "使用保存控件"
captured_at: "2026-04-17T01:35:47.020Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/20/v3/STvwFgeTRa6zaW3So1-4UQ/zh-cn_image_0000002538179208.png?HW-CC-KV=V1&HW-CC-Date=20260417T013548Z&HW-CC-Expire=86400&HW-CC-Sign=2BF78755541F312F6BD21CD8FD04C2BA61C4077F02776882E897F386E5C39D48)
...
-   当开发者需要自定义保存控件的图标和文本时，需要向应用市场申请ohos.permission.CUSTOMIZE\_SAVE\_BUTTON权限。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6/v3/OYdZTGV-SfqlDuVPCu6PZQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013548Z&HW-CC-Expire=86400&HW-CC-Sign=576573F7BA55F310464CACB4A1F6763BD54CDE27604186DF04519E6474EF5146)
      ...
      try {
        ...
        context.resourceManager.getMediaContent($r('app.media.test').id, 0)
          .then(async value => {
            ...
            promptAction.openToast({ message: $r('app.string.saved\_in\_photo') });
          });
      } catch (error) {
            ...
            SaveButton()
              ...
              .onClick((event: ClickEvent, result: SaveButtonOnClickResult) => {
                if (result === SaveButtonOnClickResult.SUCCESS) {
                  ...
                  promptAction.openToast({ message: $r('app.string.set\_permission\_failed') });
                }
              })
          }
          .width('100%')
