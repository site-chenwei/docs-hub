---
title: "声明权限"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/declare-permissions"
menu_path:
  - "指南"
  - "系统"
  - "安全"
  ...
  - "申请应用权限"
  - "声明权限"
captured_at: "2026-04-17T01:35:46.745Z"
---
...
| reason | 申请权限的原因。 | 字符串 | 
**可选填写**，该字段用于应用上架校验，申请user\_grant/manual\_settings权限时必填并需多语种适配。
...
**申请user\_grant/manual\_settings权限时，usedScene必填，其他情况下选填。**
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/97/v3/ngHkhzHuRVCiSWWrhy7ZRQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013548Z&HW-CC-Expire=86400&HW-CC-Sign=A0A3D3CD7BDD1F0A3B13EC041ECD4333E4F1CDDACE6350143B3966EB0261FA3D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/tYIwx8RfTb-IvEtVM0QxWg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013548Z&HW-CC-Expire=86400&HW-CC-Sign=1DEE10E62E0543AA28AA916E61B25CC288CD3FCF9D6EAC3EAB6CC0730DE7D220)
...

{
  "module": {
    // ···
    // 1.ohos.permission.APPROXIMATELY\_LOCATION与ohos.permission.LOCATION为user\_grant权限，reason和usedScene为必填字段。
    // 2.ohos.permission.USE\_BLUETOOTH为system\_grant权限，reason和usedScene为选填字段。
    "requestPermissions": \[
      {
        "name": "ohos.permission.APPROXIMATELY\_LOCATION",
        "reason": "$string:approximately\_location\_permission\_reason",
        "usedScene": {
          "abilities": \[
            "FormAbility"
          \],
      ...
      },
      {
        ...
        "reason": "$string:location\_permission\_reason",
        "usedScene": {
          "abilities": \[
            "FormAbility"
          \],
      ...
      {
        "name": "ohos.permission.USE\_BLUETOOTH"
      }
    \]
  }
}
