---
title: "签名/验签(ArkTS)"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/huks-signing-signature-verification-arkts"
menu_path:
  - "指南"
  - "系统"
  - "安全"
  ...
  - "签名/验签"
  - "签名/验签(ArkTS)"
captured_at: "2026-04-17T01:35:51.375Z"
---
...
let keyAlias = 'test\_eccKeyAlias';
let handle: number;
...
function getEccGenerateProperties() {
  let properties: huks.HuksParam\[\] = \[{
    ...
    value: huks.HuksKeyPurpose.HUKS\_KEY\_PURPOSE\_SIGN |
...
let keyAlias = 'test\_sm2KeyAlias';
let handle: number;
let plaintext = '123456';
let signature: Uint8Array;
...
let keyAlias = 'test\_rsaKeyAlias';
let handle: number;
let plaintext = '123456';
let signature: Uint8Array;
...
/\*
 \* 密钥算法为RSA，摘要算法为SHA256，填充模式为PKCS1\_V1\_5
 \*/
import { huks } from '@kit.UniversalKeystoreKit';
...
function getRsaGenerateProperties() {
  let properties: huks.HuksParam\[\] = \[
    { tag: huks.HuksTag.HUKS\_TAG\_ALGORITHM, value: huks.HuksKeyAlg.HUKS\_ALG\_RSA },
    { tag: huks.HuksTag.HUKS\_TAG\_KEY\_SIZE, value: huks.HuksKeySize.HUKS\_RSA\_KEY\_SIZE\_2048 },
    {
      tag: huks.HuksTag.HUKS\_TAG\_PURPOSE,
      value: huks.HuksKeyPurpose.HUKS\_KEY\_PURPOSE\_SIGN | huks.HuksKeyPurpose.HUKS\_KEY\_PURPOSE\_VERIFY
    },
    { tag: huks.HuksTag.HUKS\_TAG\_PADDING, value: huks.HuksKeyPadding.HUKS\_PADDING\_PKCS1\_V1\_5 },
    { tag: huks.HuksTag.HUKS\_TAG\_DIGEST, value: huks.HuksKeyDigest.HUKS\_DIGEST\_SHA256 }
  \];
  return properties;
}
...
let keyAlias = 'test\_rsaSha384PssKeyAlias';
let handle: number;
let plaintext = '123456';
let signature: Uint8Array;
