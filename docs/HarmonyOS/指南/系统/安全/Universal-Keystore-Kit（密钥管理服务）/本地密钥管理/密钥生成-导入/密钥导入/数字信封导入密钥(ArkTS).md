...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/huks-import-envelop-key-arkts"
menu_path:
  - "指南"
  - "系统"
  - "安全"
  ...
  - "密钥导入"
  - "数字信封导入密钥(ArkTS)"
captured_at: "2026-04-17T01:35:51.267Z"
---
...
5.  设备A将数字信封数据发送给设备B。
6.  设备B使用导入WrappedKey导入数字信封密钥。若导入密钥是对称密钥，此步骤只需对裸密钥进行加密。若导入非对称密钥的密钥对，则将公钥以DER格式封装，并放入[HUKS\_TAG\_ASYMMETRIC\_PUBLIC\_KEY\_DATA](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-huks#hukstag)中。
