---
title: "证书链在线校验证书吊销状态"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/create-verify-cerchainvalidator-revocation-object"
menu_path:
  - "指南"
  - "系统"
  - "安全"
  ...
  - "证书算法库框架"
  - "证书链在线校验证书吊销状态"
captured_at: "2026-04-17T01:35:49.672Z"
---
  ...
  try {
    ...
    const param: cert.CertChainValidationParameters = {
      ...
      revocationCheckParam: {
        options: \[
          cert.RevocationCheckOptions.REVOCATION\_CHECK\_OPTION\_LOCAL\_CRL\_ONLY\_CHECK\_END\_ENTITY\_CERT
        \],
      }
    };
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/hiZk-LKMRSWfxs3dcYMflA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013551Z&HW-CC-Expire=86400&HW-CC-Sign=2A60AFDDE9824D134D12DDE08315CA52E2034984E6C2CC2B83B80FBF91A01177)
...
async function doTestCaCheck() {
  try {
    ...
    const param: cert.CertChainValidationParameters = {
      ...
      revocationCheckParam: {
        options: \[
          cert.RevocationCheckOptions.REVOCATION\_CHECK\_OPTION\_ACCESS\_NETWORK,
          cert.RevocationCheckOptions.REVOCATION\_CHECK\_OPTION\_CHECK\_INTERMEDIATE\_CA\_ONLINE
        \],
      }
    };
    await x509CertChain.validate(param);
...
async function validateCRL() {
  ...
  const param: cert.CertChainValidationParameters = {
    ...
    revocationCheckParam: {
      options: \[
        cert.RevocationCheckOptions.REVOCATION\_CHECK\_OPTION\_IGNORE\_NETWORK\_ERROR,
        cert.RevocationCheckOptions.REVOCATION\_CHECK\_OPTION\_ACCESS\_NETWORK
      \],
    }
  }
