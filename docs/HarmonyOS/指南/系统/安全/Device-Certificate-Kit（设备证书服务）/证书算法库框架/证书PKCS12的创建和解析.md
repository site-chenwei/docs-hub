...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/create-parse-pkcs12"
menu_path:
  - "指南"
  - "系统"
  - "安全"
  ...
  - "证书算法库框架"
  - "证书PKCS12的创建和解析"
captured_at: "2026-04-17T01:35:49.660Z"
---
...
async function doTestCreatePkcs12() {
  ...
  let keyParam: cert.PbesParams = {
    saltLen: 16,
    iterations: 2048,
    encryptionAlgorithm: cert.PbesEncryptionAlgorithm.AES\_192\_CBC
  }

  let certParam: cert.PbesParams = {
    saltLen: 16,
    iterations: 2048,
    encryptionAlgorithm: cert.PbesEncryptionAlgorithm.AES\_256\_CBC
  }
