---
title: "证书CMS封装"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/create-cms-enveloped-object"
menu_path:
  - "指南"
  - "系统"
  - "安全"
  ...
  - "证书算法库框架"
  - "证书CMS封装"
captured_at: "2026-04-17T01:35:49.631Z"
---
...
async function testGetEncryptedContentData() {
  try {
    ...
    let cmsContentType = cert.CmsContentType.ENVELOPED\_DATA;
    let cmsGenerator = cert.createCmsGenerator(cmsContentType);
    console.info(\`createCmsGenerator result: success.\`);
    let algorithm = cert.CmsRecipientEncryptionAlgorithm.AES\_256\_GCM;
