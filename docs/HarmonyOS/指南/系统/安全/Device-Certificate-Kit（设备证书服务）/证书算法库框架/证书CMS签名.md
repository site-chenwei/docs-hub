---
title: "证书CMS签名"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/create-cms-sign-object"
menu_path:
  - "指南"
  - "系统"
  - "安全"
  ...
  - "证书算法库框架"
  - "证书CMS签名"
captured_at: "2026-04-17T01:35:49.604Z"
---
...
async function testPkcs7SignByPromise() {
  ...
  cert.createX509Cert(certEncodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      try {
        let cmsContentType = cert.CmsContentType.SIGNED\_DATA;
