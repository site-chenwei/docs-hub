---
title: "证书CMS解封装"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/create-cms-decapsulation-object"
menu_path:
  - "指南"
  - "系统"
  - "安全"
  ...
  - "证书算法库框架"
  - "证书CMS解封装"
captured_at: "2026-04-17T01:35:49.652Z"
---
...
async function testCmsDecryptTest() {
  try {
    ...
    let x509CertEc: cert.X509Cert = await createX509Cert(ECC\_256\_PUBKEY);
    let cms: cert.CmsGenerator = cert.createCmsGenerator(cert.CmsContentType.ENVELOPED\_DATA);
    let option: cert.CmsGeneratorOptions = {
      outFormat: cert.CmsFormat.PEM
    };
    cms.setRecipientEncryptionAlgorithm(cert.CmsRecipientEncryptionAlgorithm.AES\_128\_GCM);
