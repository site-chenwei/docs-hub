---
title: "toybox"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/toybox"
menu_path:
  - "指南"
  - "系统"
  - "调测调优"
  ...
  - "命令行工具"
  - "toybox"
captured_at: "2026-04-17T01:36:03.199Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a0/v3/XnqMb9DFRE64X5X42FAi8g/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013603Z&HW-CC-Expire=86400&HW-CC-Sign=0C848278B68E37DA2715D05664D88E8DE07D863AE80359BCF3092DEE32E3987F)
...
usage: switch\_root \[-c /dev/console\] NEW\_ROOT NEW\_INIT...
...
usage: date \[-u\] \[-I RES\] \[-r FILE\] \[-d DATE\] \[+DISPLAY\_FORMAT\] \[-D SET\_FORMAT\] \[SET\]
...
usage: killall \[-l\] \[-iqv\] \[-SIGNAL | -s SIGNAL\] PROCESS\_NAME...
...
usage: makedevs \[-d device\_table\] rootdir
...
usage: traceroute \[-46FUIldnvr\] \[-f 1ST\_TTL\] \[-m MAXTTL\] \[-p PORT\] \[-q PROBES\]

\[-s SRC\_IP\] \[-t TOS\] \[-w WAIT\_SEC\] \[-g GATEWAY\] \[-i IFACE\] \[-z PAUSE\_MSEC\] HOST \[BYTES\]

usage: traceroute6 \[-dnrv\] \[-m MAXTTL\] \[-p PORT\] \[-q PROBES\]\[-s SRC\_IP\] \[-t TOS\] \[-w WAIT\_SEC\]
...
usage: sed \[-inrszE\] \[-e SCRIPT\]... | SCRIPT \[-f SCRIPT\_FILE\]... \[FILE...\]
...
usage: seq \[-w | -f fmt\_str\] \[-s sep\_str\] \[first\] \[increment\] last
...
usage: split \[-a SUFFIX\_LEN\] \[-b BYTES\] \[-l LINES\] \[-n PARTS\] \[INPUT \[OUTPUT\]\]
...
usage: uuencode \[-m\] \[INFILE\] ENCODE\_FILENAME
