---
title: "打包工具"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/packing-tool"
menu_path:
  - "指南"
  - "系统"
  - "调测调优"
  ...
  - "打包拆包工具"
  - "打包工具"
captured_at: "2026-04-17T01:36:03.027Z"
---
...
从API version 22开始支持该参数。
 ...
 | 仅Stage模型生效。 |
| \--pkg-sdk-info-path | 否 | NA | 

pkgSdkInfo.json（构建产物中依赖的HAR的基本信息，包括模块名和版本）文件路径，文件名必须为pkgSdkInfo.json。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b2/v3/4vgUWS1eRaelMeWOk384YA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013602Z&HW-CC-Expire=86400&HW-CC-Sign=02C4AF2F79B985A16ED9FCEF049FE9AB0ABB4C13C74AAD76A1050A6602F99D5D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1d/v3/hwj9v4oTQ7eMe6_sNYK42g/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013602Z&HW-CC-Expire=86400&HW-CC-Sign=5BC66514240B68362EC865389F9AB631602E04EE0AB930540A2BD65303818664)
...
[pac.json](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/agc-pac)文件路径，文件名必须为pac.json。
...
从API version 22开始支持该参数。
 ...
 |
| \--stat-duplicate | 否 | boolean | 

打包完成后，是否扫描重复so文件，该参数可用于识别重复so，以减小包大小。取值为true时，执行扫描，扫描完成会在--out-path参数指定的输出文件所在目录下生成scan\_report目录，其中包含文件名为scan\_result的[重复so文件扫描报告](#扫描重复so文件)，并在告警中打印scan\_report目录路径。取值为false时，不执行扫描。默认值为false。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/bjot2tJPSMmDZu0-jiFQHQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013602Z&HW-CC-Expire=86400&HW-CC-Sign=DD0584CC8D002D71EEA17D9207BCAAA0D4CCFEA19F04A5B6A681F3C35BA9FFAE)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/14/v3/jIsGAG44RM2xsV_YQHzA2Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013602Z&HW-CC-Expire=86400&HW-CC-Sign=4CDFEF2126276E9C5E69DDB3C66270886B5118845A6BABA69328D0CD56D03B24)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2d/v3/bADv3so1QmW9r3bmaaYskA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013602Z&HW-CC-Expire=86400&HW-CC-Sign=C22B2DA9A0481C2BA8A3270BA364133EFE526F98A1C4FF2F1410E7D79AF196D9)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/74/v3/7JUxxDppQEKjvmwF4cDNaA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013602Z&HW-CC-Expire=86400&HW-CC-Sign=80E726FD478022600D54DCCA7A26B4746FC709FAB0E1A0F5F69E6BC4723B212A)

-   module.json文件为DevEco Studio编译构建产物，其中的字段与配置文件的对应关系，请参考[表1 module.json与配置文件属性的对照表](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/packing-tool)。

**打包App时的压缩规则：** 打包App时，对release模式的HAP、HSP包会进行压缩，对debug模式的HAP、HSP包不会压缩。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/24/v3/LBJ-hDE_Ra6crzczxZXVGA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013602Z&HW-CC-Expire=86400&HW-CC-Sign=28C2767B6F790D37AE06B3F13640B3741A2F415403BB7298AE1F3BDF0C0F1829)
...
1.  存在两个以上的[HSP包](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/in-app-hsp)。例如下图使用DevEco Studio构建App时，工程中包含了两个HSP包library和library1，此时打包APP包失败。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3a/v3/lQHbypuxSP-kQ6lmOP_8KQ/zh-cn_image_0000002568899173.png?HW-CC-KV=V1&HW-CC-Date=20260417T013602Z&HW-CC-Expire=86400&HW-CC-Sign=0F18BAD168723015A9532FF731F1891DA6010A0F5247526405EA21C3A47FDF1E)
