---
title: "hidumper"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hidumper"
menu_path:
  - "指南"
  - "系统"
  - "调测调优"
  ...
  - "命令行工具"
  - "hidumper"
captured_at: "2026-04-17T01:36:02.729Z"
---
...
| [\-e --list \[process\_name\] \[-n num\] \[--since timestamp\] \[--until timestamp\]](#获取异常退出记录列表) | 
...
**说明**：从API version 22开始，支持该参数。
 ...
 |
| [\-e --print \[process\_name\] \[-n num\] \[--since timestamp\] \[--until timestamp\]](#获取异常退出故障日志) | 

获取异常退出故障日志。输出日志的规格可参考：[CppCrash](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cppcrash-guidelines#日志规格)、[JSCrash](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/jscrash-guidelines#日志规格)、[AppFreeze](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/appfreeze-guidelines#日志规格)。

**说明**：从API version 22开始，支持该参数。

 |
| [\-e --print record\_id](#获取异常退出故障日志) | 

获取指定异常退出记录id的故障日志。输出日志的规格可参考：[CppCrash](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cppcrash-guidelines#日志规格)、[JSCrash](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/jscrash-guidelines#日志规格)、[AppFreeze](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/appfreeze-guidelines#日志规格)。
...
获取总内存使用情况。如果指定--prune，只导出精简的内存使用情况。

**说明**：从API version 20开始，支持--prune参数。

 |
| [\--mem pid \[--show-ashmem\] \[--show-dmabuf\]](#查询进程内存) | 
...
| [\--mem-smaps pid \[-v\]](#查询进程内存) | 

获取pid内存统计信息，数据来源于/proc/pid/smaps，使用-v指定更多详细信息。（仅支持导出[debug版本应用](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/performance-analysis-kit-terminology#debug版本应用)）

**说明**：从API version 20开始，支持该参数。

 |
| [\--mem-jsheap pid \[-T tid\] \[--gc\] \[--leakobj\] \[--raw\]](#查询虚拟机堆内存) | 

必选参数pid。触发ArkTS应用JS线程的gc和堆内存快照导出。指定线程tid时，仅触发该线程的gc和堆内存快照导出；指定--gc时，仅触发gc，不导出快照；指定--leakobj时，应用开启泄露检测可获取泄露对象列表。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f1/v3/ugROV5-oRdOCYZbe-BI1GA/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013602Z&HW-CC-Expire=86400&HW-CC-Sign=9ABDD9EC26CAF7907DF62E71196F5512A36682ADFC49F3519B4C393FFED06C5B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/69/v3/DAf4Ad4qS6aTB_a9AKYVEQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013602Z&HW-CC-Expire=86400&HW-CC-Sign=1EC1A95929CD23863E46FF0E488FD78833A643607F00286B65655D72D47CDBB2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/27/v3/-TAWZ6rVQXyUcLSDHOY5GQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013602Z&HW-CC-Expire=86400&HW-CC-Sign=EB2AB25F7F1DDCA6C494DCCEFD4A1BEA9C51EB4A8D7E65DDECFE4F58912ABE59)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f1/v3/618MJpKzQEm3ixwXRQiLWw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013602Z&HW-CC-Expire=86400&HW-CC-Sign=DE75FEA3F79A98336825ABD78225150390B74A1337960F33E725C149FA7826FA)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/de/v3/dF-5nJ7OSdy2chkoH4P7-g/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013602Z&HW-CC-Expire=86400&HW-CC-Sign=7C648418BD9D2BFC398CAA102C3ACF21D696F622AF6AD51DF9D579926E300788)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1e/v3/2dVEnbaWRb-mFd4-ZXvZgQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013602Z&HW-CC-Expire=86400&HW-CC-Sign=6F170C765AE98764D367C9A8CAFDFA2501E0BCCCDF5440D07545AB30B21927ED)
