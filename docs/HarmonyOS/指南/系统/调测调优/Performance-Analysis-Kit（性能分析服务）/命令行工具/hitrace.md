---
title: "hitrace"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hitrace"
menu_path:
  - "指南"
  - "系统"
  - "调测调优"
  ...
  - "命令行工具"
  - "hitrace"
captured_at: "2026-04-17T01:36:02.668Z"
---
...
| \--trace\_clock | 
设置向trace添加时间戳的时钟类型，可以是boot（默认）、global、mono、uptime或perf。不同设备支持的时钟类型不同，建议使用默认的boot进行采集，其时间为从本次开机起的时间戳，单位为s。每种时间类型的说明如下：
...
设置trace输出级别阈值，输出级别可以是Debug、Info、Critical、Commercial或其对应缩写D、I、C、M。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/67/v3/KfSEqeUWRWy9y6utErBUDg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013602Z&HW-CC-Expire=86400&HW-CC-Sign=B2746C1C0CDEDFF0236A688BD97D3E3346FDD6D9A3A64D5907F35174874B49A1)
