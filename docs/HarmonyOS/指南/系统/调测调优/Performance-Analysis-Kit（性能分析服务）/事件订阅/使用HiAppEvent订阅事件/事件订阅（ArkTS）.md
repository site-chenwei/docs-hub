---
title: "事件订阅（ArkTS）"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hiappevent-watcher-app-events-arkts"
menu_path:
  - "指南"
  - "系统"
  - "调测调优"
  ...
  - "使用HiAppEvent订阅事件"
  - "事件订阅（ArkTS）"
captured_at: "2026-04-17T01:36:01.365Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/67/v3/YysiT36GTnmK351NA_dcJw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013601Z&HW-CC-Expire=86400&HW-CC-Sign=0C096D06DB2CD7134DF3B0DB814E99386CBFAB7188BE80B316852AA81FAF89C5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5a/v3/bClcY42TSraNtHEmHaEK3Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013601Z&HW-CC-Expire=86400&HW-CC-Sign=0791304C6528ECCEA50EDA2EA148A2E2D2F18FBDB0BB73307C083DF502EE3013)
      ...
      onReceive: (domain: string, appEventGroups: Array<hiAppEvent.AppEventGroup>) => {
        ...
        for (const eventGroup of appEventGroups) {
          ...
          for (const eventInfo of eventGroup.appEventInfos) {
            ...
            // 开发者可以获取到崩溃应用的包名
            hilog.info(0x0000, 'testTag', \`AppEvents HiAppEvent eventInfo.params.bundle\_name=${JSON.stringify(eventInfo.params\['bundle\_name'\])}\`);
            // 开发者可以获取到崩溃事件发生时的故障日志文件
            hilog.info(0x0000, 'testTag', \`AppEvents HiAppEvent eventInfo.params.external\_log=${JSON.stringify(eventInfo.params\['external\_log'\])}\`);
          }
        }
      }
    });
