...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hiappevent-watcher-cpu-usage-high-arkts"
menu_path:
  - "指南"
  - "系统"
  - "调测调优"
  ...
  - "CPU高负载事件"
  - "订阅CPU高负载事件（ArkTS）"
captured_at: "2026-04-17T01:36:02.112Z"
---
...
3.  （可选）以下示例用于模拟自定义CPU高负载事件的配置策略
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/yyclEUvyRH-ClM1J-Pu0bg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013602Z&HW-CC-Expire=86400&HW-CC-Sign=EAF8FA2A3DB706CD63CDE860BE656930A8E58E70FBBEBC406EE277A848E15BC9)
...
7.  点击DevEco Studio界面中的运行按钮，运行应用工程，然后在应用界面中点击“CPU加压”按钮，触发CPU高负载事件。应用保持在前台且屏幕处于亮屏状态，五到十分钟之后可以在Log窗口看到对系统事件数据的处理日志：
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0c/v3/m2rlj-ptTrOLTGMpkb8yZw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013602Z&HW-CC-Expire=86400&HW-CC-Sign=AEEC868433DF6B331BFB38A3BDD60DA1651893F800EB988AC18B34C9BE44B6EC)
