---
title: "崩溃事件介绍"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hiappevent-watcher-crash-events"
menu_path:
  - "指南"
  - "系统"
  - "调测调优"
  ...
  - "崩溃事件"
  - "崩溃事件介绍"
captured_at: "2026-04-17T01:36:01.489Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/59/v3/bcrh4UoUS0CHWjZWGiqEDw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013601Z&HW-CC-Expire=86400&HW-CC-Sign=495348DD492A6798ADF7E07A0194CEDF94716139EFEDEC1554B29959FAC96C67)
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| extend\_pc\_lr\_printing | boolean | 否 | 
...
缺省时默认为false。
 ...
 |
| log\_file\_cutoff\_sz\_bytes | number | 否 | 
...
如果不设置，默认值取0表示不截断崩溃日志。
 ...
 |
| simplify\_vma\_printing | boolean | 否 | 
...
以32位系统为例，参考[订阅崩溃事件（ArkTS）开发步骤](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hiappevent-watcher-crash-events-arkts#开发步骤)完成崩溃事件订阅和日志配置参数设置，然后通过[external\_log](#params字段说明)字段获取NativeCrash类型崩溃日志内容。日志中打印如下使能的配置参数列表：
