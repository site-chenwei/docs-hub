---
title: "HiDebug能力概述"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hidebug-guidelines"
menu_path:
  - "指南"
  - "系统"
  - "调测调优"
  ...
  - "系统调试信息获取"
  - "HiDebug能力概述"
captured_at: "2026-04-17T01:36:02.437Z"
---
...
使用异步方式为当前线程转储虚拟机的原始堆快照，辅助[JS内存泄漏分析](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-stability-js-memleak-detection)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/WYh67WpeTuCEInGwF8uBUw/zh-cn_image_0000002569019159.png?HW-CC-KV=V1&HW-CC-Date=20260417T013602Z&HW-CC-Expire=86400&HW-CC-Sign=E067361BCAA8A12F55D1E2E03A9E62EA03B128F2BA942B82CB9B4C1E4A8370CD)
...
销毁OH\_HiDebug\_CreateBacktraceObject接口创建的用于栈回溯及栈解析对象。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7f/v3/8Xk71lhfScuSUM-uz_MDgw/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T013602Z&HW-CC-Expire=86400&HW-CC-Sign=CB2412AAC32279BA82E364FC0F97CDC8C6432BBBFAD359B6E7335B633B7BD9EE)
...
将维测信息添加到崩溃日志中，与OH\_HiDebug\_ResetCrashObj配对使用。若程序在OH\_HiDebug\_SetCrashObj与OH\_HiDebug\_ResetCrashObj之间发生崩溃，会将OH\_HiDebug\_SetCrashObj设置的维测信息添加到记录本次崩溃的日志中。
...
将维测信息对象还原到OH\_HiDebug\_SetCrashObj之前的状态，与OH\_HiDebug\_SetCrashObj配对使用。
