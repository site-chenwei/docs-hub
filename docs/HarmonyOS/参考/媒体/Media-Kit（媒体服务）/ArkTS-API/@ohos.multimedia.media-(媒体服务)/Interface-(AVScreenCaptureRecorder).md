...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-avscreencapturerecorder"
menu_path:
  - "参考"
  - "媒体"
  - "Media Kit（媒体服务）"
...
captured_at: "2026-04-17T01:48:43.148Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/AyzqKW-ATwSuQ0HGreSH1A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014845Z&HW-CC-Expire=86400&HW-CC-Sign=A296AA88B389F7E81348632AC9CD1CE1F66ABF689B543172DB3313F07B4412BD)
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| pickerMode | [PickerMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-e#pickermode22) | 是 | 
选择Picker模式。

定义了在Picker中显示的内容类型：

\- SCREEN\_ONLY：仅显示屏幕列表。

\- WINDOW\_ONLY：仅显示窗口列表。

\- SCREEN\_AND\_WINDOW：同时显示屏幕列表和窗口列表（默认值）。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ac/v3/HLu6pG4HTuKi3hn96ncp_w/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014845Z&HW-CC-Expire=86400&HW-CC-Sign=C1E53C78E1C6AD439325E811A3FE019121A854961A9C4ECE6D244D7B9AFD80A1)
