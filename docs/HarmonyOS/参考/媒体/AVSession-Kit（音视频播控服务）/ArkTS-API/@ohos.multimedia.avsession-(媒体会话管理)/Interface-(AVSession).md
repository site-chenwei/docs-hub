...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-avsession-avsession"
menu_path:
  - "参考"
  - "媒体"
  ...
  - "Interface (AVSession)"
captured_at: "2026-04-17T01:48:38.048Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/79/v3/7hCEXankSB2Pp0JidZFP-A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014839Z&HW-CC-Expire=86400&HW-CC-Sign=729F6D46157EF122FD5903BDE80C2FFA4A8B05AE3CE3A61B677154C749962202)
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| sessionId10+ | string | 是 | 否 | 
AVSession对象唯一的会话标识。

**元服务API：** 从API version 12开始，该接口支持在元服务中使用。

 |
| sessionType10+ | [AVSessionType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-avsession-t#avsessiontype10) | 是 | 否 | 
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/bgbfpn5SRcethaG28gwpKQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014839Z&HW-CC-Expire=86400&HW-CC-Sign=5D10D30CC88C15F9252205BCEE30989A888E6BE174FBC53C6B88C91844CC5CC1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8/v3/emO0w88YQ2SUjIh0EOiHwA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014839Z&HW-CC-Expire=86400&HW-CC-Sign=160C83D94DD9124DE949BAC1EDBD795E1F187C9273E39D3279AF01FBB17AD046)
...
| callback | (state: [ConnectionState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-avsession-e#connectionstate10), device: [OutputDeviceInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-avsession-i#outputdeviceinfo10)) => void | 是 | 
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| callback | Callback<[CommandInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-avsession-i#commandinfo22)\> | 否 | 
回调函数。当监听事件取消成功，err为undefined，否则返回错误对象。
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| callback | TwoParamCallback<number, [CommandInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-avsession-i#commandinfo22)\> | 否 | 
回调函数。当监听事件取消成功，err为undefined，否则返回错误对象。
...
| callback | (mode: [LoopMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-avsession-e#loopmode10)) => void | 否 | 
回调函数，参数mode是循环模式。
...
| callback | Callback<[LoopMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-avsession-e#loopmode10)\> | 否 | 
回调函数，参数表示目标循环模式。
...
| callback | (event: [KeyEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-keyevent)) => void | 否 | 
回调函数，参数event是按键事件。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f9/v3/Cb69NpAKS9CJOuAjcFg7Kg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014839Z&HW-CC-Expire=86400&HW-CC-Sign=D5E4D8DED1A06BA21B37C5A2A94F7E59B5D35F4B79A64466AE6DF98E93EBDC4C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/8VGvPaEyQFek2yGeZDlQ4A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014839Z&HW-CC-Expire=86400&HW-CC-Sign=D1DC6132472B4418E05FA3CD379E1D391E73071A2D780D7B2CC0C10D1C1E76C3)
