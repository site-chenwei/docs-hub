...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-photoaccesshelper"
menu_path:
  - "参考"
  - "媒体"
...
captured_at: "2026-04-17T01:48:45.321Z"
---

# Interface (PhotoAccessHelper)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7f/v3/V3ZxDi_eT0qqiS8yglS8YA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014847Z&HW-CC-Expire=86400&HW-CC-Sign=F7D7AB5E04F013D7A5BC1F5FFD393BA141DB59C904DF5EADB128CAD0C5C3D8E1)
...
| options | [CreateOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-i#createoptions) | 是 | 
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/63/v3/3vknYBkSRPq9nMmH2Ex1Ww/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014847Z&HW-CC-Expire=86400&HW-CC-Sign=67989BE393CF6FE9C8C7CEF53560DFF369B1CE824EDBCE568E7E8FFCF57942E7)
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| srcFileUris | Array<string> | 是 | 
需保存到媒体库中的图片/视频文件对应的[媒体文件URI](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/user-file-uri-intro#媒体文件uri)。
...
\- 不支持手动拼接的URI，需调用接口获取，获取方式参考[媒体文件URI获取方式](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/user-file-uri-intro#媒体文件uri获取方式)。
 ...
 |
| photoCreationConfigs | Array<[PhotoCreationConfig](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-i#photocreationconfig12)\> | 是 | 
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/3If1utpXQGeyW0ksHq3Y2A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014847Z&HW-CC-Expire=86400&HW-CC-Sign=1496F28FA418087D7C3A054E3102F8BD973A13098BFBD749D17F7ADF1B30AE0E)
...
| :-- | :-- | :-- | :-- |
| srcFileUris | Array<string> | 是 | 
需保存到媒体库中的图片或视频文件对应的[媒体文件URI](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/user-file-uri-intro#媒体文件uri)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ae/v3/zpoJCVl_SFik0abS7N1pwA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014847Z&HW-CC-Expire=86400&HW-CC-Sign=E8DD79D21492BFB457A3617C9C7BC0544C8686FE9078616176FC2EAC9B4850F2)
...
| :-- | :-- | :-- | :-- |
| srcFileUri | string | 是 | 
需要保存到媒体库中的图片/视频文件所对应的[媒体文件URI](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/user-file-uri-intro#媒体文件uri)。
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| photoCreationConfig | [PhotoCreationConfig](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-i#photocreationconfig12); | 是 | 
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7a/v3/i3BQvM9aSdGIfEoLEUekJg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014847Z&HW-CC-Expire=86400&HW-CC-Sign=F10D0B0CAB71CC38A82709A607E9A4DCBBDCA07BB766F5887F9A226EBD0CF4C9)
...
| :-- | :-- | :-- | :-- |
| srcFileUris | Array<string> | 是 | 
需进行授权的图片/视频文件对应的[媒体文件URI](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/user-file-uri-intro#媒体文件uri)。
...
| :-- | :-- |
| 23800301 | 
Internal system error. It is recommended to retry and check the logs.
...
| callback | Callback<[PhotoAssetChangeInfos](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-i#photoassetchangeinfos20)\> | 是 | 
返回变更的媒体资产信息[PhotoAssetChangeInfos](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-i#photoassetchangeinfos20)。
...
| callback | Callback<[PhotoAssetChangeInfos](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-i#photoassetchangeinfos20)\> | 否 | 
取消[on('photoChange')](#onphotochange20)注册时指定的callback监听；不填时，则取消对'photoChange'的所有监听。
...
| callback | Callback<[AlbumChangeInfos](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-i#albumchangeinfos20)\> | 是 | 
返回变更的相册信息[AlbumChangeInfos](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-i#albumchangeinfos20)。
...
| callback | Callback<[AlbumChangeInfos](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-i#albumchangeinfos20)\> | 否 | 
取消[on('photoAlbumChange')](#onphotoalbumchange20)注册时指定的callback监听；不填时，则取消对'photoAlbumChange'的所有监听。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9c/v3/appzad1OSY-XGOrIfYVCUg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014847Z&HW-CC-Expire=86400&HW-CC-Sign=E8D9EDF3731CD9D10D35E8DD18D9AB75635E3E165A9790A19ACDD6F444CCF3FA)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d0/v3/lZFwvS_WR7mVLVUA22ND_A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014847Z&HW-CC-Expire=86400&HW-CC-Sign=FAD0728BC96C799F08ABE08E1CED728C0805A89CFC8D47128F9005BA794988CB)
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| options | [RecentPhotoOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-class#recentphotooptions20) | 否 | 
最近图片配置选项参数。若无此参数，则取按照创建时间排序的最新一张图片。
...
| callback | Callback<[AlbumChangeInfos](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-i#albumchangeinfos20)\> | 是 | 
返回变更的媒体相册信息[PhotoAssetChangeInfos](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-i#photoassetchangeinfos20)。
