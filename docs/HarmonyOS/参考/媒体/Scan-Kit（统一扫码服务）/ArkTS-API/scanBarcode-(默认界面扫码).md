...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/scan-scanbarcode-api"
menu_path:
  - "参考"
  - "媒体"
  - "Scan Kit（统一扫码服务）"
  - "ArkTS API"
  - "scanBarcode (默认界面扫码)"
captured_at: "2026-04-17T01:48:45.965Z"
---
...
| **名称** | **类型** | 只读 | **可选** | **说明** |
| :-- | :-- | :-- | :-- | :-- |
| scanType | scanCore.[ScanType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/scan-scancore#scantype) | 否 | 否 | 
码类型。

**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。

 |
| originalValue | string | 否 | 否 | 
...
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
 ...
 |
| scanCodeRect | [ScanCodeRect](#scancoderect) | 否 | 是 | 
...
**起始版本：** 4.1.0(11)
 ...
 |
| cornerPoints | Array<[Point](#point)\> | 否 | 是 | 

码识别角点位置信息，返回QR Code四个角点。此参数仅图像识码接口[detectBarcode.decodeImage](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/scan-imagedecode#detectbarcodedecodeimage)返回。
...
**起始版本：** 6.0.2(22)
 ...
 |
| source | scanCore.[ScanSource](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/scan-scancore#scansource) | 否 | 是 | 
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/71/v3/uQOn7ygdRF2tiRyXTTHOoA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014848Z&HW-CC-Expire=86400&HW-CC-Sign=BCEF26E56654765FEE47ACD59E568D3189386AF49D1F041E2DCACA396508D8AD)
...
| **名称** | **类型** | 只读 | **可选** | **说明** |
| :-- | :-- | :-- | :-- | :-- |
| scanTypes | Array<scanCore.[ScanType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/scan-scancore#scantype)\> | 否 | 是 | 
设置扫码类型，默认扫码ALL（全部码类型）。

从6.1.0(23)版本开始，默认界面扫码的标题支持根据此参数进行动态显示。
