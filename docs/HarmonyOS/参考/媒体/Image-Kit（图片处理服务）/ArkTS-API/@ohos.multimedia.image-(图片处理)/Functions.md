---
title: "Functions"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-f"
menu_path:
  - "参考"
  - "媒体"
  - "Image Kit（图片处理服务）"
  ...
  - "Functions"
captured_at: "2026-04-17T01:48:40.913Z"
---

# Functions

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6/v3/-z1MR5hHSOu-6FkOW9Qtjw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014842Z&HW-CC-Expire=86400&HW-CC-Sign=0804B4C7683078B0E30FA870DCFC44BB62C449DA4A8831EFB2E578052F2C50D3)
...
图像像素数据的缓冲区，用于初始化PixelMap的像素。初始化前，缓冲区中的像素格式需要由[InitializationOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-i#initializationoptions8).srcPixelFormat指定，否则默认缓冲区的像素格式为BGRA\_8888。
...
| :-- | :-- | :-- | :-- |
| colors | ArrayBuffer | 是 | 
图像像素数据的缓冲区，用于初始化PixelMap的像素。初始化前，必须通过[InitializationOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-i#initializationoptions8).srcPixelFormat指定缓冲区中的像素格式。
...
| allocatorType | [AllocatorType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-e#allocatortype15) | 否 | 

指定创建pixelmap的内存类型，默认内存类型是AllocatorType.AUTO。

1\. image.AllocatorType.AUTO：不支持该内存类型的格式有UNKNOWN、YCBCR\_P010、YCRCB\_P010和ASTC\_4x4。RGBA\_1010102默认申请DMA内存。其他格式（RGB\_565、RGBA\_8888、BGRA\_8888和RGBAF\_16）尺寸大于512\*512默认申请DMA内存，否则申请共享内存。

2\. image.AllocatorType.DMA：RGBA\_1010102、RGB\_565、RGBA\_8888、BGRA\_8888和RGBAF\_16支持DMA内存类型，其余格式不支持。

3\. image.AllocatorType.SHARED：UNKNOWN、RGBA\_1010102、YCBCR\_P010、YCRCB\_P010和ASTC\_4x4不支持共享内存，其余格式支持。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fe/v3/cYHPtxJATCefOBWms_N36Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014842Z&HW-CC-Expire=86400&HW-CC-Sign=5AC468A26E55671C0E2722F905263BFDFAD32DDDF1A6AF4237439610DACCF67D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a7/v3/EB1yGZpBRiOC5QjoAdX89g/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014842Z&HW-CC-Expire=86400&HW-CC-Sign=963549D8F87CC4D55AC7F0AE040A99FAAA8C34CFB56DC7FFBF6E1AC3035EE676)
...
true：进行逆变换，变换的角度与Surface携带的角度一致且方向相反，输出的PixelMap无旋转或翻转效果。

false：不进行逆变换，输出的PixelMap会根据Surface中的变换信息而带有旋转或翻转效果。
...
1\. image.AllocatorType.AUTO：不支持该内存类型的格式有UNKNOWN和ASTC\_4x4。RGBA\_1010102、YCBCR\_P010、YCRCB\_P010格式默认申请DMA内存。其他格式（RGB\_565, RGBA\_8888, BGRA\_8888, RGBAF\_16）尺寸大于512\*512默认申请DMA内存，否则申请共享内存。

2\. image.AllocatorType.DMA：RGB\_565、RGBA\_8888、BGRA\_8888、RGBAF\_16、RGBA\_1010102、YCBCR\_P010和YCRCB\_P010支持DMA内存类型，其余格式不支持。
...
当前支持格式有：.jpg .png .gif .bmp .webp .dng .heic12+ .wbmp23+ .heifs23+ .tiff23+ [.svg10+](#svg标签说明) .ico11+。部分格式的解码能力依赖于具体的设备硬件，建议在调用前使用[image.getImageSourceSupportedFormats20+](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-f#imagegetimagesourcesupportedformats20)接口，动态查询当前设备上的解码能力。
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| options | [ImageReceiverOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-i#imagereceiveroptions23) | 否 | 
创建ImageReceiver的属性，包括图片的默认大小和同时访问的最大图片数。

未传入options时，默认的size为1920\*1080，单位为像素（px），表示期望接收宽为1920px，高为1080px的图片。

未传入options时，默认的capacity为3，表示期望同时最多有3张图片等待读取。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/WhzPwmjkSj6vvQ-uBMrL5w/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014842Z&HW-CC-Expire=86400&HW-CC-Sign=4A2037B16089323FCAE854A7333727B6B106982D6F726FBF17A431CE29CC6E06)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6f/v3/0izyIVw8TQ2JErnui76hAA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014842Z&HW-CC-Expire=86400&HW-CC-Sign=D03B0F49767A925F6BA139729559B6D294C3CEC3D317266F45BFB01EF4B36681)
