...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/vision-image-analyzer"
menu_path:
  - "参考"
  - "AI"
  - "Vision Kit（场景化视觉服务）"
...
captured_at: "2026-04-17T01:49:06.131Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/64/v3/Ykx_RkSFRPOFlXIOJoyLAA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014906Z&HW-CC-Expire=86400&HW-CC-Sign=5EB71D4103B25FCCE6CE6F315DE81662B56C542735BBF51387FA68E03F80EE77)
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| point | [visionBase.Point](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/core-vision-vision-base-api#section1465431712919) | 是 | 相对于图片左上角位置点位（px）。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[AIButtonStatus](#aibuttonstatus)\> | 是 | callback回调函数。接收AIButton展示状态。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[AIButtonStatus](#aibuttonstatus)\> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[ImageAnalyzerVisibility](#imageanalyzervisibility)\> | 是 | callback回调函数。接收AI识图控件可见状态。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[ImageAnalyzerVisibility](#imageanalyzervisibility)\> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<string> | 是 | callback回调函数。接收文字分析结果。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<string> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<string> | 是 | callback回调函数。接收文字选中结果。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[Subject](#subject)\[\]> | 是 | callback回调函数。接收主体分析结果， 返回所有主体信息。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[Subject](#subject)\[\]> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[Subject](#subject)\[\]> | 是 | callback回调函数。接收选中的主体信息。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[ObjectSearchPanelVisibility](#objectsearchpanelvisibility)\> | 是 | callback回调函数。接收图片搜索事件信息。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[ObjectSearchPanelVisibility](#objectsearchpanelvisibility)\> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<void> | 是 | callback回调函数。接收光标移入图片内文字区域事件信息。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<void> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<void> | 是 | callback回调函数。接收光标移出图片内文字区域事件信息。 |
...
| callback | [ErrorCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#errorcallback) | 是 | callback回调函数。接收AI识图异常场景信息。 |
...
| callback | [ErrorCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#errorcallback) | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
