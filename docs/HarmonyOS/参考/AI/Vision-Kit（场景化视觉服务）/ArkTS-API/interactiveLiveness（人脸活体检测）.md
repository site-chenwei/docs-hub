...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/vision-interactive-liveness"
menu_path:
  - "参考"
  - "AI"
  - "Vision Kit（场景化视觉服务）"
...
captured_at: "2026-04-17T01:49:06.102Z"
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| isSilentMode | [DetectionMode](#detectionmode) | 否 | 否 | 
表示的是人脸活体检测模式，默认动作活体检测模式。

INTERACTIVE\_MODE表示动作活体检测模式。

 |
| actionsNum | [ActionsNumber](#actionsnumber) | 否 | 是 | 
...
该参数只有当isSilentMode是INTERACTIVE\_MODE的时候有效。

 |
| successfulRouteUrl | string | 否 | 是 | 
...
当设置隐私模式时，需要申请ohos.permission.PRIVACY\_WINDOW权限。
...
| :-- | :-- | :-- | :-- |
| config | [InteractiveLivenessConfig](#interactivelivenessconfig) | 是 | 跳转到人脸活体检测页面的配置项。 |
| callback | [AsyncCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#asynccallback)<[InteractiveLivenessResult](#interactivelivenessresult) | undefined> | 是 | 回调函数，返回活体检测的结果。当前只适用于RouteRedirectionMode.BACK\_MODE跳转模式。 |
