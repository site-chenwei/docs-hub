---
title: "insightIntent"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/intents-arkts-api-insightintent"
menu_path:
  - "参考"
  - "AI"
  - "Intents Kit（意图框架服务）"
  - "ArkTS API"
  - "insightIntent"
captured_at: "2026-04-17T01:49:05.084Z"
---
...
| intentActionInfo | [IntentActionInfo](#intentactioninfo) | 否 | 否 | 
表示意图的执行信息，例如：已执行或预测将要执行意图的时间。示例请参考[shareIntent](#insightintentshareintent)的示例代码。
...
\- 从5.0.0(12)版本开始，参数类型为IntentActionInfo。该类型定义与5.0.0(12)前版本兼容。
 ...
 |
| intentEntityInfo | [IntentEntityInfo](#intententityinfo) | 否 | 否 | 

表示意图的实体信息，包含行为和事件。示例请参考[shareIntent](#insightintentshareintent)的示例代码。
