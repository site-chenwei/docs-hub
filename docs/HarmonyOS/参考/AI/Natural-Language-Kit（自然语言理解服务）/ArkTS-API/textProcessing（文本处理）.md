...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/natural-language-text-processing-api"
menu_path:
  - "参考"
  - "AI"
  ...
  - "ArkTS API"
  - "textProcessing（文本处理）"
captured_at: "2026-04-17T01:49:05.162Z"
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| entityTypes | [EntityType](#entitytype)\[\] | 否 | 是 | 
实体的类别。
...
| jsonObject | string | 否 | 否 | 
实体的其他字段。详情参考[jsonObject](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/natural-language-json-object-api)。
...
| entityConfig | [EntityConfig](#entityconfig) | 否 | 
实体配置项：实体类别。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3b/v3/ihRLbx7oRq6Jk2Hv_Mit4g/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014905Z&HW-CC-Expire=86400&HW-CC-Sign=7D98E76215B811A0F7AADA7FFF92E83FA26DD5C51226545B3539EDC62A26E82E)
