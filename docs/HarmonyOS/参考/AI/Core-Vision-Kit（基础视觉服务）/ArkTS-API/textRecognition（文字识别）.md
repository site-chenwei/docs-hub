...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/core-vision-text-recognition-api"
menu_path:
  - "参考"
  - "AI"
...
captured_at: "2026-04-17T01:49:04.888Z"
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| isDirectionDetectionSupported | boolean | 否 | 是 | 
表示是否支持文字朝向检测。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| pixelMap | [image.PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap) | 是 | 否 | 
待识别的图片。

具体规格请参考[约束与限制](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/core-vision-introduction#约束与限制)。
...
| callback | [AsyncCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#asynccallback)<[TextRecognitionResult](#textrecognitionresult)\> | 是 | 回调函数，返回文字识别的对象。 |
...
| callback | [AsyncCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#asynccallback)<[TextRecognitionResult](#textrecognitionresult)\> | 是 | 识别结果的回调，可以用于界面显示或交互。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| callback | [AsyncCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#asynccallback)<Array<string>> | 是 | 所支持的[语言类型列表](#语言类型列表)。 |
