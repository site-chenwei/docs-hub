...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/core-vision-subjectsegmentation-api"
menu_path:
  - "参考"
  - "AI"
...
captured_at: "2026-04-17T01:49:04.929Z"
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| pixelMap | [image.PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap) | 否 | 否 | 
待识别的图片。
