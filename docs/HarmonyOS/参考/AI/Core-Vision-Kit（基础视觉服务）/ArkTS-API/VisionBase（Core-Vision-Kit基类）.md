...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/core-vision-vision-base-api"
menu_path:
  - "参考"
  - "AI"
...
captured_at: "2026-04-17T01:49:04.945Z"
---
...
| scene | [SceneMode](#scenemode) | 否 | 是 | 
请求的场景模式。

该参数为预留字段，暂未实现。

 |
| requestId | string | 否 | 是 | 
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[DownloadStartData](#downloadstartdata)\> | 是 | Callback回调返回是哪个资源开始下载。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[DownloadCompleteData](#downloadcompletedata)\> | 是 | Callback回调返回完成下载的资源标识符及版本。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[DownloadCancelData](#downloadcanceldata)\> | 是 | Callback回调返回是哪个资源取消下载。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[DownloadStatusData](#downloadstatusdata)\> | 是 | Callback回调返回下载状态信息。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[DownloadProgressData](#downloadprogressdata)\> | 是 | Callback回调返回下载进度信息。 |
