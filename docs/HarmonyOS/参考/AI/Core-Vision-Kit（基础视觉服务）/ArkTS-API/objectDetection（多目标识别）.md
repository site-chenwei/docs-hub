...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/core-vision-object-detection-api"
menu_path:
  - "参考"
  - "AI"
...
captured_at: "2026-04-17T01:49:04.931Z"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| request | visionBase.[Request](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/core-vision-vision-base-api#request) | 是 | 
