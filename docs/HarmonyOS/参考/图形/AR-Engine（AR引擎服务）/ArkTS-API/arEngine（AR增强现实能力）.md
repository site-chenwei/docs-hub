...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arengine-api-arengine"
menu_path:
  - "参考"
  - "图形"
  - "AR Engine（AR引擎服务）"
  - "ArkTS API"
  - "arEngine（AR增强现实能力）"
captured_at: "2026-04-17T01:48:46.192Z"
---
...
| **名称** | **值** | **说明** |
| :-- | :-- | :-- |
| ARENGINE\_FEATURE\_TYPE\_SLAM | 0 | 平面识别特性。 |
| ARENGINE\_FEATURE\_TYPE\_DEPTH | 1 | 深度估计特性。 |
| ARENGINE\_FEATURE\_TYPE\_MESH | 2 | 环境Mesh识别特性。 |
| ARENGINE\_FEATURE\_TYPE\_IMAGE | 3 | 图像跟踪特性。 |
| ARENGINE\_FEATURE\_TYPE\_SEMANTIC\_DENSE | 4 | 高精几何特性。 |
| ARENGINE\_FEATURE\_TYPE\_SEMANTIC | 5 | 平面和物体语义特性。 |
...
| :-- | :-- | :-- |
| UNKNOWN | 0 | 无效的图像格式。 |
| YUV\_420\_888 | 2 | YUV\_420\_888格式，适用于处理高分辨率的图像数据。 |
| Y\_8 | 3 | Y\_8格式，适用于对图像数据要求较低的精度或存储空间的场景。 |
| Y\_16 | 4 | Y\_16格式，适用于对图像数据精度要求较高的场景。 |
...
世界坐标系的Y轴与重力方向一致，原点为设备所在的原始位置。参见[AR Engine重力对齐世界坐标系](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arengine-coordinate#ar-engine重力对齐世界坐标系)。

 |
| GRAVITY\_AND\_HEADING | 1 | 

由重力和指南针确定。

世界坐标系的Y轴与重力方向一致，X轴指向指南针北向，原点为设备所在的原始位置。参见[AR Engine重力对齐北向坐标系](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arengine-coordinate#ar-engine重力对齐北向坐标系)。

**说明：** 该选项当前仅支持省电模式，请将[ARPowerMode](#arpowermode)置为POWER\_SAVING以启动该选项。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/3EQcQHuySsq1bKf8wLjSiw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014848Z&HW-CC-Expire=86400&HW-CC-Sign=0CF485F7CC8895DFA531998FBEFC2A1A8B799ADAA7799046D036076E53F2030D)
...
| **类型** | **说明** |
| :-- | :-- |
| Promise<[ARAddAugmentedImageResult](#araddaugmentedimageresult)\> | 
...
| planeFindingMode | [ARPlaneFindingMode](#arplanefindingmode) | 否 | 是 | 
平面检测模式。

默认为HORIZONTAL\_AND\_VERTICAL。

 |
| powerMode | [ARPowerMode](#arpowermode) | 否 | 是 | 
...
默认为NORMAL。
 ...
 |
| focusMode | [ARFocusMode](#arfocusmode) | 否 | 是 | 
...
默认为FIXED。
 ...
 |
| semanticMode | [ARSemanticMode](#arsemanticmode) | 否 | 是 | 
...
建议根据设备的内存容量设置内存大小。超出硬件限制可能会导致意外错误。
 ...
 |
| poseMode | [ARPoseMode](#arposemode) | 否 | 是 | 
...
默认为GRAVITY。
 ...
 |
| depthMode | [ARDepthMode](#ardepthmode) | 否 | 是 | 
...
默认为DISABLED。
 ...
 |
| meshMode | [ARMeshMode](#armeshmode) | 否 | 是 | 
...
默认为DISABLED。
 ...
 |
| addAugmentedImageMode | [ARAddAugmentedImageMode](#araddaugmentedimagemode) | 否 | 是 | 
...
默认为NORMAL。
 ...
 |
| semanticDenseMode | [ARSemanticDenseMode](#arsemanticdensemode) | 否 | 是 | 
...
**起始版本：** 6.0.0(20)
 ...
 |
| cameraLensFacing | [ARCameraLensFacing](#arcameralensfacing) | 否 | 是 | 

相机镜头朝向配置项。当cameraLensFacing配置为FRONT时，type配置为[ARType](#artype).FACE或[ARType](#artype).BODY才生效。
...
**起始版本：** 6.1.0(23)
 ...
 |
| multiFaceMode | [ARMultiFaceMode](#armultifacemode) | 否 | 是 | 

多人脸模式配置项。

默认为MULTIFACE\_DISABLE。

**起始版本：** 6.1.0(23)

 |
| maxDetectedBodyNum | number | 否 | 是 | 

当类型为ARType.Body 时，需要检测的人体数量最大值。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/56/v3/EJSQYm-dSpqPqUb37VckQA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014848Z&HW-CC-Expire=86400&HW-CC-Sign=4AB9A22212E1C1162842904EF37128C48C63D2D80FB6FB2532C85E39ED0800BD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d/v3/kFLbOmdZSO2jYRE4-SYHpg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014848Z&HW-CC-Expire=86400&HW-CC-Sign=9383F97B230AB855DCBA1158F115EC0D4F658B1CCE500D38E1847376850B2B6B)
...
| **类型** | **说明** |
| :-- | :-- |
| Array<[ARBlendShapeType](#arblendshapetype)\> | 混合形状的类型。 |
...
acquireBodySkeleton(): Array<[ARBody](#arbody)\>
