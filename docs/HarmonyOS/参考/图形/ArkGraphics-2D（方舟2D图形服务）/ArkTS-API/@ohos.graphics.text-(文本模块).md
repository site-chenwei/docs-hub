...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-text"
menu_path:
  - "参考"
  - "图形"
...
captured_at: "2026-04-17T01:48:47.206Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/33/v3/z2YDNboOToyFSfHniqlC5Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014849Z&HW-CC-Expire=86400&HW-CC-Sign=FDF27CEED0FE09FEC2EE5120A4353DA4F940D826970D5DBD0BF48D9901AB6D6F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/16/v3/VHp_X00jRsqSw9iR8hnUIg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014849Z&HW-CC-Expire=86400&HW-CC-Sign=C300A03584EB4A9AB8B8521E510EED3CF6AE6CA1A81E38AFABE399364E1F8024)
...
**元服务API**：从API version 22开始，该接口支持在元服务中使用。
 ...
 |
| weight | [FontWeight](#fontweight) | 否 | 是 | 
...
**元服务API**：从API version 22开始，该接口支持在元服务中使用。
 ...
 |
| localPostscriptName23+ | string | 否 | 是 | 
...
**元服务API**：从API version 23开始，该接口支持在元服务中使用。
 ...
 |
| localSubFamilyName23+ | string | 否 | 是 | 
...
| index | number | 否 | 
字体文件格式为ttc时，指定加载的字体索引。默认为0：表示加载ttc的第一个字体。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| textStyle | [TextStyle](#textstyle) | 否 | 是 | 
作用于整个段落的文本样式，默认为初始的文本样式。

**元服务API：** 从API version 22开始，该接口支持在元服务中使用。

 |
| textDirection | [TextDirection](#textdirection) | 否 | 是 | 
...
**元服务API：** 从API version 22开始，该接口支持在元服务中使用。
 ...
 |
| wordBreak | [WordBreak](#wordbreak) | 否 | 是 | 
...
**元服务API：** 从API version 22开始，该接口支持在元服务中使用。
 ...
 |
| breakStrategy | [BreakStrategy](#breakstrategy) | 否 | 是 | 
...
**元服务API：** 从API version 22开始，该接口支持在元服务中使用。
 ...
 |
| strutStyle | [StrutStyle](#strutstyle) | 否 | 是 | 
...
**元服务API：** 从API version 22开始，该接口支持在元服务中使用。
 ...
 |
| textHeightBehavior | [TextHeightBehavior](#textheightbehavior) | 否 | 是 | 
...
**元服务API：** 从API version 22开始，该接口支持在元服务中使用。
 ...
 |
| tab18+ | [TextTab](#texttab18) | 否 | 是 | 

表示段落中文本制表符后的文本对齐方式及位置，默认将制表符替换为一个空格。此参数与文本对齐方式（align属性）或省略号样式（[TextStyle](#textstyle)中的ellipsis属性）共同配置时无效。

**元服务API：** 从API version 22开始，该接口支持在元服务中使用。

 |
| trailingSpaceOptimized20+ | boolean | 否 | 是 | 

表示文本排版时行尾空格是否参与对齐计算。true表示行尾空格不参与计算，false表示行尾空格参与计算，默认值为false。

**元服务API：** 从API version 22开始，该接口支持在元服务中使用。

 |
| autoSpace20+ | boolean | 否 | 是 | 
...
**元服务API：** 从API version 22开始，该接口支持在元服务中使用。
 ...
 |
| verticalAlign20+ | [TextVerticalAlign](#textverticalalign20) | 否 | 是 | 

文本垂直对齐方式，开启行高缩放（即设置[TextStyle](#textstyle)的heightScale）或行内不同字号（即设置[TextStyle](#textstyle)的fontSize）文本混排时生效。若行内有上下标文本（即设置[TextStyle](#textstyle)的badgeType属性文本），上下标文本将与普通文本一样参与垂直对齐。

**元服务API：** 从API version 22开始，该接口支持在元服务中使用。

 |
| lineSpacing21+ | number | 否 | 是 | 

行间距，默认值为0。lineSpacing不受[TextStyle](#textstyle)中lineHeightMaximum和lineHeightMinimum限制。尾行默认添加行间距，可通过设置[TextStyle](#textstyle).textHeightBehavior为DISABLE\_ALL或DISABLE\_LAST\_ASCENT禁用尾行行间距。

**元服务API：** 从API version 22开始，该接口支持在元服务中使用。

 |
| compressHeadPunctuation23+ | boolean | 否 | 是 | 
...
**元服务API：** 从API version 23开始，该接口支持在元服务中使用。
 ...
 |
| includeFontPadding23+ | boolean | 否 | 是 | 
...
**元服务API：** 从API version 23开始，该接口支持在元服务中使用。
 ...
 |
| fallbackLineSpacing23+ | boolean | 否 | 是 | 
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2d/v3/CADzSQtRSiGScg0UqqvzcQ/zh-cn_image_0000002538181770.png?HW-CC-KV=V1&HW-CC-Date=20260417T014849Z&HW-CC-Expire=86400&HW-CC-Sign=611096A67EC864D959760A35D8C39899DA3B059C7CDBC454F258D6C13EEA475F)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/RP8tYg0LTI6zefapPLd1CQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014849Z&HW-CC-Expire=86400&HW-CC-Sign=65275FFA889ECE68620B2825CACEE5D2F2622BB8C537D5CF8FD189E6C546578C)

示意图展示了后三种对齐方式，前三种对齐方式类似，比较位置是文本基线，即绿色线条部分。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/df/v3/JexbTNUsSCOK4CK4VAWzAQ/zh-cn_image_0000002569021557.png?HW-CC-KV=V1&HW-CC-Date=20260417T014849Z&HW-CC-Expire=86400&HW-CC-Sign=19F613C7717232C62932A36CCAD866AB5EB5DE962C0DD8DBC824AB20999F7711)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ff/v3/JpneTE3pT8mKPczk0Dv_6g/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014849Z&HW-CC-Expire=86400&HW-CC-Sign=938CF906676F133C3171C5BED994CC6ED28EF1EC3B339AE00659B77DCF951065)

示意图展示了点击按钮后layout接口示例代码的运行结果。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2a/v3/g2eRDTHLRZKpdGGzuZ9u7Q/zh-cn_image_0000002568901547.png?HW-CC-KV=V1&HW-CC-Date=20260417T014849Z&HW-CC-Expire=86400&HW-CC-Sign=0C5C2451E20A5AC9E3CCA457B58C8F9EAE951279E4C964D9F8D912F0A1C164AB)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/3PQv7B2dTFqG_RUKobW-Xg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014849Z&HW-CC-Expire=86400&HW-CC-Sign=8077962CE52D4091360C26D3D2E107F0BE27B5E50441FCF998D693864CE706E1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1