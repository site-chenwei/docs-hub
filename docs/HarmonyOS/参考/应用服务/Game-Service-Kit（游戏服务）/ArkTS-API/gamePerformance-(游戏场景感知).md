...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/gameservice-gameperformance"
menu_path:
  - "参考"
  - "应用服务"
...
captured_at: "2026-04-17T01:48:57.751Z"
---
...
| thermalInfo | [ThermalInfo](#thermalinfo) | 否 | 是 | 
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| :-- | :-- | :-- | :-- | :-- |
| maxPictureQualityLevel | number | 否 | 否 | 
支持的画质最高等级。
...
5：超高清
 ...
 |
| currentPictureQualityLevel | number | 否 | 否 | 
...
| recommendedCpuLevel | number | 否 | 是 | 
...
3：High（高）
 ...
 |
| recommendedGpuLevel | number | 否 | 是 | 
...
3：High（高）
 ...
 |
| recommendedDdrLevel | number | 否 | 是 | 
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/vfHrNhwbR4eDoAUENNtoGA/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014857Z&HW-CC-Expire=86400&HW-CC-Sign=7E268250A11BB402C4BC97168799A8A5457F95B157A914ECCAA7DA261C50655C)
...
| parameters | Record<string, string> | 否 | 是 | 
设备状态信息参数。
...
\- key取值固定为[DeviceInfoParameterKey](#deviceinfoparameterkey).THERMAL\_TEMP\_LEVEL。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/60/v3/RvavHpPnRFCA1xxVbMdt8g/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014857Z&HW-CC-Expire=86400&HW-CC-Sign=EDFAF365ECEB28DED81EDFA4CAED1D9F8A843546A4A87ADCCED2CBDA0EBF4BBF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ef/v3/pLmjHKJXRlq60oyWaV87lA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014857Z&HW-CC-Expire=86400&HW-CC-Sign=06E92B21A54FEB4AE9770552FD3C5FB463F0F4BFDDE0D0558FB57FAC91AC562F)
...
| :-- | :-- | :-- | :-- |
| type | string | 是 | 监听的事件类型，目前仅支持监听deviceStateChanged（设备状态变化）事件。 |
| callback | Callback<[DeviceInfo](#deviceinfo)\> | 否 | 
回调函数，返回设备信息。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8f/v3/GKKrBzI9T4SpsbokZTnyBQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014857Z&HW-CC-Expire=86400&HW-CC-Sign=E3D3402D803A0C207BED3B36D2957D69534DE1E8F39216741B890385B36BC53A)
