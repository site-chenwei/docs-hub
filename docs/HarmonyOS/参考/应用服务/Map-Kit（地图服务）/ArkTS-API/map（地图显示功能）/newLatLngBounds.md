...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-newlatlngbounds"
menu_path:
  - "参考"
  - "应用服务"
  - "Map Kit（地图服务）"
  ...
  - "map（地图显示功能）"
  - "newLatLngBounds"
captured_at: "2026-04-17T01:48:59.935Z"
---
...
| :-- | :-- | :-- | :-- |
| bounds | [mapCommon.LatLngBounds](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#latlngbounds) | 是 | 地图显示经纬度范围。 |
| padding | [mapCommon.Padding](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#padding) | 是 | 
