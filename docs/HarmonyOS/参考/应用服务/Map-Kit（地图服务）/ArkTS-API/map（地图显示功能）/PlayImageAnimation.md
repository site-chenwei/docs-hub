...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-playimageanimation"
menu_path:
  - "参考"
  - "应用服务"
  - "Map Kit（地图服务）"
  ...
  - "map（地图显示功能）"
  - "PlayImageAnimation"
captured_at: "2026-04-17T01:48:59.606Z"
---
...
| **参数名** | **类型** | 必填 | **说明** |
| :-- | :-- | :-- | :-- |
| images | Array<[ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | [image.PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap)\> | 是 | 
动画的图片资源。
