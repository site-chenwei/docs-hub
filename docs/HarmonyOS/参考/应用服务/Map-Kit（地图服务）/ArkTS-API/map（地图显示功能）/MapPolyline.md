---
title: "MapPolyline"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mappolyline"
menu_path:
  - "参考"
  - "应用服务"
  - "Map Kit（地图服务）"
  ...
  - "map（地图显示功能）"
  - "MapPolyline"
captured_at: "2026-04-17T01:48:59.371Z"
---
...
| 参数名 | **类型** | 必填 | **说明** |
| :-- | :-- | :-- | :-- |
| endCap | [mapCommon.CapStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#capstyle) | 是 | 折线的末尾端点样式。 |
...
| 参数名 | **类型** | 必填 | **说明** |
| :-- | :-- | :-- | :-- |
| jointType | [mapCommon.JointType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#jointtype) | 是 | 节点类型。 |
...
| 参数名 | **类型** | 必填 | **说明** |
| :-- | :-- | :-- | :-- |
| patterns | Array<[mapCommon.PatternItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#patternitem)\> | 是 | [PatternItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#patternitem)对象的集合。 |
...
| 参数名 | **类型** | 必填 | **说明** |
| :-- | :-- | :-- | :-- |
| points | Array<[mapCommon.LatLng](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#latlng)\> | 是 | 折线顶点的集合。默认情况下，折线不闭合；要形成闭合的折线，起点和终点必须相同。 |
...
| 参数名 | **类型** | 必填 | **说明** |
| :-- | :-- | :-- | :-- |
| startCap | [mapCommon.CapStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#capstyle) | 是 | 折线的起始端点样式。 |
...
| 参数名 | **类型** | 必填 | **说明** |
| :-- | :-- | :-- | :-- |
| customTexture | [ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | [image.PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap) | 是 | 折线纹理。建议纹理使用没有背景色（透明色）的图片。 |
...
| :-- | :-- | :-- | :-- |
| customTexture | [ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | [image.PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap) | 是 | 折线纹理。建议纹理使用没有背景色（透明色）的图片。 |
| isTextureMappingUsed | boolean | 是 | 
