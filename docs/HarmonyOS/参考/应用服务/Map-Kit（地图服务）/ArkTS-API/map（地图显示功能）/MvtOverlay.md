---
title: "MvtOverlay"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mvtoverlay"
menu_path:
  - "参考"
  - "应用服务"
  - "Map Kit（地图服务）"
  ...
  - "map（地图显示功能）"
  - "MvtOverlay"
captured_at: "2026-04-17T01:48:59.820Z"
---
...
| **参数名** | **类型** | 必填 | **说明** |
| :-- | :-- | :-- | :-- |
| blurIntensity | number | Record<number, number> | 是 | 
矢量图层的模糊度，不支持3D地球。
