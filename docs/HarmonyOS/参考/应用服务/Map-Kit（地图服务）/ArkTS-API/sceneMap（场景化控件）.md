...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-scenemap"
menu_path:
  - "参考"
  - "应用服务"
  - "Map Kit（地图服务）"
  - "ArkTS API"
  - "sceneMap（场景化控件）"
captured_at: "2026-04-17T01:49:00.115Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/dtrMz5EvSDCd3dNh-g1ONg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014900Z&HW-CC-Expire=86400&HW-CC-Sign=0309851F48ECAEE4BC02D004217B710F6C76A6EBFB4810CBF0FF889AB273F410)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9d/v3/07Ru2hU6TzOCM53B7GgbqQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014900Z&HW-CC-Expire=86400&HW-CC-Sign=EA00F9F8ED5726789668DF5A3A087D95FC4D55080998ABD6A43EAA6D489A6707)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/18/v3/WwdzMxvbTR6fxerxAbxQaQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014900Z&HW-CC-Expire=86400&HW-CC-Sign=5C8F780350A5D8E965D6DCCE597B35157F40EB74BCB4176793EDA0E005A93E79)
...
语言，请参见[地图Picker支持语言](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/map-language#地图picker支持语言)，如果未设置，默认使用系统语言。异常值按默认值处理。
...
版本4.1.0(11)~5.1.1(19)为预留字段，从版本6.0.0(20)开始使用。
 ...
 |
| themeColor | [CustomColors](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-theme#customcolors) | 否 | 是 | 
...
**元服务API：** 从版本5.0.3(15)开始，该接口支持在元服务中使用。
 ...
 |
| cancelCallback | Callback<void> | 否 | 是 | 
...
**元服务API：** 从版本5.0.3(15)开始，该接口支持在元服务中使用。
 ...
 |
| transitionDuration | number | 否 | 是 | 

转场动效时间，默认值：-1，取值范围\[0, Number.MAX\_VALUE)，异常值将按照默认值-1处理，保持[interpolatingSpring](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-curve#curvesinterpolatingspring10)(0.5, 1, 328, 36)。2in1设备当前不显示转场动效，该配置不生效。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/aa/v3/6RKlxDFmTZqcRU-EqIY1zQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014900Z&HW-CC-Expire=86400&HW-CC-Sign=CF4CDBFD4A1F2571D092C66D43DB47E2C62C94EA137BE2A401761A314A75B33D)
...
指定需要展示的POI类别。取值范围参见[HwLocationType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-poi#hwlocationtype)。

**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。

 |
| searchEnabled | boolean | 否 | 是 | 
...
**元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。
 ...
 |
| addressComponent | [site.AddressComponent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-site#addresscomponent) | 否 | 是 | 
...
**元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。
 ...
 |
| snapshot | [image.PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap) | 否 | 是 | 
...
设置页面语言，请参见[地图Picker支持语言](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/map-language#地图picker支持语言)，如果未设置，默认使用系统语言。异常值按默认值处理。
...
转场动效时间，默认值：-1，取值范围\[0, Number.MAX\_VALUE)，异常值将按照默认值-1处理，保持[interpolatingSpring](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-curve#curvesinterpolatingspring10)(0.5, 1, 328, 36)。当subWindowEnabled为true时该配置不生效。
...
省份：ADMINISTRATIVE\_AREA\_LEVEL\_1

城市：ADMINISTRATIVE\_AREA\_LEVEL\_2

区/县：ADMINISTRATIVE\_AREA\_LEVEL\_3

街道：ADMINISTRATIVE\_AREA\_LEVEL\_4
