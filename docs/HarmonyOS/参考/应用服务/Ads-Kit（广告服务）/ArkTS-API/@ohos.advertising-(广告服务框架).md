...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-advertising"
menu_path:
  - "参考"
  - "应用服务"
  - "Ads Kit（广告服务）"
...
captured_at: "2026-04-17T01:48:56.377Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/iP0HAXioTZCLLcV4BEAQlw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014856Z&HW-CC-Expire=86400&HW-CC-Sign=732181CC757C4AE4D93F8BABEB16A0A2F041FCA4F13E381AF4425DD0ECE5B5C5)
...
| **参数名** | **类型** | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| ad | [Advertisement](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-advertising#advertisement) | 是 | 广告对象。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e1/v3/ON8J1YPTRYyvIDHDlTV82Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014856Z&HW-CC-Expire=86400&HW-CC-Sign=064DE94D6D79B3D199C02B4F2839F3A09EDFEE7EB774BDE629763EBD0D553A39)
...
| **参数名** | **类型** | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| adParams | [AdRequestParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-advertising#adrequestparams)\[\] | 是 | 
广告请求参数。
...
| 名称 | **类型** | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| ads | Array<[Advertisement](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-advertising#advertisement)\> | 是 | 广告数据。 |
...
| **参数名** | **类型** | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| adsMap | Map<string, Array<[Advertisement](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-advertising#advertisement)\>> | 是 | 广告数据。 |
...
\- onBackClicked：点击返回按钮。
 ...
 |
| ad | [Advertisement](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-advertising#advertisement) | 是 | 发生状态变化的广告内容。 |
| data | string | 是 | 
...
| 名称 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| tagForChildProtection | number | 否 | 
...
默认为-1。
 ...
 |
| adContentClassification | string | 否 | 
...
不填以业务逻辑为准。
 ...
 |
| \[key: string\] | number | boolean | string | undefined | 否 | 
...
说明：[getAdRequestBody](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-advertising#advertisinggetadrequestbody12)接口可以不传该参数。
...
| useMobileDataReminder | boolean | 否 | 
...
\- false：未被点击。
 ...
 |
| rewardVerifyConfig | Map<string, string> | 否 | 否 | 
