---
title: "申请免密代扣"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-partner-withhold-apply"
menu_path:
  - "参考"
  - "应用服务"
  - "Payment Kit（鸿蒙支付服务）"
  ...
  - "签约代扣"
  - "申请免密代扣"
captured_at: "2026-04-17T01:49:02.297Z"
---
...
2\. 代扣请求接口成功，原商户订单号重入，接口幂等返回。该笔订单状态以异步结果通知或同步查询接口里为准。

 | 代扣请求成功，代扣订单查询或代扣回调通知扣款状态为TRX\_FAILED，则订单进入失败终态。如需重新扣款时，需要换单重试。 |
