---
title: "实名信息授权结果查询"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-api-common-auth-result"
menu_path:
  - "参考"
  - "应用服务"
  - "Payment Kit（鸿蒙支付服务）"
  ...
  - "实名信息验证与授权"
  - "实名信息授权结果查询"
captured_at: "2026-04-17T01:49:02.803Z"
---
...
| 参数 | 是否必选 | 类型 | 说明 |
| :-- | :-- | :-- | :-- |
| realNameAuthId | 是 | String | 实名信息授权ID。[应用端接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-realnameservice#realnameservicestartrealnameauth)用户授权实名信息时返回的授权ID，长度范围为1-10。 |
