---
title: "实名信息验证结果查询"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-api-common-verification-result"
menu_path:
  - "参考"
  - "应用服务"
  - "Payment Kit（鸿蒙支付服务）"
  ...
  - "实名信息验证与授权"
  - "实名信息验证结果查询"
captured_at: "2026-04-17T01:49:02.806Z"
---
...
| 参数 | 是否必选 | 类型 | 说明 |
| :-- | :-- | :-- | :-- |
| verifyResultId | 是 | String | 实名信息验证ID。[应用端接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-realnameservice#realnameservicestartrealnameverification)返回的用户实名信息验证ID。 |
...
| failedReason | 否 | String | 
开发者预期可以感知的验证错误原因。

\- ID\_TYPE\_NOT\_SUPPORT：证件类型不支持（当前华为支付开放实名验证能力仅支持身份证）

\- RARE\_WORD\_NOT\_SUPPORT：生僻字场景不支持 （如姓名中携带了生僻字）
