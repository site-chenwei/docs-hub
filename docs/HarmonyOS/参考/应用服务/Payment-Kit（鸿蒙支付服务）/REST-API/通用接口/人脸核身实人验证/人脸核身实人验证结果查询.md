---
title: "人脸核身实人验证结果查询"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-api-common-face-verifactaion-result"
menu_path:
  - "参考"
  - "应用服务"
  - "Payment Kit（鸿蒙支付服务）"
  ...
  - "人脸核身实人验证"
  - "人脸核身实人验证结果查询"
captured_at: "2026-04-17T01:49:02.882Z"
---
...
| 参数 | 是否必选 | 类型 | 说明 |
| :-- | :-- | :-- | :-- |
| verifyResultId | 是 | String | 验证结果ID。[应用端接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-realnameservice#realnameservicestartfaceverification)返回的验证结果ID。 |
