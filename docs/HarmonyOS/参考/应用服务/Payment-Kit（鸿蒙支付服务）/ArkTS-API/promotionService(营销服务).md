...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-promotionservice"
menu_path:
  - "参考"
  - "应用服务"
  - "Payment Kit（鸿蒙支付服务）"
...
captured_at: "2026-04-17T01:49:00.922Z"
---
...
\- false：否（默认）。
 ...
 |
| receiveButtonClicked | boolean | 否 | 否 | 
...
| 类型 | **说明** |
| :-- | :-- |
| Promise<[UserAction](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-promotionservice#useraction)\> | Promise对象。返回[UserAction](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-promotionservice#useraction)的Promise对象。 |
...
| 类型 | **说明** |
| :-- | :-- |
| Promise<[CouponDetail](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-promotionservice#coupondetail)\[\]> | Promise对象。返回CouponDetail数组的Promise对象。 |
