...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfviewmanage"
menu_path:
  - "参考"
  - "应用服务"
  - "PDF Kit（PDF服务）"
...
captured_at: "2026-04-17T01:49:03.066Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e/v3/d6SG-QdJRGuiLw9TrU-gEw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014903Z&HW-CC-Expire=86400&HW-CC-Sign=613002B6F1C36F1A6C59339A0B6C3380136CBAF3578105A0C788DE1463A6FF66)
...
| :-- | :-- |
| boolean | 
是否设置成功，true：是，false：否。

当传入的maxZoom小于当前的最小缩放比例、超出\[0.1 ~ 10\]的范围、输入值为空时，均会返回false。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/12/v3/EAm0EAouTUWjpyif_MvWiQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014903Z&HW-CC-Expire=86400&HW-CC-Sign=88133D26688EEA3397938D9894B6578DC7A25DBC999D199841ACE32526A85229)
...
当传入的minZoom大于当前的最大缩放比例、超出\[0.1 ~ 10\]的范围、输入值为空时，均会返回false。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/33/v3/2MKJw1GoTyCu25r4iJs-aA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014903Z&HW-CC-Expire=86400&HW-CC-Sign=DC83E7316D997C59BDE2E3F02548FD82D7412BA690FC1F302338F8B067562090)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8c/v3/dwB__n-jRKGziruYeyOD9g/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014903Z&HW-CC-Expire=86400&HW-CC-Sign=5B7F4193948397674B63EB24AC94B108B379DE2AC3A39DC6EF8D4EA7CA7D8480)
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| scrollUp | [PdfNestedScrollMode](#pdfnestedscrollmode) | 否 | 是 | 
可滑动组件往上滑动时的嵌套滑动选项。

默认值：PdfNestedScrollMode.SELF\_ONLY。

 |
| scrollDown | [PdfNestedScrollMode](#pdfnestedscrollmode) | 否 | 是 | 
...
默认值：PdfNestedScrollMode.SELF\_ONLY。
 ...
 |
| scrollLeft | [PdfNestedScrollMode](#pdfnestedscrollmode) | 否 | 是 | 
...
默认值：PdfNestedScrollMode.SELF\_ONLY。
 ...
 |
| scrollRight | [PdfNestedScrollMode](#pdfnestedscrollmode) | 否 | 是 | 
