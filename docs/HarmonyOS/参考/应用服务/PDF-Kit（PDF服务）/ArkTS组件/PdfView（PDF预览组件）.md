...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfview-component"
menu_path:
  - "参考"
  - "应用服务"
  - "PDF Kit（PDF服务）"
  - "ArkTS组件"
  - "PdfView（PDF预览组件）"
captured_at: "2026-04-17T01:49:03.003Z"
---
...
| pageLayout | pdfService.[PageLayout](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#pagelayout) | 否 | 否 | 页面布局显示模式。 |
| isContinuous | boolean | 否 | 否 | 是否连续预览，true：是，false：否。 |
| showScroll | boolean | 否 | 否 | 是否显示滚动条，true：显示，false：隐藏。 |
| pageFit | pdfService.[PageFit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#pagefit) | 否 | 否 | 页面适配模式。 |
