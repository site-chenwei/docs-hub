---
title: "归因结果回传"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/store-rest-receive"
menu_path:
  - "参考"
  - "应用服务"
  ...
  - "REST API"
  - "归因结果回传"
captured_at: "2026-04-17T01:48:56.761Z"
---
...
**说明：** 通过[申请开通权限](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/store-attribution-register#开通权限)方式向分发平台、开发者开放。

 |
| business\_scene | number | 否 | 否 | 

业务场景值，仅开发者满足回传条件时携带。

取值范围：\[0,99\]。

**说明：** 通过[申请开通权限](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/store-attribution-register#开通权限)方式向开发者开放。

 |
| trigger\_data | number | 否 | 是 | 
...
[自定义转化事件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/store-attribution-trigger-custom)取值范围：\[501, 600\]。
 ...
 |
| installation\_status | number | 否 | 否 | 

应用安装状态。

**说明：** 通过[申请开通权限](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/store-attribution-register#开通权限)方式向应用生态伙伴（分发平台、开发者、归因监测平台）开放。
...
2.  您可以使用以下代码对回传请求中签名值进行验签。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5c/v3/HzA9GSMmR7aC98mfHoPe6A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014856Z&HW-CC-Expire=86400&HW-CC-Sign=1B9F233610985E7EEEAFFF768272FA4961C16EA8D8915B5E2CB110111F16FB1C)
