...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wallet-walletpass"
menu_path:
  - "参考"
  - "应用服务"
  - "Wallet Kit（钱包服务）"
  - "ArkTS API"
  - "walletPass（Pass卡片能力）"
captured_at: "2026-04-17T01:49:04.229Z"
---
...
\- jweContent：[生成JWE数据](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wallet-rest-api-carkey#生成jwe数据)章节生成的开卡签名数据包。
...
\- serialNumber：[申请钥匙卡片](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wallet-rest-api-carkey#申请钥匙卡片)时定义的卡券唯一标识。
