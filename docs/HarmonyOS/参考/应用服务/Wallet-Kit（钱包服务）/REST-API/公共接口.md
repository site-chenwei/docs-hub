---
title: "公共接口"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wallet-rest-api-public"
menu_path:
  - "参考"
  - "应用服务"
  - "Wallet Kit（钱包服务）"
  - "REST API"
  - "公共接口"
captured_at: "2026-04-17T01:49:04.355Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9/v3/v0UZOaz9T3Wf48Ep7Fc8Og/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014904Z&HW-CC-Expire=86400&HW-CC-Sign=DD7B2A47C30072DA2E648C05C67DAA3AD3A36AD533C777199138EFC20CAA8C02)
...
| requestBody | transId | String | 必选 | 随机数。 |
| signature | \- | String | 必选 | Applet的身份私钥对requestBody的Hash值的签名。 |
| certificate | signature | String | 必选 | 
在[设备认证](#设备认证)接口返回的certificate的签名。

DK业务管理服务使用[创建Wallet Kit服务](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/wallet-preparations)步骤5生成的私钥对Applet的身份公钥签名信息。
