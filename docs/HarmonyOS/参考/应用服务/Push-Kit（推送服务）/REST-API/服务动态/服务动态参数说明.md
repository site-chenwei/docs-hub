---
title: "服务动态参数说明"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/push-api-service-timeline-param"
menu_path:
  - "参考"
  - "应用服务"
  - "Push Kit（推送服务）"
  ...
  - "服务动态"
  - "服务动态参数说明"
captured_at: "2026-04-17T01:49:03.735Z"
---
...
| :-- | :-- | :-- |
| status | Integer | 
服务动态指定场景下指定子场景状态。例如：发送**外卖**场景下**外卖自取**子场景“待支付”状态，则status=1。详细参数取值参见[指定状态下发送服务动态参数要求](#指定状态下发送服务动态参数要求)。
...
图片SKUId，商家图片托管分配的资源唯一标识。需要通过[申请权益](https://developer.huawei.com/consumer/cn/doc/atomic-guides/push-as-timeline#section592010820304)提供图片获取SKUId。最大长度128。示例：Image\_001
...
| :-- | :-- | :-- |
| status | Integer | 
服务动态指定场景下指定子场景状态。例如：发送**外卖**场景下**外卖配送**子场景“制作中”状态，则status=3。详细参数取值参见[指定状态下发送服务动态参数要求](#指定状态下发送服务动态参数要求-1)。
