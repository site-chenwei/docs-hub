...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/cloudfoundation-cloudstorage"
menu_path:
  - "参考"
  - "应用服务"
  ...
  - "ArkTS API"
  - "cloudStorage (云存储模块)"
captured_at: "2026-04-17T01:48:58.431Z"
---
...
传入''（空字符串）表示获取云侧根路径下的文件列表；传入'some\_directory/'表示获取指定文件夹some\_directory下的文件列表。
