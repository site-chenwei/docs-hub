...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/cloudfoundation-cloudfunction"
menu_path:
  - "参考"
  - "应用服务"
  ...
  - "ArkTS API"
  - "cloudFunction (云函数模块)"
captured_at: "2026-04-17T01:48:57.032Z"
---
...
**元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。
 ...
 |
| loadMode | [LoadMode](#loadmode) | 否 | 是 | 
...
本地启动的云函数地址，格式为http://域名:端口，例如http://localhost:18090。
...
**设备行为差异：** 该参数在Phone、Tablet、PC/2in1中可正常使用，在其他设备类型中传此参数时，返回1008211001错误码。

**说明：** HarmonyOS 5.0.3版本增强了预加载功能，将多种预加载能力（如安装预加载、周期性预加载）整合进了一套全新的API中，使体验更加友好，具体请参见[cloudResPrefetch（预加载模块）](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/cloudfoundation-cloudresprefetch)。
