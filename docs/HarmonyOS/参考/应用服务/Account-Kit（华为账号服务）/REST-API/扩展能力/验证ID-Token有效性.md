---
title: "验证ID Token有效性"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-verify-id-token"
menu_path:
  - "参考"
  - "应用服务"
  - "Account Kit（华为账号服务）"
  ...
  - "扩展能力"
  - "验证ID Token有效性"
captured_at: "2026-04-17T01:48:56.266Z"
---

# 验证ID Token有效性

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/30/v3/_lgB2CgIQTWobJrjKeBodw/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014856Z&HW-CC-Expire=86400&HW-CC-Sign=4CAB50DCED7B90F216267CA341B26D0781EDC05479555798A413766E98915519)
...
| :-- | :-- | :-- | :-- |
| 1203 | 100305 | id\_token的header解析失败。 | 
id\_token格式错误或者伪造的id\_token。
...
\- 检查是否为华为账号返回的原始值。
 ...
 |
| 1203 | 100306 | id\_token的payload解析失败。 | 
...
\- 检查是否为华为账号返回的原始值。
 ...
 |
| 1203 | 150023 | id\_token的signature解析失败。 | 
