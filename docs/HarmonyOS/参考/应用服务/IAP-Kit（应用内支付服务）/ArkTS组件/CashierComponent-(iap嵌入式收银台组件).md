...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/iap-cashier-component"
menu_path:
  - "参考"
  - "应用服务"
  - "IAP Kit（应用内支付服务）"
...
captured_at: "2026-04-17T01:48:58.521Z"
---
...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| params | [iap.PurchaseParameter](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/iap-iap#purchaseparameter) | 是 | 
@Require
