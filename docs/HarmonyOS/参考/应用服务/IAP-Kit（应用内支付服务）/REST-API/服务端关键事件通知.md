---
title: "服务端关键事件通知"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/iap-key-event-notifications"
menu_path:
  - "参考"
  - "应用服务"
  - "IAP Kit（应用内支付服务）"
  - "REST API"
  - "服务端关键事件通知"
captured_at: "2026-04-17T01:48:58.800Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a4/v3/3ahCnS49S0GHgVn0Wx_-Dw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014858Z&HW-CC-Expire=86400&HW-CC-Sign=AEF1C2421D9E3C517EDC24963B47D4DC9C1ADBF19F08C4A4CDED07726A3E169F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/49/v3/-ugvdnlhRn2AtlgNx8k_Yg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014858Z&HW-CC-Expire=86400&HW-CC-Sign=7E4B90304020CD1F8C1CC94C5802D1798690D7AA647AB14751FFE7920840F94D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2d/v3/mEGw95grStO2lQFfndJFDg/zh-cn_image_0000002569021563.png?HW-CC-KV=V1&HW-CC-Date=20260417T014858Z&HW-CC-Expire=86400&HW-CC-Sign=E2C56B2029A9BF7D37AE71AFA93EB82394B0827A1B904328C695E51231EDA7EC)
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| :-- | :-- | :-- | :-- |
| jwsNotification | 是 | String | 
通知内容信息，对通知内容NotificationPayload签名后的字符串。具体请参见表[NotificationPayload](#notificationpayload)。
...
| EXPIRE | 订阅已过期。 |
| TEST | 
测试服务端通知，仅开发者调用[测试服务端通知](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/iap-server-notifications-test)接口才会发送此类型通知。
...
使用主类型：DID\_NEW\_TRANSACTION
 ...
 |
| AUTO\_RENEW\_ENABLED | 

自动续期功能开启。

使用主类型：DID\_CHANGE\_RENEWAL\_STATUS

 |
| AUTO\_RENEW\_DISABLED | 
...
使用主类型：DID\_CHANGE\_RENEWAL\_STATUS或DID\_NEW\_TRANSACTION
...
使用主类型：EXPIRE
 ...
 |
| APPLICATION\_DELETE\_SUBSCRIPTION\_HOSTING | 
...
| purchaseOrderId | 否 | String | 

具体一笔订单中对应的购买订单号。当NotificationType为DID\_CHANGE\_RENEWAL\_STATUS且NotificationSubtype为DOWNGRADE时不返回purchaseOrderId。
