...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-access"
menu_path:
  - "参考"
  - "系统"
  - "网络"
...
captured_at: "2026-04-17T01:48:21.198Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/74/v3/ngklFiRzS_Wb4IZO4R4log/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014822Z&HW-CC-Expire=86400&HW-CC-Sign=6359C2F42B5019291532C410C75ADD5DA0B571E31B044B5F8C0E0B6418C1AE37)
...
如：当调用[access.enableBluetooth](#accessenablebluetooth)或[access.disableBluetooth](#accessdisablebluetooth)时，可触发该事件。
...
| callback | Callback<[BluetoothState](#bluetoothstate)\> | 否 | 
指定取消订阅的回调函数通知。

若传参，则需与[access.on('stateChange')](#accessonstatechange)中的回调函数一致；若无传参，则取消订阅该type对应的所有回调函数通知。
...
该地址一般来源于蓝牙扫描结果，如：可通过调用[startScan](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-ble#startscan15)或[connection.startBluetoothDiscovery](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-connection#connectionstartbluetoothdiscovery)扫描得到。
...
该地址一般来源于蓝牙扫描结果，如：通过调用[startScan](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-ble#startscan15)或[connection.startBluetoothDiscovery](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-connection#connectionstartbluetoothdiscovery)扫描得到。
