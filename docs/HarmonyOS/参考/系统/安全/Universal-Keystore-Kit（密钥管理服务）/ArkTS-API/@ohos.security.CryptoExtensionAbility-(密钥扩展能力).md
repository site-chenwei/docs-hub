...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cryptoextensionability"
menu_path:
  - "参考"
  - "系统"
  - "安全"
...
captured_at: "2026-04-17T01:48:20.474Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/GLCtdfx0RjGp_XWpsuOpPw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014821Z&HW-CC-Expire=86400&HW-CC-Sign=A463698B6222438EC2003060DE8E152E3ABEB2686805308D1301DA801AA3DD3E)
...
| 名称 | 值 | 说明 |
| :-- | :-- | :-- |
| HUKS\_CRYPTO\_EXTENSION\_ERR\_EXTENSION\_FAIL | 34800000 | 
密钥扩展错误。可能的原因：
...
2\. 密钥扩展出现无法解决的错误状态。
 ...
 |
| HUKS\_CRYPTO\_EXTENSION\_ERR\_UKEY\_NOT\_EXIST | 34800001 | 
...
| HUKS\_CRYPTO\_EXTENSION\_ERR\_HANDLE\_NOT\_EXIST | 34800004 | 
...
2\. HUKS服务和密钥扩展的状态不一致。由于异常情况，HUKS服务持有的句柄未能释放。
 ...
 |
| HUKS\_CRYPTO\_EXTENSION\_ERR\_HANDLE\_UNAVAILABLE | 34800005 | 
...
| HUKS\_CRYPTO\_EXTENSION\_ERR\_PIN\_LOCKED | 34800007 | 
...
| 类型 | 说明 |
| :-- | :-- |
| Promise<[HuksCryptoExtensionResult](#hukscryptoextensionresult)\> | 
...
具体含义可查询[HuksCryptoExtensionResultCode](#hukscryptoextensionresultcode)。
...
| :-- | :-- |
| Promise<[HuksCryptoExtensionResult](#hukscryptoextensionresult)\> | 
Promise对象。当调用成功时，resultCode为0，HuksCryptoExtensionResult的property成员非空，包含获取到的属性，由[HUKS\_EXT\_CRYPTO\_TAG\_EXTRA\_DATA](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-huksexternalcrypto#huksexternalcryptotag)参数携带。调用失败时，resultCode携带错误码信息。
