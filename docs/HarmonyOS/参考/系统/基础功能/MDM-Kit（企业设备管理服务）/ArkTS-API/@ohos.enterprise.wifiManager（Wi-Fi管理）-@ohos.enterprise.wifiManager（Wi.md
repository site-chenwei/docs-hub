---
title: "@ohos.enterprise.wifiManager（Wi"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-enterprise-wifimanager"
menu_path:
  - "参考"
  - "系统"
  - "基础功能"
...
captured_at: "2026-04-17T01:48:31.985Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4b/v3/rp9h4s6SR8mqj1KJVZOrVA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014833Z&HW-CC-Expire=86400&HW-CC-Sign=2BA74DC861EABF0541E0864B9D5D4BE2CCCD7ED55912328936B1EDC2ADEE3774)
...
true表示强制开启Wi-Fi，强制开启后不支持用户在设备上手动关闭Wi-Fi开关，必须采用[turnOffWifi](#wifimanagerturnoffwifi20)接口关闭。false表示非强制开启Wi-Fi，此时用户可以在设备上手动操作关闭Wi-Fi开关。
...
作为[addDisallowedWifiList](#wifimanageradddisallowedwifilist19)和[removeDisallowedWifiList](#wifimanagerremovedisallowedwifilist19)接口的入参时，该属性可选，默认值为空字符串。

作为[addAllowedWifiList](#wifimanageraddallowedwifilist19)和[removeAllowedWifiList](#wifimanagerremoveallowedwifilist19)接口入参时，从API version 21开始，该属性可选，默认值为空字符串。API version 20及之前的版本，该属性必填。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8c/v3/kGATAs_BSLCudmlpeZzyKg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014833Z&HW-CC-Expire=86400&HW-CC-Sign=01A9A995031D35C0982E88243263A6D36F06AC3F19F15DA49A079A27847568AB)
