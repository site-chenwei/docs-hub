...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-enterprise-accountmanager"
menu_path:
  - "参考"
  - "系统"
  - "基础功能"
...
captured_at: "2026-04-17T01:48:31.549Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/26/v3/TOp4M-L5RUmgNynFTlQkKw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014833Z&HW-CC-Expire=86400&HW-CC-Sign=524D4203516FC8B557708438ABE70B5BD20B43E40A27E5AF3749AD8A28C7488E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/68/v3/Y0Yl8VSST7KDis2fIQBn_Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014833Z&HW-CC-Expire=86400&HW-CC-Sign=FE907D88A41DDD8E7162F32F0366BD000061EB179ABAF13638E75A6643348693)
...
| type | [osAccount.OsAccountType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-osaccount#osaccounttype) | 是 | 
要添加的账号的类型。
...
| :-- | :-- | :-- | :-- |
| admin | [Want](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-want) | 是 | 企业设备管理扩展组件。Want中必须包含企业设备管理扩展能力的abilityName和所在应用的bundleName。 |
| domainAccountInfo | [osAccount.DomainAccountInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-osaccount#domainaccountinfo8) | 是 | 
域账号信息。
...
**说明**：若为指定域账号设置策略，DomainAccountInfo的serverConfigId字段必填。
 ...
 |
| policy | [DomainAccountPolicy](#domainaccountpolicy19) | 是 | 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| authenticationValidityPeriod | number | 否 | 是 | 
...
默认值为-1，表示Token永久有效。取值为0，表示Token立即失效。Token过期/失效后，用户进入系统时必须进行域账号认证，验证域账号和密码。
 ...
 |
| passwordValidityPeriod | number | 否 | 是 | 
...
默认值为-1，表示域账号密码永久有效。
 ...
 |
| passwordExpirationNotification | number | 否 | 是 | 
