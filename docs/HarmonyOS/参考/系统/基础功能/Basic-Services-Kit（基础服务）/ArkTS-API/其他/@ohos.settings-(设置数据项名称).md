...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-settings"
menu_path:
  - "参考"
  - "系统"
  - "基础功能"
...
captured_at: "2026-04-17T01:48:28.463Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bd/v3/EBGPXgIWTwqZTEzLLFe8ig/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014829Z&HW-CC-Expire=86400&HW-CC-Sign=12A8618D1F23875313FF46486F3DDB063852D1DDFAEA1A06C1523C05909F17C4)
...
\- 值为"24"表示24小时格式。
 ...
 |
| AUTO\_GAIN\_TIME(deprecated21) | string | 是 | 
...
\- 值为false，表示不自动获取信息（该常量不支持使用）。
 ...
 |
| AUTO\_GAIN\_TIME\_ZONE(deprecated21) | string | 是 | 
...
| AUTO\_SCREEN\_BRIGHTNESS | string | 是 | 
是否启用屏幕亮度自动调整。

\- 值为AUTO\_SCREEN\_BRIGHTNESS\_MODE，表示启用自动调整。

\- 值为MANUAL\_SCREEN\_BRIGHTNESS\_MODE，表示不启用自动调整。
...
| DEFAULT\_SCREEN\_ROTATION(deprecated21) | string | 是 | 
...
\- 值为3，表示屏幕旋转270度（该常量不支持使用）。
 ...
 |
| ANIMATOR\_DURATION\_SCALE(deprecated21) | string | 是 | 
...
值为0，表示动画将立即结束。默认值为1（该常量不支持使用）。
 ...
 |
| TRANSITION\_ANIMATION\_SCALE(deprecated21) | string | 是 | 
...
值为0，表示禁用过渡动画（该常量不支持使用）。
 ...
 |
| WINDOW\_ANIMATION\_SCALE(deprecated21) | string | 是 | 
...
值为0，表示禁用窗口动画（该常量不支持使用）。
 ...
 |
| DISPLAY\_INVERSION\_STATUS(deprecated21) | string | 是 | 
...
| 名称 | 类型 | 只读 | 说明 |
| :-- | :-- | :-- | :-- |
| SETUP\_WIZARD\_FINISHED(deprecated21) | string | 是 | 
是否已运行启动向导。
...
\- 值为非0，表示启动向导已运行（该常量不支持使用）。
 ...
 |
| END\_BUTTON\_ACTION(deprecated21) | string | 是 | 
...
\- 值为3，表示显示主屏幕。如果用户已在主屏幕上，设备将进入睡眠状态（该常量不支持使用）。
 ...
 |
| ACCELEROMETER\_ROTATION\_STATUS | string | 是 | 
...
\- 值为0，表示不启用加速计。
 ...
 |
| DEVICE\_PROVISION\_STATUS(deprecated21) | string | 是 | 
...
在具有单个系统用户的多用户设备上，当值为true时，屏幕可能会被锁定。此外，其他功能无法在系统用户上启动，除非被标记在屏幕锁定上显示（该常量不支持使用）。
 ...
 |
| HDC\_STATUS(deprecated21) | string | 是 | 
...
| CONTACT\_METADATA\_SYNC\_STATUS(deprecated21) | string | 是 | 
...
| USB\_STORAGE\_STATUS(deprecated21) | string | 是 | 
...
\- 值为false，表示不启用USB大容量存储（该常量不支持使用）。
 ...
 |
| DEBUGGER\_WAITING(deprecated21) | string | 是 | 
...
| ACCESSIBILITY\_STATUS(deprecated21) | string | 是 | 
...
| SKIP\_USE\_HINTS(deprecated21) | string | 是 | 
...
\- 值为0，表示应用程序不会在首次启动时跳过所有介绍性提示（该常量不支持使用）。
 ...
 |
| TOUCH\_EXPLORATION\_STATUS(deprecated21) | string | 是 | 
...
| ACTIVATED\_INPUT\_METHODS(deprecated21) | string | 是 | 
已激活的输入法的列表。
...
用ima代表输入法ID，keyboardType代表键盘类型，示例格式是ima0:keyboardType0;keyboardType1;ima1:ima2:keyboardTypes0（该常量不支持使用）。
 ...
 |
| SELECTOR\_VISIBILITY\_FOR\_INPUT\_METHOD(deprecated21) | string | 是 | 
...
\- 值为0，表示输入法选择器不可见（该常量不支持使用）。
 ...
 |
| AUTO\_CAPS\_TEXT\_INPUT(deprecated21) | string | 是 | 
...
\- 值为1，表示启用自动大写（该常量不支持使用）。
 ...
 |
| AUTO\_PUNCTUATE\_TEXT\_INPUT(deprecated21) | string | 是 | 
...
\- 值为1，表示启用自动标点符号（该常量不支持使用）。
 ...
 |
| AUTO\_REPLACE\_TEXT\_INPUT(deprecated21) | string | 是 | 
...
\- 值为1，表示启用自动更正（该常量不支持使用）。
 ...
 |
| SHOW\_PASSWORD\_TEXT\_INPUT(deprecated21) | string | 是 | 
...
| 名称 | 类型 | 只读 | 说明 |
| :-- | :-- | :-- | :-- |
| DATA\_ROAMING\_STATUS(deprecated21) | string | 是 | 
是否启用数据漫游。
...
| 名称 | 类型 | 只读 | 说明 |
| :-- | :-- | :-- | :-- |
| RTT\_CALLING\_STATUS(deprecated21) | string | 是 | 
...
| 名称 | 类型 | 只读 | 说明 |
| :-- | :-- | :-- | :-- |
| VIBRATE\_WHILE\_RINGING(deprecated21) | string | 是 | 
...
| DTMF\_TONE\_TYPE\_WHILE\_DIALING(deprecated21) | string | 是 | 
...
\- 值为1，表示长音效（该常量不支持使用）。
 ...
 |
| DTMF\_TONE\_WHILE\_DIALING(deprecated21) | string | 是 | 
...
| SOUND\_EFFECTS\_STATUS(deprecated21) | string | 是 | 
...
\- 值为1，表示可用（该常量不支持使用）。
 ...
 |
| VIBRATE\_STATUS(deprecated21) | string | 是 | 
...
\- 值为0，表示设备不因事件振动（该常量不支持使用）。
 ...
 |
| HAPTIC\_FEEDBACK\_STATUS(deprecated21) | string | 是 | 
...
| 名称 | 类型 | 只读 | 说明 |
| :-- | :-- | :-- | :-- |
| DEFAULT\_TTS\_PITCH(deprecated21) | string | 是 | 
文本转语音(TTS)引擎的默认音高。

其中100=1x，该值设置为200，表示频率是正常声音频率的两倍（该常量不支持使用）。

 |
| DEFAULT\_TTS\_RATE(deprecated21) | string | 是 | 
...
| 名称 | 类型 | 只读 | 说明 |
| :-- | :-- | :-- | :-- |
| BLUETOOTH\_DISCOVER\_ABILITY\_STATUS(deprecated21) | string | 是 | 
...
\- 值为2，表示设备可以被连接和发现（该常量不支持使用）。
 ...
 |
| BLUETOOTH\_DISCOVER\_TIMEOUT(deprecated21) | string | 是 | 
...
这段时间后，设备不可以被蓝牙搜寻到（该常量不支持使用）。
 ...
 |
| AIRPLANE\_MODE\_RADIOS(deprecated21) | string | 是 | 

启用飞行模式时要禁用的无线电信号列表。

多个无线电信号用逗号(,)分隔。

取值包括以下常量：BLUETOOTH\_RADIO、 CELL\_RADIO、 NFC\_RADIO、 WIFI\_RADIO（该常量不支持使用）。
...
| BLUETOOTH\_STATUS(deprecated21) | string | 是 | 
...
\- 值为false，表示蓝牙不可用（该常量不支持使用）。
 ...
 |
| OWNER\_LOCKDOWN\_WIFI\_CFG(deprecated21) | string | 是 | 
...
| WIFI\_STATUS(deprecated21) | string | 是 | 
...
\- 值为false，表示Wi-Fi不可用（该常量不支持使用）。
 ...
 |
| WIFI\_WATCHDOG\_STATUS(deprecated21) | string | 是 | 
...
\- domainName为domainName.DEVICE\_SHARED,

表示设备属性共享域。

\- domainName为domainName.USER\_PROPERTY,

表示用户属性域。

\- domainName为domainName.USER\_SECURITY,
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4a/v3/osFa_DsNQtayBkJXiUPbVQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014829Z&HW-CC-Expire=86400&HW-CC-Sign=15E5AA0D9689150F9A28B22306046DA534BA0F4D035E1A6FFFDB0BAC9E83CF21)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a9/v3/fu41YOv7Sr-mqq4GO8CG0w/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014829Z&HW-CC-Expire=86400&HW-CC-Sign=1CC6BF7C92604524F26EF162DC57266FBBB05663547046C813AA7C999109642F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6a/v3/KQXhHik8Qpqbp3_qIKAiZQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014829Z&HW-CC-Expire=86400&HW-CC-Sign=8DDEFC3CD7751DED128554DD987D7E90341BFE3096BB8DA9DAFB03E1FFE9DC2F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f2/v3/HuK83y3LQKmwUoGnCWiLZw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014829Z&HW-CC-Expire=86400&HW-CC-Sign=3A9C7DFBD6773A60B4C76CB4548584F61A2E3AD638DD415E94EC2DA819A5E1EB)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/AQKiXDhFTbqLT6ak9q1DRg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014829Z&HW-CC-Expire=86400&HW-CC-Sign=D2E77CCD5C6DA599A73BF37051F6F2B9487B51B6966ADCED9E1467C98B183642)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c5/v3/kSssobiLTuWYDbnbz_t22A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014829Z&HW-CC-Expire=86400&HW-CC-Sign=D8203190145F91C1023819EEC5C7E8DF7678B48B657FD620268D16D4B936758D)
