---
title: "@ohos.hiviewdfx.jsLeakWatcher (js泄漏检测)"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-jsleakwatcher"
menu_path:
  - "参考"
  - "系统"
  - "调测调优"
...
captured_at: "2026-04-17T01:48:34.646Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c9/v3/AQens6U3QxqF4RVKWzajMA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014836Z&HW-CC-Expire=86400&HW-CC-Sign=7B818A936FFAF85C370B808D44198569AAD4590E95516B2338DA1039E000C6E6)
...
**说明**：check成功，返回JSON格式的泄漏对象列表；check失败，返回空字符串。
...
**说明**：dump成功，返回泄漏列表文件路径和虚拟机内存快照路径；dump失败，返回空数组。
