...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-hashset"
menu_path:
  - "参考"
  - "应用框架"
  - "ArkTS（方舟编程语言）"
...
captured_at: "2026-04-17T01:47:51.961Z"
---
...
HashSet和[TreeSet](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-treeset)相比，HashSet中的数据按Hash值排序，因此元素的插入顺序与遍历时的顺序可能不一致，而TreeSet则是按照元素的自然排序或者自定义比较器进行有序存储。它们集合中的元素都不允许重复，HashSet允许插入null值，TreeSet不建议插入null值，可能会影响排序。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/75/v3/A6tumTJMRuC8lZ4Pd1U9Uw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014754Z&HW-CC-Expire=86400&HW-CC-Sign=F8EDBE42D827930177246599A67E946B48B4F0A4E56F38427169864D424B7E0F)
