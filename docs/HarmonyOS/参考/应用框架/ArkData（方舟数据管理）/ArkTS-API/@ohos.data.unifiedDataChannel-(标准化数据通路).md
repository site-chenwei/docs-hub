...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-data-unifieddatachannel"
menu_path:
  - "参考"
  - "应用框架"
  - "ArkData（方舟数据管理）"
...
captured_at: "2026-04-17T01:47:49.761Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/58/v3/MDRgVtk-R_yJerb2xdlq1Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014751Z&HW-CC-Expire=86400&HW-CC-Sign=B6762943099FDA23C2B6A5560BDCC3099F0FCDC62FDC349AE620B9F58E61EB21)
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| properties12+ | [UnifiedDataProperties](#unifieddataproperties12) | 否 | 否 | 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| summary | Record<string, number> | 否 | 否 | 
是一个字典类型对象，key表示数据类型（见[UniformDataType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-data-uniformtypedescriptor#uniformdatatype)），value为统一数据对象中该类型记录大小总和（单位：Byte）。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

 |
| totalSize | number | 否 | 否 | 
...
**元服务API：** 从API version 11开始，该接口支持在元服务中使用。
 ...
 |
| overview22+ | Record<string, number> | 是 | 否 | 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| details | Record<string, string> | 否 | 是 | 
...
| appIconId | string | 否 | 否 | 
图标的图片id。

**模型约束：** 此接口仅可在Stage模型下使用。

 |
| appLabelId | string | 否 | 否 | 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| intention | [Intention](#intention) | 否 | 是 | 
表示数据操作相关的数据通路类型。
...
UDMF中数据对象的唯一标识符，可通过[insertData](#unifieddatachannelinsertdata)接口的返回值获取。
...
**元服务API：** 从API version 11开始，该接口支持在元服务中使用。
 ...
 |
| visibility20+ | [Visibility](#visibility20) | 否 | 是 | 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| progressIndicator | [ProgressIndicator](#progressindicator15) | 否 | 否 | 
定义进度条指示选项，可选择是否采用系统默认进度显示。

**元服务API：** 从API version 15开始，该接口支持在元服务中使用。

 |
| dataProgressListener | [DataProgressListener](#dataprogresslistener15) | 否 | 否 | 
...
**元服务API：** 从API version 15开始，该接口支持在元服务中使用。
 ...
 |
| fileConflictOptions | [FileConflictOptions](#fileconflictoptions15) | 否 | 是 | 
...
**元服务API：** 从API version 15开始，该接口支持在元服务中使用。
 ...
 |
| acceptableInfo20+ | [DataLoadInfo](#dataloadinfo20) | 否 | 是 | 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| loadHandler | [DataLoadHandler](#dataloadhandler20) | 否 | 否 | 
表示用于延迟加载数据的处理函数。

**元服务API：** 从API version 20开始，该接口支持在元服务中使用。

 |
| delayedDataLoadHandler22+ | [DelayedDataLoadHandler](#delayeddataloadhandler22) | 否 | 是 | 
...
**模型约束：** 此接口仅可在Stage模型下使用。
 ...
 |
| dataLoadInfo | [DataLoadInfo](#dataloadinfo20) | 否 | 否 | 
...
| callback | AsyncCallback<Array<[UnifiedData](#unifieddata)\>> | 是 | 
回调函数，返回查询到的所有数据。
...
| 类型 | 说明 |
| :-- | :-- |
| Promise<Array<[UnifiedData](#unifieddata)\>> | 
