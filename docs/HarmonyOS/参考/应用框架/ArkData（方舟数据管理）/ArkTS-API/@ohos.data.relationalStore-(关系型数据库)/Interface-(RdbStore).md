...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-data-relationalstore-rdbstore"
menu_path:
  - "参考"
  - "应用框架"
  - "ArkData（方舟数据管理）"
  ...
  - "Interface (RdbStore)"
captured_at: "2026-04-17T01:47:49.653Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e0/v3/Z8RBLNKbShiVcY8Lh0YFYQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014751Z&HW-CC-Expire=86400&HW-CC-Sign=BB8FCFFF6CE5967BE06BB39B33E26CDE7CE0E0085B3882A503B686586708EBA6)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f9/v3/WVdJCz-3RqO2ha-gmmG2jA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014751Z&HW-CC-Expire=86400&HW-CC-Sign=3427C97285351F622213E097401AB4A09A7F70A6908B91D448E58F6CE093AAB1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f2/v3/iQv1B5NOT-ad_a2_PNnYJQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014751Z&HW-CC-Expire=86400&HW-CC-Sign=9DF3CC949C24D83DE980B79CDB84A109424A9DE247962A428EE6DD015715D28F)
...
| primaryKeys | [PRIKeyType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-data-relationalstore-t#prikeytype10)\[\] | 是 | 
指定要查询的行的主键。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9c/v3/j2Z_K6AeR6e4c0X8s0femQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014751Z&HW-CC-Expire=86400&HW-CC-Sign=B2BC9536FAF4E3923AF3E72DBA26F29840B8EAFFD8F33919A9A2A2FEA626427C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a6/v3/gS01xxGiR8ePXFjHq75Drw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014751Z&HW-CC-Expire=86400&HW-CC-Sign=90C747031F99FBA08F31C9A55ECE3E3BF31E6D33E15A83CC296BE3E3122FC922)
...
| event | string | 是 | 取值为'dataChange'，表示数据更改。 |
| type | [SubscribeType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-data-relationalstore-e#subscribetype) | 是 | 订阅类型。 |
| observer | Callback<Array<string>> | Callback<Array<[ChangeInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-data-relationalstore-i#changeinfo10)\>> | 是 | 
回调函数。

当type为SUBSCRIBE\_TYPE\_REMOTE，observer类型需为Callback<Array<string>>，其中Array<string>为数据库中的数据发生改变的对端设备ID。

当type为SUBSCRIBE\_TYPE\_CLOUD，observer类型需为Callback<Array<string>>，其中Array<string>为数据库中的数据发生改变的云端账号。

当type为SUBSCRIBE\_TYPE\_CLOUD\_DETAILS，observer类型需为Callback<Array<ChangeInfo>>，其中Array<ChangeInfo>为数据库端云同步过程的详情。

当type为SUBSCRIBE\_TYPE\_LOCAL\_DETAILS，observer类型需为Callback<Array<ChangeInfo>>，其中Array<ChangeInfo>为本地数据库中的数据更改的详情。
...
| event | string | 是 | 取值为'dataChange'，表示数据更改。 |
| type | [SubscribeType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-data-relationalstore-e#subscribetype) | 是 | 订阅类型。 |
| observer | Callback<Array<string>>| Callback<Array<[ChangeInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-data-relationalstore-i#changeinfo10)\>> | 否 | 
回调函数。
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| cryptoParam | [CryptoParam](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-data-relationalstore-i#cryptoparam14) | 否 | 
指定用户自定义的加密参数。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/89/v3/42QPynLrQ22ukrSiNbLN7Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014751Z&HW-CC-Expire=86400&HW-CC-Sign=26D2ADA436B3F4ECCCD7CF8470F3589B31255476C9063D64EED809C70A4EEFDC)
