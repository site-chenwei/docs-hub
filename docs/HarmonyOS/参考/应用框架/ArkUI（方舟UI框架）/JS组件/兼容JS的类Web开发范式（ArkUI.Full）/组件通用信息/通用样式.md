---
title: "通用样式"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-components-common-styles"
menu_path:
  - "参考"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "组件通用信息"
  - "通用样式"
captured_at: "2026-04-17T01:48:00.459Z"
---

# 通用样式

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/nj5KLNcoTJ6M9OcVc7AAMA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014803Z&HW-CC-Expire=86400&HW-CC-Sign=D3A9AEB59BFA25D27C66ED3F1DE1720CAD83CC38F213C7E6772301798D61680D)
...
通过这个样式可以设置当前组件布局范围的窗口模糊程度和模糊样式，如果没有设置值，则默认是0%(不模糊)，多块模糊区域时不支持设置不同的模糊值和模糊样式。style可选值：small\_light(默认值), medium\_light, large\_light, xlarge\_light, small\_dark, medium\_dark, large\_dark, xlarge\_dark。

示例：

\- window-filter: blur(50%)

\- window-filter: blur(10%), large\_light
...
指定四个值时分别为上、右、下、左边的边框图像超出边框的距离 （顺时针顺序）。
 ...
 |
| border-image-repeat7+ | string | stretch | 
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/22/v3/h7zqGOxsRQeTRKYax5vkIA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014803Z&HW-CC-Expire=86400&HW-CC-Sign=36E9E25799CAC7E04BE9957DD6B3B044E468763FB2A2B2A27E8B1C3E957FE4B8)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d/v3/LOwOjuyXS8G5LMc3C29rEA/zh-cn_image_0000002538021122.png?HW-CC-KV=V1&HW-CC-Date=20260417T014803Z&HW-CC-Expire=86400&HW-CC-Sign=1576806E8AF70ADC5FDFFAD61E9AA4526983F8E972AD473D516932446CAE117F)
