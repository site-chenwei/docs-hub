---
title: "通用事件"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-components-common-events"
menu_path:
  - "参考"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "组件通用信息"
  - "通用事件"
captured_at: "2026-04-17T01:48:00.453Z"
---

# 通用事件

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4f/v3/b8zSKnwoQoOlmBZK-UzLMw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014803Z&HW-CC-Expire=86400&HW-CC-Sign=65F5538513D2010F84CECB0EEA4630527831D1ECDF7FF4474FD845B0CA1EA80C)
...
| doubleclick7+ | BaseEvent | 双击动作触发该事件。 | 
否

从API version 9 开始支持冒泡。

 | 否 |
| longpress | BaseEvent | 长按动作触发该事件。 | 
...
从API version 9 开始支持冒泡。
 ...
 | 否 |
| swipe5+ | SwipeEvent | 组件上快速滑动后触发该事件。 SwipeEvent具体可参考表4 。 | 
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/M6CqOY55TWK4c1VF4lL_Bg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014803Z&HW-CC-Expire=86400&HW-CC-Sign=49584D8114CFD019D9B8CA84F40EC3B02102C3E6963D2DFD4CBFC0759623B25A)
