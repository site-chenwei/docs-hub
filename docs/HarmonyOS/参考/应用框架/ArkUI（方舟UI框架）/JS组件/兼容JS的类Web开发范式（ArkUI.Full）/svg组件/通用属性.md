---
title: "通用属性"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-components-svg-common-attributes"
menu_path:
  - "参考"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "svg组件"
  - "通用属性"
captured_at: "2026-04-17T01:48:05.820Z"
---

# 通用属性

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d3/v3/xLpuIazCRValjETxGGd0bA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014805Z&HW-CC-Expire=86400&HW-CC-Sign=902825AAB5F1F2DF5572A655564338F6489381BFEB421E249F5458A91C1CDC7A)
...
| stroke-linejoin | \[bevel | miter | round\] | miter | 否 | 
进行描边时在路径的拐角处使用的形状。
...
round：使用圆角连接路径段。
 ...
 |
| stroke-linecap | \[butt | round | square\] | butt | 否 | 
