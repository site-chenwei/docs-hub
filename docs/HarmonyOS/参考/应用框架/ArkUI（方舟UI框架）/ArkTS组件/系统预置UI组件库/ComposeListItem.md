...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-composelistitem"
menu_path:
  - "参考"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "系统预置UI组件库"
  - "ComposeListItem"
captured_at: "2026-04-17T01:47:59.443Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/FFl1S73gTQWWwVJwqLwOGw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014802Z&HW-CC-Expire=86400&HW-CC-Sign=9B1F643ACF7D5142505929F8B88D46EB02A8D345392259F26D399BBC44FBE2CB)
...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| contentItem | [ContentItem](#contentitem) | 否 | @Prop | 
定义左侧以及中间元素。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

 |
| operateItem | [OperateItem](#operateitem) | 否 | @Prop | 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| iconStyle | [IconType](#icontype) | 否 | 是 | 
左侧元素的图标样式。
...
**元服务API：** 从API version 18开始，该接口支持在元服务中使用。
 ...
 |
| primaryText | [ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | 否 | 是 | 
...
**元服务API：** 从API version 11开始，该接口支持在元服务中使用。
 ...
 |
| secondaryText | [ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | 否 | 是 | 
...
**元服务API：** 从API version 11开始，该接口支持在元服务中使用。
 ...
 |
| description | [ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | 否 | 是 | 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| arrow | [OperateIcon](#operateicon) | 否 | 是 | 
右侧元素为箭头，大小为12\*24vp。
...
**元服务API：** 从API version 11开始，该接口支持在元服务中使用。
 ...
 |
| icon | [OperateIcon](#operateicon) | 否 | 是 | 
...
**元服务API：** 从API version 11开始，该接口支持在元服务中使用。
 ...
 |
| subIcon | [OperateIcon](#operateicon) | 否 | 是 | 
...
**元服务API：** 从API version 11开始，该接口支持在元服务中使用。
 ...
 |
| button | [OperateButton](#operatebutton) | 否 | 是 | 
...
**元服务API：** 从API version 11开始，该接口支持在元服务中使用。
 ...
 |
| switch | [OperateCheck](#operatecheck) | 否 | 是 | 
...
**元服务API：** 从API version 11开始，该接口支持在元服务中使用。
 ...
 |
| checkbox | [OperateCheck](#operatecheck) | 否 | 是 | 
...
**元服务API：** 从API version 11开始，该接口支持在元服务中使用。
 ...
 |
| radio | [OperateCheck](#operatecheck) | 否 | 是 | 
...
**元服务API：** 从API version 11开始，该接口支持在元服务中使用。
 ...
 |
| onChange | (value: boolean)=>void | 否 | 是 | 
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/71/v3/IagFD3Z-SgKlUgfh0yIQ9w/zh-cn_image_0000002538180976.jpg?HW-CC-KV=V1&HW-CC-Date=20260417T014802Z&HW-CC-Expire=86400&HW-CC-Sign=2AB33401A3B47ECB355313FE6BCD24DA8D046D189F8FA84E291F9EACB190C823)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c/v3/Wya2lX6gRaKX_YfoYf1jzQ/zh-cn_image_0000002569020763.png?HW-CC-KV=V1&HW-CC-Date=20260417T014802Z&HW-CC-Expire=86400&HW-CC-Sign=39DB443CBE3310915BFA7F2B5299002F7786567A843425CC40943E2A90893CC4)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/28/v3/_aviKRO2T-WaZimy8cVj5A/zh-cn_image_0000002568900753.png?HW-CC-KV=V1&HW-CC-Date=20260417T014802Z&HW-CC-Expire=86400&HW-CC-Sign=4CDD03298A1995680C61D909DB8C9D21767A56008907F967B207EFF983080DD6)
