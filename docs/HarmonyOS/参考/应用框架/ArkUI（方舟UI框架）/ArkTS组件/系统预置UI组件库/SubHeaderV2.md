---
title: "SubHeaderV2"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-subheaderv2"
menu_path:
  - "参考"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "系统预置UI组件库"
  - "SubHeaderV2"
captured_at: "2026-04-17T01:47:59.825Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f6/v3/zKpSjX6RT2WY6YO_p-6sLw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014802Z&HW-CC-Expire=86400&HW-CC-Sign=704FD716F8DDA833873E1EDD93BA55DC2FB5A56F4F79F422AD8F90566E683F22)
...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| icon | [SubHeaderV2IconType](#subheaderv2icontype) | 否 | @Param | 
图标设置项。
...
当title使用secondaryTitle属性时，设置icon属性才会生效。
 ...
 |
| title | [SubHeaderV2Title](#subheaderv2title) | 否 | @Param | 
...
默认值：undefined
 ...
 |
| select | [SubHeaderV2Select](#subheaderv2select) | 否 | @Param | 
...
默认值：undefined
 ...
 |
| operationType | [SubHeaderV2OperationType](#subheaderv2operationtype) | 否 | @Param | 
...
默认值：SubHeaderV2OperationType.BUTTON
 ...
 |
| operationItems | [SubHeaderV2OperationItem](#subheaderv2operationitem)\[\] | 否 | @Param | 
...
默认值：undefined
 ...
 |
| titleBuilder | [SubHeaderV2TitleBuilder](#subheaderv2titlebuilder) | 否 | @BuilderParam | 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| primaryTitle | [ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | 否 | 是 | 
标题内容。

当[SubHeaderV2](#subheaderv2-1)中同时使用primaryTitle、secondaryTitle、icon属性时，设置primaryTitle属性不生效。
...
**元服务API：** 从API version 18开始，该接口支持在元服务中使用。
 ...
 |
| secondaryTitle | [ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | 否 | 是 | 
...
**元服务API：** 从API version 18开始，该接口支持在元服务中使用。
 ...
 |
| primaryTitleModifier | [TextModifier](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-attribute-modifier#自定义modifier) | 否 | 是 | 
...
**元服务API：** 从API version 18开始，该接口支持在元服务中使用。
 ...
 |
| secondaryTitleModifier | [TextModifier](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-attribute-modifier#自定义modifier) | 否 | 是 | 
...
**元服务API：** 从API version 18开始，该接口支持在元服务中使用。
 ...
 |
| titleAccessibilityText23+ | [ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | 否 | 是 | 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| options | [SelectOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-select#selectoption对象说明)\[\] | 否 | 否 | 
下拉选项内容。

装饰器类型：@Trace

 |
| selectedIndex | number | 否 | 是 | 
...
装饰器类型：@Trace
 ...
 |
| selectedContent | [ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | 否 | 是 | 
...
装饰器类型：@Trace
 ...
 |
| onSelect | [SubHeaderV2SelectOnSelect](#subheaderv2selectonselect) | 否 | 是 | 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| options | [SelectOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-select#selectoption对象说明)\[\] | 否 | 否 | 下拉选项内容。 |
| selectedIndex | number | 否 | 是 | 
设置下拉菜单初始选项的索引。
...
默认选择值为-1，菜单项不选中。
 ...
 |
| selectedContent | [ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | 否 | 是 | 设置下拉按钮本身的文本内容。默认值：''。从API version 20开始，支持Resource类型。 |
| onSelect | [SubHeaderV2SelectOnSelect](#subheaderv2selectonselect) | 否 | 是 | 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| content | [SubHeaderV2OperationItemType](#subheaderv2operationitemtype) | 否 | 否 | 
操作区元素内容。

装饰器类型：@Trace

 |
| action | [SubHeaderV2OperationItemAction](#subheaderv2operationitemaction) | 否 | 是 | 
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2a/v3/tIIQDnroS-KNFEUqRes2eA/zh-cn_image_0000002538181008.png?HW-CC-KV=V1&HW-CC-Date=20260417T014802Z&HW-CC-Expire=86400&HW-CC-Sign=F4F2DE1F6A8EFD4D65068639E575E81964403411E4EA8ED805103D3A75AFCF16)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/fttrX9byRXOD5vm_PaR_pw/zh-cn_image_0000002569020795.png?HW-CC-KV=V1&HW-CC-Date=20260417T014802Z&HW-CC-Expire=86400&HW-CC-Sign=AF58FBD50815E50FF3E6918CB0D26584C3817DD49B614DAA2AC7A78D0968F453)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/m265r_SXQLiATAlAxIlQ9w/zh-cn_image_0000002568900785.png?HW-CC-KV=V1&HW-CC-Date=20260417T014802Z&HW-CC-Expire=86400&HW-CC-Sign=BE4749D38358D0D0EDD33446C229C609EDBC9F4665E41ACD31BC1542F0C3C7D2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/79/v3/ow519sK4SBWFHy5VWQVK4g/zh-cn_image_0000002538021084.gif?HW-CC-KV=V1&HW-CC-Date=20260417T014802Z&HW-CC-Expire=86400&HW-CC-Sign=8509D90505A27594DC49986C75C74AA3B223D6AFBFB78B4ED0B0054980C44B17)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/dg9THHWcTD-5FDCc4Qnqmw/zh-cn_image_0000002538181010.png?HW-CC-KV=V1&HW-CC-Date=20260417T014802Z&HW-CC-Expire=86400&HW-CC-Sign=16C04886D0627818ED21FFF77DA011998601EDB9D9FC72B046DF4A121109711B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f7/v3/Dp985yvjQiS9dRYwPysiLw/zh-cn_image_0000002569020797.png?HW-CC-KV=V1&HW-CC-Date=20260417T014802Z&HW-CC-Expire=86400&HW-CC-Sign=82989573EFADED23ECFDA885C95F5B943832C55B21AC3B40EBB643D4F32507FD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7f/v3/cJPc8HipTziESQZBLhlj5A/zh-cn_image_0000002569020799.png?HW-CC-KV=V1&HW-CC-Date=20260417T014802Z&HW-CC-Expire=86400&HW-CC-Sign=407136EF29D26AEE04BFA7AE2C5D4C02ED916425F01C877BD82DB8B5BBC8BE3F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4/v3/zCLwfiR4RBaL6rh2DwEYdg/zh-cn_image_0000002538021086.png?HW-CC-KV=V1&HW-CC-Date=20260417T014802Z&HW-CC-Expire=86400&HW-CC-Sign=E8DB52B5E7C81743C0D7BA9BDB4340694D1C0127D858A3C45947610002596508)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e1/v3/QrMZ0R7pRXCrQefmnY25wQ/zh-cn_image_0000002538181012.png?HW-CC-KV=V1&HW-CC-Date=20260417T014802Z&HW-CC-Expire=86400&HW-CC-Sign=1C9CD01099ED044B659DA623F25AEFBD48A991C96E64A0AA772BA0F8B3193EA5)
