---
title: "ToolBar"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-toolbar"
menu_path:
  - "参考"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "系统预置UI组件库"
  - "ToolBar"
captured_at: "2026-04-17T01:47:59.879Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a9/v3/nfqkUge-SUukeLcoHK1t5A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014802Z&HW-CC-Expire=86400&HW-CC-Sign=66165C71A87EE4BD8FB5550A1C3647D991FE25FD9FE60185C917DA27F19D9E02)
...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| toolBarList | [ToolBarOptions](#toolbaroptions) | 是 | @ObjectLink | 
工具栏列表。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

 |
| activateIndex | number | 否 | @Prop | 
...
**元服务API：** 从API version 11开始，该接口支持在元服务中使用。
 ...
 |
| controller | [TabsController](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-tabs#tabscontroller) | 是 | \- | 
...
**元服务API：** 从API version 11开始，该接口支持在元服务中使用。
 ...
 |
| dividerModifier13+ | [DividerModifier](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-attribute-modifier#自定义modifier) | 否 | @Prop | 
...
**元服务API：** 从API version 13开始，该接口支持在元服务中使用。
 ...
 |
| toolBarModifier13+ | [ToolBarModifier](#toolbarmodifier13) | 否 | @Prop | 
...
**元服务API：** 从API version 11开始，该接口支持在元服务中使用。
 ...
 |
| icon | [Resource](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resource) | 否 | 是 | 
...
**元服务API：** 从API version 11开始，该接口支持在元服务中使用。
 ...
 |
| iconColor13+ | [ResourceColor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcecolor) | 否 | 是 | 

工具栏子项的图标填充颜色。

默认值为$r('sys.color.icon\_primary')。

**元服务API：** 从API version 13开始，该接口支持在元服务中使用。

 |
| activatedIconColor13+ | [ResourceColor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcecolor) | 否 | 是 | 

工具栏子项激活态的图标填充颜色。

默认值为$r('sys.color.icon\_emphasize')。

**元服务API：** 从API version 13开始，该接口支持在元服务中使用。

 |
| textColor13+ | [ResourceColor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcecolor) | 否 | 是 | 

工具栏子项的文本颜色。

默认值为$r('sys.color.font\_primary')。

**元服务API：** 从API version 13开始，该接口支持在元服务中使用。

 |
| activatedTextColor13+ | [ResourceColor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcecolor) | 否 | 是 | 

工具栏子项激活态的文本颜色。

默认值为$r('sys.color.font\_emphasize')。

**元服务API：** 从API version 13开始，该接口支持在元服务中使用。

 |
| toolBarSymbolOptions13+ | [ToolBarSymbolGlyphOptions](#toolbarsymbolglyphoptions13) | 否 | 是 | 
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| backgroundColor | [ResourceColor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcecolor) | 是 | 
工具栏背景色。
...
默认值：fontColor：$r('sys.color.icon\_primary')，fontSize：24vp。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/61/v3/DyMszGCMTS2RZM4FYAWQXA/zh-cn_image_0000002568900791.png?HW-CC-KV=V1&HW-CC-Date=20260417T014802Z&HW-CC-Expire=86400&HW-CC-Sign=FC7D4D9E074FF81F0A1F9C6AE77CED346C3C28C0FB5EE60C5CFAAEA0C3C805A6)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/72/v3/D8ALLAELRuyoUlcj2tJYBQ/zh-cn_image_0000002538021090.png?HW-CC-KV=V1&HW-CC-Date=20260417T014802Z&HW-CC-Expire=86400&HW-CC-Sign=D9BD447358BA3C9768451EDCED89A500CADD8FAAC36FAC21DA088211B8A62F92)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e1/v3/OvTJPUejT-iHFA7M5qw50g/zh-cn_image_0000002568900791.png?HW-CC-KV=V1&HW-CC-Date=20260417T014802Z&HW-CC-Expire=86400&HW-CC-Sign=19954CD649398967B186328722D7CB316F3EE4FF8C5A6AFD138A7D656B698CA9)
