---
title: "拖拽事件"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop"
menu_path:
  - "参考"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "交互响应事件"
  - "拖拽事件"
captured_at: "2026-04-17T01:47:54.369Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e0/v3/e8ianyGQSvChUIIqnmSP7w/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014756Z&HW-CC-Expire=86400&HW-CC-Sign=B0D97E3DFA02881EBE48E649EEF01D928B5549816A9DCEB6D45B268D15038FB4)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/i9sjqszaRWqVjO8tZ1ziaQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014756Z&HW-CC-Expire=86400&HW-CC-Sign=3635ECBDADDA80FC3E39E28A9FB437C41B49289256CF44D05F5F498E5385D49B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f1/v3/m3FI_94kRmaqo-_K1H3knA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014756Z&HW-CC-Expire=86400&HW-CC-Sign=E06EA1CDF79436E7F1121495D2CEDB51479385CBD3AB9E42A6EB7A9A2C662A38)
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| event | (event: [DragEvent](#dragevent7), extraParams?: string) => [CustomBuilder](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#custombuilder8) | [DragItemInfo](#dragiteminfo) | 是 | 
回调函数。
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| event | (event: [DragEvent](#dragevent7), extraParams?: string) => void | 是 | 
回调函数。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cb/v3/I2ZIAGEpS2WN6m4nYeelOw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014756Z&HW-CC-Expire=86400&HW-CC-Sign=BFC53CD1BD660C257A7079AE4BBCC665BC21AF8D052B5C305417850CF015C57E)
...
builder传参时，建议传参格式为builder: ()=>{this.customBuilder()}，用以保证this指向的正确性。具体请参考[将@Builder装饰的函数当作CustomBuilder类型使用](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-builder#将builder装饰的函数当作custombuilder类型使用)。
...
仅在[ListItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem)组件的拖拽事件中生效，否则返回undefined。
...
仅在[List](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list)组件的拖拽事件中生效，否则返回undefined。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| useCustomDropAnimation10+ | boolean | 否 | 否 | 
当拖拽结束时，是否禁用系统默认落位动效。

应用可将该值设定为true来禁用系统默认落位动效，并实现自己的自定义落位动效。

当不配置或设置为false时，系统默认落位动效生效，当[setResult](#setresult10)设置为DRAG\_SUCCESSFUL时，落位为缩小消失动效，不为DRAG\_SUCCESSFUL时，则为放大消失动效。
...
默认值：false
 ...
 |
| dragBehavior10+ | [DragBehavior](#dragbehavior10) | 否 | 否 | 
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| customDropAnimation | [Callback<void>](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback) | 是 | 
在此回调函数中实现自定义落位动效。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8d/v3/jc1oZdTBTJ-D597tob8dpA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014756Z&HW-CC-Expire=86400&HW-CC-Sign=75F1E0C1DD1FDDFE7312359537D0ED5CCF329A78F9E433AB605F9D87017334D1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4f/v3/BqJXubcoQbKexaUmCwHscQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014756Z&HW-CC-Expire=86400&HW-CC-Sign=1850C224A76760F7979EFB1DC22367D836A4585F3E4BB082B2A7D46DA8809DCA)
...
| 名称 | 值 | 说明 |
| :-- | :-- | :-- |
| ACTION\_DETECTING\_STATUS | 0 | 
拖拽手势启动阶段。(按下50ms时触发)

**元服务API：** 从API version 12开始，该接口支持在元服务中使用。

 |
| READY\_TO\_TRIGGER\_DRAG\_ACTION | 1 | 
...
**元服务API：** 从API version 12开始，该接口支持在元服务中使用。
 ...
 |
| ACTION\_CANCELED\_BEFORE\_DRAG | 6 | 
...
**元服务API：** 从API version 12开始，该接口支持在元服务中使用。
 ...
 |
| PREPARING\_FOR\_DRAG\_DETECTION18+ | 7 | 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| disableDataPrefetch | boolean | 否 | 是 | 
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4b/v3/0humjYm1QECahqpay_-qUg/zh-cn_image_0000002538020416.png?HW-CC-KV=V1&HW-CC-Date=20260417T014756Z&HW-CC-Expire=86400&HW-CC-Sign=1CAB91AA4EE3F0E92D8569431331645A6D5B47DB84B95844F3FF6E9743A7DB18)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4d/v3/7AUWl3fKQaWniqEFer5y3g/zh-cn_image_0000002538180342.gif?HW-CC-KV=V1&HW-CC-Date=20260417T014756Z&HW-CC-Expire=86400&HW-CC-Sign=E8B79F81D8583B0D97E51B62A58E55578C5FC5776D46CCEC73DFCA759A54253A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/xHzYIl2oTBqMw7767oBpyQ/zh-cn_image_0000002569020129.png?HW-CC-KV=V1&HW-CC-Date=20260417T014756Z&HW-CC-Expire=86400&HW-CC-Sign=4497220478EA6E6B0BF2C3909924445D68A22323190B99F753765093A4231E65)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/be/v3/5LGpyQ02RTy2_lsqmTe5jQ/zh-cn_image_0000002568900121.png?HW-CC-KV=V1&HW-CC-Date=20260417T014756Z&HW-CC-Expire=86400&HW-CC-Sign=0D437A77ECCE8128FEAE82F979F4F620BE1143AD057F6FF2DD2C9B22E01021E2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/hxWjnR9mSy2QLSxAhjZ_3A/zh-cn_image_0000002538020418.gif?HW-CC-KV=V1&HW-CC-Date=20260417T014756Z&HW-CC-Expire=86400&HW-CC-Sign=34F44C7909B97D8705FA6573C2D7D211AD6520EE0499E1A298FB99D28C34E0B0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e2/v3/1FTxka-dQa2wsaF-mASXhA/zh-cn_image_0000002538180344.gif?HW-CC-KV=V1&HW-CC-Date=20260417T014756Z&HW-CC-Expire=86400&HW-CC-Sign=3E2D5C676BF8B10F993DF28C8AB0FEAD0010C6D57D390BD398DF017D4DA76E2A)
