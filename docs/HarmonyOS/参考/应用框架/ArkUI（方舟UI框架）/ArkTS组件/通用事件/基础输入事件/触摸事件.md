---
title: "触摸事件"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-touch"
menu_path:
  - "参考"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "基础输入事件"
  - "触摸事件"
captured_at: "2026-04-17T01:47:54.175Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b8/v3/Jj6GI5SpTuiTVG1ZYrPvHA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014756Z&HW-CC-Expire=86400&HW-CC-Sign=11D25837CCBA4B9DE1EE40F10ED8B791C43C260900CDF4D600D51203AF692585)
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| type | [TouchType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#touchtype) | 否 | 否 | 
触摸事件的类型。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

 |
| touches | [TouchObject](#touchobject)\[\] | 否 | 否 | 
...
**元服务API：** 从API version 11开始，该接口支持在元服务中使用。
 ...
 |
| changedTouches | [TouchObject](#touchobject)\[\] | 否 | 否 | 
...
触摸点在事件响应组件为基准的[组件坐标系](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkui-glossary#组件坐标系)中的X坐标。
...
触摸点在事件响应组件为基准的[组件坐标系](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkui-glossary#组件坐标系)中的Y坐标。
...
触摸点在[全局坐标系](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/window-terminology#全局坐标系)中的X坐标。
...
触摸点在[全局坐标系](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/window-terminology#全局坐标系)中的Y坐标。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3b/v3/t1dGJfsgQWGyerCqYecg9A/zh-cn_image_0000002538020412.gif?HW-CC-KV=V1&HW-CC-Date=20260417T014756Z&HW-CC-Expire=86400&HW-CC-Sign=670F4EA7FDC71D62859D2F68D0C23DA29687A2DA4CFA77E0C7F85703D0C342BC)
