---
title: "Rating"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-rating"
menu_path:
  - "参考"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "按钮与选择"
  - "Rating"
captured_at: "2026-04-17T01:47:56.882Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/89/v3/iJ_AbLH0S3ep-UniF-MkVw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014759Z&HW-CC-Expire=86400&HW-CC-Sign=E9F59CF3D35D270DB60E8D6A4928ABD765444D3E5C9E83398933403B0BA06092)
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| options | [RatingOptions](#ratingoptions18对象说明) | 否 | 
设置评分组件。
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| starCount | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)<number> | 是 | 
设置评分总数。
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| size | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)<number> | 是 | 
操作评级的步长。
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| options | [StarStyleOptions](#starstyleoptions18对象说明) | 是 | 
评分的样式。
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| options | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)<[StarStyleOptions](#starstyleoptions18对象说明)\> | 是 | 
评分的样式。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4/v3/MxVoqhkaQpi6htisfSTdsg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014759Z&HW-CC-Expire=86400&HW-CC-Sign=75EF6F6EA62C5DE9EBCE83A05A3BE4BE9FF7FF378922D35392C4F7087458ED64)
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| modifier | [ContentModifier<RatingConfiguration>](#ratingconfiguration12对象说明) | 是 | 
在Rating组件上，定制内容区的方法。
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| modifier | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)<[ContentModifier<RatingConfiguration>](#ratingconfiguration12对象说明)\> | 是 | 
在Rating组件上，定制内容区的方法。
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| callback | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)<[OnRatingChangeCallback](#onratingchangecallback18)\> | 是 | 
操作评分条的评星变化时触发该回调。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b/v3/647p36m2SgqpnIDraTvecQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014759Z&HW-CC-Expire=86400&HW-CC-Sign=A02D324E99C509B9B12242F52AF50D89668FA75606FBD02A8AF4E86900B4F97A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e1/v3/m3x5yDl1SfyxvLshsnKgwQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014759Z&HW-CC-Expire=86400&HW-CC-Sign=537B4A95C63048D00EF82DF8855C402ADF7EE71B80F256D4ED9401D6481022B4)
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| backgroundUri7+ | [ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | 否 | 否 | 
...
从API version 20开始，该接口支持设置Resource资源。参考[示例3（通过Resource资源设置评分的样式）](#示例3通过resource资源设置评分的样式)代码。

 |
| foregroundUri7+ | [ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | 否 | 否 | 
...
从API version 20开始，该接口支持设置Resource资源。参考[示例3（通过Resource资源设置评分的样式）](#示例3通过resource资源设置评分的样式)代码。
 ...
 |
| secondaryUri7+ | [ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | 否 | 是 | 
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/zEkQFKJwQAeNP4g0o6KcRw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014759Z&HW-CC-Expire=86400&HW-CC-Sign=C7DDBD5F0A3F1C056FC804B682EAF28E2327C1B9D213BB219CA9680005F206FC)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/42/v3/gSg-NEiITAGoBG4sq7920Q/zh-cn_image_0000002538180596.gif?HW-CC-KV=V1&HW-CC-Date=20260417T014759Z&HW-CC-Expire=86400&HW-CC-Sign=2D75CA1F13D3A3033A50C574D6BFCFB33C1663261EDD57DA93DB35408FF03119)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b3/v3/ibCyKI4_S0WNJEThz23Ymg/zh-cn_image_0000002569020383.gif?HW-CC-KV=V1&HW-CC-Date=20260417T014759Z&HW-CC-Expire=86400&HW-CC-Sign=860A2596C6D41D9472F56144CF632AAB8C134CC87723582C284B6BCD49352B0B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e3/v3/5F8SYOp1TMS9OtWBoPk6bg/zh-cn_image_0000002568900375.gif?HW-CC-KV=V1&HW-CC-Date=20260417T014759Z&HW-CC-Expire=86400&HW-CC-Sign=3F84B1D069B7459E06425A717EDD93B98BC7C23F1FB920098378B19C8C825373)

#### \[h2\]示例4（设置评分的样式）

以下示例展示了如何通过配置starStyle实现自定义星级的图片链接。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/qqFzcrcXRwamcX2Qaox2hQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014759Z&HW-CC-Expire=86400&HW-CC-Sign=A4E6B705CFEFEE933B1FF8612E76386A63586C7C4E50168DAEF3412DF077FE68)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/51/v3/iRZxxKHYTCaNFN4BIDpzhw/zh-cn_image_0000002568900375.gif?HW-CC-KV=V1&HW-CC-Date=20260417T014759Z&HW-CC-Expire=86400&HW-CC-Sign=D154C9F7B97897BAE1BC8BC23DFB9558F95E5B5C9333CB3D39C53212C743B3AF)
