...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-alphabet-indexer"
menu_path:
  - "参考"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "信息展示"
  - "AlphabetIndexer"
captured_at: "2026-04-17T01:47:57.643Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/15/v3/iAoR8oLZTi6tc-74Rh8Mwg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014800Z&HW-CC-Expire=86400&HW-CC-Sign=9EEBA84C817213C78C3C66286C3A07578D9F9826DB7189DB6F4C5D8DB920DD27)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ce/v3/XRW0fZq2SrOVqjfIX251CQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014800Z&HW-CC-Expire=86400&HW-CC-Sign=9C8546FA633C6DB13FF8B8479D958CAFB074423B81022A71800D5ED52B584891)
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| arrayValue7+ | Array<string> | 否 | 否 | 
字符串数组，每个字符串代表一个索引项。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

 |
| selected7+ | number | 否 | 否 | 

初始选中项索引值，若超出索引值范围，则取默认值0。与[selected](#selected8)属性同时设置时，selected属性的优先级较高。
...
弹窗的背景模糊材质效果会对背景色产生影响，可通过设置[popupBackgroundBlurStyle](#popupbackgroundblurstyle12)属性值为NONE关闭背景模糊材质效果。
...
实际取值会受到组件尺寸的约束，索引项宽度最大为组件宽度-左右[padding](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-size#padding)，索引项高度最大为（组件高度-上下[padding](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-size#padding)）/索引项个数。传入值小于等于0时，按照默认值处理。
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| value | [IndexerAlign](#indexeralign枚举说明) | 是 | 
...
取值范围：\[0, [arrayValue](#alphabetindexeroptions18对象说明).length-1\]
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e2/v3/Ac30ZGiwQsCbtuHuUFD3XQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014800Z&HW-CC-Expire=86400&HW-CC-Sign=62E779FC67D2C26C6719C4F87F37E1CA93495541EBFD8DF32113C4FA9500BAB5)
...
弹窗的背景模糊材质效果会对背景色[popupBackground](#popupbackground)产生影响，可通过设置属性值为NONE关闭背景模糊材质效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ec/v3/6g7i0LO-Qiu6UQ0Gj0vFzg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014800Z&HW-CC-Expire=86400&HW-CC-Sign=64DCF0F724B086A1D28ED6EECA4B65734159335C5B20165EC71506846F06DCC1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b7/v3/7jQAl_5VSoKzLQcI1gaiKw/zh-cn_image_0000002569020561.gif?HW-CC-KV=V1&HW-CC-Date=20260417T014800Z&HW-CC-Expire=86400&HW-CC-Sign=2129205C1BF4208E67311F2715FD22E535F86D23F068F374FB17AEDD8058B39C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/12/v3/Iz0HDbEgQoGMHgwuX33f7Q/zh-cn_image_0000002568900553.gif?HW-CC-KV=V1&HW-CC-Date=20260417T014800Z&HW-CC-Expire=86400&HW-CC-Sign=C3AA88F7E406020739003779C3F46C58ECF007B8D689E84395B0E635987D3477)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/72/v3/3aPW4NjwSBqz5xznBpLTvg/zh-cn_image_0000002538020852.gif?HW-CC-KV=V1&HW-CC-Date=20260417T014800Z&HW-CC-Expire=86400&HW-CC-Sign=D24F5F67DEA4C2C7EBD9B8C36D405D04F0215A084DED48219974C55C342A430A)
