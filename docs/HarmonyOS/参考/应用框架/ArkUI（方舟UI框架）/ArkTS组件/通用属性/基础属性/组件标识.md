---
title: "组件标识"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-component-id"
menu_path:
  - "参考"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "基础属性"
  - "组件标识"
captured_at: "2026-04-17T01:47:54.566Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/64/v3/gdAhRrShR864uJ8hLUU5Ng/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014756Z&HW-CC-Expire=86400&HW-CC-Sign=10E214874515E7F846076CC2E824E5075D079556BBEBA39B1EC2C2364C937347)
...
字符串信息包含组件的tag、id、位置信息(相对于窗口左上角的坐标)以及用于测试检查的组件所包含的相关属性信息。组件中每个字段的含义请参考[getInspectorInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-framenode#getinspectorinfo12)的返回值说明。
