---
title: "拖拽排序"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-drag-sorting"
menu_path:
  - "参考"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "交互属性"
  - "拖拽排序"
captured_at: "2026-04-17T01:47:55.156Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ff/v3/Z0B8Gq_gRx2tQqYXNJ2-dg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014757Z&HW-CC-Expire=86400&HW-CC-Sign=0FB952EC97AEFB3C56EAD0DE27768101E0CA1E339F8A0EFD176FEF6AD5B5186A)
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| onLongPress | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<number> | 否 | 是 | 
长按时触发的回调。

\- 参数index为长按时当前目标的索引号。

 |
| onDragStart | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<number> | 否 | 是 | 
...
| onDrop | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<number> | 否 | 是 | 
