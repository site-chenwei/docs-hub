---
title: "自定义组件内置方法"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-custom-component-api"
menu_path:
  - "参考"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "自定义组件"
  - "自定义组件内置方法"
captured_at: "2026-04-17T01:47:59.297Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/cwROQmdjSYKoYNELTppq9A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014801Z&HW-CC-Expire=86400&HW-CC-Sign=E6C9D8464E0981844D5E71B206393CE7AA0C7F5CA0BF095B95355B1374A81A27)
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| isInner | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)<boolean> | 是 | 
