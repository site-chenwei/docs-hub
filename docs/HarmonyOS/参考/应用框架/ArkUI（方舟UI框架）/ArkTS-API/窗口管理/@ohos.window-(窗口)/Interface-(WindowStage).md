...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-windowstage"
menu_path:
  - "参考"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
...
captured_at: "2026-04-17T01:47:53.794Z"
---

# Interface (WindowStage)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b7/v3/DZvLJH7OQreLq9o6Cfj0Bw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014755Z&HW-CC-Expire=86400&HW-CC-Sign=48021DB1567A1B8CCCF9BB91EA40669A64F7C9CAA62B820FF90AE283E6C1B4DA)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/51/v3/S4_lipOrRNiln2f25MdjKw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014755Z&HW-CC-Expire=86400&HW-CC-Sign=450BE9A0D6D445BDA9302B3C4FF380627D2C6EB60177A01986DAA1DCA226E49A)
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| supportedWindowModes | Array<[bundleManager.SupportWindowMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bundlemanager#supportwindowmode)\> | 是 | 
设置主窗的窗口支持模式。
...
\- SPLIT：支持分屏模式。需要配合FULL\_SCREEN或FLOATING一起使用，不支持仅配置SPLIT。
