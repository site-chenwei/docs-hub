...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-shape"
menu_path:
  - "参考"
  - "应用框架"
  - "ArkUI（方舟UI框架）"
  ...
  - "UI界面"
  - "@ohos.arkui.shape (形状)"
captured_at: "2026-04-17T01:47:52.602Z"
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/eb/v3/lKIbGkniSImYXomB77xR5A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T014754Z&HW-CC-Expire=86400&HW-CC-Sign=0BD3B8C3B3B78D5C14FED9FE70D0E188560BDF6D1665BBE1D1BD9EA02CF7C4D5)
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| radius | number | string | Array<number | string> | 是 | 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| radius | number | string | Array<number | string> | 否 | 是 | 
矩形形状的圆角半径。
...
取值为异常值时按照0vp处理。
 ...
 |
| radiusHeight | number | string | 否 | 是 | 
...
| 参数名 | 类型 | 必填 | 说明 |
| :-- | :-- | :-- | :-- |
| width | [Length](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#length) | 是 | 
形状的宽度。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8f/v3/RVCMh1XiQHqYeZuSy9ISvA/zh-cn_image_0000002538020352.png?HW-CC-KV=V1&HW-CC-Date=20260417T014754Z&HW-CC-Expire=86400&HW-CC-Sign=2887BCC8DA80296DE7A7D664E6C0990A80C41AEE9CC33F8206FE40FC15912C3F)
