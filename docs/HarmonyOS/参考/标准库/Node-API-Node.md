---
title: "Node"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-references/napi"
menu_path:
  - "参考"
  - "标准库"
  - "Node-API"
captured_at: "2026-04-17T01:49:07.097Z"
---
...
#### \[h2\]napi\_get\_typedarray\_info
...
#### \[h2\]napi\_get\_property\_names

**返回：**

-   当参数object不是Object或Function对象时，该导出接口返回napi\_object\_expected。

#### \[h2\]napi\_set\_property

**返回：**

-   当参数object不是Object或Function对象时，该导出接口返回napi\_object\_expected。

#### \[h2\]napi\_get\_property

**返回：**

-   当参数object不是Object或Function对象时，该导出接口返回napi\_object\_expected。

#### \[h2\]napi\_has\_property

**返回：**

-   当参数object不是Object或Function对象时，该导出接口返回napi\_object\_expected。

#### \[h2\]napi\_delete\_property

**返回：**

-   当参数object不是Object或Function对象时，该导出接口返回napi\_object\_expected。

#### \[h2\]napi\_has\_own\_property

**返回：**

-   当参数object不是Object或Function对象时，该导出接口返回napi\_object\_expected。

#### \[h2\]napi\_set\_named\_property

**返回：**

-   当参数object不是Object或Function对象时，该导出接口返回napi\_object\_expected。

#### \[h2\]napi\_get\_named\_property

**返回：**

-   当参数object不是Object或Function对象时，该导出接口返回napi\_object\_expected。

#### \[h2\]napi\_has\_named\_property

**返回：**

-   当参数object不是Object或Function对象时，该导出接口返回napi\_object\_expected。

#### \[h2\]napi\_set\_element
...
#### \[h2\]napi\_get\_element

**返回：**

-   当参数object不是Object或Function对象时，该导出接口返回napi\_object\_expected。

#### \[h2\]napi\_has\_element

**返回：**

-   当参数object不是Object或Function对象时，该导出接口返回napi\_object\_expected。

#### \[h2\]napi\_delete\_element

**返回：**

-   当参数object不是Object或Function对象时，该导出接口返回napi\_object\_expected。

#### \[h2\]napi\_define\_properties
...
#### \[h2\]napi\_type\_tag\_object

**返回：**

-   当参数js\_object不是Object或Function对象时，该导出接口返回napi\_object\_expected。

#### \[h2\]napi\_check\_object\_type\_tag

**返回：**

-   当参数js\_object不是Object或Function对象时，该导出接口返回napi\_object\_expected。

#### \[h2\]napi\_call\_function
...
#### \[h2\]napi\_delete\_async\_work

**参数：**

-   该导出接口暂时不支持async\_hooks资源管理机制。

#### \[h2\]napi\_queue\_async\_work

**参数：**

-   该导出接口暂时不支持async\_hooks资源管理机制。

#### \[h2\]napi\_cancel\_async\_work
...
#### \[h2\]napi\_call\_threadsafe\_function
...
#### \[h2\]napi\_release\_threadsafe\_function
...
#### \[h2\]napi\_create\_external\_buffer
...
#### \[h2\]napi\_queue\_async\_work\_with\_qos
...
#### \[h2\]napi\_create\_object\_with\_properties
...
#### \[h2\]napi\_create\_object\_with\_named\_properties
...
#### \[h2\]napi\_coerce\_to\_native\_binding\_object
...
#### \[h2\]napi\_destroy\_ark\_runtime
...
#### \[h2\]napi\_load\_module\_with\_info
...
#### \[h2\]napi\_delete\_serialization\_data
...
#### \[h2\]napi\_call\_threadsafe\_function\_with\_priority
...
#### \[h2\]napi\_define\_sendable\_class
...
#### \[h2\]napi\_create\_sendable\_object\_with\_properties
...
#### \[h2\]napi\_create\_sendable\_array
...
#### \[h2\]napi\_create\_sendable\_array\_with\_length
...
#### \[h2\]napi\_create\_sendable\_arraybuffer
...
#### \[h2\]napi\_create\_sendable\_typedarray
...
#### \[h2\]napi\_wrap\_sendable\_with\_size
...
#### \[h2\]napi\_remove\_wrap\_sendable
...
#### \[h2\]napi\_destroy\_ark\_context
...
#### \[h2\]napi\_open\_critical\_scope
...
#### \[h2\]napi\_close\_critical\_scope
...
#### \[h2\]napi\_get\_buffer\_string\_utf16\_in\_critical\_scope
...
#### \[h2\]napi\_create\_strong\_reference
...
#### \[h2\]napi\_delete\_strong\_reference
...
#### \[h2\]napi\_get\_strong\_reference\_value
...
#### \[h2\]napi\_finalize\_callback回调函数说明
...
#### \[h2\]napi\_create\_external\_string\_utf16
...
#### \[h2\]napi\_create\_external\_string\_ascii
...
#### \[h2\]napi\_create\_strong\_sendable\_reference
...
#### \[h2\]napi\_delete\_strong\_sendable\_reference
...
#### \[h2\]napi\_get\_strong\_sendable\_reference\_value
...
#### \[h2\]napi\_throw\_business\_error
