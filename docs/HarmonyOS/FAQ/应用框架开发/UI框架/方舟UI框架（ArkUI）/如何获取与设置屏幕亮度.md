---
title: "如何获取与设置屏幕亮度"
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-faqs/faqs-arkui-132"
menu_path:
  - "FAQ"
  - "应用框架开发"
  - "UI框架"
  - "方舟UI框架（ArkUI）"
  - "如何获取与设置屏幕亮度"
captured_at: "2026-04-17T02:03:04.026Z"
---
...
1.  通过使用[settings.getValueSync()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-settings#settingsgetvaluesync10)方法可获取屏幕亮度，传入应用上下文与数据项的名称（屏幕亮度为settings.display.SCREEN\_BRIGHTNESS\_STATUS），以及默认值，即可获取当前屏幕亮度，获取值范围为0-255。
    ...
    Button('获取屏幕亮度')
      ...
      .onClick(() => {
        ...
        this.settingsBrightness = settings.getValueSync(this.context, settings.display.SCREEN\_BRIGHTNESS\_STATUS, '10');
      })
...
2.  通过window实例的[getWindowProperties()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-window#getwindowproperties9)获取窗口属性，其中包括屏幕亮度的信息。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/70/v3/igj0SpfNTE-GLJfP1ebXgQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T020306Z&HW-CC-Expire=86400&HW-CC-Sign=FE63E6330AF0A763B54D239678CC259DB5D149309146B011F94312E218E66AB8)
...
3.  通过window实例提供的[setWindowBrightness()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-window#setwindowbrightness9)方法，即可设置屏幕亮度。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/42/v3/bMPc4kU4QfObBeS6FyaHkQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260417T020306Z&HW-CC-Expire=86400&HW-CC-Sign=C4237BF6E4C233AA29679461B759EEA342DBF195626E01648A916991B14CCFEA)
