...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-faqs/faqs-arkui-250"
menu_path:
  - "FAQ"
  - "应用框架开发"
  - "UI框架"
...
captured_at: "2026-04-17T02:03:05.386Z"
---
...
struct ScrollListDemoPage {
  ...
  rightScroll() {
    Scroll(this.horizontalScroller) {
      ...
      .scrollBar(BarState.Off)
      .edgeEffect(EdgeEffect.None)
      .nestedScroll({ scrollForward: NestedScrollMode.PARENT\_FIRST, scrollBackward: NestedScrollMode.PARENT\_FIRST })
      .onScrollFrameBegin((offset: number) => {
