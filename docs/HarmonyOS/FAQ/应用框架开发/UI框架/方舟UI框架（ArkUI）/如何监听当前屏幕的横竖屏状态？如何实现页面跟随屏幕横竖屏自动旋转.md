...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-faqs/faqs-arkui-34"
menu_path:
  - "FAQ"
  - "应用框架开发"
  - "UI框架"
...
captured_at: "2026-04-17T02:03:03.176Z"
---
  ...
  setOrientation() {
    try {
      window.getLastWindow(this.context.getHostContext(), (err, data) => { // 获取window实例
        ...
        let orientation = window.Orientation.AUTO\_ROTATION; // 设置窗口方向为传感器自动旋转模式。
        try {
