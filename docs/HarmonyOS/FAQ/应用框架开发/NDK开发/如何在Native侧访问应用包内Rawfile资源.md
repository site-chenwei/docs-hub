...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-faqs/faqs-ndk-22"
menu_path:
  - "FAQ"
  - "应用框架开发"
  - "NDK开发"
  - "如何在Native侧访问应用包内Rawfile资源"
captured_at: "2026-04-17T02:03:01.868Z"
---
...
3.  在napi\_init.cpp文件中实现功能代码。
    ...
    static napi\_value GetRawFileContent(napi\_env env, napi\_callback\_info info)
    {
        ...
        // Argv \[0\] is the first parameter of the function, Js resource object, and OH\_ ResourceManagerial is converted to a Native object.
