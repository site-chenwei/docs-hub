...
source_url: "https://developer.huawei.com/consumer/cn/doc/harmonyos-faqs/faqs-arkweb-40"
menu_path:
  - "FAQ"
  - "应用框架开发"
  - "Web框架"
...
captured_at: "2026-04-17T02:03:15.498Z"
---
      ...
      Scroll(this.scrollerForScroll) {
        Column({ space: 5 }) {
          ...
          Web({ src: $rawfile('index.html'), controller: this.controller })
            ...
            .height('100%')
            .width('100%')
            .layoutMode(WebLayoutMode.FIT\_CONTENT)
          Text(this.review)
            .fontSize(30)
          List() {
            ForEach(this.list, () => {
