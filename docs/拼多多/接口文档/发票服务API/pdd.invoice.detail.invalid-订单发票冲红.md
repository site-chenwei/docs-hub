---
title: "pdd.invoice.detail.invalid - 订单发票冲红"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.invoice.detail.invalid"
menu_path:
  - "发票服务API"
  - "pdd.invoice.detail.invalid"
captured_at: "2026-04-09T15:21:25.496Z"
---
...
| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| invoice\_detail\_invalid\_response | OBJECT |  | response |
| error\_code | INTEGER |  | errorCode |
| error\_msg | STRING |  | errorMsg |
| result | OBJECT |  | result |
| result | BOOLEAN |  | 红冲是否成功 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddInvoiceDetailInvalidRequest;
...
public class PopClientDemo {
 ...
        PddInvoiceDetailInvalidRequest request = new PddInvoiceDetailInvalidRequest();
        request.setOrderSn("str");
        PddInvoiceDetailInvalidResponse response = client.syncInvoke(request, accessToken);
...
```
{
  "invoice_detail_invalid_response": {
    "error_code": 0,
    "error_msg": "str",
    "result": {
      "result": false
...
| 50001 | 业务服务错误 | 4000000 | 系统内部错误 | 联系小二排查 |
