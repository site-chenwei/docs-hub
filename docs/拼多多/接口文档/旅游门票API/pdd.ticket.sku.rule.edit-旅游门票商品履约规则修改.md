---
title: "pdd.ticket.sku.rule.edit - 旅游门票商品履约规则修改"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.ticket.sku.rule.edit"
menu_path:
  - "旅游门票API"
  - "pdd.ticket.sku.rule.edit"
captured_at: "2026-04-09T15:25:17.460Z"
---
...
| ticket\_time | OBJECT\[\] | 必填 | 换票时间 |
| comment | STRING | 非必填 | 备注 |
| end\_at | STRING | 必填 | 换票结束时间 |
| start\_at | STRING | 必填 | 换票开始时间 |
...
| provider\_business\_hour | OBJECT\[\] | 必填 | 服务时间 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddTicketSkuRuleEditRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddTicketSkuRuleEditResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddTicketSkuRuleEditRequest.BookerInfoLimitation;
import com.pdd.pop.sdk.http.api.pop.request.PddTicketSkuRuleEditRequest.BookingNotice;
import com.pdd.pop.sdk.http.api.pop.request.PddTicketSkuRuleEditRequest.BookingNoticeEnterTimeItem;
import com.pdd.pop.sdk.http.api.pop.request.PddTicketSkuRuleEditRequest.BookingNoticeTicketTimeItem;
import com.pdd.pop.sdk.http.api.pop.request.PddTicketSkuRuleEditRequest.OrderLimitation;
import com.pdd.pop.sdk.http.api.pop.request.PddTicketSkuRuleEditRequest.ProviderContactInfo;
import com.pdd.pop.sdk.http.api.pop.request.PddTicketSkuRuleEditRequest.ProviderContactInfoProviderBusinessHourItem;
import com.pdd.pop.sdk.http.api.pop.request.PddTicketSkuRuleEditRequest.RefundLimitations;
import com.pdd.pop.sdk.http.api.pop.request.PddTicketSkuRuleEditRequest.RefundLimitationsRefundRulesItem;
import com.pdd.pop.sdk.http.api.pop.request.PddTicketSkuRuleEditRequest.TravelerInfoLimitation;
import com.pdd.pop.sdk.http.api.pop.request.PddTicketSkuRuleEditRequest.ValidLimitation;
...
public class PopClientDemo {
 ...
        PddTicketSkuRuleEditRequest request = new PddTicketSkuRuleEditRequest();
 ...
        PddTicketSkuRuleEditResponse response = client.syncInvoke(request, accessToken);
