---
title: "pdd.order.virtual.information.get - 虚拟业务信息查询接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.order.virtual.information.get"
menu_path:
  - "订单API"
  - "pdd.order.virtual.information.get"
captured_at: "2026-04-09T15:13:54.264Z"
---
...
| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| order\_virtual\_information\_response | OBJECT |  |  |
| contact\_mobile
加密

 | STRING |  | 联系人手机号，与 pdd.order.information.get 接口的 contact\_mobile 一致 |
| contact\_phone

加密

 | STRING |  | 收件人手机号，与 pdd.order.information.get 接口的 receiver\_phone 一致 |
| id\_card\_name
...
| phone\_number\_chosen\_by\_user | STRING |  | 选号卡号 |
...
public class PopClientDemo {
 ...
        PddOrderVirtualInformationGetResponse response = client.syncInvoke(request, accessToken);
...
```
{
  "order_virtual_information_response": {
    "contact_mobile": "str",
    "contact_phone": "str",
    "id_card_name": "str",
    "id_card_num": "str",
