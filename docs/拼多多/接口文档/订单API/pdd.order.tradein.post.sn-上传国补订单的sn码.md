---
title: "pdd.order.tradein.post.sn - 上传国补订单的sn码"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.order.tradein.post.sn"
menu_path:
  - "订单API"
  - "pdd.order.tradein.post.sn"
captured_at: "2026-04-09T15:13:38.672Z"
---
...
import com.pdd.pop.sdk.http.api.pop.request.PddOrderTradeinPostSnRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddOrderTradeinPostSnResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddOrderTradeinPostSnRequest.Request;
...
public class PopClientDemo {
 ...
        PddOrderTradeinPostSnRequest request = new PddOrderTradeinPostSnRequest();

        Request request1 = new Request();
        request1.setOrderSn("str");
        request1.setSn("str");
        request.setRequest(request1);
        PddOrderTradeinPostSnResponse response = client.syncInvoke(request, accessToken);
