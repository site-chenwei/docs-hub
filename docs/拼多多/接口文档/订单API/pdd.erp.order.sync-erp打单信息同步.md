---
title: "pdd.erp.order.sync - erp打单信息同步"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.erp.order.sync"
menu_path:
  - "订单API"
  - "pdd.erp.order.sync"
captured_at: "2026-04-09T15:12:39.105Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| logistics\_id | LONG | 必填 | 物流公司编码 |
| order\_sn | STRING | 必填 | 订单号 |
| order\_state | INTEGER | 必填 | 订单状态：1-已打单 |
| waybill\_no | STRING | 必填 | 运单号 |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| error\_code | LONG | 1 | 错误代码 |
| error\_msg | STRING |  | 错误参数 |
| result | BOOLEAN | true | 是否有结果 |
