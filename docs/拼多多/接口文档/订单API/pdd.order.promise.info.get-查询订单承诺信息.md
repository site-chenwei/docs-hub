---
title: "pdd.order.promise.info.get - 查询订单承诺信息"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.order.promise.info.get"
menu_path:
  - "订单API"
  - "pdd.order.promise.info.get"
captured_at: "2026-04-09T15:13:07.235Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| promise\_id | LONG | 必填 | 承诺id |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| promise\_info\_get\_response | OBJECT |  |  |
| promise\_info | OBJECT |  |  |
| detail\_info | MAP |  | 承诺详情 |
| $key | STRING | promise\_delivery\_time | key 详情请参阅接口文档 |
| $value | STRING | 2020-08-02 12:05:01 | value 详情请参阅接口文档 |
| extra\_info | MAP |  | 额外信息 |
| $key | STRING | extra\_info\_key |  |
| $value | STRING | extra\_info\_value |  |
| is\_deleted | BOOLEAN | false | 是否已删除 |
| order\_sn | STRING |  | 订单号 |
| promise\_desc | STRING |  | 服务承诺描述 |
| promise\_level | INTEGER | 1 | 服务承诺单性质，1-平台协议，2-客服承 诺，3-平台建议 |
| promise\_status | INTEGER | 0 | 服务承诺状态，0-已创建，1-履约中，2-履 约未达成，3-履约成功 |
| promise\_type | INTEGER |  | 服务承诺类型，1-指定快递/物流，2-优先发 货 |
| promise\_id | LONG | 12345 | 承诺信息id |
| scene\_type | INTEGER | 1 | 业务场景，1-发货场景 |
| updated\_at | STRING | 2020-08-02 12:05:01 | 最后更新时间 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddOrderPromiseInfoGetRequest;
...
public class PopClientDemo {
 ...
        request.setPromiseId(123456L);
        PddOrderPromiseInfoGetResponse response = client.syncInvoke(request, accessToken);
...
```
{
  "promise_info_get_response": {
    "promise_info": {
      "detail_info": {
        "promise_delivery_time": "2020-08-02 12:05:01"
      },
      "extra_info": {
 ...
      "promise_type": 0,
      "scene_type": 1,
      "updated_at": "2020-08-02 12:05:01"
    }
  }
}
```
...
| --- | --- |
| 订单服务承诺权限包 | 打单、进销存、虚拟商家后台系统、企业ERP、商家后台系统、订单处理、跨境企业ERP报关版 |
