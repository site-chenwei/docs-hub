---
title: "pdd.order.status.get - 订单状态"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.order.status.get"
menu_path:
  - "订单API"
  - "pdd.order.status.get"
captured_at: "2026-04-09T15:13:25.922Z"
---
...
| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| order\_status\_get\_response | OBJECT |  | response |
| order\_status\_list | OBJECT\[\] |  | 订单状态列表对象 |
| orderSn | STRING |  | 订单编号 |
| order\_status | INTEGER |  | 订单发货状态，1：待发货，2：已发货待签收，3：已签收 0：异常 |
| refund\_status | INTEGER |  | 订单售后状态，1：无售后或售后关闭，2：售后处理中，3：退款中，4：退款成功，0：异常 |
