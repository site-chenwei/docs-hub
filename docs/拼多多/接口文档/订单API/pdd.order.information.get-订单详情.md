---
title: "pdd.order.information.get - 订单详情"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.order.information.get"
menu_path:
  - "订单API"
  - "pdd.order.information.get"
captured_at: "2026-04-09T15:12:51.491Z"
---
...
| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| order\_info\_get\_response | OBJECT | 1 | response |
| order\_info | OBJECT | 1 | 订单详情对象 |
| address
加密
...
| delivery\_install\_value | DOUBLE | 1 | 送货入户并安装 单位：元 |
...
| free\_sf | INTEGER | 1 | 是否顺丰包邮 1表示是 0表示否 |
...
| item\_list | OBJECT\[\] | 1 | 订单中商品sku列表 |
...
| step\_order\_info | OBJECT | 1 | 定金订单信息 ，非定金订单该字段为null |
| advanced\_paid\_fee | DOUBLE | 1 | 已付定金 单位：元 |
| step\_discount\_amount | DOUBLE | 1 | 膨胀金额 （包含券减） 单位：元 |
| step\_paid\_fee | DOUBLE | 1 | 分阶段已付金额（定金+尾款） 单位：元 |
...
| store\_info | OBJECT |  | 门店信息 |
| out\_store\_code | STRING |  | 外部门店code |
| store\_id | LONG |  | 门店id |
| store\_name | STRING |  | 门店名称 |
| store\_number | STRING |  | 门店自定义编码 |
