---
title: "pdd.order.upload.relation.logistics - 订单关联运单信息上传"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.order.upload.relation.logistics"
menu_path:
  - "订单API"
  - "pdd.order.upload.relation.logistics"
captured_at: "2026-04-09T15:13:51.178Z"
---
...
import com.pdd.pop.sdk.http.api.pop.request.PddOrderUploadRelationLogisticsRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddOrderUploadRelationLogisticsResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddOrderUploadRelationLogisticsRequest.ExtraTrackListItem;
...
public class PopClientDemo {
 ...
        PddOrderUploadRelationLogisticsRequest request = new PddOrderUploadRelationLogisticsRequest();
 ...
        PddOrderUploadRelationLogisticsResponse response = client.syncInvoke(request, accessToken);
