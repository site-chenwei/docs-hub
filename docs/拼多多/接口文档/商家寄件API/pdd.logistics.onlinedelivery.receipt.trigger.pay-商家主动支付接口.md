---
title: "pdd.logistics.onlinedelivery.receipt.trigger.pay - 商家主动支付接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.logistics.onlinedelivery.receipt.trigger.pay"
menu_path:
  - "商家寄件API"
  - "pdd.logistics.onlinedelivery.receipt.trigger.pay"
captured_at: "2026-04-09T15:26:26.172Z"
---
...
import com.pdd.pop.sdk.http.api.pop.request.PddLogisticsOnlinedeliveryReceiptTriggerPayRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddLogisticsOnlinedeliveryReceiptTriggerPayResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddLogisticsOnlinedeliveryReceiptTriggerPayRequest.Request;
...
public class PopClientDemo {
 ...
        PddLogisticsOnlinedeliveryReceiptTriggerPayRequest request = new PddLogisticsOnlinedeliveryReceiptTriggerPayRequest();

        Request request1 = new Request();
        request1.setDeliveryReceiptSn("str");
        request.setRequest(request1);
        PddLogisticsOnlinedeliveryReceiptTriggerPayResponse response = client.syncInvoke(request, accessToken);
