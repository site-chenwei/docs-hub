---
title: "pdd.logistics.onlinedelivery.receipt.cancel - 取消寄件接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.logistics.onlinedelivery.receipt.cancel"
menu_path:
  - "商家寄件API"
  - "pdd.logistics.onlinedelivery.receipt.cancel"
captured_at: "2026-04-09T15:26:10.522Z"
---
...
| cancelType | INTEGER | 必填 | 取消原因枚举值 500-信息填错了需要修改 501-暂时不需要寄件 502-联系不到快递员 503-快递员不上门 504-时间原因，着急发货 505-选择其他发货方式 506-价格太高不合适 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddLogisticsOnlinedeliveryReceiptCancelRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddLogisticsOnlinedeliveryReceiptCancelResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddLogisticsOnlinedeliveryReceiptCancelRequest.Request;
...
public class PopClientDemo {
 ...
        PddLogisticsOnlinedeliveryReceiptCancelRequest request = new PddLogisticsOnlinedeliveryReceiptCancelRequest();

        Request request1 = new Request();
        request1.setCancelType(10);
        request1.setDeliveryReceiptSn("OD123456");
        request.setRequest(request1);
        PddLogisticsOnlinedeliveryReceiptCancelResponse response = client.syncInvoke(request, accessToken);
