---
title: "pdd.logistics.onlinedelivery.courier.query - 查询可选快递公司"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.logistics.onlinedelivery.courier.query"
menu_path:
  - "商家寄件API"
  - "pdd.logistics.onlinedelivery.courier.query"
captured_at: "2026-04-09T15:26:01.081Z"
---
...
在前端支持商家看到并选择下单的快递公司，支持商家选择商家寄件合作的特惠快递公司
...
| sendCityName | STRING | 非必填 | 发件地市名称(没填，则addressId必填) |
...
| deliveryShipBranchList | OBJECT\[\] |  | deliveryShipBranchList |
| shipCode | STRING | JTSD | 快递编码 |
| shipName | STRING | 极兔速递 | 快递名称 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddLogisticsOnlinedeliveryCourierQueryRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddLogisticsOnlinedeliveryCourierQueryResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddLogisticsOnlinedeliveryCourierQueryRequest.Request;
...
public class PopClientDemo {
 ...
        PddLogisticsOnlinedeliveryCourierQueryRequest request = new PddLogisticsOnlinedeliveryCourierQueryRequest();
 ...
        PddLogisticsOnlinedeliveryCourierQueryResponse response = client.syncInvoke(request, accessToken);
