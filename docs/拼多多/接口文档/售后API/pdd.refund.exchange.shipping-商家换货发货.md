---
title: "pdd.refund.exchange.shipping - 商家换货发货"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.refund.exchange.shipping"
menu_path:
  - "售后API"
  - "pdd.refund.exchange.shipping"
captured_at: "2026-04-09T15:14:12.760Z"
---
...
| order\_sn | STRING | 必填 | 订单编号 |
| shipping\_id | INTEGER | 必填 | 物流公司id |
| shipping\_name | STRING | 必填 | 物流公司名称 |
| tracking\_number | STRING | 必填 | 换货物流单号 |
...
| response | OBJECT |  |  |
| result | OBJECT |  |  |
| after\_sales\_id | LONG |  |  |
| message | STRING | 操作成功 | 操作结果信息。如果失败，会返回失败原因 |
| order\_sn | STRING |  |  |
| succ | BOOLEAN | true | 是否操作成功 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddRefundExchangeShippingRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddRefundExchangeShippingResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddRefundExchangeShippingRequest.Request;
...
public class PopClientDemo {
 ...
        PddRefundExchangeShippingRequest request = new PddRefundExchangeShippingRequest();

        Request request1 = new Request();
        request1.setAfterSalesId(0L);
        request1.setOrderSn("str");
        request1.setShippingId(0);
        request1.setShippingName("str");
        request1.setTrackingNumber("str");
        request.setRequest(request1);
        PddRefundExchangeShippingResponse response = client.syncInvoke(request, accessToken);
