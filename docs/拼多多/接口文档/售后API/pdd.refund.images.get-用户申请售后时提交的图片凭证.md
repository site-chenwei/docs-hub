---
title: "pdd.refund.images.get - 用户申请售后时提交的图片凭证"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.refund.images.get"
menu_path:
  - "售后API"
  - "pdd.refund.images.get"
captured_at: "2026-04-09T15:14:15.835Z"
---
...
更新时间：2025-10-20 19:47:03

¥免费API

必须用户授权

查看售后详情时展示用户申请售后时提交的图片凭证（图片链接有效时间一小时）
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| request | OBJECT | 必填 | 查询售后申请图片列表请求 |
| after\_sales\_id | LONG | 必填 | 售后单id |
...
import com.pdd.pop.sdk.http.api.pop.request.PddRefundImagesGetRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddRefundImagesGetResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddRefundImagesGetRequest.Request;
...
public class PopClientDemo {
 ...
        PddRefundImagesGetRequest request = new PddRefundImagesGetRequest();

        Request request1 = new Request();
        request1.setAfterSalesId(0L);
        request1.setOrderSn("str");
        request.setRequest(request1);
        PddRefundImagesGetResponse response = client.syncInvoke(request, accessToken);
