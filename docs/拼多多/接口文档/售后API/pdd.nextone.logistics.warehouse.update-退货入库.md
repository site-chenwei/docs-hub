---
title: "pdd.nextone.logistics.warehouse.update - 退货入库"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.nextone.logistics.warehouse.update"
menu_path:
  - "售后API"
  - "pdd.nextone.logistics.warehouse.update"
captured_at: "2026-04-09T15:14:00.373Z"
---
...
| operate\_time | LONG | 必填 | 操作时间 |
| order\_sn | STRING | 必填 | order\_sn |
| reverse\_logistics\_id | INTEGER | 非必填 | 物流公司id |
| reverse\_tracking\_number | STRING | 必填 | 物流单号 |
| warehouse\_status | INTEGER | 必填 | 退货入库状态 1：成功；2：失败 |
...
| after\_sales\_id | LONG |  | after\_sales\_id |
| order\_sn | STRING |  | order\_sn |
...
| 50001 | 业务服务错误 | isv.\*\*\*-service-error:### | 服务异常，重试处理 | 重试 |
| isv.invalid-parameter:\*\*\* | 请求参数错误 | 根据错误提示处理 |
