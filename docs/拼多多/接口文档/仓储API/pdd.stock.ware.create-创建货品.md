---
title: "pdd.stock.ware.create - 创建货品"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.stock.ware.create"
menu_path:
  - "仓储API"
  - "pdd.stock.ware.create"
captured_at: "2026-04-09T15:22:09.115Z"
---
...
| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| open\_api\_response | INTEGER |  | 货品id |
...
import com.pdd.pop.sdk.http.api.pop.request.PddStockWareCreateRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddStockWareCreateResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddStockWareCreateRequest.WareInfosItem;
...
public class PopClientDemo {
 ...
        PddStockWareCreateRequest request = new PddStockWareCreateRequest();
 ...
        PddStockWareCreateResponse response = client.syncInvoke(request, accessToken);
