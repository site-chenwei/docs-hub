---
title: "pdd.stock.ware.delete - 删除货品"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.stock.ware.delete"
menu_path:
  - "仓储API"
  - "pdd.stock.ware.delete"
captured_at: "2026-04-09T15:22:12.438Z"
---
...
| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| open\_api\_response | BOOLEAN | true | 操作成功：true |
...
import com.pdd.pop.sdk.http.api.pop.request.PddStockWareDeleteRequest;
...
public class PopClientDemo {
 ...
        PddStockWareDeleteRequest request = new PddStockWareDeleteRequest();
        request.setWareId(100L);
        PddStockWareDeleteResponse response = client.syncInvoke(request, accessToken);
