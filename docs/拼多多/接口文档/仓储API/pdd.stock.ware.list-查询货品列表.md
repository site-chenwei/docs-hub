---
title: "pdd.stock.ware.list - 查询货品列表"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.stock.ware.list"
menu_path:
  - "仓储API"
  - "pdd.stock.ware.list"
captured_at: "2026-04-09T15:22:21.826Z"
---
...
| --- | --- | --- | --- |
| id | LONG | 非必填 | 货品id |
| ware\_sn | STRING | 非必填 | 货品编码 |
| ware\_name | STRING | 非必填 | 货品名称 |
| ware\_type | INTEGER | 非必填 | 类型 0:单独货品。1:组合货品 |
| page | INTEGER | 必填 | 页数，从1开始 |
| size | INTEGER | 必填 | 每页记录数 |
...
| sku\_id | LONG |  | skuid |
| ware\_id | LONG |  | 货品id |
| exist\_ware | BOOLEAN |  | 是否已绑定货品true/false |
| is\_onsale | BOOLEAN |  | 上下架状态，true为上架 |
| specs | OBJECT\[\] |  | 规格信息 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddStockWareListRequest;
...
public class PopClientDemo {
 ...
        PddStockWareListRequest request = new PddStockWareListRequest();
        request.setId(0L);
 ...
        request.setPage(0);
        request.setSize(0);
        PddStockWareListResponse response = client.syncInvoke(request, accessToken);
