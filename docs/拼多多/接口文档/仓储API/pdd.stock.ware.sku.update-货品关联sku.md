---
title: "pdd.stock.ware.sku.update - 货品关联sku"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.stock.ware.sku.update"
menu_path:
  - "仓储API"
  - "pdd.stock.ware.sku.update"
captured_at: "2026-04-09T15:22:28.074Z"
---
...
| ware\_skus | OBJECT\[\] | 必填 | 组合货品中子货品的关联关系 |
| sku\_id | LONG | 必填 | sku id |
...
| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| open\_api\_response | BOOLEAN |  | 操作成功：true |
...
import com.pdd.pop.sdk.http.api.pop.request.PddStockWareSkuUpdateRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddStockWareSkuUpdateResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddStockWareSkuUpdateRequest.WareSkusItem;
...
public class PopClientDemo {
 ...
        PddStockWareSkuUpdateRequest request = new PddStockWareSkuUpdateRequest();
        request.setWareId(0L);
        List<WareSkusItem> wareSkus = new ArrayList<WareSkusItem>();

        WareSkusItem item = new WareSkusItem();
        item.setSkuId(0L);
        item.setGoodsId(0L);
        wareSkus.add(item);
        request.setWareSkus(wareSkus);
        PddStockWareSkuUpdateResponse response = client.syncInvoke(request, accessToken);
