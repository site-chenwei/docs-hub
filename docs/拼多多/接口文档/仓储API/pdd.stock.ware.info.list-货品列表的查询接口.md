---
title: "pdd.stock.ware.info.list - 货品列表的查询接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.stock.ware.info.list"
menu_path:
  - "仓储API"
  - "pdd.stock.ware.info.list"
captured_at: "2026-04-09T15:22:18.672Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| ware\_sn\_list | STRING\[\] | 必填 | 货品编码集合 |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| stock\_ware\_info\_list\_response | OBJECT |  | response |
| ware\_list | OBJECT\[\] |  | 货品信息列表 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddStockWareInfoListRequest;
...
public class PopClientDemo {
 ...
        PddStockWareInfoListRequest request = new PddStockWareInfoListRequest();
        List<String> wareSnList = new ArrayList<String>();
        wareSnList.add("str");
        request.setWareSnList(wareSnList);
        PddStockWareInfoListResponse response = client.syncInvoke(request, accessToken);
...
| 50001 | 业务服务错误 | isv.invalid-paramete | 参数不合法 | 调试解决 |
