---
title: "pdd.express.change.depot.info - 修改仓库信息"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.express.change.depot.info"
menu_path:
  - "仓储API"
  - "pdd.express.change.depot.info"
captured_at: "2026-04-09T15:21:53.427Z"
---
...
| depot\_code | STRING | 非必填 | 仓库编码 |
| depot\_name | STRING | 非必填 | 仓库名称 |
| depot\_alias | STRING | 非必填 | 别名 |
| depot\_province\_id | INTEGER | 非必填 | 所在省id |
| depot\_city\_id | INTEGER | 非必填 | 所在市id |
| depot\_district\_id | INTEGER | 非必填 | 所在区id |
| depot\_address | STRING | 非必填 | 仓库详细地址 5-20字 |
| contact\_name | STRING | 非必填 | 联系人姓名 |
| telephone | STRING | 非必填 | 联系人电话 |
| depot\_region | STRING | 非必填 | 仓库区域（ 省->市->区id列表）例如：{"34":{"396":\[3383\]}}Map<Integer, Map<Integer, List<Integer>>> |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| open\_api\_response | STRING |  | 响应结果 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddExpressChangeDepotInfoRequest;
...
public class PopClientDemo {
 ...
        PddExpressChangeDepotInfoRequest request = new PddExpressChangeDepotInfoRequest();
        request.setDepotId(0L);
        request.setDepotCode("str");
        request.setDepotName("str");
        request.setDepotAlias("str");
        request.setDepotProvinceId(0);
        request.setDepotCityId(0);
        request.setDepotDistrictId(0);
        request.setDepotAddress("str");
        request.setContactName("str");
        request.setTelephone("str");
        request.setDepotRegion("str");
        PddExpressChangeDepotInfoResponse response = client.syncInvoke(request, accessToken);
