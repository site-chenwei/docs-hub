---
title: "pdd.goods.opt.get - 查询商品标签列表"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.goods.opt.get"
menu_path:
  - "商品API"
  - "pdd.goods.opt.get"
captured_at: "2026-04-09T15:16:58.443Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| parent\_opt\_id | INTEGER | 必填 | 值=0时为顶点opt\_id,通过树顶级节点获取opt树 |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| goods\_opt\_get\_response | OBJECT |  | 返回response |
| goods\_opt\_list | OBJECT\[\] |  | opt列表 |
| level | INTEGER |  | 层级，1-一级，2-二级，3-三级，4-四级 |
| opt\_id | LONG |  | 商品标签ID |
| opt\_name | STRING |  | 商品标签名 |
| parent\_opt\_id | LONG |  | id所属父ID，其中，parent\_id=0时为顶级节点 |
