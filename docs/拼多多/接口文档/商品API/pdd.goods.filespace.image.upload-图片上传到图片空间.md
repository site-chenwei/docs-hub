---
title: "pdd.goods.filespace.image.upload - 图片上传到图片空间"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.goods.filespace.image.upload"
menu_path:
  - "商品API"
  - "pdd.goods.filespace.image.upload"
captured_at: "2026-04-09T15:16:11.256Z"
---
...
| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| goods\_filespace\_image\_upload\_response | OBJECT |  | response |
| file\_id | LONG |  | 文件id |
| url | STRING |  | url |
...
public class PopClientDemo {
 ...
        PddGoodsFilespaceImageUploadResponse response = client.syncInvoke(request, accessToken);
