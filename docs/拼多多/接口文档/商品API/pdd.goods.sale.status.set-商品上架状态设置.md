---
title: "pdd.goods.sale.status.set - 商品上架状态设置"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.goods.sale.status.set"
menu_path:
  - "商品API"
  - "pdd.goods.sale.status.set"
captured_at: "2026-04-09T15:17:10.877Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| goods\_id | LONG | 必填 | 拼多多商品id |
| is\_onsale | INTEGER | 必填 | 上下架状态：1:上架 0:下架 |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| goods\_sale\_status\_set\_response | OBJECT |  | 返回response |
...
| --- | --- |
| 商品上下架权限包 | 进销存、商品优化分析、虚拟商家后台系统、企业ERP、商家后台系统、电子凭证商家后台系统、跨境企业ERP报关版 |
