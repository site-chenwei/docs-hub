---
title: "pdd.goods.video.upload - 商品视频上传接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.goods.video.upload"
menu_path:
  - "商品API"
  - "pdd.goods.video.upload"
captured_at: "2026-04-09T15:17:48.577Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| file | FILE | 必填 | 视频文件,为文件流 |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| goods\_video\_upload\_response | OBJECT |  | 1 |
| id | LONG |  | 文件id |
| url | STRING |  | 文件url |
| status | INTEGER |  | 审核状态 |
...
import com.pdd.pop.sdk.http.api.file.request.PddGoodsVideoUploadRequest;
...
public class PopClientDemo {
 ...
        PddGoodsVideoUploadRequest request = new PddGoodsVideoUploadRequest();
        request.setFile("/tmp/image.jpg");
        PddGoodsVideoUploadResponse response = client.syncInvoke(request, accessToken);
