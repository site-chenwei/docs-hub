---
title: "pdd.goods.get.relation - 商品映射查询接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.goods.get.relation"
menu_path:
  - "商品API"
  - "pdd.goods.get.relation"
captured_at: "2026-04-09T15:16:14.443Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| pdd\_goods\_id | LONG\[\] | 必填 | 拼多多商品id |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| query\_goods\_relation\_response | OBJECT\[\] |  | 映射关系查询返回对象列表 |
| out\_goods\_id | STRING |  | 外部平台商品id |
| pdd\_goods\_id | LONG |  | 拼多多商品id |
...
import com.pdd.pop.sdk.http.api.pop.request.PddGoodsGetRelationRequest;
...
public class PopClientDemo {
 ...
        PddGoodsGetRelationRequest request = new PddGoodsGetRelationRequest();
        List<Long> pddGoodsId = new ArrayList<Long>();
        pddGoodsId.add(0L);
        request.setPddGoodsId(pddGoodsId);
        PddGoodsGetRelationResponse response = client.syncInvoke(request, accessToken);
