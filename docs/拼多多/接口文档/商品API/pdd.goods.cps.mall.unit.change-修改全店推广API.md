---
title: "pdd.goods.cps.mall.unit.change - 修改全店推广API"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.goods.cps.mall.unit.change"
menu_path:
  - "商品API"
  - "pdd.goods.cps.mall.unit.change"
captured_at: "2026-04-09T15:15:43.059Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| rate | INTEGER | 必填 | 全店推广计划佣金比（千分比） |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| goods\_cps\_mall\_unit\_change\_response | OBJECT |  | response |
...
import com.pdd.pop.sdk.http.api.pop.request.PddGoodsCpsMallUnitChangeRequest;
...
public class PopClientDemo {
 ...
        PddGoodsCpsMallUnitChangeRequest request = new PddGoodsCpsMallUnitChangeRequest();
        request.setRate(1);
        PddGoodsCpsMallUnitChangeResponse response = client.syncInvoke(request, accessToken);
...
```
{
  "goods_cps_mall_unit_change_response": {
    "result": true
  }
}
```
