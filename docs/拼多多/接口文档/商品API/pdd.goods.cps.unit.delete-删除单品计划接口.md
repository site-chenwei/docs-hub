---
title: "pdd.goods.cps.unit.delete - 删除单品计划接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.goods.cps.unit.delete"
menu_path:
  - "商品API"
  - "pdd.goods.cps.unit.delete"
captured_at: "2026-04-09T15:15:55.518Z"
---
...
| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| goods\_cps\_unit\_delete\_response | OBJECT |  | response |
...
import com.pdd.pop.sdk.http.api.pop.request.PddGoodsCpsUnitDeleteRequest;
...
public class PopClientDemo {
 ...
        PddGoodsCpsUnitDeleteResponse response = client.syncInvoke(request, accessToken);
...
```
{
  "goods_cps_unit_delete_response": {
    "success": false
  }
}
```
