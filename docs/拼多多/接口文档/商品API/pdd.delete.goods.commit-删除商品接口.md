---
title: "pdd.delete.goods.commit - 删除商品接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.delete.goods.commit"
menu_path:
  - "商品API"
  - "pdd.delete.goods.commit"
captured_at: "2026-04-09T15:15:08.707Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| goods\_ids | LONG\[\] | 必填 | 商品id 列表(List<Long>) json string，例：\[1,2\]，一次操作数量请小于50 |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| open\_api\_response | BOOLEAN |  | 操作结果 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddDeleteGoodsCommitRequest;
...
public class PopClientDemo {
 ...
        PddDeleteGoodsCommitResponse response = client.syncInvoke(request, accessToken);
