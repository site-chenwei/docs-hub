---
title: "pdd.goods.cats.get - 商品标准类目接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.goods.cats.get"
menu_path:
  - "商品API"
  - "pdd.goods.cats.get"
captured_at: "2026-04-09T15:15:24.293Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| parent\_cat\_id | LONG | 必填 | 值=0时为顶点cat\_id,通过树顶级节点获取cat树 |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| goods\_cats\_get\_response | OBJECT |  | response |
| goods\_cats\_list | OBJECT\[\] |  | 类目树对象 |
| cat\_id | LONG |  | 商品类目ID |
| cat\_name | STRING |  | 商品类目名称 |
| level | INTEGER |  | 类目层级，1-一级类目，2-二级类目，3-三级类目，4-四级类目 |
| parent\_cat\_id | LONG |  | id所属父类目ID，其中，parent\_id=0时为顶级节点 |
