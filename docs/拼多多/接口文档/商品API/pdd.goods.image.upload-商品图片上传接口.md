---
title: "pdd.goods.image.upload - 商品图片上传接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.goods.image.upload"
menu_path:
  - "商品API"
  - "pdd.goods.image.upload"
captured_at: "2026-04-09T15:16:17.566Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| image | STRING | 必填 | 支持格式有：jpg/jpeg、png等图片格式，注意入参图片必须转码为base64编码 |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| goods\_image\_upload\_response | OBJECT |  | 商品图片上传响应对象 |
| image\_url | STRING |  | 返回图片url |
...
public class PopClientDemo {
 ...
        PddGoodsImageUploadResponse response = client.syncInvoke(request, accessToken);
