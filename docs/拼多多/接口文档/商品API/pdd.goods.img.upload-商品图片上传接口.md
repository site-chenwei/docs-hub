---
title: "pdd.goods.img.upload - 商品图片上传接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.goods.img.upload"
menu_path:
  - "商品API"
  - "pdd.goods.img.upload"
captured_at: "2026-04-09T15:16:20.687Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| file | FILE | 必填 | 商品图片文件流 |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| goods\_img\_upload\_response | OBJECT |  |  |
| url | STRING |  |  |
...
public class PopClientDemo {
 ...
        PddGoodsImgUploadResponse response = client.syncInvoke(request, accessToken);
