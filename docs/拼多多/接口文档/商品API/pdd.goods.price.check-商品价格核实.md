---
title: "pdd.goods.price.check - 商品价格核实"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.goods.price.check"
menu_path:
  - "商品API"
  - "pdd.goods.price.check"
captured_at: "2026-04-09T15:17:04.678Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| goodsId | LONG | 必填 | 商品id，long值，大于0 |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| goodsid\_price\_check\_response | OBJECT |  |  |
| result | LONG |  |  |
...
import com.pdd.pop.sdk.http.api.pop.request.PddGoodsPriceCheckRequest;
...
public class PopClientDemo {
 ...
        PddGoodsPriceCheckRequest request = new PddGoodsPriceCheckRequest();
        request.setGoodsId(1L);
        PddGoodsPriceCheckResponse response = client.syncInvoke(request, accessToken);
...
| --- | --- |
| 商品价格更新权限包 | 进销存、商品优化分析、虚拟商家后台系统、企业ERP、商家后台系统、电子凭证商家后台系统、跨境企业ERP报关版 |
...
| 50001 | 业务服务错误 | 3000000 | 参数错误 | 请按要求输入请求参数 |
| 4000000 | 服务错误 | 稍后重试 |
