---
title: "pdd.goods.template.property.value.search - 模板属性值搜索接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.goods.template.property.value.search"
menu_path:
  - "商品API"
  - "pdd.goods.template.property.value.search"
captured_at: "2026-04-09T15:17:45.422Z"
---
...
| page\_num | INTEGER | 非必填 | 页码 从1开始 |
| page\_size | INTEGER | 非必填 | 1页查询的最大数据 \[1，500\], 默认100 |
| parent\_vid | LONG | 非必填 | 父属性值id |
| template\_pid | LONG | 非必填 | 模板属性id，废弃中，请入参属性id |
| value | STRING | 必填 | 需要模糊搜索的属性值 |
...
| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| goods\_template\_prop\_val\_search\_response | OBJECT |  | resposne |
| list | OBJECT\[\] |  | list |
| value | STRING |  | 属性值 |
| vid | LONG |  | 属性值id |
...
import com.pdd.pop.sdk.http.api.pop.request.PddGoodsTemplatePropertyValueSearchRequest;
...
public class PopClientDemo {
 ...
        request.setParentVid(0L);
        request.setTemplatePid(0L);
        request.setValue("str");
        request.setRefPid(0L);
        PddGoodsTemplatePropertyValueSearchResponse response = client.syncInvoke(request, accessToken);
...
```
{
  "goods_template_prop_val_search_response": {
    "list": [
      {
        "value": "str",
        "vid": 0
