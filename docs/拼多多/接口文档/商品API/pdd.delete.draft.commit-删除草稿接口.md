---
title: "pdd.delete.draft.commit - 删除草稿接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.delete.draft.commit"
menu_path:
  - "商品API"
  - "pdd.delete.draft.commit"
captured_at: "2026-04-09T15:15:05.524Z"
---
...
| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| open\_api\_response | BOOLEAN | true | 操作状态，true |
...
import com.pdd.pop.sdk.http.api.pop.request.PddDeleteDraftCommitRequest;
...
public class PopClientDemo {
 ...
        PddDeleteDraftCommitResponse response = client.syncInvoke(request, accessToken);
