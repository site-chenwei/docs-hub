---
title: "pdd.goods.material.delete - 商品素材删除接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.goods.material.delete"
menu_path:
  - "商品API"
  - "pdd.goods.material.delete"
captured_at: "2026-04-09T15:16:52.193Z"
---
...
import com.pdd.pop.sdk.http.api.pop.request.PddGoodsMaterialDeleteRequest;
...
public class PopClientDemo {
 ...
        PddGoodsMaterialDeleteRequest request = new PddGoodsMaterialDeleteRequest();
        request.setMaterialId(0L);
        PddGoodsMaterialDeleteResponse response = client.syncInvoke(request, accessToken);
