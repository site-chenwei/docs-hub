---
title: "pdd.goods.authorization.cats - 获取当前授权商家可发布的商品类目信息"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.goods.authorization.cats"
menu_path:
  - "商品API"
  - "pdd.goods.authorization.cats"
captured_at: "2026-04-09T15:15:14.935Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| parent\_cat\_id | LONG | 非必填 | 默认值=0，值=0时为顶点cat\_id,通过树顶级节点获取一级类目 |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| goods\_auth\_cats\_get\_response | OBJECT |  | response |
| goods\_cats\_list | OBJECT\[\] |  | 类目对象列表 |
| cat\_id | LONG |  | 类目ID，一级类目ID |
| cat\_name | STRING |  | 对应ID下的类目名称 |
| leaf | BOOLEAN |  | 是否为叶子类目 |
...
public class PopClientDemo {
 ...
        PddGoodsAuthorizationCatsResponse response = client.syncInvoke(request, accessToken);
