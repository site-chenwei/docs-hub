---
title: "pdd.goods.information.update - 商品编辑"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.goods.information.update"
menu_path:
  - "商品API"
  - "pdd.goods.information.update"
captured_at: "2026-04-09T15:16:26.937Z"
---
...
| cost\_template\_id | LONG | 必填 | 物流运费模板ID，可使用pdd.logistics.template.get获取 |
| country\_id | INTEGER | 必填 | 地区/国家ID，0-中国，暂时只传0（普通商品） |
| customer\_num | INTEGER | 非必填 | 团购人数 |
| customs | STRING | 非必填 | 海关名称，只在goods\_type为直供商品时有效（现阶段暂不支持） |
| delivery\_one\_day | INTEGER | 非必填 | 是否当日发货 |
...
| table\_info | OBJECT | 非必填 | 成分表表单内容 |
| table\_value\_list | OBJECT\[\] | 非必填 | 表单信息列表 |
| column\_type | INTEGER | 非必填 | 表单列类型：1-材质成分占比 |
| unit | STRING | 非必填 | 成分表单位，材质成分表时为‘%’ |
| value | STRING | 非必填 | 成分表值，材质成分表时为成分占比百分值 |
...
| invoice\_status | INTEGER | 非必填 | 是否支持开票（测试中） |
...
| operate\_type | INTEGER | 非必填 | 是否提交草稿，默认提交 0:提交，1：保存 |
...
| oversea\_goods | OBJECT | 非必填 | 实例：{ "consumption\_tax\_rate": 1, "value\_added\_tax\_rate": 9, "hs\_code": "2200", "customs\_broker": "sss", "customs\_declaration\_method": 1, "bonded\_warehouse": "sss", "bonded\_warehouse\_key": "pp" } |
...
| shipment\_limit\_second | LONG | 必填 | 承诺发货时间（ 秒），48小时或24小时，is\_pre\_sale为true时不必传 |
...
| quantity | LONG | 必填 | 商品sku库存增减数量，可入参值为正负0整数。后续库存update建议只使用stocks.update接口进行调用 |
| sku\_id | LONG | 必填 | sku编码，如果传值，则在原sku基础上进行编辑，如果传空，则新增sku。 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddGoodsInformationUpdateRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddGoodsInformationUpdateResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddGoodsInformationUpdateRequest.CarouselVideoItem;
import com.pdd.pop.sdk.http.api.pop.request.PddGoodsInformationUpdateRequest.ElecGoodsAttributes;
import com.pdd.pop.sdk.http.api.pop.request.PddGoodsInformationUpdateRequest.GoodsPropertiesItem;
import com.pdd.pop.sdk.http.api.pop.request.PddGoodsInformationUpdateRequest.GoodsPropertiesItemTableInfo;
import com.pdd.pop.sdk.http.api.pop.request.PddGoodsInformationUpdateRequest.GoodsPropertiesItemTableInfoTableValueListItem;
import com.pdd.pop.sdk.http.api.pop.request.PddGoodsInformationUpdateRequest.GoodsTradeAttr;
import com.pdd.pop.sdk.http.api.pop.request.PddGoodsInformationUpdateRequest.GoodsTradeAttrBookingNotes;
import com.pdd.pop.sdk.http.api.pop.request.PddGoodsInformationUpdateRequest.GoodsTravelAttr;
import com.pdd.pop.sdk.http.api.pop.request.PddGoodsInformationUpdateRequest.OverseaGoods;
import com.pdd.pop.sdk.http.api.pop.request.PddGoodsInformationUpdateRequest.SkuListItem;
import com.pdd.pop.sdk.http.api.pop.request.PddGoodsInformationUpdateRequest.SkuListItemOverseaSku;
import com.pdd.pop.sdk.http.api.pop.request.PddGoodsInformationUpdateRequest.SkuListItemSkuPropertiesItem;
...
public class PopClientDemo {
 ...
        PddGoodsInformationUpdateResponse response = client.syncInvoke(request, accessToken);
