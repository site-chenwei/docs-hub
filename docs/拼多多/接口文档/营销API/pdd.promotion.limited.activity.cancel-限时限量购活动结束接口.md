---
title: "pdd.promotion.limited.activity.cancel - 限时限量购活动结束接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.promotion.limited.activity.cancel"
menu_path:
  - "营销API"
  - "pdd.promotion.limited.activity.cancel"
captured_at: "2026-04-09T15:20:28.797Z"
---
...
import com.pdd.pop.sdk.http.api.pop.request.PddPromotionLimitedActivityCancelRequest;
...
public class PopClientDemo {
 ...
        PddPromotionLimitedActivityCancelRequest request = new PddPromotionLimitedActivityCancelRequest();
        request.setDetailId(0L);
        request.setGoodsId(0L);
        PddPromotionLimitedActivityCancelResponse response = client.syncInvoke(request, accessToken);
