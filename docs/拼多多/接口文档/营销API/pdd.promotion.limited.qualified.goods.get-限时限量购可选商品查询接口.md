---
title: "pdd.promotion.limited.qualified.goods.get - 限时限量购可选商品查询接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.promotion.limited.qualified.goods.get"
menu_path:
  - "营销API"
  - "pdd.promotion.limited.qualified.goods.get"
captured_at: "2026-04-09T15:20:38.396Z"
---
...
| is\_valid | BOOLEAN | 必填 | TRUE-仅查询可选商品（满足活动资格商品）数据；FALSE-查询不可选商品数据 |
| page\_no | INTEGER | 非必填 | 页码 |
| page\_size | INTEGER | 非必填 | 每页查询数 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddPromotionLimitedQualifiedGoodsGetRequest;
...
public class PopClientDemo {
 ...
        PddPromotionLimitedQualifiedGoodsGetRequest request = new PddPromotionLimitedQualifiedGoodsGetRequest();
 ...
        PddPromotionLimitedQualifiedGoodsGetResponse response = client.syncInvoke(request, accessToken);
