---
title: "pdd.ddk.oauth.member.authority.query - 查询是否绑定备案"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.ddk.oauth.member.authority.query"
menu_path:
  - "多多客工具API"
  - "pdd.ddk.oauth.member.authority.query"
captured_at: "2026-04-09T15:20:03.850Z"
---
...
| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| authority\_query\_response | OBJECT |  | 查询结果 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddDdkOauthMemberAuthorityQueryRequest;
...
public class PopClientDemo {
 ...
        PddDdkOauthMemberAuthorityQueryRequest request = new PddDdkOauthMemberAuthorityQueryRequest();
        request.setPid("str");
        request.setCustomParameters("str");
        PddDdkOauthMemberAuthorityQueryResponse response = client.syncInvoke(request, accessToken);
