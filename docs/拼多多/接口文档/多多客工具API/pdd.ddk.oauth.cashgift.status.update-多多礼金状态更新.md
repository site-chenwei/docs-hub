---
title: "pdd.ddk.oauth.cashgift.status.update - 多多礼金状态更新"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.ddk.oauth.cashgift.status.update"
menu_path:
  - "多多客工具API"
  - "pdd.ddk.oauth.cashgift.status.update"
captured_at: "2026-04-09T15:19:35.372Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| cash\_gift\_id | LONG | 必填 | 多多礼金ID |
| update\_type | INTEGER | 必填 | 礼金更新类型：0-停止礼金推广，1-恢复礼金推广 |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| update\_cashgift\_response | OBJECT |  | response |
| cash\_gift\_id | LONG |  | 多多礼金ID |
...
import com.pdd.pop.sdk.http.api.pop.request.PddDdkOauthCashgiftStatusUpdateRequest;
...
public class PopClientDemo {
 ...
        PddDdkOauthCashgiftStatusUpdateRequest request = new PddDdkOauthCashgiftStatusUpdateRequest();
        request.setCashGiftId(0L);
        request.setUpdateType(0);
        PddDdkOauthCashgiftStatusUpdateResponse response = client.syncInvoke(request, accessToken);
