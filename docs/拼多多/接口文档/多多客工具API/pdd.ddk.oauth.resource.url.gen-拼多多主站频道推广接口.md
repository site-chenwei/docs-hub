---
title: "pdd.ddk.oauth.resource.url.gen - 拼多多主站频道推广接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.ddk.oauth.resource.url.gen"
menu_path:
  - "多多客工具API"
  - "pdd.ddk.oauth.resource.url.gen"
captured_at: "2026-04-09T15:20:16.248Z"
---
...
| pid | STRING | 必填 | 推广位 |
| resource\_type | INTEGER | 非必填 | 频道来源：4-限时秒杀,39997-充值中心, 39998-活动转链，39996-百亿补贴，39999-电器城，40000-领券中心，50005-火车票 |
| url | STRING | 非必填 | 原链接 |
...
| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| resource\_url\_response | OBJECT |  | resource\_url\_response |
| multi\_url\_list | OBJECT |  | 多人团链接 |
| short\_url | STRING |  | 频道推广短链接，对应出参url的短链接，与url功能一致。 |
| url | STRING |  | 频道推广长链接，唤起H5页面 |
| sign | STRING |  | sign |
| single\_url\_list | OBJECT |  | 单人团链接 |
| short\_url | STRING |  | 频道推广短链接，对应出参url的短链接，与url功能一致。 |
| url | STRING |  | 频道推广长链接，唤起H5页面 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddDdkOauthResourceUrlGenRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddDdkOauthResourceUrlGenResponse;
...
public class PopClientDemo {
 ...
        PddDdkOauthResourceUrlGenRequest request = new PddDdkOauthResourceUrlGenRequest();
 ...
        request.setUrl("str");
        PddDdkOauthResourceUrlGenResponse response = client.syncInvoke(request, accessToken);
