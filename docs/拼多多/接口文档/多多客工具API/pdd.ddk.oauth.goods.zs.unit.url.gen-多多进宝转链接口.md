---
title: "pdd.ddk.oauth.goods.zs.unit.url.gen - 多多进宝转链接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.ddk.oauth.goods.zs.unit.url.gen"
menu_path:
  - "多多客工具API"
  - "pdd.ddk.oauth.goods.zs.unit.url.gen"
captured_at: "2026-04-09T15:20:00.761Z"
---
...
| pid | STRING | 必填 | 渠道id |
| source\_url | STRING | 必填 | 需转链的链接，支持拼多多商品链接、进宝长链/短链（即为pdd.ddk.goods.promotion.url.generate接口生成的长短链） |
| generate\_we\_app\_long\_link | BOOLEAN | 非必填 | 是否生成微信LongLink |
| generate\_short\_link | BOOLEAN | 非必填 | 是否生成微信shortlink链接，仅支持单品，单个渠道每天生成的shortLink数量有限，请合理生成shortLink链接 |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| goods\_zs\_unit\_generate\_response | OBJECT |  | goods\_zs\_unit\_generate\_response |
| mobile\_short\_url | STRING |  | 推广短链接（可唤起拼多多app） |
| mobile\_url | STRING |  | 推广长链接（唤起拼多多app） |
| multi\_group\_mobile\_short\_url | STRING |  | 推广短链接（唤起拼多多app） |
| multi\_group\_mobile\_url | STRING |  | 推广长链接（可唤起拼多多app） |
| multi\_group\_short\_url | STRING |  | 双人团推广短链接 |
| multi\_group\_url | STRING |  | 双人团推广长链接 |
| schema\_url | STRING |  | schema的链接 |
| short\_url | STRING |  | 单人团推广短链接 |
| url | STRING |  | 单人团推广长链接 |
| weixin\_long\_link | STRING |  | 微信小程序longLink |
| weixin\_short\_link | STRING |  | 微信小程序shortLink |
...
import com.pdd.pop.sdk.http.api.pop.request.PddDdkOauthGoodsZsUnitUrlGenRequest;
...
public class PopClientDemo {
 ...
        PddDdkOauthGoodsZsUnitUrlGenRequest request = new PddDdkOauthGoodsZsUnitUrlGenRequest();
 ...
        PddDdkOauthGoodsZsUnitUrlGenResponse response = client.syncInvoke(request, accessToken);
