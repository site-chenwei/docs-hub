---
title: "pdd.pmc.user.cancel - 取消用户的消息服务"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.pmc.user.cancel"
menu_path:
  - "消息服务API"
  - "pdd.pmc.user.cancel"
captured_at: "2026-04-09T15:22:40.726Z"
---
...
| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| tmc\_user\_cancel\_response | OBJECT |  | response |
...
import com.pdd.pop.sdk.http.api.pop.request.PddPmcUserCancelRequest;
...
public class PopClientDemo {
 ...
        PddPmcUserCancelResponse response = client.syncInvoke(request);
