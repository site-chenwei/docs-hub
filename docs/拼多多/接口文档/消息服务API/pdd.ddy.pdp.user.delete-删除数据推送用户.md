---
title: "pdd.ddy.pdp.user.delete - 删除数据推送用户"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.ddy.pdp.user.delete"
menu_path:
  - "pdd.ddy.pdp.user.delete"
captured_at: "2026-04-15T03:32:33.125Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| owner\_id | LONG | 必填 | 需要删除的用户编号 |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| ddy\_pdp\_users\_delete\_response | OBJECT |  | 返回结果 |
| is\_success | BOOLEAN | true | 是否删除成功 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddDdyPdpUserDeleteRequest;
...
public class PopClientDemo {
 ...
        PddDdyPdpUserDeleteRequest request = new PddDdyPdpUserDeleteRequest();
        request.setOwnerId(6041278L);
        PddDdyPdpUserDeleteResponse response = client.syncInvoke(request);
...
| 50001 | 业务服务错误 | isv.invalid-parameter:owner\_id | 商家尚未添加 | 请检查owner\_id |
