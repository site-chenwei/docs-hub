---
title: "pdd.live.video.mall.upload.part - 多多视频商家上传视频分片上传接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.live.video.mall.upload.part"
menu_path:
  - "自媒体API"
  - "pdd.live.video.mall.upload.part"
captured_at: "2026-04-09T15:25:39.228Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| part\_file | FILE | 必填 | 当前分片的文件流，不能大于20M |
| part\_num | STRING | 必填 | 当前分片编号名，从1开始 |
...
| --- | --- | --- | --- |
| response | OBJECT |  |  |
| uploaded\_part\_num | INTEGER |  | 表示本次成功上传的part number |
...
import com.pdd.pop.sdk.http.api.file.request.PddLiveVideoMallUploadPartRequest;
...
public class PopClientDemo {
 ...
        PddLiveVideoMallUploadPartRequest request = new PddLiveVideoMallUploadPartRequest();
        request.setPartFile("/tmp/image.jpg");
        request.setPartNum("str");
        request.setUploadSign("str");
        PddLiveVideoMallUploadPartResponse response = client.syncInvoke(request, accessToken);
