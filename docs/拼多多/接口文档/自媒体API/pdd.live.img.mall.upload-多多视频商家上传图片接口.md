---
title: "pdd.live.img.mall.upload - 多多视频商家上传图片接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.live.img.mall.upload"
menu_path:
  - "自媒体API"
  - "pdd.live.img.mall.upload"
captured_at: "2026-04-09T15:25:49.954Z"
---
...
import com.pdd.pop.sdk.http.api.file.request.PddLiveImgMallUploadRequest;
...
public class PopClientDemo {
 ...
        PddLiveImgMallUploadRequest request = new PddLiveImgMallUploadRequest();
        request.setFile("/tmp/image.jpg");
        PddLiveImgMallUploadResponse response = client.syncInvoke(request, accessToken);
