---
title: "pdd.live.video.mall.upload.part.init - 多多视频商家上传视频分片初始化接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.live.video.mall.upload.part.init"
menu_path:
  - "自媒体API"
  - "pdd.live.video.mall.upload.part.init"
captured_at: "2026-04-09T15:25:45.424Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| content\_type | STRING | 必填 | 文件对应的contentType，且必须为视频类型 |
...
import com.pdd.pop.sdk.http.api.file.request.PddLiveVideoMallUploadPartInitRequest;
...
public class PopClientDemo {
 ...
        PddLiveVideoMallUploadPartInitRequest request = new PddLiveVideoMallUploadPartInitRequest();
        request.setContentType("video/mp4");
        PddLiveVideoMallUploadPartInitResponse response = client.syncInvoke(request, accessToken);
