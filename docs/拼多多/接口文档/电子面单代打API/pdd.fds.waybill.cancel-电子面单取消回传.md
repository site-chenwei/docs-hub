---
title: "pdd.fds.waybill.cancel - 电子面单取消回传"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.fds.waybill.cancel"
menu_path:
  - "电子面单代打API"
  - "pdd.fds.waybill.cancel"
captured_at: "2026-04-09T15:24:05.292Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| pdd\_fds\_waybill\_cancel\_request | OBJECT | 必填 | 入参信息 |
...
| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| pdd\_fds\_waybill\_cancel\_response | OBJECT |  | response |
| return\_result | BOOLEAN | true | 取消回传结果true:成功false：失败 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddFdsWaybillCancelRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddFdsWaybillCancelResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddFdsWaybillCancelRequest.InnerPddFdsWaybillCancelRequest;
...
public class PopClientDemo {
 ...
        PddFdsWaybillCancelRequest request = new PddFdsWaybillCancelRequest();

        InnerPddFdsWaybillCancelRequest pddFdsWaybillCancelRequest = new InnerPddFdsWaybillCancelRequest();
        pddFdsWaybillCancelRequest.setMallMaskId("978623a8d9d7425f8c7ff08d2af2875e");
        pddFdsWaybillCancelRequest.setOrderMaskSn("4956c0af9ce548ccb7d9c8c3d2c7cce2");
        pddFdsWaybillCancelRequest.setWaybillCode("6610442027204");
        pddFdsWaybillCancelRequest.setWpCode("ZTO");
        request.setPddFdsWaybillCancelRequest(pddFdsWaybillCancelRequest);
        PddFdsWaybillCancelResponse response = client.syncInvoke(request, accessToken);
...
```
{
  "pdd_fds_waybill_cancel_response": {
    "return_result": true
  }
}
```
