---
title: "pdd.fds.waybill.return - 电子面单回传"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.fds.waybill.return"
menu_path:
  - "电子面单代打API"
  - "pdd.fds.waybill.return"
captured_at: "2026-04-09T15:24:11.540Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| param\_fds\_waybill\_return\_request | OBJECT | 必填 | 入参信息 |
...
| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| pdd\_fds\_waybill\_return\_response | OBJECT |  | response |
| return\_result | BOOLEAN | true | 回传结果true:成功false：失败 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddFdsWaybillReturnRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddFdsWaybillReturnResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddFdsWaybillReturnRequest.ParamFdsWaybillReturnRequest;
...
public class PopClientDemo {
 ...
        PddFdsWaybillReturnRequest request = new PddFdsWaybillReturnRequest();

        ParamFdsWaybillReturnRequest paramFdsWaybillReturnRequest = new ParamFdsWaybillReturnRequest();
        paramFdsWaybillReturnRequest.setMallMaskId("978623a8d9d7425f8c7ff08d2af2875e");
        paramFdsWaybillReturnRequest.setOrderMaskSn("4956c0af9ce548ccb7d9c8c3d2c7cce2");
        paramFdsWaybillReturnRequest.setWaybillCode("6610442027204");
        paramFdsWaybillReturnRequest.setWpCode("ZTO");
        request.setParamFdsWaybillReturnRequest(paramFdsWaybillReturnRequest);
        PddFdsWaybillReturnResponse response = client.syncInvoke(request, accessToken);
...
```
{
  "pdd_fds_waybill_return_response": {
    "return_result": true
  }
}
```
