---
title: "pdd.mall.notification.type.show.check - 判断是否对商家展示某个通知"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.mall.notification.type.show.check"
menu_path:
  - "店铺API"
  - "pdd.mall.notification.type.show.check"
captured_at: "2026-04-09T15:21:37.857Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| notification\_type | STRING | 必填 | 通知类型 |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| result | BOOLEAN | true | 是否展示通知：true-展示,false-不展示 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddMallNotificationTypeShowCheckRequest;
...
public class PopClientDemo {
 ...
        PddMallNotificationTypeShowCheckRequest request = new PddMallNotificationTypeShowCheckRequest();
        request.setNotificationType("str");
        PddMallNotificationTypeShowCheckResponse response = client.syncInvoke(request, accessToken);
