---
title: "pdd.delivery.receipt.image.upload - 发货底单图片上传"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.delivery.receipt.image.upload"
menu_path:
  - "物流API"
  - "pdd.delivery.receipt.image.upload"
captured_at: "2026-04-09T15:14:31.305Z"
---
...
| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| delivery\_receipt\_img\_upload\_response | OBJECT |  |  |
| url | STRING |  |  |
...
import com.pdd.pop.sdk.http.api.file.request.PddDeliveryReceiptImageUploadRequest;
import com.pdd.pop.sdk.http.api.file.response.PddDeliveryReceiptImageUploadResponse;
...
public class PopClientDemo {
 ...
        PddDeliveryReceiptImageUploadRequest request = new PddDeliveryReceiptImageUploadRequest();
        request.setFile("/tmp/image.jpg");
        PddDeliveryReceiptImageUploadResponse response = client.syncInvoke(request, accessToken);
...
```
{
  "delivery_receipt_img_upload_response": {
    "url": "str"
  }
}
```
