---
title: "pdd.logistics.available.company.recommend - 获取可发货快递接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.logistics.available.company.recommend"
menu_path:
  - "物流API"
  - "pdd.logistics.available.company.recommend"
captured_at: "2026-04-09T15:14:37.491Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| city\_id | LONG\[\] | 必填 | 收件人市id（最多支持50个） |
...
| response | OBJECT |  |  |
| result | OBJECT\[\] |  |  |
| city\_id | LONG | 1 | 收件人市id |
| company\_id | LONG\[\] |  | 快递公司id |
...
import com.pdd.pop.sdk.http.api.pop.request.PddLogisticsAvailableCompanyRecommendRequest;
...
public class PopClientDemo {
 ...
        PddLogisticsAvailableCompanyRecommendRequest request = new PddLogisticsAvailableCompanyRecommendRequest();
        List<Long> cityId = new ArrayList<Long>();
        cityId.add(0L);
        request.setCityId(cityId);
        PddLogisticsAvailableCompanyRecommendResponse response = client.syncInvoke(request, accessToken);
