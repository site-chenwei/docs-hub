---
title: "pdd.voucher.appointment.info.send - 卡券预约提货接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.voucher.appointment.info.send"
menu_path:
  - "卡券API"
  - "pdd.voucher.appointment.info.send"
captured_at: "2026-04-09T15:20:50.991Z"
---
...
| appointment\_time | LONG | 必填 | 预约时间, 距离格林威治时间 1970 年 01 月 01 日 00 时 00 分 00 秒(北京时间 1970 年 01 月 01 日 08 时 00 分 00 秒)起至现在的总毫秒数 |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| voucher\_appointment\_info\_send\_response | OBJECT |  | voucher\_appointment\_info\_send\_response |
| is\_success | BOOLEAN |  | is\_success |
...
import com.pdd.pop.sdk.http.api.pop.request.PddVoucherAppointmentInfoSendRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddVoucherAppointmentInfoSendResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddVoucherAppointmentInfoSendRequest.VoucherListItem;
...
public class PopClientDemo {
 ...
        PddVoucherAppointmentInfoSendRequest request = new PddVoucherAppointmentInfoSendRequest();
 ...
        request.setAppointmentTime(0L);
        PddVoucherAppointmentInfoSendResponse response = client.syncInvoke(request, accessToken);
