---
title: "pdd.voucher.physical.goods.send - 卡券发货（实物）接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.voucher.physical.goods.send"
menu_path:
  - "卡券API"
  - "pdd.voucher.physical.goods.send"
captured_at: "2026-04-09T15:21:00.466Z"
---
...
| voucher\_list | OBJECT\[\] | 必填 | 优惠券信息列表,例子\[{"voucher\_id":"test voucher\_id","voucher\_no":"test voucher\_no"}\] |
| voucher\_id | STRING | 必填 | 卡券ID |
| voucher\_no | STRING | 必填 | 卡券号 |
| logistics\_type | INTEGER | 必填 | 物流方式 1 物流发货 2 自提 |
| recipient | STRING | 必填 | 收件人 |
| recipient\_mobile | STRING | 必填 | 收件人电话 |
| recipient\_address | STRING | 必填 | 收件人地址 |
| logistics\_no | STRING | 必填 | 物流单号 |
| logistics\_company\_id | STRING | 必填 | 物流公司编号 |
| logistics\_company | STRING | 必填 | 物流公司名称 |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| voucher\_physical\_voucher\_send\_response | OBJECT |  | response |
| is\_success | BOOLEAN |  | 请求成功 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddVoucherPhysicalGoodsSendRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddVoucherPhysicalGoodsSendResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddVoucherPhysicalGoodsSendRequest.VoucherListItem;
...
public class PopClientDemo {
 ...
        PddVoucherPhysicalGoodsSendRequest request = new PddVoucherPhysicalGoodsSendRequest();
 ...
        PddVoucherPhysicalGoodsSendResponse response = client.syncInvoke(request, accessToken);
...
```
{
  "voucher_physical_voucher_send_response": {
    "is_success": false
  }
}
```
