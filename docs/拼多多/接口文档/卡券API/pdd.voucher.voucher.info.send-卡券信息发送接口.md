---
title: "pdd.voucher.voucher.info.send - 卡券信息发送接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.voucher.voucher.info.send"
menu_path:
  - "卡券API"
  - "pdd.voucher.voucher.info.send"
captured_at: "2026-04-09T15:21:16.115Z"
---
...
| voucher\_list | OBJECT\[\] | 必填 | 卡券信息列表,例子\[{"voucher\_id":"test voucher\_id","voucher\_no":"test voucher\_no"}\] |
...
| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| voucher\_voucher\_info\_send\_response | OBJECT |  | response |
...
import com.pdd.pop.sdk.http.api.pop.request.PddVoucherVoucherInfoSendRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddVoucherVoucherInfoSendResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddVoucherVoucherInfoSendRequest.VoucherListItem;
...
public class PopClientDemo {
 ...
        PddVoucherVoucherInfoSendRequest request = new PddVoucherVoucherInfoSendRequest();
 ...
        PddVoucherVoucherInfoSendResponse response = client.syncInvoke(request, accessToken);
...
```
{
  "voucher_voucher_info_send_response": {
    "is_success": false
  }
}
```
