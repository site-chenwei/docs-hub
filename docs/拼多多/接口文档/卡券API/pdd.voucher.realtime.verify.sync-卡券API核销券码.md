---
title: "pdd.voucher.realtime.verify.sync - 卡券API核销券码"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.voucher.realtime.verify.sync"
menu_path:
  - "卡券API"
  - "pdd.voucher.realtime.verify.sync"
captured_at: "2026-04-09T15:21:03.640Z"
---
...
| serial\_no | STRING | 必填 | ISV核销流水号 |
| shop\_name | STRING | 非必填 | 门店名称 |
| shop\_no | STRING | 非必填 | 门店编号 |
| verify\_time | LONG | 必填 | 卡券核销时间（13 位毫秒） |
| out\_voucher\_id | STRING | 必填 | 卡券编号 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddVoucherRealtimeVerifySyncRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddVoucherRealtimeVerifySyncResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddVoucherRealtimeVerifySyncRequest.Request;
...
public class PopClientDemo {
 ...
        PddVoucherRealtimeVerifySyncRequest request = new PddVoucherRealtimeVerifySyncRequest();

        Request request1 = new Request();
        request1.setOrderSn("str");
        request1.setRemark("str");
        request1.setSerialNo("str");
        request1.setShopName("str");
        request1.setShopNo("str");
        request1.setVerifyTime(0L);
        request1.setOutVoucherId("str");
        request.setRequest(request1);
        PddVoucherRealtimeVerifySyncResponse response = client.syncInvoke(request, accessToken);
