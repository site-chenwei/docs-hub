---
title: "pdd.mall.info.group.query.post - 查询店铺下门店组列表"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.mall.info.group.query.post"
menu_path:
  - "门店API"
  - "pdd.mall.info.group.query.post"
captured_at: "2026-04-09T15:24:24.071Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| page\_number | INTEGER | 必填 | 第几页 |
| page\_size | INTEGER | 必填 | 每页多少个 |
...
| --- | --- | --- | --- |
| response | OBJECT |  |  |
| mall\_store\_group\_list | OBJECT\[\] |  |  |
| group\_id | INTEGER |  |  |
| group\_name | STRING |  |  |
| mall\_id | LONG |  |  |
| total | INTEGER |  | 总数 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddMallInfoGroupQueryPostRequest;
...
public class PopClientDemo {
 ...
        PddMallInfoGroupQueryPostRequest request = new PddMallInfoGroupQueryPostRequest();
        request.setPageNumber(1);
        request.setPageSize(100);
        PddMallInfoGroupQueryPostResponse response = client.syncInvoke(request, accessToken);
