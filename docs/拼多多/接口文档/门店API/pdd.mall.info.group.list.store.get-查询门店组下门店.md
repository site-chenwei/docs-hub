---
title: "pdd.mall.info.group.list.store.get - 查询门店组下门店"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.mall.info.group.list.store.get"
menu_path:
  - "门店API"
  - "pdd.mall.info.group.list.store.get"
captured_at: "2026-04-09T15:24:20.922Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| group\_id | LONG | 必填 | 门店组ID |
| page\_number | INTEGER | 必填 | 分页页码 |
| page\_size | INTEGER | 必填 | 分页大小 |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| mall\_info\_group\_list\_store\_get\_response | OBJECT |  |  |
| mall\_store\_final\_vo\_list | OBJECT\[\] |  | 门店列表 |
| businessStatus | INTEGER |  | 门店经营状态 |
| city | STRING |  | 省市区三级地址-市 |
| district | STRING |  | 省市区三级地址-区 |
| exists | BOOLEAN |  |  |
| province | STRING |  | 省市区三级地址-省 |
| storeAddress | STRING |  | 门店地址 |
| storeId | LONG |  | 门店ID |
| storeName | STRING |  | 店铺名称 |
| storeNumber | STRING |  | 门店自有编号 |
| total | INTEGER |  | 总数 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddMallInfoGroupListStoreGetRequest;
...
public class PopClientDemo {
 ...
        PddMallInfoGroupListStoreGetRequest request = new PddMallInfoGroupListStoreGetRequest();
        request.setGroupId(0L);
        request.setPageNumber(0);
        request.setPageSize(0);
        PddMallInfoGroupListStoreGetResponse response = client.syncInvoke(request, accessToken);
...
```
{
  "mall_info_group_list_store_get_response": {
    "mall_store_final_vo_list": [
      {
        "businessStatus": 0,
        "city": "str",
        "district": "str",
