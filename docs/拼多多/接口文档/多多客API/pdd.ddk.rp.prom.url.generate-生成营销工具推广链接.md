---
title: "pdd.ddk.rp.prom.url.generate - 生成营销工具推广链接"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.ddk.rp.prom.url.generate"
menu_path:
  - "多多客API"
  - "pdd.ddk.rp.prom.url.generate"
captured_at: "2026-04-09T15:19:06.808Z"
---
...
| diy\_promotion\_act\_collection\_param | OBJECT | 非必填 | 大促会场集合页参数 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddDdkRpPromUrlGenerateRequest.DiyCouponRebateParam;
import com.pdd.pop.sdk.http.api.pop.request.PddDdkRpPromUrlGenerateRequest.DiyOneYuanParam;
import com.pdd.pop.sdk.http.api.pop.request.PddDdkRpPromUrlGenerateRequest.DiyPromotionActCollectionParam;
...
import com.pdd.pop.sdk.http.api.pop.request.PddDdkRpPromUrlGenerateRequest.DiySpRedPacketParam;
import com.pdd.pop.sdk.http.api.pop.request.PddDdkRpPromUrlGenerateRequest.TmccParam;
...
public class PopClientDemo {
 ...
        DiyPromotionActCollectionParam diyPromotionActCollectionParam = new DiyPromotionActCollectionParam();
        diyPromotionActCollectionParam.setCollectionId(0L);
        request.setDiyPromotionActCollectionParam(diyPromotionActCollectionParam);
