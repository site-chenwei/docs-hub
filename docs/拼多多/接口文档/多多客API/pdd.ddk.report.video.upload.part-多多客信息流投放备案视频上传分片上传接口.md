---
title: "pdd.ddk.report.video.upload.part - 多多客信息流投放备案视频上传分片上传接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.ddk.report.video.upload.part"
menu_path:
  - "多多客API"
  - "pdd.ddk.report.video.upload.part"
captured_at: "2026-04-09T15:18:26.150Z"
---
...
import com.pdd.pop.sdk.http.api.file.request.PddDdkReportVideoUploadPartRequest;
...
public class PopClientDemo {
 ...
        PddDdkReportVideoUploadPartRequest request = new PddDdkReportVideoUploadPartRequest();
        request.setPartFile("/tmp/image.jpg");
        request.setPartNum("str");
        request.setUploadSign("str");
        PddDdkReportVideoUploadPartResponse response = client.syncInvoke(request);
