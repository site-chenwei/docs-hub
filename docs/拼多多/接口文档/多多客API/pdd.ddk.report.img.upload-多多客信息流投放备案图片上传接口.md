---
title: "pdd.ddk.report.img.upload - 多多客信息流投放备案图片上传接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.ddk.report.img.upload"
menu_path:
  - "多多客API"
  - "pdd.ddk.report.img.upload"
captured_at: "2026-04-09T15:18:35.511Z"
---
...
import com.pdd.pop.sdk.http.api.file.request.PddDdkReportImgUploadRequest;
...
public class PopClientDemo {
 ...
        PddDdkReportImgUploadRequest request = new PddDdkReportImgUploadRequest();
        request.setFile("/tmp/image.jpg");
        PddDdkReportImgUploadResponse response = client.syncInvoke(request);
