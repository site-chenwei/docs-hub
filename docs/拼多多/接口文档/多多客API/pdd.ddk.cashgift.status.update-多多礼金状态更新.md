---
title: "pdd.ddk.cashgift.status.update - 多多礼金状态更新"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.ddk.cashgift.status.update"
menu_path:
  - "多多客API"
  - "pdd.ddk.cashgift.status.update"
captured_at: "2026-04-09T15:18:24.363Z"
---
...
import com.pdd.pop.sdk.http.api.pop.request.PddDdkCashgiftStatusUpdateRequest;
...
public class PopClientDemo {
 ...
        PddDdkCashgiftStatusUpdateRequest request = new PddDdkCashgiftStatusUpdateRequest();
        request.setCashGiftId(0L);
        request.setUpdateType(0);
        PddDdkCashgiftStatusUpdateResponse response = client.syncInvoke(request);
