---
title: "pdd.ddk.order.list.range.get - 用时间段查询推广订单接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.ddk.order.list.range.get"
menu_path:
  - "多多客API"
  - "pdd.ddk.order.list.range.get"
captured_at: "2026-04-09T15:19:25.896Z"
---
...
| end\_time | STRING | 必填 | 支付结束时间，格式: "yyyy-MM-dd HH:mm:ss" ，比如 "2020-12-01 00:00:00" |
| last\_order\_id | STRING | 非必填 | 上一次的迭代器id(第一次不填) |
| page\_size | INTEGER | 非必填 | 每次请求多少条，建议300 |
| query\_order\_type | INTEGER | 非必填 | 订单类型：1-推广订单；2-直播间订单 |
| start\_time | STRING | 必填 | 支付起始时间，格式: "yyyy-MM-dd HH:mm:ss" ，比如 "2020-12-01 00:00:00" |
...
| last\_order\_id | STRING |  | last\_order\_id |
...
public class PopClientDemo {
 ...
        request.setEndTime("2019-05-07 00:00:00");
        request.setLastOrderId("1000");
