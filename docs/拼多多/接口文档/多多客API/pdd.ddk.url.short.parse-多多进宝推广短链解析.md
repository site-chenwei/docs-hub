---
title: "pdd.ddk.url.short.parse - 多多进宝推广短链解析"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.ddk.url.short.parse"
menu_path:
  - "多多客API"
  - "pdd.ddk.url.short.parse"
captured_at: "2026-04-09T15:18:41.779Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| original\_url | STRING | 必填 | 需要解析出长链的多多进宝短连接，仅支持短链接（即为pdd.ddk.goods.promotion.url.generate接口生成的短链） |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| url | STRING |  | 普通长链，与短链接功能一致 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddDdkUrlShortParseRequest;
...
public class PopClientDemo {
 ...
        PddDdkUrlShortParseRequest request = new PddDdkUrlShortParseRequest();
        request.setOriginalUrl("str");
        PddDdkUrlShortParseResponse response = client.syncInvoke(request);
