---
title: "pdd.ddk.cashgift.create - 创建多多礼金"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.ddk.cashgift.create"
menu_path:
  - "多多客API"
  - "pdd.ddk.cashgift.create"
captured_at: "2026-04-09T15:18:57.378Z"
---
...
| is\_open\_renew | BOOLEAN | 非必填 | 是否开启续费功能，默认不开启 |
| link\_acquire\_limit | LONG | 非必填 | 活动单链接可领券数量，默认无限制，最小值为1。 |
| name | STRING | 非必填 | 礼金名称 |
| p\_id\_list | STRING\[\] | 非必填 | 可使用推广位列表，例如：\["60005\_612"\]。(列表中的PID方可推广该礼金) |
...
import com.pdd.pop.sdk.http.api.pop.request.PddDdkCashgiftCreateRequest;
...
public class PopClientDemo {
 ...
        PddDdkCashgiftCreateRequest request = new PddDdkCashgiftCreateRequest();
 ...
        PddDdkCashgiftCreateResponse response = client.syncInvoke(request);
