---
title: "pdd.ddk.report.video.upload - 多多客信息流投放备案视频上传接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.ddk.report.video.upload"
menu_path:
  - "多多客API"
  - "pdd.ddk.report.video.upload"
captured_at: "2026-04-09T15:18:32.381Z"
---
...
import com.pdd.pop.sdk.http.api.file.request.PddDdkReportVideoUploadRequest;
...
public class PopClientDemo {
 ...
        PddDdkReportVideoUploadRequest request = new PddDdkReportVideoUploadRequest();
        request.setFile("/tmp/image.jpg");
        PddDdkReportVideoUploadResponse response = client.syncInvoke(request);
