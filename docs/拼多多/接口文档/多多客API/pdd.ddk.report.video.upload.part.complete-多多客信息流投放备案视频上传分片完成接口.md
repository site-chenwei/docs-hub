---
title: "pdd.ddk.report.video.upload.part.complete - 多多客信息流投放备案视频上传分片完成接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.ddk.report.video.upload.part.complete"
menu_path:
  - "多多客API"
  - "pdd.ddk.report.video.upload.part.complete"
captured_at: "2026-04-09T15:18:23.080Z"
---
...
import com.pdd.pop.sdk.http.api.file.request.PddDdkReportVideoUploadPartCompleteRequest;
...
public class PopClientDemo {
 ...
        PddDdkReportVideoUploadPartCompleteRequest request = new PddDdkReportVideoUploadPartCompleteRequest();
        request.setUploadSign("str");
        PddDdkReportVideoUploadPartCompleteResponse response = client.syncInvoke(request);
