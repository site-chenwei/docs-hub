---
title: "pdd.ddk.report.video.upload.part.init - 多多客信息流投放备案视频上传分片初始化接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.ddk.report.video.upload.part.init"
menu_path:
  - "多多客API"
  - "pdd.ddk.report.video.upload.part.init"
captured_at: "2026-04-09T15:18:49.327Z"
---
...
import com.pdd.pop.sdk.http.api.file.request.PddDdkReportVideoUploadPartInitRequest;
...
public class PopClientDemo {
 ...
        PddDdkReportVideoUploadPartInitRequest request = new PddDdkReportVideoUploadPartInitRequest();
        request.setContentType("video/mp4");
        PddDdkReportVideoUploadPartInitResponse response = client.syncInvoke(request);
