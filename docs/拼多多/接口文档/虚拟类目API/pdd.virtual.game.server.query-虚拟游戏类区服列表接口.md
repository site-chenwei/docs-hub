---
title: "pdd.virtual.game.server.query - 虚拟游戏类区服列表接口"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.virtual.game.server.query"
menu_path:
  - "虚拟类目API"
  - "pdd.virtual.game.server.query"
captured_at: "2026-04-09T15:14:56.081Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| goods\_config\_code | STRING | 必填 | 游戏CODE |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| game\_server\_query\_response | OBJECT |  | response |
| goods\_config\_code | STRING |  | 游戏CODE |
| goods\_config\_id | LONG |  | 游戏ID |
| goods\_config\_name | STRING |  | 游戏配置名称 |
| item\_list | OBJECT\[\] |  | 区服信息 |
| children | OBJECT\[\] |  | 下级区服信息 |
| id | LONG |  | 区服ID |
| name | STRING |  | 名称 |
| type | INTEGER |  | 类型 1-区 2-服 |
| id | LONG |  | 区服ID |
| name | STRING |  | 名称 |
| type | INTEGER |  | 类型 1-区 2-服 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddVirtualGameServerQueryRequest;
...
public class PopClientDemo {
 ...
        PddVirtualGameServerQueryRequest request = new PddVirtualGameServerQueryRequest();
        request.setGoodsConfigCode("str");
        PddVirtualGameServerQueryResponse response = client.syncInvoke(request);
...
```
{
  "game_server_query_response": {
    "goods_config_code": "str",
    "goods_config_id": 0,
    "goods_config_name": "str",
    "item_list": [
      {
        "children": [
          {
...
| 50001 | 业务服务错误 | isv.service-error | 业务方系统错误 | 请联系业务方，或者开平客服反馈 |
