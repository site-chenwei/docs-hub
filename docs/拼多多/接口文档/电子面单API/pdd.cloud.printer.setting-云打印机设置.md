---
title: "pdd.cloud.printer.setting - 云打印机设置"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.cloud.printer.setting"
menu_path:
  - "电子面单API"
  - "pdd.cloud.printer.setting"
captured_at: "2026-04-09T15:23:02.983Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| request | OBJECT | 必填 | 开平请求基类 |
| density | INTEGER | 必填 | 打印浓度（1-淡，2-正常，3-浓） |
| printer\_id | STRING | 必填 | 打印机标识 |
...
| error\_msg | STRING |  |  |
| result | OBJECT |  |  |
| cloud\_printer\_setting\_result | BOOLEAN |  | 打印机设置修改结果 |
| success | BOOLEAN |  |  |
...
import com.pdd.pop.sdk.http.api.pop.request.PddCloudPrinterSettingRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddCloudPrinterSettingResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddCloudPrinterSettingRequest.Request;
...
public class PopClientDemo {
 ...
        PddCloudPrinterSettingRequest request = new PddCloudPrinterSettingRequest();

        Request request1 = new Request();
        request1.setDensity(0);
        request1.setPrinterId("str");
        request1.setShareCode("str");
        request.setRequest(request1);
        PddCloudPrinterSettingResponse response = client.syncInvoke(request, accessToken);
...
```
{
 ...
    "error_msg": "str",
    "result": {
      "cloud_printer_setting_result": false
    },
    "success": false
  }
}
...
| 50001 | 业务服务错误 | 2003 | 打印机未绑定，请重新申请绑定 | 打印机未绑定，请重新申请绑定 |
| 2006 | 共享码无效，请重新绑定 | 共享码无效，请重新绑定 |
| 2500 | 云打印机打印浓度设置失败 | 云打印机打印浓度设置失败 |
