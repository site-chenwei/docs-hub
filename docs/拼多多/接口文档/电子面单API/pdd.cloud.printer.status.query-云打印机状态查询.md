---
title: "pdd.cloud.printer.status.query - 云打印机状态查询"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.cloud.printer.status.query"
menu_path:
  - "电子面单API"
  - "pdd.cloud.printer.status.query"
captured_at: "2026-04-09T15:23:06.126Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| cloud\_printer\_status\_query\_request | OBJECT | 必填 | 打印状态查询请求 |
...
| error\_msg | STRING |  |  |
| result | OBJECT |  |  |
| printer\_id | STRING |  | 打印机id |
| signal\_strength | STRING |  | 信号强度dbm |
| signal\_strength\_friendly | INTEGER |  | 信号格度0-5,未查询到为null |
| status | STRING |  | 打印机状态 -1:未知 0:未找到打印机 1:不在线 2:在线 |
| success | BOOLEAN |  |  |
...
import com.pdd.pop.sdk.http.api.pop.request.PddCloudPrinterStatusQueryRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddCloudPrinterStatusQueryResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddCloudPrinterStatusQueryRequest.CloudPrinterStatusQueryRequest;
...
public class PopClientDemo {
 ...
        PddCloudPrinterStatusQueryRequest request = new PddCloudPrinterStatusQueryRequest();

        CloudPrinterStatusQueryRequest cloudPrinterStatusQueryRequest = new CloudPrinterStatusQueryRequest();
        cloudPrinterStatusQueryRequest.setPrinterId("str");
        cloudPrinterStatusQueryRequest.setShareCode("str");
        request.setCloudPrinterStatusQueryRequest(cloudPrinterStatusQueryRequest);
        PddCloudPrinterStatusQueryResponse response = client.syncInvoke(request, accessToken);
