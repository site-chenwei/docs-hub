---
title: "pdd.cloud.printer.bind - 云打印机绑定"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.cloud.printer.bind"
menu_path:
  - "电子面单API"
  - "pdd.cloud.printer.bind"
captured_at: "2026-04-09T15:22:59.890Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| cloud\_printer\_bind\_request | OBJECT | 必填 | 云打印绑定请求 |
| printer\_id | STRING | 必填 | 打印机id |
| verify\_code | STRING | 必填 | 验证码 |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| cloud\_printer\_bind\_response | OBJECT |  |  |
| errorCode | INTEGER |  |  |
| errorMsg | STRING |  |  |
| result | OBJECT |  |  |
| result | BOOLEAN |  |  |
...
import com.pdd.pop.sdk.http.api.pop.request.PddCloudPrinterBindRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddCloudPrinterBindResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddCloudPrinterBindRequest.CloudPrinterBindRequest;
...
public class PopClientDemo {
 ...
        PddCloudPrinterBindRequest request = new PddCloudPrinterBindRequest();

        CloudPrinterBindRequest cloudPrinterBindRequest = new CloudPrinterBindRequest();
        cloudPrinterBindRequest.setPrinterId("str");
        cloudPrinterBindRequest.setVerifyCode("str");
        request.setCloudPrinterBindRequest(cloudPrinterBindRequest);
        PddCloudPrinterBindResponse response = client.syncInvoke(request, accessToken);
