---
title: "pdd.cloudprint.stdtemplates.get - 获取所有标准电子面单模板"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.cloudprint.stdtemplates.get"
menu_path:
  - "电子面单API"
  - "pdd.cloudprint.stdtemplates.get"
captured_at: "2026-04-09T15:23:12.361Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| wp\_code | STRING | 非必填 | 快递公司code |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| pdd\_cloudprint\_stdtemplates\_get\_response | OBJECT |  | response |
| result | OBJECT |  | 结果集 |
| datas | OBJECT\[\] |  | 所有wp的标准模板 |
| standard\_templates | OBJECT\[\] |  | 该wp的所有标准模板 |
| standard\_template\_id | LONG |  | 模板id |
| standard\_template\_name | STRING |  | 模板名称 |
| standard\_template\_url | STRING |  | 模板url |
| standard\_waybill\_type | INTEGER |  | 模版类型 |
| wp\_code | STRING |  | wp编码 |
...
```
{
  "pdd_cloudprint_stdtemplates_get_response": {
    "result": {
      "datas": [
        {
          "standard_templates": [
            {
              "standard_template_id": 0,
              "standard_template_name": "str",
              "standard_template_url": "str",
              "standard_waybill_type": 0
            }
          ],
          "wp_code": "str"
        }
