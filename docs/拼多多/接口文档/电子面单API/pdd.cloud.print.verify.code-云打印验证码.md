---
title: "pdd.cloud.print.verify.code - 云打印验证码"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.cloud.print.verify.code"
menu_path:
  - "电子面单API"
  - "pdd.cloud.print.verify.code"
captured_at: "2026-04-09T15:22:56.777Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| cloud\_print\_verify\_code\_request | OBJECT | 必填 | 云打印验证码请求 |
...
| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| cloud\_print\_verify\_code\_response | OBJECT |  | 云打印验证码响应 |
| error\_code | INTEGER |  | 错误码 |
| error\_msg | STRING |  | 错误信息 |
| result | OBJECT |  | 响应结果 |
| result | BOOLEAN |  | true:请求验证码成功 false:请求验证码失败 |
...
import com.pdd.pop.sdk.http.api.pop.request.PddCloudPrintVerifyCodeRequest;
import com.pdd.pop.sdk.http.api.pop.response.PddCloudPrintVerifyCodeResponse;
import com.pdd.pop.sdk.http.api.pop.request.PddCloudPrintVerifyCodeRequest.CloudPrintVerifyCodeRequest;
...
public class PopClientDemo {
 ...
        PddCloudPrintVerifyCodeRequest request = new PddCloudPrintVerifyCodeRequest();

        CloudPrintVerifyCodeRequest cloudPrintVerifyCodeRequest = new CloudPrintVerifyCodeRequest();
        cloudPrintVerifyCodeRequest.setPrinterId("str");
        request.setCloudPrintVerifyCodeRequest(cloudPrintVerifyCodeRequest);
        PddCloudPrintVerifyCodeResponse response = client.syncInvoke(request, accessToken);
...
| 1002 | 云打印机验证码一分钟只能打印一次 | 云打印机验证码一分钟只能打印一次 |
| 2001 | 打印验证码失败 | 打印验证码失败，请重试 |
| 2005 | 打印验证码每日限制 | 打印验证码每日限制，请第二天重试 |
| 2007 | 打印机不在线，请尝试重启设备 | 打印机不在线，请尝试重启设备 |
| 2008 | 打印机id无效 | 打印机id无效 |
| 2011 | 请求打印机超时，请稍后再试 | 请求打印机超时，请稍后再试 |
| 2012 | 请求打印机失败，请稍后再试 | 请求打印机失败，请稍后再试 |
| 2100 | 系统繁忙，请稍后再试 | 系统繁忙，请稍后再试 |
| 9999 | 系统异常 | 系统异常 |
