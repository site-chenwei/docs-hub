---
title: "pdd.waybill.cancel - 商家取消获取的电子面单号"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.waybill.cancel"
menu_path:
  - "电子面单API"
  - "pdd.waybill.cancel"
captured_at: "2026-04-09T15:23:15.455Z"
---
...
| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| pdd\_waybill\_cancel\_response | OBJECT |  | response |
| cancel\_result | BOOLEAN |  | 调用取消是否成功 |
