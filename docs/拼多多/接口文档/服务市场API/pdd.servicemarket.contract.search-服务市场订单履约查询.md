---
title: "pdd.servicemarket.contract.search - 服务市场订单履约查询"
source_url: "https://open.pinduoduo.com/application/document/api?id=pdd.servicemarket.contract.search"
menu_path:
  - "服务市场API"
  - "pdd.servicemarket.contract.search"
captured_at: "2026-04-09T15:23:40.417Z"
---
...
| 参数接口 | 参数类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| mallId | LONG | 必填 | 买家店铺id |

### 返回参数说明

| 参数接口 | 参数类型 | 例子 | 说明 |
| --- | --- | --- | --- |
| servicemarket\_contract\_search\_response | OBJECT |  | response |
| endAt | LONG | 1588043682000 | 授权结束时间 |
| orderSns | STRING\[\] |  | 订单号列表 |
| specValue | OBJECT |  |  |
| specValueList | OBJECT\[\] |  |  |
| id | LONG | 1 | 规格值id |
| specName | STRING | 服务版本 | 规格名称 |
| specValue | STRING | 基础版 | 规格值名称 |
| timeLengthValue | LONG | 86400 | 规格时长参数 |
| startAt | LONG | 1588043682000 | 授权开始时间 |
...
public class PopClientDemo {
 ...
        PddServicemarketContractSearchResponse response = client.syncInvoke(request);
...
```
{
  "servicemarket_contract_search_response": {
    "endAt": 1588043682000,
    "orderSns": [
      "20200426-000007370036545"
    ],
    "specValue": {
      "specValueList": [
        {
 ...
          "specName": "服务版本",
          "specValue": "基础版",
          "timeLengthValue": 86400
        }
      ]
    },
    "startAt": 1588043682000
  }
}
```
