...
用法：
    python3 scripts/build_docset_index.py --hub-root . --docset harmonyos
    python3 scripts/build_docset_index.py --hub-root . --docset all --rebuild
"""
...
def main() -> None:
    ...
    ensure_initialized(hub_root, "构建索引")
